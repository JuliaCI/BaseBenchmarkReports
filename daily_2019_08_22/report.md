...
*Commit(s):* [JuliaLang/julia@828a2ecf3a8da5ac9ed85ef7646af46226105765](https://github.com/JuliaLang/julia/commit/828a2ecf3a8da5ac9ed85ef7646af46226105765)

*Triggered By:* [link](https://github.com/JuliaLang/julia/commit/828a2ecf3a8da5ac9ed85ef7646af46226105765#commitcomment-34786465)

*Tag Predicate:* `ALL`

*Daily Job:* 2019-08-22 vs 2019-08-21
...
|----|------------|--------------|
| `["array", "any/all", "(\"all\", \"Array{Int64,1}\")"]` | 1.06 (5%) :x: | 1.00 (1%)  |
...
| `["broadcast", "dotop", "(\"Float64\", (1000, 1000), 2)"]` | 1.00 (5%)  | 0.00 (1%) :white_check_mark: |
...
| `["random", "types", "(\"randn\", \"MersenneTwister\", \"Complex{Float16}\")"]` | 1.40 (25%) :x: | 1.00 (1%)  |
...
| `["scalar", "asinh", "(\"0 <= abs(x) < 2^-28\", \"negative argument\", \"Float64\")"]` | 1.17 (5%) :x: | 1.00 (1%)  |
...
| `["scalar", "exp2", "(\"2pow35\", \"negative argument\", \"Float64\")"]` | 0.53 (5%) :white_check_mark: | 1.00 (1%)  |
...
| `["scalar", "tan", "(\"very small\", \"negative argument\", \"Float32\")"]` | 1.24 (5%) :x: | 1.00 (1%)  |
| `["scalar", "tan", "(\"very small\", \"negative argument\", \"Float64\")"]` | 1.69 (5%) :x: | 1.00 (1%)  |
| `["scalar", "tan", "(\"very small\", \"positive argument\", \"Float32\")"]` | 0.94 (5%) :white_check_mark: | 1.00 (1%)  |
| `["scalar", "tanh", "(\"0 <= abs(x) < 2f0^-12\", \"positive argument\", \"Float32\")"]` | 0.80 (5%) :white_check_mark: | 1.00 (1%)  |
| `["simd", "(\"loop_fields!\", \"Float32\", \"BaseBenchmarks.SIMDBenchmarks.MutableFields\", 4095)"]` | 1.23 (20%) :x: | 1.00 (1%)  |
...
| `["sparse", "constructors", "(\"IV\", 100)"]` | 0.60 (5%) :white_check_mark: | 1.00 (1%)  |
...
| `["tuple", "reduction", "(\"minimum\", (2, 2))"]` | 0.78 (5%) :white_check_mark: | 1.00 (1%)  |
...
| `["union", "array", "(\"perf_sum2\", Complex{Float64}, true)"]` | 1.26 (5%) :x: | 1.00 (1%)  |
...
| `["union", "array", "(\"perf_sum\", Float32, true)"]` | 0.89 (5%) :white_check_mark: | 1.00 (1%)  |
...
```
Julia Version 1.4.0-DEV.29
Commit 828a2ec (2019-08-21 21:19 UTC)
Platform Info:
  ...
  CPU: Intel(R) Xeon(R) CPU E3-1241 v3 @ 3.50GHz: 
       ...
       #1  3501 MHz   97792716 s       5041 s   11329847 s  4309674192 s         28 s
       #2  3501 MHz  659711658 s        208 s   11357566 s  3754728131 s         24 s
       #3  3501 MHz   81236270 s       3245 s    6733275 s  4337835025 s         32 s
       #4  3501 MHz   76220442 s         24 s    9497340 s  4338338899 s         22 s
       
  Memory: 31.383651733398438 GB (14511.55078125 MB free)
  Uptime: 4.4290611e7 sec
