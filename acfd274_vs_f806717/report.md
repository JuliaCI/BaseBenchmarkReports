...
*Commit(s):* [JuliaLang/julia@acfd2742ae2deb04dd6c88c0f2fe0ba39cd29d16](https://github.com/JuliaLang/julia/commit/acfd2742ae2deb04dd6c88c0f2fe0ba39cd29d16) vs [JuliaLang/julia@f8067172557e4967714e92450f27d74dbf959760](https://github.com/JuliaLang/julia/commit/f8067172557e4967714e92450f27d74dbf959760)

*Triggered By:* [link](https://github.com/JuliaLang/julia/pull/33678#issuecomment-546532955)
...
| `["array", "cat", "(\"hcat\", 500)"]` | 1.20 (5%) :x: | 1.00 (1%)  |
...
| `["collection", "queries & updates", "(\"Set\", \"String\", \"pop!\", \"specified\")"]` | 0.46 (25%) :white_check_mark: | 1.00 (1%)  |
...
| `["random", "types", "(\"rand!\", \"MersenneTwister\", \"Complex{Float64}\")"]` | 1.81 (25%) :x: | 1.00 (1%)  |
| `["scalar", "arithmetic", "(\"add\", \"BigInt\", \"BigInt\")"]` | 1.81 (50%) :x: | 1.00 (1%)  |
| `["scalar", "arithmetic", "(\"rem type\", \"Char\", \"BigInt\")"]` | 1.71 (40%) :x: | 1.00 (1%)  |
...
| `["sparse", "index", "(\"spmat\", \"row\", \"logical\", 1000)"]` | 1.65 (30%) :x: | 1.00 (1%)  |
| `["sparse", "matmul", "(\"A_mul_B\", \"dense 5x5, sparse 5x500 -> dense 5x500\")"]` | 1.30 (30%) :x: | 1.00 (1%)  |
| `["sparse", "matmul", "(\"A_mul_B\", \"dense 5x50, sparse 50x500 -> dense 5x500\")"]` | 1.40 (30%) :x: | 1.00 (1%)  |
| `["sparse", "matmul", "(\"A_mul_B\", \"dense 5x500, sparse 500x500 -> dense 5x500\")"]` | 1.42 (30%) :x: | 1.00 (1%)  |
| `["sparse", "matmul", "(\"At_mul_B!\", \"dense 400x400, sparse 400x40 -> dense 400x40\")"]` | 1.35 (30%) :x: | 1.00 (1%)  |
| `["sparse", "matmul", "(\"At_mul_B!\", \"dense 40x4000, sparse 40x40 -> dense 4000x40\")"]` | 1.36 (30%) :x: | 1.00 (1%)  |
| `["sparse", "matmul", "(\"At_mul_B\", \"dense 500x5, sparse 500x50 -> dense 5x50\")"]` | 1.63 (30%) :x: | 1.00 (1%)  |
| `["sparse", "matmul", "(\"At_mul_B\", \"dense 500x5, sparse 500x500 -> dense 5x500\")"]` | 1.70 (30%) :x: | 1.00 (1%)  |
| `["sparse", "matmul", "(\"At_mul_B\", \"dense 50x5, sparse 50x500 -> dense 5x500\")"]` | 1.70 (30%) :x: | 1.00 (1%)  |
| `["sparse", "matmul", "(\"At_mul_B\", \"dense 50x50, sparse 50x50 -> dense 50x50\")"]` | 1.62 (30%) :x: | 1.00 (1%)  |
| `["sparse", "matmul", "(\"At_mul_B\", \"dense 5x5, sparse 5x500 -> dense 5x500\")"]` | 1.71 (30%) :x: | 1.00 (1%)  |
| `["sparse", "matmul", "(\"At_mul_B\", \"dense 5x50, sparse 5x50 -> dense 50x50\")"]` | 1.68 (30%) :x: | 1.00 (1%)  |
...
| `["union", "array", "(\"broadcast\", abs, Float32, false)"]` | 1.26 (5%) :x: | 1.00 (1%)  |
...
| `["union", "array", "(\"skipmissing\", sum, Union{Nothing, Int64}, false)"]` | 1.14 (5%) :x: | 1.00 (1%)  |
| `["union", "array", "(\"skipmissing\", sum, Union{Nothing, Int8}, false)"]` | 1.24 (5%) :x: | 1.00 (1%)  |
...
```
Julia Version 1.4.0-DEV.376
Commit acfd274 (2019-10-25 22:24 UTC)
Platform Info:
  ...
  CPU: Intel(R) Xeon(R) CPU E3-1241 v3 @ 3.50GHz: 
       ...
       #1  3501 MHz   52962584 s       2442 s   15296814 s  4904412021 s         16 s
       #2  3501 MHz  325564767 s         42 s    6287244 s  4653526164 s         23 s
       #3  3501 MHz   44032094 s       3196 s    5183711 s  4936039481 s         35 s
       #4  3501 MHz   42439940 s         16 s    4031031 s  4940746545 s         31 s
       
  Memory: 31.383651733398438 GB (15199.48828125 MB free)
  Uptime: 4.9887783e7 sec
...
Platform Info:
  ...
  CPU: Intel(R) Xeon(R) CPU E3-1241 v3 @ 3.50GHz: 
              speed         user         nice          sys         idle          irq
       #1  3501 MHz   53071988 s       2442 s   15305706 s  4905602197 s         16 s
       #2  3501 MHz  326791721 s         42 s    6312022 s  4653587296 s         23 s
       #3  3501 MHz   44135464 s       3196 s    5188284 s  4937244967 s         35 s
       #4  3501 MHz   42541135 s         16 s    4035490 s  4941954496 s         31 s
       
  Memory: 31.383651733398438 GB (14869.71875 MB free)
  Uptime: 4.9900923e7 sec
  Load Avg:  1.0029296875  1.0146484375  1.04541015625
  WORD_SIZE: 64
  LIBM: libopenlibm
  LLVM: libLLVM-6.0.1 (ORCJIT, haswell)
