...
*Commit(s):* [JuliaLang/julia@f227b9b1feb9a6f41ba24cbfd5508a0acda443bd](https://github.com/JuliaLang/julia/commit/f227b9b1feb9a6f41ba24cbfd5508a0acda443bd)

*Triggered By:* [link](https://github.com/JuliaLang/julia/commit/f227b9b1feb9a6f41ba24cbfd5508a0acda443bd#commitcomment-33316811)

*Tag Predicate:* `ALL`

*Daily Job:* 2019-04-26 vs 2019-04-25
...
| `["io", "array_limit", "(\"display\", \"Array{Float64,1}(100000000,)\")"]` | 1.06 (5%) :x: | 1.01 (1%)  |
| `["io", "array_limit", "(\"display\", \"Array{Float64,2}(10000, 10000)\")"]` | 1.06 (5%) :x: | 1.00 (1%)  |
| `["io", "array_limit", "(\"display\", \"Array{Float64,2}(100000000, 1)\")"]` | 1.06 (5%) :x: | 1.01 (1%)  |
...
| `["problem", "json", "parse_json"]` | 1.23 (5%) :x: | 1.00 (1%)  |
| `["problem", "laplacian", "laplace_sparse_matvec"]` | 1.06 (5%) :x: | 1.00 (1%)  |
| `["random", "types", "(\"randn\", \"RandomDevice\", \"ImplicitFloat64\")"]` | 1.35 (25%) :x: | 1.00 (1%)  |
...
| `["scalar", "atan2", "(\"y infinite\", \"y negative\", \"x infinite\", \"x negative\", \"Float32\")"]` | 0.93 (5%) :white_check_mark: | 1.00 (1%)  |
...
| `["scalar", "cos", "(\"argument reduction (hard) abs(x) < 8π/4\", \"negative argument\", \"Float32\", \"cos_kernel\")"]` | 1.23 (5%) :x: | 1.00 (1%)  |
...
| `["scalar", "exp2", "(\"one\", \"Float64\")"]` | 0.73 (5%) :white_check_mark: | 1.00 (1%)  |
| `["scalar", "exp2", "(\"very small\", \"negative argument\", \"Float64\")"]` | 0.88 (5%) :white_check_mark: | 1.00 (1%)  |
...
| `["scalar", "tan", "(\"very small\", \"negative argument\", \"Float64\")"]` | 0.76 (5%) :white_check_mark: | 1.00 (1%)  |
...
| `["union", "array", "(\"map\", identity, Float64, true)"]` | 1.22 (5%) :x: | 1.00 (1%)  |
...
```
Julia Version 1.3.0-DEV.115
Commit f227b9b (2019-04-26 01:50 UTC)
Platform Info:
  ...
  CPU: Intel(R) Xeon(R) CPU E3-1241 v3 @ 3.50GHz: 
       ...
       #1  3501 MHz   86638678 s       5023 s    9798248 s  3304744317 s         24 s
       #2  3501 MHz  544661436 s        203 s    9128969 s  2852881817 s         20 s
       #3  3501 MHz   69882943 s       3237 s    5834369 s  3330994609 s         30 s
       #4  3501 MHz   65670558 s         12 s    7748140 s  3332250661 s         18 s
       
  Memory: 31.383651733398438 GB (5517.8359375 MB free)
  Uptime: 3.4093611e7 sec
