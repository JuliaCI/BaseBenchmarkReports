...
*Commit(s):* [JuliaLang/julia@3a431577893c8991c0887402c181aef6d606e6c3](https://github.com/JuliaLang/julia/commit/3a431577893c8991c0887402c181aef6d606e6c3)

*Triggered By:* [link](https://github.com/JuliaLang/julia/commit/3a431577893c8991c0887402c181aef6d606e6c3#commitcomment-31113557)

*Tag Predicate:* `ALL`

*Daily Job:* 2018-10-31 vs 2018-10-30
...
| `["array", "growth", "(\"prerend!\", 256)"]` | 1.25 (5%) :x: | 1.00 (1%)  |
...
| `["array", "reductions", "(\"Statistics.mean\", \"Int64\")"]` | 0.94 (5%) :white_check_mark: | 1.00 (1%)  |
...
| `["collection", "iteration", "(\"IdDict\", \"Int\", \"iterate second\")"]` | 1.29 (25%) :x: | 1.00 (1%)  |
| `["collection", "iteration", "(\"IdDict\", \"String\", \"iterate\")"]` | 1.33 (25%) :x: | 1.00 (1%)  |
| `["collection", "set operations", "(\"BitSet\", \"Int\", \"⊆\", \"Vector\")"]` | 1.33 (25%) :x: | 1.00 (1%)  |
| `["dates", "parse", "(\"DateTime\", \"RFC1123Format\", \"Lowercase\")"]` | 0.68 (5%) :white_check_mark: | 1.00 (1%)  |
| `["dates", "parse", "(\"DateTime\", \"RFC1123Format\", \"Mixedcase\")"]` | 0.77 (5%) :white_check_mark: | 1.00 (1%)  |
| `["dates", "parse", "(\"DateTime\", \"RFC1123Format\", \"Titlecase\")"]` | 0.69 (5%) :white_check_mark: | 1.00 (1%)  |
...
| `["scalar", "arithmetic", "(\"add\", \"Complex{Float64}\", \"BigInt\")"]` | 1.62 (50%) :x: | 1.00 (1%)  |
...
| `["scalar", "exp2", "(\"2pow35\", \"positive argument\", \"Float32\")"]` | 1.47 (5%) :x: | 1.00 (1%)  |
...
```
Julia Version 1.1.0-DEV.583
Commit 3a43157 (2018-10-31 00:50 UTC)
Platform Info:
  ...
  CPU: Intel(R) Xeon(R) CPU E3-1241 v3 @ 3.50GHz: 
       ...
       #1  3501 MHz   58576814 s       5004 s    6432606 s  1811635207 s         21 s
       #2  3501 MHz  311479388 s        203 s    4979438 s  1563461140 s         14 s
       #3  3501 MHz   43059549 s       3209 s    3677386 s  1833175038 s         25 s
       #4  3501 MHz   39900274 s          0 s    4587548 s  1835089935 s         14 s
       
  Memory: 31.383651733398438 GB (4841.0625 MB free)
  Uptime: 1.8815334e7 sec
