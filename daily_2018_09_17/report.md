...
*Commit(s):* [JuliaLang/julia@7d6bc6bd1eb12d08113efb1995717ae6b2bccdcd](https://github.com/JuliaLang/julia/commit/7d6bc6bd1eb12d08113efb1995717ae6b2bccdcd)

*Triggered By:* [link](https://github.com/JuliaLang/julia/commit/7d6bc6bd1eb12d08113efb1995717ae6b2bccdcd#commitcomment-30524141)

*Tag Predicate:* `ALL`

*Daily Job:* 2018-09-17 vs 2018-09-16
...
| `["find", "findnext", "(\"ispos\", \"Array{UInt8,1}\")"]` | 1.24 (5%) :x: | 1.00 (1%)  |
...
| `["random", "collections", "(\"rand\", \"ImplicitRNG\", \"small Dict\")"]` | 1.52 (25%) :x: | 1.00 (1%)  |
| `["random", "ranges", "(\"RangeGenerator\", \"BigInt\", \"1:18446744073709551615\")"]` | 1.30 (25%) :x: | 1.00 (1%)  |
| `["random", "ranges", "(\"RangeGenerator\", \"BigInt\", \"1:4294967297\")"]` | 1.25 (25%) :x: | 1.00 (1%)  |
...
| `["scalar", "arithmetic", "(\"add\", \"UInt64\", \"BigInt\")"]` | 1.57 (50%) :x: | 1.00 (1%)  |
| `["scalar", "arithmetic", "(\"add\", \"UInt64\", \"Complex{BigInt}\")"]` | 1.55 (50%) :x: | 1.00 (1%)  |
| `["scalar", "arithmetic", "(\"mul\", \"BigInt\", \"UInt64\")"]` | 1.61 (50%) :x: | 1.00 (1%)  |
| `["scalar", "arithmetic", "(\"sub\", \"Int64\", \"BigInt\")"]` | 1.70 (50%) :x: | 1.00 (1%)  |
...
| `["scalar", "atan", "(\"very small\", \"positive argument\", \"Float64\")"]` | 0.54 (5%) :white_check_mark: | 1.00 (1%)  |
| `["scalar", "atan2", "(\"abs(y/x) high\", \"y negative\", \"x negative\", \"Float32\")"]` | 1.06 (5%) :x: | 1.00 (1%)  |
| `["scalar", "atan2", "(\"abs(y/x) high\", \"y positive\", \"x negative\", \"Float64\")"]` | 0.94 (5%) :white_check_mark: | 1.00 (1%)  |
...
| `["scalar", "cos", "(\"argument reduction (hard) abs(x) < 6π/4\", \"negative argument\", \"Float32\", \"sin_kernel\")"]` | 0.85 (5%) :white_check_mark: | 1.00 (1%)  |
...
| `["union", "array", "(\"map\", identity, Complex{Float64}, true)"]` | 1.11 (5%) :x: | 1.00 (1%)  |
...
| `["union", "array", "(\"perf_sum2\", Complex{Float64}, true)"]` | 1.18 (5%) :x: | 1.00 (1%)  |
...
```
Julia Version 1.1.0-DEV.270
Commit 7d6bc6b (2018-09-17 01:57 UTC)
Platform Info:
  ...
  CPU: Intel(R) Xeon(R) CPU E3-1241 v3 @ 3.50GHz: 
       ...
       #1  3501 MHz   49767769 s       4998 s    5443729 s  1440827457 s         20 s
       #2  3501 MHz  237946282 s        203 s    3711920 s  1257014909 s         10 s
       #3  3501 MHz   34171608 s       3200 s    3014762 s  1461486789 s         22 s
       #4  3501 MHz   31725716 s          0 s    3705483 s  1463036655 s         10 s
       
  Memory: 31.383651733398438 GB (4981.3984375 MB free)
  Uptime: 1.4999874e7 sec
