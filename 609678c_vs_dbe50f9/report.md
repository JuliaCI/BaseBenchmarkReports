...
*Commit(s):* [JuliaLang/julia@609678c6684d68c8b3969c32eba9eba8cd84a9ba](https://github.com/JuliaLang/julia/commit/609678c6684d68c8b3969c32eba9eba8cd84a9ba) vs [JuliaLang/julia@dbe50f9787cd056b39917612394eeab339e34406](https://github.com/JuliaLang/julia/commit/dbe50f9787cd056b39917612394eeab339e34406)

*Triggered By:* [link](https://github.com/JuliaLang/julia/pull/31407#issuecomment-477726720)
...
| `["io", "array_limit", "(\"display\", \"Array{Float64,1}(100000000,)\")"]` | 1.05 (5%)  | 1.01 (1%) :x: |
| `["io", "array_limit", "(\"display\", \"Array{Float64,2}(10000, 10000)\")"]` | 0.99 (5%)  | 0.97 (1%) :white_check_mark: |
| `["io", "array_limit", "(\"display\", \"Array{Float64,2}(100000000, 1)\")"]` | 1.04 (5%)  | 1.01 (1%) :x: |
...
| `["random", "types", "(\"randn\", \"MersenneTwister\", \"Float64\")"]` | 0.74 (25%) :white_check_mark: | 1.00 (1%)  |
| `["scalar", "acos", "(\"0.5 <= abs(x) < 1\", \"negative argument\", \"Float64\")"]` | 1.08 (5%) :x: | 1.00 (1%)  |
| `["scalar", "acos", "(\"small\", \"negative argument\", \"Float32\")"]` | 1.47 (5%) :x: | 1.00 (1%)  |
...
| `["scalar", "atan2", "(\"abs(y/x) high\", \"y negative\", \"x negative\", \"Float32\")"]` | 0.86 (5%) :white_check_mark: | 1.00 (1%)  |
| `["scalar", "atan2", "(\"abs(y/x) high\", \"y positive\", \"x positive\", \"Float32\")"]` | 1.73 (5%) :x: | 1.00 (1%)  |
...
| `["scalar", "cos", "(\"no reduction\", \"zero\", \"Float32\")"]` | 1.14 (5%) :x: | 1.00 (1%)  |
| `["scalar", "cos", "(\"no reduction\", \"zero\", \"Float64\")"]` | 1.14 (5%) :x: | 1.00 (1%)  |
| `["scalar", "exp2", "(\"2pow1023\", \"negative argument\", Float64)"]` | 1.43 (5%) :x: | 1.00 (1%)  |
...
| `["scalar", "sin", "(\"argument reduction (paynehanek) abs(x) > 2.0^20*π/2\", \"negative argument\", \"Float32\", \"sin_kernel\")"]` | 1.10 (5%) :x: | 1.00 (1%)  |
...
| `["scalar", "sinh", "(\"very small\", \"negative argument\", \"Float64\")"]` | 0.63 (5%) :white_check_mark: | 1.00 (1%)  |
...
| `["shootout", "binary_trees"]` | 1.17 (5%) :x: | 1.00 (1%)  |
...
| `["sparse", "index", "(\"spmat\", \"integer\", 1000)"]` | 1.32 (30%) :x: | 1.00 (1%)  |
...
| `["union", "array", "(\"broadcast\", identity, Complex{Float64}, false)"]` | 1.10 (5%) :x: | 1.00 (1%)  |
...
| `["union", "array", "(\"map\", identity, Int8, true)"]` | 0.84 (5%) :white_check_mark: | 1.00 (1%)  |
...
| `["union", "array", "(\"perf_sum2\", Int8, true)"]` | 0.79 (5%) :white_check_mark: | 1.00 (1%)  |
...
Commit 609678c (2019-03-28 18:34 UTC)
Platform Info:
  ...
  CPU: Intel(R) Xeon(R) CPU E3-1241 v3 @ 3.50GHz: 
       ...
       #1  3501 MHz   45735028 s       2430 s    9807806 s  3098939624 s         12 s
       #2  3501 MHz  260751301 s         14 s    4733403 s  2896414818 s         19 s
       #3  3501 MHz   36743798 s       3161 s    4483568 s  3120469305 s         27 s
       #4  3501 MHz   35430616 s         14 s    3366432 s  3124300440 s         24 s
       
  Memory: 31.383651733398438 GB (4961.5625 MB free)
  Uptime: 3.1642943e7 sec
...
```
Julia Version 1.2.0-DEV.565
Commit dbe50f9 (2019-03-28 18:25 UTC)
Platform Info:
  OS: Linux (x86_64-linux-gnu)
      Ubuntu 14.04.5 LTS
  uname: Linux 3.13.0-85-generic #129-Ubuntu SMP Thu Mar 17 20:50:15 UTC 2016 x86_64 x86_64
  CPU: Intel(R) Xeon(R) CPU E3-1241 v3 @ 3.50GHz: 
              speed         user         nice          sys         idle          irq
       #1  3501 MHz   45849884 s       2430 s    9818368 s  3099985267 s         12 s
       #2  3501 MHz  261846196 s         14 s    4749587 s  2896478422 s         19 s
       #3  3501 MHz   36862370 s       3161 s    4490765 s  3121518159 s         27 s
       #4  3501 MHz   35547849 s         14 s    3373286 s  3125351164 s         24 s
       
  Memory: 31.383651733398438 GB (4644.58203125 MB free)
  Uptime: 3.1654697e7 sec
