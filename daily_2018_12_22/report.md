...
*Commit(s):* [JuliaLang/julia@da1df1e094c50dcfe5781b512cd385acf9dd27b4](https://github.com/JuliaLang/julia/commit/da1df1e094c50dcfe5781b512cd385acf9dd27b4)

*Triggered By:* [link](https://github.com/JuliaLang/julia/commit/da1df1e094c50dcfe5781b512cd385acf9dd27b4#commitcomment-31763973)

*Tag Predicate:* `ALL`

*Daily Job:* 2018-12-22 vs 2018-12-21
...
| `["array", "comprehension", "(\"collect\", \"Array{Float64,1}\")"]` | 1.12 (5%) :x: | 1.00 (1%)  |
| `["array", "comprehension", "(\"collect\", \"StepRangeLen{Float64,Base.TwicePrecision{Float64},Base.TwicePrecision{Float64}}\")"]` | 1.08 (5%) :x: | 1.00 (1%)  |
| `["array", "comprehension", "(\"comprehension_collect\", \"Array{Float64,1}\")"]` | 1.14 (5%) :x: | 1.00 (1%)  |
| `["array", "comprehension", "(\"comprehension_collect\", \"StepRangeLen{Float64,Base.TwicePrecision{Float64},Base.TwicePrecision{Float64}}\")"]` | 1.11 (5%) :x: | 1.00 (1%)  |
...
| `["array", "growth", "(\"append!\", 256)"]` | 1.12 (5%) :x: | 1.00 (1%)  |
| `["array", "growth", "(\"prerend!\", 256)"]` | 1.18 (5%) :x: | 1.00 (1%)  |
| `["array", "index", "(\"sumvector_view\", \"Array{Float32,2}\")"]` | 1.61 (50%) :x: | 1.00 (1%)  |
| `["array", "index", "(\"sumvector_view\", \"Array{Int32,2}\")"]` | 1.68 (50%) :x: | 1.00 (1%)  |
| `["array", "index", "(\"sumvector_view\", \"SubArray{Float32,2,Array{Float32,2},Tuple{Base.Slice{Base.OneTo{Int64}},Base.Slice{Base.OneTo{Int64}}},true}\")"]` | 1.71 (50%) :x: | 1.00 (1%)  |
...
| `["collection", "iteration", "(\"BitSet\", \"Int\", \"iterate\")"]` | 0.49 (25%) :white_check_mark: | 1.00 (1%)  |
| `["collection", "queries & updates", "(\"Dict\", \"Any\", \"pop!\", \"specified\")"]` | 1.54 (25%) :x: | 1.00 (1%)  |
| `["collection", "queries & updates", "(\"Dict\", \"Any\", \"push!\", \"overwrite\")"]` | 1.33 (25%) :x: | 1.00 (1%)  |
| `["collection", "queries & updates", "(\"Dict\", \"Any\", \"setindex!\", \"new\")"]` | 1.26 (25%) :x: | 1.00 (1%)  |
| `["collection", "queries & updates", "(\"Dict\", \"Any\", \"setindex!\", \"overwrite\")"]` | 1.49 (25%) :x: | 1.00 (1%)  |
| `["collection", "queries & updates", "(\"Dict\", \"Int\", \"pop!\", \"unspecified\")"]` | 0.68 (25%) :white_check_mark: | 1.00 (1%)  |
...
| `["find", "findnext", "(\"ispos\", \"Array{Float32,1}\")"]` | 1.17 (5%) :x: | 1.00 (1%)  |
...
| `["problem", "go", "go_game"]` | 1.18 (5%) :x: | 1.00 (1%)  |
| `["problem", "grigoriadis khachiyan", "grigoriadis_khachiyan"]` | 1.21 (5%) :x: | 1.00 (1%)  |
...
| `["problem", "ziggurat", "ziggurat"]` | 1.23 (5%) :x: | 1.00 (1%)  |
...
| `["random", "ranges", "(\"rand\", \"MersenneTwister\", \"BigInt\", \"RangeGenerator(1:170141183460469231731687303715884105728)\")"]` | 1.27 (25%) :x: | 1.00 (1%)  |
...
| `["scalar", "arithmetic", "(\"sub\", \"BigInt\", \"UInt64\")"]` | 1.85 (50%) :x: | 1.00 (1%)  |
...
| `["scalar", "atan", "(\"very small\", \"positive argument\", \"Float32\")"]` | 1.71 (5%) :x: | 1.00 (1%)  |
...
| `["scalar", "cosh", "(\"very large\", \"negative argument\", \"Float32\")"]` | 1.17 (5%) :x: | 1.00 (1%)  |
...
| `["scalar", "exp2", "(\"2pow35\", \"positive argument\", \"Float64\")"]` | 0.47 (5%) :white_check_mark: | 1.00 (1%)  |
| `["scalar", "exp2", "(\"zero\", \"Float32\")"]` | 1.08 (5%) :x: | 1.00 (1%)  |
| `["scalar", "expm1", "(\"arg reduction II\", \"negative argument\", \"Float32\")"]` | 1.30 (5%) :x: | 1.00 (1%)  |
...
| `["scalar", "predicate", "(\"isfinite\", \"Complex{BigInt}\")"]` | 1.42 (40%) :x: | 1.00 (1%)  |
...
| `["sparse", "index", "(\"spvec\", \"integer\", 100000)"]` | 1.37 (30%) :x: | 1.00 (1%)  |
...
| `["sparse", "sparse solves", "least squares (qr), vector rhs"]` | 1.12 (5%) :x: | 1.00 (1%)  |
...
| `["tuple", "reduction", "(\"sum\", (8,))"]` | 0.78 (5%) :white_check_mark: | 1.00 (1%)  |
...
| `["union", "array", "(\"perf_sum2\", Complex{Float64}, true)"]` | 1.06 (5%) :x: | 1.00 (1%)  |
...
| `["union", "array", "(\"perf_sum3\", Float32, true)"]` | 1.25 (5%) :x: | 1.00 (1%)  |
| `["union", "array", "(\"perf_sum3\", Float64, true)"]` | 0.82 (5%) :white_check_mark: | 1.00 (1%)  |
| `["union", "array", "(\"perf_sum4\", Complex{Float64}, true)"]` | 1.13 (5%) :x: | 1.00 (1%)  |
...
```
Julia Version 1.2.0-DEV.56
Commit da1df1e (2018-12-22 04:25 UTC)
Platform Info:
  ...
  CPU: Intel(R) Xeon(R) CPU E3-1241 v3 @ 3.50GHz: 
       ...
       #1  3501 MHz   68053986 s       5010 s    7511414 s  2248488184 s         22 s
       #2  3501 MHz  384113817 s        203 s    6274345 s  1937565135 s         18 s
       #3  3501 MHz   52081110 s       3218 s    4384217 s  2271405682 s         26 s
       #4  3501 MHz   48659007 s          0 s    5610333 s  2273106818 s         16 s
       
  Memory: 31.383651733398438 GB (4274.69921875 MB free)
  Uptime: 2.32987e7 sec
