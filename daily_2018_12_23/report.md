...
*Commit(s):* [JuliaLang/julia@341e031c0a9d61b13d63777ab877f68177d16d19](https://github.com/JuliaLang/julia/commit/341e031c0a9d61b13d63777ab877f68177d16d19)

*Triggered By:* [link](https://github.com/JuliaLang/julia/commit/341e031c0a9d61b13d63777ab877f68177d16d19#commitcomment-31766602)

*Tag Predicate:* `ALL`

*Daily Job:* 2018-12-23 vs 2018-12-22
...
| `["array", "growth", "(\"append!\", 256)"]` | 0.90 (5%) :white_check_mark: | 1.00 (1%)  |
...
| `["broadcast", "typeargs", "(\"tuple\", 10)"]` | 1.30 (5%) :x: | 1.00 (1%)  |
| `["collection", "deletion", "(\"Vector\", \"Int\", \"filter!\")"]` | 1.31 (25%) :x: | 1.00 (1%)  |
| `["collection", "iteration", "(\"BitSet\", \"Int\", \"iterate\")"]` | 2.19 (25%) :x: | 1.00 (1%)  |
| `["collection", "iteration", "(\"IdDict\", \"Any\", \"iterate\")"]` | 1.29 (25%) :x: | 1.00 (1%)  |
| `["collection", "iteration", "(\"Vector\", \"Any\", \"iterate second\")"]` | 1.28 (25%) :x: | 1.00 (1%)  |
| `["collection", "queries & updates", "(\"Dict\", \"Any\", \"pop!\", \"specified\")"]` | 0.69 (25%) :white_check_mark: | 1.00 (1%)  |
| `["collection", "queries & updates", "(\"Dict\", \"Any\", \"setindex!\", \"overwrite\")"]` | 0.67 (25%) :white_check_mark: | 1.00 (1%)  |
...
| `["io", "array_limit", "(\"display\", \"Array{Float64,2}(10000, 10000)\")"]` | 0.95 (5%)  | 0.92 (1%) :white_check_mark: |
...
| `["scalar", "atan", "(\"11/16 <= abs(x) < 19/16\", \"positive argument\", \"Float32\")"]` | 1.19 (5%) :x: | 1.00 (1%)  |
| `["scalar", "atan", "(\"19/16 <= abs(x) < 39/16\", \"negative argument\", \"Float64\")"]` | 1.26 (5%) :x: | 1.00 (1%)  |
| `["scalar", "atan", "(\"very small\", \"positive argument\", \"Float32\")"]` | 0.58 (5%) :white_check_mark: | 1.00 (1%)  |
...
| `["scalar", "predicate", "(\"isequal\", \"Complex{BigInt}\")"]` | 2.22 (40%) :x: | 1.00 (1%)  |
...
| `["sparse", "index", "(\"spmat\", \"row\", \"logical\", 1000)"]` | 1.59 (30%) :x: | 1.00 (1%)  |
...
| `["tuple", "reduction", "(\"sum\", (8,))"]` | 1.33 (5%) :x: | 1.00 (1%)  |
...
| `["union", "array", "(\"perf_simplecopy\", BigFloat, false)"]` | 1.14 (5%) :x: | 1.00 (1%)  |
...
```
Julia Version 1.2.0-DEV.59
Commit 341e031 (2018-12-22 21:47 UTC)
Platform Info:
  ...
  CPU: Intel(R) Xeon(R) CPU E3-1241 v3 @ 3.50GHz: 
       ...
       #1  3501 MHz   68182166 s       5010 s    7529442 s  2256920818 s         22 s
       #2  3501 MHz  385298808 s        203 s    6295464 s  1944950784 s         18 s
       #3  3501 MHz   52204358 s       3218 s    4396501 s  2279861120 s         26 s
       #4  3501 MHz   48772617 s          0 s    5624454 s  2281569089 s         16 s
       
  Memory: 31.383651733398438 GB (4928.8125 MB free)
  Uptime: 2.3384678e7 sec
