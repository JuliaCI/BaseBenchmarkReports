...
*Triggered By:* [link](https://github.com/JuliaLang/julia/commit/442d1599e62b1a3a453bd0c28c9a795e09e939ff#commitcomment-34490923)

*Tag Predicate:* `ALL`

*Daily Job:* 2019-07-30 vs 2019-07-29
...
| `["array", "index", "(\"sumcolon\", \"100000:-1:1\")"]` | 1.88 (50%) :x: | 1.00 (1%)  |
| `["array", "index", "(\"sumcolon\", \"1:100000\")"]` | 1.73 (50%) :x: | 1.00 (1%)  |
...
| `["collection", "queries & updates", "(\"Set\", \"Int\", \"pop!\", \"unspecified\")"]` | 2.57 (25%) :x: | 1.00 (1%)  |
...
| `["io", "array_limit", "(\"display\", \"Array{Float64,2}(10000, 10000)\")"]` | 1.08 (5%) :x: | 1.04 (1%) :x: |
...
| `["scalar", "acos", "(\"0.5 <= abs(x) < 1\", \"positive argument\", \"Float64\")"]` | 1.38 (5%) :x: | 1.00 (1%)  |
...
| `["scalar", "sin", "(\"argument reduction (hard) abs(x) < 8π/4\", \"positive argument\", \"Float32\", \"sin_kernel\")"]` | 0.87 (5%) :white_check_mark: | 1.00 (1%)  |
| `["scalar", "sin", "(\"no reduction\", \"negative argument\", \"Float32\", \"sin_kernel\")"]` | 0.81 (5%) :white_check_mark: | 1.00 (1%)  |
...
| `["scalar", "tanh", "(\"0 <= abs(x) < 2.0^-28\", \"positive argument\", \"Float64\")"]` | 1.69 (5%) :x: | 1.00 (1%)  |
...
Platform Info:
  ...
  CPU: Intel(R) Xeon(R) CPU E3-1241 v3 @ 3.50GHz: 
       ...
       #1  3501 MHz   94673631 s       5038 s   10928495 s  4114964782 s         27 s
       #2  3501 MHz  627953087 s        208 s   10637768 s  3588604452 s         22 s
       #3  3501 MHz   78076895 s       3244 s    6507355 s  4142611069 s         31 s
       #4  3501 MHz   73263119 s         20 s    9209859 s  4143011053 s         22 s
       
  Memory: 31.383651733398438 GB (14904.203125 MB free)
  Uptime: 4.2303297e7 sec
