...
*Commit(s):* [JuliaLang/julia@8eb0f9fefb7064be5c14dd4d6a9e01bba8ffeabc](https://github.com/JuliaLang/julia/commit/8eb0f9fefb7064be5c14dd4d6a9e01bba8ffeabc)

*Triggered By:* [link](https://github.com/JuliaLang/julia/commit/8eb0f9fefb7064be5c14dd4d6a9e01bba8ffeabc#commitcomment-37314765)

*Tag Predicate:* `ALL`

*Daily Job:* 2020-02-16 vs 2020-02-15
...
| `["collection", "set operations", "(\"Set\", \"Int\", \"==\", \"Set\")"]` | 1.38 (25%) :x: | 1.00 (1%)  |
...
| `["random", "ranges", "(\"RangeGenerator\", \"UInt32\", \"1:1\")"]` | 0.55 (25%) :white_check_mark: | 1.00 (1%)  |
| `["random", "ranges", "(\"rand\", \"MersenneTwister\", \"UInt16\", \"RangeGenerator(1:1)\")"]` | 1.56 (25%) :x: | 1.00 (1%)  |
| `["random", "ranges", "(\"rand\", \"MersenneTwister\", \"UInt64\", \"RangeGenerator(1:4294967297)\")"]` | 0.72 (25%) :white_check_mark: | 1.00 (1%)  |
| `["random", "types", "(\"rand\", \"MersenneTwister\", \"Complex{Int8}\")"]` | 0.61 (25%) :white_check_mark: | 1.00 (1%)  |
| `["random", "types", "(\"randexp\", \"ImplicitRNG\", \"Float64\")"]` | 0.67 (25%) :white_check_mark: | 1.00 (1%)  |
...
| `["scalar", "arithmetic", "(\"rem type\", \"UInt64\", \"BigInt\")"]` | 0.44 (40%) :white_check_mark: | 1.00 (1%)  |
...
| `["scalar", "atan2", "(\"abs(y/x) safe (large)\", \"y negative\", \"x negative\", \"Float32\")"]` | 1.29 (5%) :x: | 1.00 (1%)  |
...
| `["scalar", "cos", "(\"argument reduction (easy) abs(x) < 2π/4\", \"positive argument\", \"Float32\", \"sin_kernel\")"]` | 0.86 (5%) :white_check_mark: | 1.00 (1%)  |
| `["scalar", "cos", "(\"argument reduction (easy) abs(x) < 2π/4\", \"positive argument\", \"Float64\", \"sin_kernel\")"]` | 0.86 (5%) :white_check_mark: | 1.00 (1%)  |
...
| `["scalar", "predicate", "(\"isless\", \"BigFloat\")"]` | 1.48 (40%) :x: | 1.00 (1%)  |
| `["scalar", "sin", "(\"argument reduction (easy) abs(x) < 5π/4\", \"positive argument\", \"Float32\", \"sin_kernel\")"]` | 0.87 (5%) :white_check_mark: | 1.00 (1%)  |
| `["scalar", "sin", "(\"argument reduction (easy) abs(x) < 7π/4\", \"negative argument\", \"Float64\", \"sin_kernel\")"]` | 1.26 (5%) :x: | 1.00 (1%)  |
...
| `["tuple", "reduction", "(\"sum\", (16, 16))"]` | 0.87 (5%) :white_check_mark: | 1.00 (1%)  |
...
| `["union", "array", "(\"broadcast\", identity, BigFloat, true)"]` | 0.90 (5%) :white_check_mark: | 1.00 (1%)  |
...
| `["union", "array", "(\"sort\", Union{Nothing, Float32}, false)"]` | 1.36 (5%) :x: | 1.00 (1%)  |
...
Commit 8eb0f9f (2020-02-15 12:41 UTC)
Platform Info:
  ...
  CPU: Intel(R) Xeon(R) CPU E3-1241 v3 @ 3.50GHz: 
       ...
       #1  3501 MHz  123293268 s       5052 s   14249784 s  5816287731 s         33 s
       #2  3501 MHz  913892445 s        217 s   17428660 s  5031606793 s         26 s
       #3  3501 MHz  107529393 s       3272 s    8446754 s  5847151540 s         36 s
       #4  3501 MHz  100775745 s         43 s   12145573 s  5847794070 s         26 s
       
  Memory: 31.383651733398438 GB (18638.06640625 MB free)
  Uptime: 5.9673956e7 sec
