...
*Commit(s):* [JuliaLang/julia@fc279ca80f36f5e1e45c888045419d35c78a731e](https://github.com/JuliaLang/julia/commit/fc279ca80f36f5e1e45c888045419d35c78a731e)

*Triggered By:* [link](https://github.com/JuliaLang/julia/commit/fc279ca80f36f5e1e45c888045419d35c78a731e#commitcomment-39595743)

*Tag Predicate:* `ALL`

*Daily Job:* 2020-06-02 vs 2020-06-01
...
| `["collection", "iteration", "(\"IdDict\", \"Any\", \"iterate second\")"]` | 2.45 (25%) :x: | 1.00 (1%)  |
...
| `["problem", "laplacian", "laplace_sparse_matvec"]` | 1.01 (5%)  | 1.03 (1%) :x: |
...
| `["scalar", "cosh", "(\"0.00024414062f0 <= abs(x) < 9f0\", \"positive argument\", \"Float32\")"]` | 1.05 (5%) :x: | 1.00 (1%)  |
...
| `["scalar", "sincos", "(\"argument reduction (easy) abs(x) < 6π/4\", \"positive argument\", \"Float64\")"]` | 0.74 (5%) :white_check_mark: | 1.00 (1%)  |
...
| `["union", "array", "(\"broadcast\", *, Float32, (false, false))"]` | 0.72 (5%) :white_check_mark: | 1.00 (1%)  |
...
| `["union", "array", "(\"map\", abs, Complex{Float64}, false)"]` | 1.06 (5%) :x: | 1.00 (1%)  |
| `["union", "array", "(\"map\", identity, BigInt, true)"]` | 1.30 (5%) :x: | 1.00 (1%)  |
...
```
Julia Version 1.6.0-DEV.141
Commit fc279ca (2020-06-02 03:26 UTC)
Platform Info:
  ...
  CPU: Intel(R) Xeon(R) CPU E3-1241 v3 @ 3.50GHz: 
       ...
       #1  3501 MHz  142748286 s       5056 s   16172332 s  6717076094 s         35 s
       #2  3501 MHz  1077174176 s        217 s   21359722 s  5787641886 s         27 s
       #3  3501 MHz  127701549 s       3307 s    9629881 s  6748385305 s         38 s
       #4  3501 MHz  119919960 s         43 s   13804102 s  6750166073 s         27 s
       
  Memory: 31.383651733398438 GB (19811.2109375 MB free)
  Uptime: 6.8914935e7 sec
