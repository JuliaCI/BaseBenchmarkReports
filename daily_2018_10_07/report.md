...
*Commit(s):* [JuliaLang/julia@cfc967bf93c6ae77e3e4a9891fbc29d5eb727d6a](https://github.com/JuliaLang/julia/commit/cfc967bf93c6ae77e3e4a9891fbc29d5eb727d6a)

*Triggered By:* [link](https://github.com/JuliaLang/julia/commit/cfc967bf93c6ae77e3e4a9891fbc29d5eb727d6a#commitcomment-30799801)

*Tag Predicate:* `ALL`

*Daily Job:* 2018-10-07 vs 2018-10-06
...
| `["problem", "laplacian", "laplace_sparse_matvec"]` | 0.87 (5%) :white_check_mark: | 1.00 (1%)  |
...
| `["scalar", "atan2", "(\"y infinite\", \"y positive\", \"x infinite\", \"x negative\", \"Float64\")"]` | 0.93 (5%) :white_check_mark: | 1.00 (1%)  |
...
| `["union", "array", "(\"perf_sum2\", BigFloat, true)"]` | 1.11 (5%) :x: | 1.00 (1%)  |
...
| `["union", "array", "(\"perf_sum4\", BigFloat, true)"]` | 1.08 (5%) :x: | 1.00 (1%)  |
| `["union", "array", "(\"perf_sum4\", Complex{Float64}, true)"]` | 0.94 (5%) :white_check_mark: | 1.00 (1%)  |
| `["union", "array", "(\"perf_sum\", BigFloat, false)"]` | 1.14 (5%) :x: | 1.00 (1%)  |
| `["union", "array", "(\"perf_sum\", BigFloat, true)"]` | 1.13 (5%) :x: | 1.00 (1%)  |
...
| `["union", "array", "(\"skipmissing\", sum, Float64, true)"]` | 1.15 (5%) :x: | 1.00 (1%)  |
...
Platform Info:
  ...
  CPU: Intel(R) Xeon(R) CPU E3-1241 v3 @ 3.50GHz: 
       ...
       #1  3501 MHz   53726626 s       5001 s    5897666 s  1609457701 s         21 s
       #2  3501 MHz  272782040 s        203 s    4298146 s  1394916984 s         12 s
       #3  3501 MHz   38185714 s       3202 s    3313502 s  1630503821 s         23 s
       #4  3501 MHz   35457109 s          0 s    4100060 s  1632178092 s         13 s
       
  Memory: 31.383651733398438 GB (6373.38671875 MB free)
  Uptime: 1.6734513e7 sec
  Load Avg:  1.21435546875  1.0478515625  1.05615234375
  WORD_SIZE: 64
  LIBM: libopenlibm
