...
*Commit(s):* [JuliaLang/julia@85a0f141d4a2a23d25328071dc1ac86aac2bc0f0](https://github.com/JuliaLang/julia/commit/85a0f141d4a2a23d25328071dc1ac86aac2bc0f0)

*Triggered By:* [link](https://github.com/JuliaLang/julia/commit/85a0f141d4a2a23d25328071dc1ac86aac2bc0f0#commitcomment-42262050)
...
| `["collection", "queries & updates", "(\"IdDict\", \"Int\", \"push!\", \"overwrite\")"]` | 1.25 (25%) :x: | 1.00 (1%)  |
| `["collection", "queries & updates", "(\"IdDict\", \"Int\", \"setindex!\", \"new\")"]` | 1.29 (25%) :x: | 1.00 (1%)  |
| `["collection", "queries & updates", "(\"Set\", \"Int\", \"in\", \"true\")"]` | 0.69 (25%) :white_check_mark: | 1.00 (1%)  |
| `["collection", "set operations", "(\"BitSet\", \"Int\", \"intersect\", \"Vector\")"]` | 1.64 (25%) :x: | 1.00 (1%)  |
| `["collection", "set operations", "(\"BitSet\", \"Int\", \"intersect\", \"Vector\", \"Vector\")"]` | 1.48 (25%) :x: | 1.00 (1%)  |
...
| `["io", "array_limit", "(\"display\", \"Matrix{Float64}(10000, 10000)\")"]` | 0.91 (5%) :white_check_mark: | 0.90 (1%) :white_check_mark: |
...
| `["random", "ranges", "(\"rand\", \"MersenneTwister\", \"BigInt\", \"RangeGenerator(1:4294967295)\")"]` | 1.48 (25%) :x: | 1.00 (1%)  |
...
| `["scalar", "mod2pi", "(\"argument reduction (easy) abs(x) < 2.0^20π/4\", \"negative argument\", \"Float64\")"]` | 0.86 (5%) :white_check_mark: | 1.00 (1%)  |
| `["scalar", "sin", "(\"argument reduction (easy) abs(x) < 6π/4\", \"positive argument\", \"Float32\", \"cos_kernel\")"]` | 0.84 (5%) :white_check_mark: | 1.00 (1%)  |
| `["scalar", "sin", "(\"argument reduction (hard) abs(x) < 4π/4\", \"negative argument\", \"Float64\", \"sin_kernel\")"]` | 1.23 (5%) :x: | 1.00 (1%)  |
...
| `["sparse", "constructors", "(\"Bidiagonal\", 100)"]` | 1.33 (5%) :x: | 1.00 (1%)  |
| `["sparse", "constructors", "(\"IV\", 1000)"]` | 1.10 (5%) :x: | 1.00 (1%)  |
| `["sparse", "index", "(\"spvec\", \"integer\", 1000)"]` | 2.42 (30%) :x: | 1.00 (1%)  |
...
```
Julia Version 1.6.0-DEV.903
Commit 85a0f14 (2020-09-12 21:31 UTC)
Platform Info:
  ...
  CPU: Intel(R) Xeon(R) CPU E3-1241 v3 @ 3.50GHz: 
       ...
       #1  3501 MHz  159158275 s       5069 s   17591244 s  7588032505 s         39 s
       #2  3501 MHz  1211897123 s        220 s   24695394 s  6538815948 s         29 s
       #3  3501 MHz  144726084 s       3325 s   10654932 s  7618621746 s         40 s
       #4  3501 MHz  135412816 s         43 s   15551795 s  7621361169 s         28 s
       
  Memory: 31.383651733398438 GB (14499.3203125 MB free)
  Uptime: 7.7814457e7 sec
