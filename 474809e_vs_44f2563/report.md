...
*Commit(s):* [JuliaLang/julia@474809ea6047afe096894a4d866686df40022d1c](https://github.com/JuliaLang/julia/commit/474809ea6047afe096894a4d866686df40022d1c) vs [JuliaLang/julia@44f2563d11f3a6fa56e9a059a8349df53cdc8eb8](https://github.com/JuliaLang/julia/commit/44f2563d11f3a6fa56e9a059a8349df53cdc8eb8)

*Triggered By:* [link](https://github.com/JuliaLang/julia/pull/29796)
...
| `["array", "any/all", "(\"any\", \"Array{Float64,1}\")"]` | 1.51 (5%) :x: | 1.00 (1%)  |
...
| `["collection", "queries & updates", "(\"Dict\", \"String\", \"in\", \"false\")"]` | 1.25 (25%) :x: | 1.00 (1%)  |
...
| `["find", "findnext", "(\"ispos\", \"Array{Float32,1}\")"]` | 1.18 (5%) :x: | 1.00 (1%)  |
...
| `["problem", "spellcheck", "spellcheck"]` | 1.00 (5%)  | 1.05 (1%) :x: |
...
| `["scalar", "arithmetic", "(\"sub\", \"UInt64\", \"BigInt\")"]` | 1.80 (50%) :x: | 1.00 (1%)  |
...
| `["scalar", "atan2", "(\"abs(y/x) safe (large)\", \"y positive\", \"x positive\", \"Float32\")"]` | 0.72 (5%) :white_check_mark: | 1.00 (1%)  |
...
| `["scalar", "fastmath", "(\"div\", \"Float32\")"]` | 1.46 (40%) :x: | 1.00 (1%)  |
...
| `["scalar", "predicate", "(\"isinteger\", \"Complex{BigFloat}\")"]` | 1.64 (40%) :x: | 1.00 (1%)  |
...
| `["sparse", "index", "(\"spmat\", \"splogical\", 10)"]` | 1.58 (30%) :x: | 1.00 (1%)  |
...
| `["union", "array", "(\"skipmissing\", collect, Complex{Float64}, true)"]` | 0.95 (5%) :white_check_mark: | 1.00 (1%)  |
...
Commit 474809e (2018-10-25 02:28 UTC)
Platform Info:
  ...
  CPU: Intel(R) Xeon(R) CPU E3-1241 v3 @ 3.50GHz: 
       ...
       #1  3501 MHz   57408423 s       5003 s    6306194 s  1759351818 s         21 s
       #2  3501 MHz  301089306 s        203 s    4809589 s  1520319895 s         14 s
       #3  3501 MHz   41895236 s       3206 s    3585656 s  1780740032 s         24 s
       #4  3501 MHz   38819058 s          0 s    4447934 s  1782663781 s         14 s
       
  Memory: 31.383651733398438 GB (4757.71875 MB free)
  Uptime: 1.8278068e7 sec
...
Platform Info:
  ...
  CPU: Intel(R) Xeon(R) CPU E3-1241 v3 @ 3.50GHz: 
              speed         user         nice          sys         idle          irq
       #1  3501 MHz   57535129 s       5003 s    6316935 s  1760446594 s         21 s
       #2  3501 MHz  302232217 s        203 s    4825572 s  1520397675 s         14 s
       #3  3501 MHz   42021269 s       3206 s    3593292 s  1781842761 s         24 s
       #4  3501 MHz   38939590 s          0 s    4455328 s  1783772497 s         14 s
       
  Memory: 31.383651733398438 GB (4400.58984375 MB free)
  Uptime: 1.829044e7 sec
