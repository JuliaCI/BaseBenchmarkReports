...
*Commit(s):* [JuliaLang/julia@1fc43803696585bf4dc9792b34cf359e4611b270](https://github.com/JuliaLang/julia/commit/1fc43803696585bf4dc9792b34cf359e4611b270)

*Triggered By:* [link](https://github.com/JuliaLang/julia/commit/1fc43803696585bf4dc9792b34cf359e4611b270#commitcomment-32648073)

*Tag Predicate:* `ALL`

*Daily Job:* 2019-03-08 vs 2019-03-07
...
| `["array", "comprehension", "(\"collect\", \"Array{Float64,1}\")"]` | 1.21 (5%) :x: | 1.00 (1%)  |
...
| `["collection", "iteration", "(\"IdDict\", \"Any\", \"iterate\")"]` | 0.72 (25%) :white_check_mark: | 1.00 (1%)  |
| `["collection", "queries & updates", "(\"Dict\", \"String\", \"pop!\", \"specified\")"]` | 0.71 (25%) :white_check_mark: | 1.00 (1%)  |
...
| `["collection", "queries & updates", "(\"Dict\", \"String\", \"push!\", \"overwrite\")"]` | 0.67 (25%) :white_check_mark: | 1.00 (1%)  |
| `["collection", "queries & updates", "(\"Dict\", \"String\", \"setindex!\", \"new\")"]` | 0.72 (25%) :white_check_mark: | 1.00 (1%)  |
| `["collection", "queries & updates", "(\"Dict\", \"String\", \"setindex!\", \"overwrite\")"]` | 0.72 (25%) :white_check_mark: | 1.00 (1%)  |
...
| `["dates", "string", "DateTime"]` | 1.25 (5%) :x: | 1.00 (1%)  |
...
| `["io", "array_limit", "(\"display\", \"Array{Float64,1}(100000000,)\")"]` | 0.98 (5%)  | 0.97 (1%) :white_check_mark: |
| `["io", "array_limit", "(\"display\", \"Array{Float64,2}(100000000, 1)\")"]` | 1.00 (5%)  | 0.97 (1%) :white_check_mark: |
...
| `["scalar", "asin", "(\"zero\", \"Float32\")"]` | 1.57 (5%) :x: | 1.00 (1%)  |
...
| `["scalar", "cosh", "(\"very large\", \"positive argument\", \"Float64\")"]` | 1.26 (5%) :x: | 1.00 (1%)  |
...
```
Julia Version 1.2.0-DEV.443
Commit 1fc4380 (2019-03-07 21:46 UTC)
Platform Info:
  ...
  CPU: Intel(R) Xeon(R) CPU E3-1241 v3 @ 3.50GHz: 
       ...
       #1  3501 MHz   79696298 s       5019 s    8971527 s  2890470924 s         24 s
       #2  3501 MHz  481149845 s        203 s    8028726 s  2494885409 s         19 s
       #3  3501 MHz   62873550 s       3228 s    5300487 s  2915799776 s         27 s
       #4  3501 MHz   58989327 s          7 s    6912967 s  2917314397 s         17 s
       
  Memory: 31.383651733398438 GB (4538.88671875 MB free)
  Uptime: 2.986414e7 sec
