...
*Commit(s):* [JuliaLang/julia@3935491dc5028f23587ca8df6d4e0de75cf50e53](https://github.com/JuliaLang/julia/commit/3935491dc5028f23587ca8df6d4e0de75cf50e53)

*Triggered By:* [link](https://github.com/JuliaLang/julia/commit/3935491dc5028f23587ca8df6d4e0de75cf50e53#commitcomment-37831011)

*Tag Predicate:* `ALL`

*Daily Job:* 2020-03-15 vs 2020-03-14
...
| `["dates", "parse", "(\"DateTime\", \"RFC1123Format\", \"Lowercase\")"]` | 1.26 (5%) :x: | 1.00 (1%)  |
| `["dates", "parse", "(\"DateTime\", \"RFC1123Format\", \"Mixedcase\")"]` | 1.16 (5%) :x: | 1.00 (1%)  |
| `["dates", "parse", "(\"DateTime\", \"RFC1123Format\", \"Titlecase\")"]` | 1.28 (5%) :x: | 1.00 (1%)  |
...
| `["random", "ranges", "(\"RangeGenerator\", \"BigInt\", \"1:1\")"]` | 0.59 (25%) :white_check_mark: | 1.00 (1%)  |
...
| `["random", "types", "(\"rand\", \"MersenneTwister\", \"Complex{Int16}\")"]` | 1.53 (25%) :x: | 1.00 (1%)  |
| `["random", "types", "(\"rand\", \"MersenneTwister\", \"Complex{UInt8}\")"]` | 1.44 (25%) :x: | 1.00 (1%)  |
| `["random", "types", "(\"rand\", \"MersenneTwister\", \"UInt8\")"]` | 1.31 (25%) :x: | 1.00 (1%)  |
| `["random", "types", "(\"randn\", \"MersenneTwister\", \"ImplicitFloat64\")"]` | 1.40 (25%) :x: | 1.00 (1%)  |
...
| `["scalar", "arithmetic", "(\"rem type\", \"Bool\", \"BigInt\")"]` | 1.73 (40%) :x: | 1.00 (1%)  |
...
| `["scalar", "cosh", "(\"0.00024414062f0 <= abs(x) < 9f0\", \"negative argument\", \"Float32\")"]` | 0.69 (5%) :white_check_mark: | 1.00 (1%)  |
...
| `["scalar", "exp2", "(\"2pow3\", \"positive argument\", \"Float64\")"]` | 0.61 (5%) :white_check_mark: | 1.00 (1%)  |
...
| `["scalar", "expm1", "(\"one\", \"Float32\")"]` | 1.26 (5%) :x: | 1.00 (1%)  |
| `["scalar", "expm1", "(\"small\", \"negative argument\", \"Float32\")"]` | 1.07 (5%) :x: | 1.00 (1%)  |
| `["scalar", "expm1", "(\"small\", \"positive argument\", \"Float32\")"]` | 1.34 (5%) :x: | 1.00 (1%)  |
...
| `["tuple", "reduction", "(\"sum\", (4, 4))"]` | 1.59 (5%) :x: | 1.00 (1%)  |
...
| `["union", "array", "(\"map\", identity, Complex{Float64}, true)"]` | 0.76 (5%) :white_check_mark: | 1.00 (1%)  |
...
| `["union", "array", "(\"perf_sum2\", Int8, true)"]` | 0.88 (5%) :white_check_mark: | 1.00 (1%)  |
...
| `["union", "array", "(\"skipmissing\", sum, Union{Nothing, Int64}, false)"]` | 2.16 (5%) :x: | 1.00 (1%)  |
...
Commit 3935491 (2020-03-13 16:05 UTC)
Platform Info:
  ...
  CPU: Intel(R) Xeon(R) CPU E3-1241 v3 @ 3.50GHz: 
       ...
       #1  3501 MHz  128112957 s       5056 s   14770337 s  6051976025 s         34 s
       #2  3501 MHz  955776124 s        217 s   18440415 s  5230123425 s         26 s
       #3  3501 MHz  112555966 s       3279 s    8746344 s  6083056315 s         36 s
       #4  3501 MHz  105578349 s         43 s   12526908 s  6083979147 s         26 s
       
  Memory: 31.383651733398438 GB (18787.50390625 MB free)
  Uptime: 6.2089584e7 sec
  Load Avg:  0.96533203125  1.009765625  1.04052734375
  WORD_SIZE: 64
  LIBM: libopenlibm
