...
*Commit(s):* [JuliaLang/julia@4c027678cc847b8bb3aab1cc8e853159a3e4ee64](https://github.com/JuliaLang/julia/commit/4c027678cc847b8bb3aab1cc8e853159a3e4ee64)

*Triggered By:* [link](https://github.com/JuliaLang/julia/commit/4c027678cc847b8bb3aab1cc8e853159a3e4ee64#commitcomment-41868760)

*Tag Predicate:* `ALL`

*Daily Job:* 2020-08-29 vs 2020-08-24
...
| `["array", "any/all", "(\"all\", \"BitArray\")"]` | 1.14 (5%) :x: | 1.00 (1%)  |
...
| `["collection", "set operations", "(\"BitSet\", \"Int\", \"<\", \"BitSet\")"]` | 0.15 (25%) :white_check_mark: | 0.00 (1%) :white_check_mark: |
| `["collection", "set operations", "(\"BitSet\", \"Int\", \"⊆\", \"BitSet\")"]` | 0.14 (25%) :white_check_mark: | 0.00 (1%) :white_check_mark: |
| `["collection", "set operations", "(\"BitSet\", \"Int\", \"⊆\", \"self\")"]` | 0.19 (25%) :white_check_mark: | 0.00 (1%) :white_check_mark: |
| `["collection", "set operations", "(\"empty\", \"Int\", \"<\", \"BitSet\")"]` | 0.25 (25%) :white_check_mark: | 0.00 (1%) :white_check_mark: |
| `["collection", "set operations", "(\"empty\", \"Int\", \"⊆\", \"BitSet\")"]` | 0.20 (25%) :white_check_mark: | 0.00 (1%) :white_check_mark: |
| `["dates", "parse", "(\"DateTime\", \"RFC1123Format\", \"Lowercase\")"]` | 0.74 (5%) :white_check_mark: | 0.00 (1%) :white_check_mark: |
| `["dates", "parse", "(\"DateTime\", \"RFC1123Format\", \"Mixedcase\")"]` | 0.73 (5%) :white_check_mark: | 0.25 (1%) :white_check_mark: |
| `["dates", "parse", "(\"DateTime\", \"RFC1123Format\", \"Titlecase\")"]` | 0.73 (5%) :white_check_mark: | 0.00 (1%) :white_check_mark: |
...
| `["problem", "imdb", "centrality"]` | 0.93 (5%) :white_check_mark: | 0.84 (1%) :white_check_mark: |
| `["problem", "raytrace", "raytrace"]` | 0.89 (5%) :white_check_mark: | 1.00 (1%)  |
| `["problem", "spellcheck", "spellcheck"]` | 0.96 (5%)  | 0.98 (1%) :white_check_mark: |
...
| `["scalar", "fastmath", "(\"add\", \"BigInt\")"]` | 1.59 (40%) :x: | 1.00 (1%)  |
...
| `["union", "array", "(\"skipmissing\", sum, Union{Missing, Float32}, true)"]` | 0.70 (5%) :white_check_mark: | 1.00 (1%)  |
...
```
Julia Version 1.6.0-DEV.762
Commit 4c02767 (2020-08-29 01:44 UTC)
Platform Info:
  ...
  CPU: Intel(R) Xeon(R) CPU E3-1241 v3 @ 3.50GHz: 
       ...
       #1  3501 MHz  156505726 s       5068 s   17381962 s  7461374041 s         39 s
       #2  3501 MHz  1189632620 s        217 s   24132880 s  6432122544 s         29 s
       #3  3501 MHz  141993225 s       3324 s   10490741 s  7492235089 s         40 s
       #4  3501 MHz  132865346 s         43 s   15293271 s  7494821879 s         28 s
       
  Memory: 31.383651733398438 GB (14256.1484375 MB free)
  Uptime: 7.6518308e7 sec
