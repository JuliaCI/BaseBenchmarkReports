...
*Commit(s):* [JuliaLang/julia@b56a9f07948255dfbe804eef25bdbada06ec2a57](https://github.com/JuliaLang/julia/commit/b56a9f07948255dfbe804eef25bdbada06ec2a57)

*Triggered By:* [link](https://github.com/JuliaLang/julia/commit/b56a9f07948255dfbe804eef25bdbada06ec2a57#commitcomment-31921338)

*Tag Predicate:* `ALL`

*Daily Job:* 2019-01-13 vs 2019-01-12
...
| `["array", "any/all", "(\"any\", \"Array{Int16,1}\")"]` | 0.93 (5%) :white_check_mark: | 1.00 (1%)  |
...
| `["array", "index", "(\"sumvector_view\", \"Array{Float32,2}\")"]` | 1.73 (50%) :x: | 1.00 (1%)  |
...
| `["array", "index", "(\"sumvector_view\", \"SubArray{Float32,2,Array{Float32,3},Tuple{Int64,Base.Slice{Base.OneTo{Int64}},Base.Slice{Base.OneTo{Int64}}},true}\")"]` | 1.62 (50%) :x: | 1.00 (1%)  |
...
| `["array", "reductions", "(\"Statistics.mean\", \"Float64\")"]` | 0.93 (5%) :white_check_mark: | 1.00 (1%)  |
...
| `["problem", "ziggurat", "ziggurat"]` | 1.08 (5%) :x: | 1.00 (1%)  |
...
| `["random", "types", "(\"rand\", \"MersenneTwister\", \"Complex{Int16}\")"]` | 1.40 (25%) :x: | 1.00 (1%)  |
| `["random", "types", "(\"rand\", \"MersenneTwister\", \"Complex{Int8}\")"]` | 1.40 (25%) :x: | 1.00 (1%)  |
| `["random", "types", "(\"rand\", \"MersenneTwister\", \"Complex{UInt32}\")"]` | 1.40 (25%) :x: | 1.00 (1%)  |
| `["random", "types", "(\"rand\", \"MersenneTwister\", \"Complex{UInt8}\")"]` | 1.31 (25%) :x: | 1.00 (1%)  |
| `["random", "types", "(\"rand\", \"MersenneTwister\", \"Int128\")"]` | 1.47 (25%) :x: | 1.00 (1%)  |
| `["random", "types", "(\"rand\", \"MersenneTwister\", \"Int64\")"]` | 1.47 (25%) :x: | 1.00 (1%)  |
| `["random", "types", "(\"rand\", \"MersenneTwister\", \"UInt64\")"]` | 1.40 (25%) :x: | 1.00 (1%)  |
...
| `["scalar", "atan", "(\"39/16 <= abs(x) < 2^66\", \"negative argument\", \"Float32\")"]` | 1.17 (5%) :x: | 1.00 (1%)  |
...
| `["scalar", "atan", "(\"zero\", \"Float32\")"]` | 1.21 (5%) :x: | 1.00 (1%)  |
...
| `["scalar", "atan2", "(\"abs(y/x) safe (large)\", \"y positive\", \"x positive\", \"Float32\")"]` | 0.78 (5%) :white_check_mark: | 1.00 (1%)  |
| `["scalar", "atan2", "(\"abs(y/x) safe (small)\", \"y negative\", \"x negative\", \"Float32\")"]` | 0.76 (5%) :white_check_mark: | 1.00 (1%)  |
| `["scalar", "atan2", "(\"abs(y/x) safe (small)\", \"y negative\", \"x positive\", \"Float32\")"]` | 1.22 (5%) :x: | 1.00 (1%)  |
| `["scalar", "atan2", "(\"abs(y/x) safe (small)\", \"y positive\", \"x positive\", \"Float32\")"]` | 0.76 (5%) :white_check_mark: | 1.00 (1%)  |
...
| `["scalar", "exp2", "(\"zero\", \"Float64\")"]` | 1.57 (5%) :x: | 1.00 (1%)  |
...
| `["sparse", "index", "(\"spmat\", \"row\", \"range\", 1000)"]` | 1.31 (30%) :x: | 1.00 (1%)  |
...
| `["union", "array", "(\"broadcast\", identity, Float64, false)"]` | 1.10 (5%) :x: | 1.00 (1%)  |
...
| `["union", "array", "(\"perf_countequals\", \"Float32\")"]` | 0.81 (5%) :white_check_mark: | 1.00 (1%)  |
...
```
Julia Version 1.2.0-DEV.163
Commit b56a9f0 (2019-01-13 01:29 UTC)
Platform Info:
  ...
  CPU: Intel(R) Xeon(R) CPU E3-1241 v3 @ 3.50GHz: 
       ...
       #1  3501 MHz   71024949 s       5013 s    7899424 s  2434780220 s         23 s
       #2  3501 MHz  407435688 s        203 s    6703096 s  2103731294 s         18 s
       #3  3501 MHz   54573765 s       3220 s    4623460 s  2458604484 s         26 s
       #4  3501 MHz   50989458 s          2 s    5957396 s  2460271585 s         17 s
       
  Memory: 31.383651733398438 GB (5315.8203125 MB free)
  Uptime: 2.5199223e7 sec
