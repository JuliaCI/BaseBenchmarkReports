...
*Commit(s):* [JuliaLang/julia@c8c48a29740519453068fac227c69a22a778a28b](https://github.com/JuliaLang/julia/commit/c8c48a29740519453068fac227c69a22a778a28b)

*Triggered By:* [link](https://github.com/JuliaLang/julia/commit/c8c48a29740519453068fac227c69a22a778a28b#commitcomment-31753537)

*Tag Predicate:* `ALL`

*Daily Job:* 2018-12-21 vs 2018-12-20
...
| `["collection", "deletion", "(\"Vector\", \"Int\", \"filter!\")"]` | 1.32 (25%) :x: | 1.00 (1%)  |
| `["collection", "iteration", "(\"BitSet\", \"Int\", \"iterate\")"]` | 2.05 (25%) :x: | 1.00 (1%)  |
| `["collection", "iteration", "(\"Vector\", \"Any\", \"iterate second\")"]` | 1.27 (25%) :x: | 1.00 (1%)  |
| `["collection", "queries & updates", "(\"Dict\", \"Int\", \"pop!\", \"unspecified\")"]` | 1.48 (25%) :x: | 1.00 (1%)  |
| `["collection", "queries & updates", "(\"Dict\", \"Int\", \"push!\", \"new\")"]` | 1.76 (25%) :x: | 1.00 (1%)  |
| `["dates", "string", "Date"]` | 1.05 (5%) :x: | 1.00 (1%)  |
| `["find", "findprev", "(\"ispos\", \"Array{Bool,1}\")"]` | 1.18 (5%) :x: | 1.00 (1%)  |
...
| `["scalar", "exp2", "(\"2pow35\", \"positive argument\", \"Float64\")"]` | 2.14 (5%) :x: | 1.00 (1%)  |
...
| `["scalar", "expm1", "(\"one\", \"Float32\")"]` | 0.91 (5%) :white_check_mark: | 1.00 (1%)  |
...
| `["shootout", "meteor_contest"]` | 0.89 (5%) :white_check_mark: | 1.00 (1%)  |
| `["shootout", "pidigits"]` | 0.85 (5%) :white_check_mark: | 1.00 (1%)  |
...
Platform Info:
  ...
  CPU: Intel(R) Xeon(R) CPU E3-1241 v3 @ 3.50GHz: 
       ...
       #1  3501 MHz   67460927 s       5010 s    7462008 s  2240458441 s         22 s
       #2  3501 MHz  381283780 s        203 s    6222083 s  1931759803 s         18 s
       #3  3501 MHz   51462462 s       3218 s    4344836 s  2263377651 s         26 s
       #4  3501 MHz   48074211 s          0 s    5569277 s  2265046309 s         16 s
       
  Memory: 31.383651733398438 GB (5163.67578125 MB free)
  Uptime: 2.3211757e7 sec
