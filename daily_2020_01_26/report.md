...
*Commit(s):* [JuliaLang/julia@9790a8db1cb65cb8d1081cd14706939f49e9a771](https://github.com/JuliaLang/julia/commit/9790a8db1cb65cb8d1081cd14706939f49e9a771)

*Triggered By:* [link](https://github.com/JuliaLang/julia/commit/9790a8db1cb65cb8d1081cd14706939f49e9a771#commitcomment-36966837)
...
| `["array", "growth", "(\"push_multiple!\", 8)"]` | 1.19 (5%) :x: | 1.00 (1%)  |
...
| `["collection", "queries & updates", "(\"Dict\", \"String\", \"push!\", \"new\")"]` | 1.42 (25%) :x: | 1.00 (1%)  |
| `["collection", "queries & updates", "(\"Dict\", \"String\", \"setindex!\", \"new\")"]` | 1.67 (25%) :x: | 1.00 (1%)  |
...
| `["scalar", "arithmetic", "(\"mul\", \"BigInt\", \"BigFloat\")"]` | 0.48 (50%) :white_check_mark: | 1.00 (1%)  |
...
| `["scalar", "atan", "(\"very large\", \"negative argument\", \"Float32\")"]` | 1.67 (5%) :x: | 1.00 (1%)  |
| `["scalar", "atan", "(\"very small\", \"positive argument\", \"Float32\")"]` | 0.48 (5%) :white_check_mark: | 1.00 (1%)  |
...
| `["scalar", "cos", "(\"argument reduction (easy) abs(x) < 5π/4\", \"positive argument\", \"Float64\", \"cos_kernel\")"]` | 0.89 (5%) :white_check_mark: | 1.00 (1%)  |
| `["scalar", "cos", "(\"argument reduction (easy) abs(x) < 6π/4\", \"negative argument\", \"Float64\", \"sin_kernel\")"]` | 1.64 (5%) :x: | 1.00 (1%)  |
...
| `["scalar", "cos", "(\"argument reduction (easy) abs(x) < 7π/4\", \"positive argument\", \"Float64\", \"cos_kernel\")"]` | 1.13 (5%) :x: | 1.00 (1%)  |
...
| `["scalar", "cos", "(\"argument reduction (hard) abs(x) < 6π/4\", \"negative argument\", \"Float32\", \"sin_kernel\")"]` | 0.79 (5%) :white_check_mark: | 1.00 (1%)  |
| `["scalar", "cos", "(\"argument reduction (hard) abs(x) < 6π/4\", \"negative argument\", \"Float64\", \"sin_kernel\")"]` | 1.23 (5%) :x: | 1.00 (1%)  |
...
| `["scalar", "predicate", "(\"isnan\", \"Complex{BigFloat}\")"]` | 0.31 (40%) :white_check_mark: | 1.00 (1%)  |
...
| `["sparse", "matmul", "(\"At_mul_B\", \"dense 5x500, sparse 5x5 -> dense 500x5\")"]` | 1.45 (30%) :x: | 1.00 (1%)  |
...
| `["union", "array", "(\"perf_sum2\", Int8, false)"]` | 1.21 (5%) :x: | 1.00 (1%)  |
...
Commit 9790a8d (2020-01-25 20:28 UTC)
Platform Info:
  ...
  CPU: Intel(R) Xeon(R) CPU E3-1241 v3 @ 3.50GHz: 
       ...
       #1  3501 MHz  119860664 s       5051 s   13889054 s  5638975005 s         32 s
       #2  3501 MHz  883982783 s        217 s   16700818 s  4880903934 s         26 s
       #3  3501 MHz  104061636 s       3266 s    8257944 s  5669459427 s         36 s
       #4  3501 MHz   97517991 s         43 s   11826906 s  5670084895 s         25 s
       
  Memory: 31.383651733398438 GB (18596.44921875 MB free)
  Uptime: 5.7859088e7 sec
