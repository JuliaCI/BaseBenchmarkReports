...
*Commit(s):* [JuliaLang/julia@a8a567e72b669525dc4d3a38af275fe042f44a42](https://github.com/JuliaLang/julia/commit/a8a567e72b669525dc4d3a38af275fe042f44a42)

*Triggered By:* [link](https://github.com/JuliaLang/julia/commit/a8a567e72b669525dc4d3a38af275fe042f44a42#commitcomment-34453772)

*Tag Predicate:* `ALL`

*Daily Job:* 2019-07-26 vs 2019-07-25
...
| `["array", "index", "(\"sumcolon\", \"100000:-1:1\")"]` | 1.78 (50%) :x: | 1.00 (1%)  |
...
| `["collection", "queries & updates", "(\"Dict\", \"Any\", \"in\", \"false\")"]` | 0.51 (25%) :white_check_mark: | 1.00 (1%)  |
| `["dates", "parse", "(\"DateTime\", \"RFC1123Format\", \"Mixedcase\")"]` | 0.87 (5%) :white_check_mark: | 1.00 (1%)  |
| `["io", "array_limit", "(\"display\", \"Array{Float64,2}(10000, 10000)\")"]` | 0.96 (5%)  | 0.92 (1%) :white_check_mark: |
| `["io", "serialization", "(\"deserialize\", \"Vector{String}\")"]` | 1.12 (5%) :x: | 1.00 (1%)  |
| `["linalg", "arithmetic", "(\"+\", \"Matrix\", \"Matrix\", 256)"]` | 2.30 (45%) :x: | 1.00 (1%)  |
...
| `["scalar", "acosh", "(\"1 <= abs(x) < 2\", \"positive argument\", \"Float32\")"]` | 1.12 (5%) :x: | 1.00 (1%)  |
| `["scalar", "acosh", "(\"2 <= abs(x) < 2^28\", \"positive argument\", \"Float32\")"]` | 1.10 (5%) :x: | 1.00 (1%)  |
| `["scalar", "acosh", "(\"very large\", \"positive argument\", \"Float32\")"]` | 1.44 (5%) :x: | 1.00 (1%)  |
...
| `["scalar", "cos", "(\"argument reduction (easy) abs(x) < 6π/4\", \"negative argument\", \"Float64\", \"sin_kernel\")"]` | 0.87 (5%) :white_check_mark: | 1.00 (1%)  |
...
| `["scalar", "predicate", "(\"isequal\", \"BigFloat\")"]` | 0.56 (40%) :white_check_mark: | 1.00 (1%)  |
| `["scalar", "predicate", "(\"isequal\", \"Complex{BigFloat}\")"]` | 0.55 (40%) :white_check_mark: | 1.00 (1%)  |
...
| `["tuple", "reduction", "(\"sum\", (4, 4))"]` | 1.55 (5%) :x: | 1.00 (1%)  |
...
| `["union", "array", "(\"broadcast\", abs, Float64, true)"]` | 1.38 (5%) :x: | 1.00 (1%)  |
...
| `["union", "array", "(\"map\", identity, BigFloat, true)"]` | 0.79 (5%) :white_check_mark: | 1.00 (1%)  |
...
```
Julia Version 1.3.0-alpha.10
Commit a8a567e (2019-07-24 21:15 UTC)
Platform Info:
  ...
  CPU: Intel(R) Xeon(R) CPU E3-1241 v3 @ 3.50GHz: 
       ...
       #1  3501 MHz   94254135 s       5037 s   10863080 s  4080968879 s         27 s
       #2  3501 MHz  623024970 s        208 s   10518370 s  3559103716 s         22 s
       #3  3501 MHz   77625693 s       3243 s    6479146 s  4108533751 s         30 s
       #4  3501 MHz   72840616 s         20 s    9159822 s  4108942734 s         22 s
       
  Memory: 31.383651733398438 GB (14526.77734375 MB free)
  Uptime: 4.1957586e7 sec
