...
*Commit(s):* [JuliaLang/julia@fe593469a057bce9f3a905141dbfca360edbdac5](https://github.com/JuliaLang/julia/commit/fe593469a057bce9f3a905141dbfca360edbdac5)

*Triggered By:* [link](https://github.com/JuliaLang/julia/commit/fe593469a057bce9f3a905141dbfca360edbdac5#commitcomment-39192186)

*Tag Predicate:* `ALL`

*Daily Job:* 2020-05-15 vs 2020-05-14
...
|----|------------|--------------|
| `["array", "cat", "(\"catnd\", 5)"]` | 0.82 (5%) :white_check_mark: | 1.00 (1%)  |
...
| `["array", "reductions", "(\"mean\", \"Float64\")"]` | 0.90 (5%) :white_check_mark: | 0.00 (1%) :white_check_mark: |
| `["array", "reductions", "(\"mean\", \"Int64\")"]` | 0.99 (5%)  | 0.00 (1%) :white_check_mark: |
...
| `["collection", "queries & updates", "(\"Set\", \"Any\", \"push!\", \"overwrite\")"]` | 1.38 (25%) :x: | 1.00 (1%)  |
| `["dates", "parse", "(\"DateTime\", \"ISODateTimeFormat\")"]` | 0.94 (5%) :white_check_mark: | 1.00 (1%)  |
| `["dates", "parse", "(\"Date\", \"ISODateFormat\")"]` | 0.81 (5%) :white_check_mark: | 1.00 (1%)  |
| `["dates", "parse", "Date"]` | 1.10 (5%) :x: | 1.00 (1%)  |
| `["find", "findall", "(\"BitArray{1}\", \"10-90\")"]` | 1.70 (5%) :x: | 1.00 (1%)  |
| `["find", "findall", "(\"BitArray{1}\", \"50-50\")"]` | 1.22 (5%) :x: | 1.00 (1%)  |
...
| `["random", "ranges", "(\"RangeGenerator\", \"BigInt\", \"1:1\")"]` | 0.60 (25%) :white_check_mark: | 1.00 (1%)  |
...
| `["scalar", "acosh", "(\"very large\", \"positive argument\", \"Float32\")"]` | 1.60 (5%) :x: | 1.00 (1%)  |
...
| `["scalar", "asinh", "(\"2^-28 <= abs(x) < 2\", \"negative argument\", \"Float64\")"]` | 1.11 (5%) :x: | 1.00 (1%)  |
...
| `["scalar", "atan2", "(\"abs(y/x) safe (large)\", \"y negative\", \"x negative\", \"Float64\")"]` | 0.79 (5%) :white_check_mark: | 1.00 (1%)  |
...
| `["scalar", "atan2", "(\"abs(y/x) safe (small)\", \"y negative\", \"x positive\", \"Float64\")"]` | 0.80 (5%) :white_check_mark: | 1.00 (1%)  |
| `["scalar", "atan2", "(\"abs(y/x) safe (small)\", \"y positive\", \"x negative\", \"Float64\")"]` | 0.83 (5%) :white_check_mark: | 1.00 (1%)  |
...
| `["scalar", "predicate", "(\"iseven\", \"BigInt\")"]` | 0.07 (40%) :white_check_mark: | 0.00 (1%) :white_check_mark: |
| `["scalar", "predicate", "(\"isodd\", \"BigInt\")"]` | 0.07 (40%) :white_check_mark: | 0.00 (1%) :white_check_mark: |
...
| `["union", "array", "(\"broadcast\", identity, BigFloat, true)"]` | 1.09 (5%) :x: | 1.00 (1%)  |
...
| `["union", "array", "(\"map\", *, Complex{Float64}, (false, true))"]` | 1.05 (5%) :x: | 1.00 (1%)  |
| `["union", "array", "(\"map\", *, Complex{Float64}, (true, true))"]` | 1.17 (5%) :x: | 1.00 (1%)  |
...
| `["union", "array", "(\"map\", abs, Float64, true)"]` | 1.34 (5%) :x: | 1.00 (1%)  |
...
| `["union", "array", "(\"map\", identity, Complex{Float64}, false)"]` | 0.56 (5%) :white_check_mark: | 1.00 (1%)  |
...
```
Julia Version 1.6.0-DEV.40
Commit fe59346 (2020-05-15 02:34 UTC)
Platform Info:
  ...
  CPU: Intel(R) Xeon(R) CPU E3-1241 v3 @ 3.50GHz: 
       ...
       #1  3501 MHz  139372140 s       5056 s   15872416 s  6565508421 s         35 s
       #2  3501 MHz  1049375403 s        217 s   20699756 s  5660800858 s         27 s
       #3  3501 MHz  124219362 s       3301 s    9424545 s  6596605820 s         38 s
       #4  3501 MHz  116665978 s         43 s   13484678 s  6598386927 s         27 s
       
  Memory: 31.383651733398438 GB (18844.0703125 MB free)
  Uptime: 6.7359465e7 sec
