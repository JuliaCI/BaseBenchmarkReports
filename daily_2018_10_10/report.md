...
*Commit(s):* [JuliaLang/julia@367aab3dc15a5543bd14c73d1e38a3ce7e310f05](https://github.com/JuliaLang/julia/commit/367aab3dc15a5543bd14c73d1e38a3ce7e310f05)

*Triggered By:* [link](https://github.com/JuliaLang/julia/commit/367aab3dc15a5543bd14c73d1e38a3ce7e310f05#commitcomment-30840681)

*Tag Predicate:* `ALL`

*Daily Job:* 2018-10-10 vs 2018-10-09
...
| `["scalar", "acos", "(\"0.5 <= abs(x) < 1\", \"negative argument\", \"Float32\")"]` | 1.23 (5%) :x: | 1.00 (1%)  |
...
| `["scalar", "asin", "(\"0.5 <= abs(x) < 0.975\", \"negative argument\", \"Float32\")"]` | 1.28 (5%) :x: | 1.00 (1%)  |
...
| `["scalar", "cosh", "(\"very small\", \"negative argument\", \"Float32\")"]` | 0.83 (5%) :white_check_mark: | 1.00 (1%)  |
...
| `["scalar", "exp2", "(\"2pow3\", \"negative argument\", \"Float32\")"]` | 0.75 (5%) :white_check_mark: | 1.00 (1%)  |
...
| `["scalar", "tan", "(\"medium\", \"negative argument\", \"Float32\")"]` | 1.24 (5%) :x: | 1.00 (1%)  |
...
| `["tuple", "reduction", "(\"sum\", (8, 8))"]` | 1.46 (5%) :x: | 1.00 (1%)  |
...
| `["union", "array", "(\"perf_sum3\", Int8, true)"]` | 1.45 (5%) :x: | 1.00 (1%)  |
...
Platform Info:
  ...
  CPU: Intel(R) Xeon(R) CPU E3-1241 v3 @ 3.50GHz: 
       ...
       #1  3501 MHz   54114416 s       5001 s    5944276 s  1634276050 s         21 s
       #2  3501 MHz  276176729 s        203 s    4359504 s  1416761566 s         12 s
       #3  3501 MHz   38584602 s       3204 s    3345521 s  1655371973 s         23 s
       #4  3501 MHz   35808002 s          0 s    4153569 s  1657054852 s         13 s
       
  Memory: 31.383651733398438 GB (4806.98828125 MB free)
  Uptime: 1.6987677e7 sec
