...
*Commit(s):* [JuliaLang/julia@984749bc0b3c50434d970f9c871b1eae23371943](https://github.com/JuliaLang/julia/commit/984749bc0b3c50434d970f9c871b1eae23371943)

*Triggered By:* [link](https://github.com/JuliaLang/julia/commit/984749bc0b3c50434d970f9c871b1eae23371943#commitcomment-41096191)
...
| `["collection", "deletion", "(\"IdDict\", \"Any\", \"filter\")"]` | 0.71 (25%) :white_check_mark: | 1.00 (1%)  |
| `["collection", "iteration", "(\"Dict\", \"Int\", \"iterate second\")"]` | 1.53 (25%) :x: | 1.00 (1%)  |
...
| `["io", "array_limit", "(\"display\", \"Matrix{Float64}(10000, 10000)\")"]` | 0.98 (5%)  | 0.97 (1%) :white_check_mark: |
| `["io", "serialization", "(\"deserialize\", \"Vector{String}\")"]` | 0.78 (5%) :white_check_mark: | 1.00 (1%)  |
| `["io", "serialization", "(\"serialize\", \"Vector{String}\")"]` | 0.85 (5%) :white_check_mark: | 1.00 (1%)  |
| `["linalg", "factorization", "(\"eigen\", \"typename(Diagonal)\", 256)"]` | 2.10 (45%) :x: | 1.00 (1%)  |
| `["linalg", "small exp #29116"]` | 0.90 (5%) :white_check_mark: | 1.00 (1%)  |
| `["misc", "20517"]` | 0.89 (5%) :white_check_mark: | 1.00 (1%)  |
| `["misc", "afoldl", "Int"]` | 1.17 (5%) :x: | 1.00 (1%)  |
...
| `["random", "ranges", "(\"RangeGenerator\", \"BigInt\", \"1:18446744073709551615\")"]` | 1.53 (25%) :x: | 1.00 (1%)  |
| `["random", "ranges", "(\"RangeGenerator\", \"BigInt\", \"1:18446744073709551616\")"]` | 1.47 (25%) :x: | 1.00 (1%)  |
| `["random", "ranges", "(\"RangeGenerator\", \"BigInt\", \"1:1\")"]` | 0.75 (25%) :white_check_mark: | 1.00 (1%)  |
...
| `["shootout", "binary_trees"]` | 0.76 (5%) :white_check_mark: | 1.00 (1%)  |
...
| `["union", "array", "(\"perf_simplecopy\", Float32, false)"]` | 1.10 (5%) :x: | 1.00 (1%)  |
...
| `["union", "array", "(\"skipmissing\", collect, Bool, false)"]` | 0.93 (5%) :white_check_mark: | 1.00 (1%)  |
...
```
Julia Version 1.6.0-DEV.566
Commit 984749b (2020-08-01 01:10 UTC)
Platform Info:
  ...
  CPU: Intel(R) Xeon(R) CPU E3-1241 v3 @ 3.50GHz: 
       ...
       #1  3501 MHz  152718017 s       5060 s   17115817 s  7223634249 s         38 s
       #2  3501 MHz  1158013376 s        217 s   23295871 s  6222830006 s         28 s
       #3  3501 MHz  138094150 s       3324 s   10223928 s  7255001489 s         39 s
       #4  3501 MHz  129316605 s         43 s   14805959 s  7257485235 s         28 s
       
  Memory: 31.383651733398438 GB (18317.2421875 MB free)
  Uptime: 7.4099063e7 sec
