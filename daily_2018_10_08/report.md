...
*Commit(s):* [JuliaLang/julia@c03d1dcc5dbba4fd72a3f74899a8c8eb9aa3fee1](https://github.com/JuliaLang/julia/commit/c03d1dcc5dbba4fd72a3f74899a8c8eb9aa3fee1)

*Triggered By:* [link](https://github.com/JuliaLang/julia/commit/c03d1dcc5dbba4fd72a3f74899a8c8eb9aa3fee1#commitcomment-30806022)

*Tag Predicate:* `ALL`

*Daily Job:* 2018-10-08 vs 2018-10-07
...
| `["collection", "iteration", "(\"IdDict\", \"Int\", \"iterate second\")"]` | 0.45 (25%) :white_check_mark: | 1.00 (1%)  |
| `["collection", "queries & updates", "(\"IdDict\", \"Any\", \"pop!\", \"specified\")"]` | 1.48 (25%) :x: | 1.00 (1%)  |
| `["collection", "queries & updates", "(\"Set\", \"Int\", \"first\")"]` | 1.28 (25%) :x: | 1.00 (1%)  |
| `["collection", "queries & updates", "(\"Set\", \"String\", \"pop!\", \"unspecified\")"]` | 1.39 (25%) :x: | 1.00 (1%)  |
| `["collection", "set operations", "(\"Set\", \"Int\", \"⊆\", \"Vector\")"]` | 0.49 (25%) :white_check_mark: | 1.00 (1%)  |
...
| `["random", "ranges", "(\"RangeGenerator\", \"BigInt\", \"1:1\")"]` | 1.50 (25%) :x: | 1.00 (1%)  |
...
| `["scalar", "acosh", "(\"very large\", \"positive argument\", \"Float32\")"]` | 1.19 (5%) :x: | 1.00 (1%)  |
...
| `["scalar", "asinh", "(\"0 <= abs(x) < 2^-28\", \"positive argument\", \"Float32\")"]` | 1.22 (5%) :x: | 1.00 (1%)  |
...
| `["scalar", "atan2", "(\"y infinite\", \"y negative\", \"x infinite\", \"x positive\", \"Float32\")"]` | 1.31 (5%) :x: | 1.00 (1%)  |
...
| `["scalar", "exp2", "(\"2pow35\", \"positive argument\", \"Float64\")"]` | 1.27 (5%) :x: | 1.00 (1%)  |
...
| `["simd", "(\"sum_reduce\", \"Int32\", 4095)"]` | 1.25 (20%) :x: | 1.00 (1%)  |
...
| `["union", "array", "(\"map\", abs, BigInt, true)"]` | 0.95 (5%) :white_check_mark: | 1.00 (1%)  |
...
| `["union", "array", "(\"perf_sum2\", BigFloat, true)"]` | 0.89 (5%) :white_check_mark: | 1.00 (1%)  |
...
| `["union", "array", "(\"perf_sum3\", Bool, true)"]` | 1.11 (5%) :x: | 1.00 (1%)  |
| `["union", "array", "(\"perf_sum3\", Float32, true)"]` | 1.22 (5%) :x: | 1.00 (1%)  |
| `["union", "array", "(\"perf_sum4\", BigFloat, false)"]` | 0.93 (5%) :white_check_mark: | 1.00 (1%)  |
| `["union", "array", "(\"perf_sum4\", BigFloat, true)"]` | 0.93 (5%) :white_check_mark: | 1.00 (1%)  |
| `["union", "array", "(\"perf_sum\", BigFloat, false)"]` | 0.89 (5%) :white_check_mark: | 1.00 (1%)  |
| `["union", "array", "(\"perf_sum\", BigFloat, true)"]` | 0.90 (5%) :white_check_mark: | 1.00 (1%)  |
...
| `["union", "array", "(\"skipmissing\", collect, Complex{Float64}, false)"]` | 1.07 (5%) :x: | 1.00 (1%)  |
...
```
Julia Version 1.1.0-DEV.428
Commit c03d1dc (2018-10-07 15:44 UTC)
Platform Info:
  ...
  CPU: Intel(R) Xeon(R) CPU E3-1241 v3 @ 3.50GHz: 
       ...
       #1  3501 MHz   53851578 s       5001 s    5913551 s  1617274289 s         21 s
       #2  3501 MHz  273887650 s        203 s    4319019 s  1401763621 s         12 s
       #3  3501 MHz   38307258 s       3204 s    3325872 s  1638339086 s         23 s
       #4  3501 MHz   35589682 s          0 s    4113796 s  1640004448 s         13 s
       
  Memory: 31.383651733398438 GB (4915.87890625 MB free)
  Uptime: 1.6814304e7 sec
