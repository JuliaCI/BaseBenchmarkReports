...
*Commit(s):* [JuliaLang/julia@caefb9b7493b62b5c5574503350e3f3cf9a36312](https://github.com/JuliaLang/julia/commit/caefb9b7493b62b5c5574503350e3f3cf9a36312) vs [JuliaLang/julia@38612e03bcbdce12bebf9180faefbfad9d1739c3](https://github.com/JuliaLang/julia/commit/38612e03bcbdce12bebf9180faefbfad9d1739c3)

*Triggered By:* [link](https://github.com/JuliaLang/julia/pull/29406#issuecomment-428167704)
...
| `["array", "growth", "(\"prerend!\", 2048)"]` | 0.86 (5%) :white_check_mark: | 1.00 (1%)  |
...
| `["broadcast", "typeargs", "(\"tuple\", 5)"]` | 0.74 (5%) :white_check_mark: | 1.00 (1%)  |
| `["collection", "deletion", "(\"Vector\", \"Any\", \"filter\")"]` | 1.45 (25%) :x: | 1.00 (1%)  |
...
| `["find", "findnext", "(\"ispos\", \"Array{Float32,1}\")"]` | 0.85 (5%) :white_check_mark: | 1.00 (1%)  |
...
| `["find", "findprev", "(\"ispos\", \"Array{Bool,1}\")"]` | 0.84 (5%) :white_check_mark: | 1.00 (1%)  |
...
| `["parallel", "remotecall", "(\"identity\", 1024)"]` | 1.10 (5%) :x: | 1.00 (1%)  |
| `["parallel", "remotecall", "(\"identity\", 2)"]` | 1.12 (5%) :x: | 1.00 (1%)  |
| `["parallel", "remotecall", "(\"identity\", 4096)"]` | 1.10 (5%) :x: | 1.00 (1%)  |
| `["parallel", "remotecall", "(\"identity\", 512)"]` | 1.12 (5%) :x: | 1.00 (1%)  |
| `["parallel", "remotecall", "(\"identity\", 64)"]` | 1.12 (5%) :x: | 1.00 (1%)  |
...
| `["problem", "laplacian", "laplace_sparse_matvec"]` | 0.88 (5%) :white_check_mark: | 1.00 (1%)  |
...
| `["scalar", "exp2", "(\"very small\", \"positive argument\", \"Float32\")"]` | 1.11 (5%) :x: | 1.00 (1%)  |
...
| `["union", "array", "(\"perf_sum4\", Int8, false)"]` | 0.88 (5%) :white_check_mark: | 1.00 (1%)  |
...
| `["union", "array", "(\"skipmissing\", collect, Int64, true)"]` | 1.05 (5%) :x: | 1.00 (1%)  |
| `["union", "array", "(\"skipmissing\", sum, BigFloat, true)"]` | 0.92 (5%) :white_check_mark: | 1.00 (1%)  |
...
```
Julia Version 1.1.0-DEV.434
Commit caefb9b (2018-10-08 20:56 UTC)
Platform Info:
  ...
  CPU: Intel(R) Xeon(R) CPU E3-1241 v3 @ 3.50GHz: 
       ...
       #1  3501 MHz   34389875 s       2410 s    5397699 s  1648140259 s          9 s
       #2  3501 MHz  171231458 s          9 s    3102708 s  1517297553 s         15 s
       #3  3501 MHz   25650980 s       3131 s    3038979 s  1662706633 s         22 s
       #4  3501 MHz   24627006 s         11 s    2394138 s  1665241260 s         16 s
       
  Memory: 31.383651733398438 GB (5427.82421875 MB free)
  Uptime: 1.6930564e7 sec
  Load Avg:  0.9228515625  1.0009765625  1.0400390625
  WORD_SIZE: 64
  LIBM: libopenlibm
...
Platform Info:
  ...
  CPU: Intel(R) Xeon(R) CPU E3-1241 v3 @ 3.50GHz: 
              speed         user         nice          sys         idle          irq
       #1  3501 MHz   34523286 s       2410 s    5409157 s  1649279410 s          9 s
       #2  3501 MHz  172373734 s          9 s    3118683 s  1517427683 s         15 s
       #3  3501 MHz   25778144 s       3131 s    3046313 s  1663859993 s         22 s
       #4  3501 MHz   24740296 s         11 s    2401198 s  1666409374 s         16 s
       
  Memory: 31.383651733398438 GB (4597.98046875 MB free)
  Uptime: 1.6943456e7 sec
