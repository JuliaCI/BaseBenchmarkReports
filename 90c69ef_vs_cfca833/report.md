...
*Commit(s):* [JuliaLang/julia@90c69ef218e521a59e68adf53e3c3a4cccfdbede](https://github.com/JuliaLang/julia/commit/90c69ef218e521a59e68adf53e3c3a4cccfdbede) vs [JuliaLang/julia@cfca8334dd6f99a3d7f621e338869c0a58a3ae99](https://github.com/JuliaLang/julia/commit/cfca8334dd6f99a3d7f621e338869c0a58a3ae99)

*Triggered By:* [link](https://github.com/JuliaLang/julia/pull/28857#issuecomment-419530825)
...
| `["broadcast", "fusion", "(\"Float64\", (1000000,), 1)"]` | 0.86 (5%) :white_check_mark: | 1.00 (1%)  |
| `["broadcast", "fusion", "(\"Float64\", (1000000,), 2)"]` | 0.89 (5%) :white_check_mark: | 1.00 (1%)  |
...
| `["dates", "arithmetic", "(\"DateTime\", \"Year\")"]` | 0.87 (5%) :white_check_mark: | 1.00 (1%)  |
...
| `["find", "findprev", "(\"ispos\", \"Array{Float32,1}\")"]` | 1.18 (5%) :x: | 1.00 (1%)  |
...
| `["random", "collections", "(\"rand\", \"MersenneTwister\", \"'a':'z'\")"]` | 1.37 (25%) :x: | 1.00 (1%)  |
| `["random", "ranges", "(\"rand\", \"MersenneTwister\", \"BigInt\", \"RangeGenerator(1:2^10000)\")"]` | 1.36 (25%) :x: | 1.00 (1%)  |
| `["random", "types", "(\"rand\", \"MersenneTwister\", \"UInt128\")"]` | 1.26 (25%) :x: | 1.00 (1%)  |
...
| `["scalar", "arithmetic", "(\"add\", \"Float32\", \"Float32\")"]` | 0.68 (25%) :white_check_mark: | 1.00 (1%)  |
| `["scalar", "arithmetic", "(\"add\", \"UInt64\", \"Complex{Int64}\")"]` | 1.71 (50%) :x: | 1.00 (1%)  |
...
| `["scalar", "asin", "(\"abs(x) < 0.5\", \"negative argument\", \"Float64\")"]` | 1.58 (5%) :x: | 1.00 (1%)  |
| `["scalar", "asin", "(\"abs(x) < 0.5\", \"positive argument\", \"Float64\")"]` | 1.40 (5%) :x: | 1.00 (1%)  |
| `["scalar", "asin", "(\"one\", \"negative argument\", \"Float32\")"]` | 1.07 (5%) :x: | 1.00 (1%)  |
| `["scalar", "asin", "(\"one\", \"negative argument\", \"Float64\")"]` | 1.53 (5%) :x: | 1.00 (1%)  |
| `["scalar", "asin", "(\"one\", \"positive argument\", \"Float64\")"]` | 1.47 (5%) :x: | 1.00 (1%)  |
| `["scalar", "asin", "(\"small\", \"negative argument\", \"Float64\")"]` | 2.13 (5%) :x: | 1.00 (1%)  |
| `["scalar", "asin", "(\"small\", \"positive argument\", \"Float64\")"]` | 1.35 (5%) :x: | 1.00 (1%)  |
| `["scalar", "asin", "(\"zero\", \"Float64\")"]` | 2.07 (5%) :x: | 1.00 (1%)  |
...
| `["scalar", "atan2", "(\"abs(y/x) small\", \"y positive\", \"x negative\", \"Float64\")"]` | 0.95 (5%) :white_check_mark: | 1.00 (1%)  |
...
| `["scalar", "atanh", "(\"very small\", \"positive argument\", \"Float32\")"]` | 1.38 (5%) :x: | 1.00 (1%)  |
...
| `["scalar", "predicate", "(\"isequal\", \"BigFloat\")"]` | 1.59 (40%) :x: | 1.00 (1%)  |
| `["scalar", "predicate", "(\"isequal\", \"Complex{BigFloat}\")"]` | 1.83 (40%) :x: | 1.00 (1%)  |
...
| `["scalar", "rem_pio2", "(\"argument reduction (easy) abs(x) < 4π/4\", \"negative argument\", \"Float64\")"]` | 1.75 (5%) :x: | 1.00 (1%)  |
...
| `["union", "array", "(\"map\", abs, BigInt, true)"]` | 0.53 (5%) :white_check_mark: | 1.00 (1%)  |
...
| `["union", "array", "(\"skipmissing\", sum, Float32, true)"]` | 1.25 (5%) :x: | 1.00 (1%)  |
...
| `["union", "array", "(\"sort\", BigInt, true)"]` | 0.91 (5%) :white_check_mark: | 1.00 (1%)  |
...
Commit 90c69ef (2018-09-07 18:33 UTC)
Platform Info:
  ...
  CPU: Intel(R) Xeon(R) CPU E3-1241 v3 @ 3.50GHz: 
       ...
       #1  3501 MHz   30453233 s       2407 s    4393829 s  1380220296 s          8 s
       #2  3501 MHz  138480676 s          4 s    2564452 s  1276851559 s         13 s
       #3  3501 MHz   21834866 s       3126 s    2728573 s  1393312242 s         20 s
       #4  3501 MHz   20900610 s         11 s    2134497 s  1395466575 s         12 s
       
  Memory: 31.383651733398438 GB (1242.4921875 MB free)
  Uptime: 1.4192304e7 sec
...
```
Julia Version 1.1.0-DEV.208
Commit cfca833 (2018-09-07 18:25 UTC)
Platform Info:
  OS: Linux (x86_64-linux-gnu)
      Ubuntu 14.04.5 LTS
  uname: Linux 3.13.0-85-generic #129-Ubuntu SMP Thu Mar 17 20:50:15 UTC 2016 x86_64 x86_64
  CPU: Intel(R) Xeon(R) CPU E3-1241 v3 @ 3.50GHz: 
              speed         user         nice          sys         idle          irq
       #1  3501 MHz   30581865 s       2407 s    4404814 s  1381318672 s          8 s
       #2  3501 MHz  139633154 s          4 s    2580604 s  1276925229 s         13 s
       #3  3501 MHz   21947376 s       3126 s    2735846 s  1394434478 s         20 s
       #4  3501 MHz   21013693 s         11 s    2141424 s  1396588803 s         12 s
       
  Memory: 31.383651733398438 GB (3544.703125 MB free)
  Uptime: 1.4204734e7 sec
  Load Avg:  1.0029296875  1.0146484375  1.04541015625
  WORD_SIZE: 64
  LIBM: libopenlibm
  LLVM: libLLVM-6.0.1 (ORCJIT, haswell)
