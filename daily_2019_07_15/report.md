...
*Commit(s):* [JuliaLang/julia@a1165b843da796028cab774b5926580ec6227f17](https://github.com/JuliaLang/julia/commit/a1165b843da796028cab774b5926580ec6227f17)

*Triggered By:* [link](https://github.com/JuliaLang/julia/commit/a1165b843da796028cab774b5926580ec6227f17#commitcomment-34299068)

*Tag Predicate:* `ALL`

*Daily Job:* 2019-07-15 vs 2019-07-14
...
|----|------------|--------------|
| `["array", "accumulate", "(\"cumsum!\", \"Float64\", \"dim1\")"]` | 0.87 (5%) :white_check_mark: | 1.00 (1%)  |
...
| `["collection", "deletion", "(\"Dict\", \"Int\", \"filter!\")"]` | 1.35 (25%) :x: | 1.00 (1%)  |
| `["collection", "queries & updates", "(\"Dict\", \"Any\", \"push!\", \"new\")"]` | 1.46 (25%) :x: | 1.00 (1%)  |
| `["collection", "set operations", "(\"BitSet\", \"Int\", \"union!\", \"big\")"]` | 1.35 (25%) :x: | 1.00 (1%)  |
| `["collection", "set operations", "(\"BitSet\", \"Int\", \"union!\", \"small\")"]` | 1.26 (25%) :x: | 1.00 (1%)  |
...
| `["io", "array_limit", "(\"display\", \"Array{Float64,2}(10000, 10000)\")"]` | 0.95 (5%) :white_check_mark: | 1.04 (1%) :x: |
...
| `["scalar", "atanh", "(\"very small\", \"negative argument\", \"Float32\")"]` | 1.44 (5%) :x: | 1.00 (1%)  |
| `["scalar", "atanh", "(\"very small\", \"negative argument\", \"Float64\")"]` | 1.50 (5%) :x: | 1.00 (1%)  |
...
| `["scalar", "expm1", "(\"arg reduction I\", \"negative argument\", \"Float32\")"]` | 0.58 (5%) :white_check_mark: | 1.00 (1%)  |
...
| `["union", "array", "(\"broadcast\", identity, Float64, false)"]` | 1.15 (5%) :x: | 1.00 (1%)  |
...
| `["union", "array", "(\"perf_sum2\", Float64, true)"]` | 1.32 (5%) :x: | 1.00 (1%)  |
...
```
Julia Version 1.3.0-DEV.542
Commit a1165b8 (2019-07-14 21:21 UTC)
Platform Info:
  ...
  CPU: Intel(R) Xeon(R) CPU E3-1241 v3 @ 3.50GHz: 
       ...
       #1  3501 MHz   92825217 s       5037 s   10669995 s  3987650599 s         26 s
       #2  3501 MHz  606843633 s        208 s   10234041 s  3480471417 s         22 s
       #3  3501 MHz   76206318 s       3241 s    6389704 s  4014915934 s         30 s
       #4  3501 MHz   71489706 s         20 s    9013207 s  4015358952 s         21 s
       
  Memory: 31.383651733398438 GB (10302.77734375 MB free)
  Uptime: 4.1005907e7 sec
