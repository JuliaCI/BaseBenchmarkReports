...
*Commit(s):* [JuliaLang/julia@2e91c5e73af4e44c45e942e057e5c09fa062cf8f](https://github.com/JuliaLang/julia/commit/2e91c5e73af4e44c45e942e057e5c09fa062cf8f)

*Triggered By:* [link](https://github.com/JuliaLang/julia/commit/2e91c5e73af4e44c45e942e057e5c09fa062cf8f#commitcomment-31806660)

*Tag Predicate:* `ALL`

*Daily Job:* 2018-12-31 vs 2018-12-30
...
| `["collection", "iteration", "(\"BitSet\", \"Int\", \"iterate\")"]` | 0.48 (25%) :white_check_mark: | 1.00 (1%)  |
...
| `["scalar", "atan", "(\"very large\", \"negative argument\", \"Float64\")"]` | 2.14 (5%) :x: | 1.00 (1%)  |
| `["scalar", "atan", "(\"zero\", \"Float32\")"]` | 1.07 (5%) :x: | 1.00 (1%)  |
| `["scalar", "atan2", "(\"abs(y/x) high\", \"y negative\", \"x positive\", \"Float32\")"]` | 1.06 (5%) :x: | 1.00 (1%)  |
| `["scalar", "atan2", "(\"abs(y/x) safe (small)\", \"y negative\", \"x positive\", \"Float64\")"]` | 1.15 (5%) :x: | 1.00 (1%)  |
...
| `["scalar", "exp2", "(\"2pow35\", \"negative argument\", \"Float64\")"]` | 0.78 (5%) :white_check_mark: | 1.00 (1%)  |
...
| `["scalar", "predicate", "(\"isequal\", \"Float32\")"]` | 1.42 (25%) :x: | 1.00 (1%)  |
...
| `["string", "repeat", "repeat char 1"]` | 0.75 (5%) :white_check_mark: | 1.00 (1%)  |
...
```
Julia Version 1.2.0-DEV.74
Commit 2e91c5e (2018-12-30 07:21 UTC)
Platform Info:
  ...
  CPU: Intel(R) Xeon(R) CPU E3-1241 v3 @ 3.50GHz: 
       ...
       #1  3501 MHz   69267641 s       5013 s    7659012 s  2324710432 s         22 s
       #2  3501 MHz  391157492 s        203 s    6408177 s  2008055582 s         18 s
       #3  3501 MHz   52813526 s       3220 s    4472897 s  2348262613 s         26 s
       #4  3501 MHz   49347071 s          0 s    5733886 s  2349945688 s         17 s
       
  Memory: 31.383651733398438 GB (4672.9609375 MB free)
  Uptime: 2.4076045e7 sec
