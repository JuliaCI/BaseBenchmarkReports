...
*Triggered By:* [link](https://github.com/JuliaLang/julia/commit/864e6d63d234031b9b6a0abb524572d69fe91707#commitcomment-35571319)

*Tag Predicate:* `ALL`

*Daily Job:* 2019-10-19 vs 2019-10-18
...
| `["collection", "deletion", "(\"Dict\", \"String\", \"pop!\")"]` | 0.66 (25%) :white_check_mark: | 1.00 (1%)  |
...
| `["io", "skipchars"]` | 1.00 (5%)  | 0.88 (1%) :white_check_mark: |
...
| `["scalar", "arithmetic", "(\"rem type\", \"UInt64\", \"BigInt\")"]` | 1.50 (40%) :x: | 1.00 (1%)  |
| `["scalar", "asin", "(\"abs(x) < 0.5\", \"negative argument\", \"Float32\")"]` | 1.14 (5%) :x: | 1.00 (1%)  |
| `["scalar", "asin", "(\"small\", \"positive argument\", \"Float64\")"]` | 1.60 (5%) :x: | 1.00 (1%)  |
...
| `["scalar", "fastmath", "(\"sub\", \"BigInt\")"]` | 0.52 (40%) :white_check_mark: | 1.00 (1%)  |
...
| `["shootout", "mandelbrot"]` | 1.00 (5%)  | 0.96 (1%) :white_check_mark: |
...
| `["tuple", "linear algebra", "(\"matmat\", (2, 2), (2, 2))"]` | 0.93 (5%) :white_check_mark: | 1.00 (1%)  |
...
| `["union", "array", "(\"perf_binaryop\", *, Complex{Float64}, (true, true))"]` | 0.82 (5%) :white_check_mark: | 1.00 (1%)  |
...
Platform Info:
  ...
  CPU: Intel(R) Xeon(R) CPU E3-1241 v3 @ 3.50GHz: 
       ...
       #1  3501 MHz  105012908 s       5044 s   12245389 s  4801609627 s         29 s
       #2  3501 MHz  734543759 s        214 s   13139363 s  4178752405 s         24 s
       #3  3501 MHz   88717818 s       3255 s    7257749 s  4830645937 s         34 s
       #4  3501 MHz   83180349 s         27 s   10298069 s  4831186164 s         22 s
       
  Memory: 31.383651733398438 GB (15393.74609375 MB free)
  Uptime: 4.9301754e7 sec
