...
*Commit(s):* [JuliaLang/julia@ce498d65f86a2672357060a994753eb65f5b4089](https://github.com/JuliaLang/julia/commit/ce498d65f86a2672357060a994753eb65f5b4089)

*Triggered By:* [link](https://github.com/JuliaLang/julia/commit/ce498d65f86a2672357060a994753eb65f5b4089#commitcomment-36577277)
...
| `["array", "growth", "(\"push_single!\", 8)"]` | 1.27 (5%) :x: | 1.00 (1%)  |
...
| `["collection", "queries & updates", "(\"Dict\", \"String\", \"in\", \"false\")"]` | 0.62 (25%) :white_check_mark: | 1.00 (1%)  |
...
| `["dates", "parse", "(\"DateTime\", \"ISODateTimeFormat\")"]` | 0.61 (5%) :white_check_mark: | 1.00 (1%)  |
| `["dates", "parse", "(\"Date\", \"DateFormat\")"]` | 1.12 (5%) :x: | 1.00 (1%)  |
| `["find", "findall", "(\"ispos\", \"Array{Bool,1}\")"]` | 0.62 (5%) :white_check_mark: | 1.00 (1%)  |
...
| `["random", "types", "(\"randn\", \"ImplicitRNG\", \"ImplicitFloat64\")"]` | 1.31 (25%) :x: | 1.00 (1%)  |
...
| `["scalar", "asinh", "(\"0 <= abs(x) < 2^-28\", \"negative argument\", \"Float32\")"]` | 0.68 (5%) :white_check_mark: | 1.00 (1%)  |
...
| `["scalar", "asinh", "(\"2^-28 <= abs(x) < 2\", \"negative argument\", \"Float32\")"]` | 0.83 (5%) :white_check_mark: | 1.00 (1%)  |
| `["scalar", "asinh", "(\"2^-28 <= abs(x) < 2\", \"positive argument\", \"Float32\")"]` | 0.83 (5%) :white_check_mark: | 1.00 (1%)  |
| `["scalar", "asinh", "(\"2^-28 <= abs(x) < 2\", \"positive argument\", \"Float64\")"]` | 0.94 (5%) :white_check_mark: | 1.00 (1%)  |
| `["scalar", "asinh", "(\"very large\", \"negative argument\", \"Float32\")"]` | 0.64 (5%) :white_check_mark: | 1.00 (1%)  |
| `["scalar", "asinh", "(\"very large\", \"positive argument\", \"Float32\")"]` | 0.54 (5%) :white_check_mark: | 1.00 (1%)  |
| `["scalar", "asinh", "(\"very small\", \"negative argument\", \"Float32\")"]` | 0.68 (5%) :white_check_mark: | 1.00 (1%)  |
| `["scalar", "asinh", "(\"very small\", \"positive argument\", \"Float32\")"]` | 0.62 (5%) :white_check_mark: | 1.00 (1%)  |
| `["scalar", "asinh", "(\"zero\", \"Float32\")"]` | 0.62 (5%) :white_check_mark: | 1.00 (1%)  |
...
| `["sparse", "index", "(\"spmat\", \"col\", \"range\", 100)"]` | 0.69 (30%) :white_check_mark: | 1.00 (1%)  |
| `["sparse", "index", "(\"spmat\", \"col\", \"range\", 1000)"]` | 0.68 (30%) :white_check_mark: | 1.00 (1%)  |
...
| `["tuple", "reduction", "(\"sum\", (4,))"]` | 0.61 (5%) :white_check_mark: | 1.00 (1%)  |
...
Commit ce498d6 (2019-12-25 11:44 UTC)
Platform Info:
  ...
  CPU: Intel(R) Xeon(R) CPU E3-1241 v3 @ 3.50GHz: 
       ...
       #1  3501 MHz  115282639 s       5048 s   13429849 s  5376736175 s         31 s
       #2  3501 MHz  844169871 s        217 s   15664728 s  4654142054 s         26 s
       #3  3501 MHz   99391673 s       3261 s    7941751 s  5406853956 s         35 s
       #4  3501 MHz   93163203 s         40 s   11302014 s  5407532876 s         25 s
       
  Memory: 31.383651733398438 GB (14772.6015625 MB free)
  Uptime: 5.5181167e7 sec
