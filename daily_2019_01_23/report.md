...
*Commit(s):* [JuliaLang/julia@155c319ac30f3218061771179eb9668cd50056c3](https://github.com/JuliaLang/julia/commit/155c319ac30f3218061771179eb9668cd50056c3)

*Triggered By:* [link](https://github.com/JuliaLang/julia/commit/155c319ac30f3218061771179eb9668cd50056c3#commitcomment-32031336)

*Tag Predicate:* `ALL`

*Daily Job:* 2019-01-23 vs 2019-01-22
...
| `["collection", "deletion", "(\"Dict\", \"Int\", \"pop!\")"]` | 2.21 (25%) :x: | 1.00 (1%)  |
| `["collection", "queries & updates", "(\"Dict\", \"Any\", \"getindex\")"]` | 1.81 (25%) :x: | 1.00 (1%)  |
...
| `["find", "findprev", "(\"ispos\", \"Array{Int64,1}\")"]` | 0.81 (5%) :white_check_mark: | 1.00 (1%)  |
...
| `["scalar", "acos", "(\"small\", \"negative argument\", \"Float64\")"]` | 0.74 (5%) :white_check_mark: | 1.00 (1%)  |
...
| `["scalar", "acos", "(\"zero\", \"Float64\")"]` | 0.78 (5%) :white_check_mark: | 1.00 (1%)  |
...
| `["sparse", "matmul", "(\"A_mul_B\", \"dense 5x500, sparse 500x500 -> dense 5x500\")"]` | 1.40 (30%) :x: | 1.00 (1%)  |
...
| `["union", "array", "(\"sort\", Union{Missing, BigFloat}, true)"]` | 0.94 (5%) :white_check_mark: | 1.00 (1%)  |
...
```
Julia Version 1.2.0-DEV.200
Commit 155c319 (2019-01-23 03:44 UTC)
Platform Info:
  ...
  CPU: Intel(R) Xeon(R) CPU E3-1241 v3 @ 3.50GHz: 
       ...
       #1  3501 MHz   72467134 s       5014 s    8080685 s  2519336483 s         23 s
       #2  3501 MHz  421234800 s        203 s    6938936 s  2176002407 s         19 s
       #3  3501 MHz   56031920 s       3224 s    4742432 s  2543302632 s         26 s
       #4  3501 MHz   52413414 s          2 s    6151554 s  2544890512 s         17 s
       
  Memory: 31.383651733398438 GB (5464.5703125 MB free)
  Uptime: 2.6062725e7 sec
