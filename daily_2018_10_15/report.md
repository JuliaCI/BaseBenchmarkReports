...
*Commit(s):* [JuliaLang/julia@b7a70028026380cec4679df33a1488e06d65c8ce](https://github.com/JuliaLang/julia/commit/b7a70028026380cec4679df33a1488e06d65c8ce)

*Triggered By:* [link](https://github.com/JuliaLang/julia/commit/b7a70028026380cec4679df33a1488e06d65c8ce#commitcomment-30898252)

*Tag Predicate:* `ALL`

*Daily Job:* 2018-10-15 vs 2018-10-14
...
| `["broadcast", "mix_scalar_tuple", "(10, \"scal_tup\")"]` | 1.15 (5%) :x: | 1.00 (1%)  |
...
| `["collection", "set operations", "(\"BitSet\", \"Int\", \"symdiff!\", \"Set\")"]` | 1.34 (25%) :x: | 1.00 (1%)  |
| `["collection", "set operations", "(\"Set\", \"Int\", \"setdiff!\", \"Vector\")"]` | 1.40 (25%) :x: | 1.00 (1%)  |
| `["dates", "parse", "(\"DateTime\", \"ISODateTimeFormat\")"]` | 1.06 (5%) :x: | 1.00 (1%)  |
| `["find", "findnext", "(\"ispos\", \"Array{Int64,1}\")"]` | 1.05 (5%) :x: | 1.00 (1%)  |
| `["find", "findnext", "(\"ispos\", \"Array{UInt8,1}\")"]` | 1.25 (5%) :x: | 1.00 (1%)  |
...
| `["random", "collections", "(\"rand!\", \"MersenneTwister\", \"large BitSet\")"]` | 1.43 (25%) :x: | 1.00 (1%)  |
| `["random", "collections", "(\"rand\", \"ImplicitRNG\", \"'a':'z'\")"]` | 1.43 (25%) :x: | 1.00 (1%)  |
...
| `["random", "ranges", "(\"rand!\", \"ImplicitRNG\", \"Int\", \"1:1000\")"]` | 2.06 (25%) :x: | 1.00 (1%)  |
| `["random", "ranges", "(\"rand!\", \"MersenneTwister\", \"Int\", \"1:1000\")"]` | 2.04 (25%) :x: | 1.00 (1%)  |
| `["random", "ranges", "(\"rand\", \"MersenneTwister\", \"BigInt\", \"RangeGenerator(1:170141183460469231731687303715884105728)\")"]` | 1.33 (25%) :x: | 1.00 (1%)  |
| `["random", "types", "(\"rand!\", \"MersenneTwister\", \"Complex{Float16}\")"]` | 1.46 (25%) :x: | 1.00 (1%)  |
| `["random", "types", "(\"rand!\", \"MersenneTwister\", \"Float16\")"]` | 1.48 (25%) :x: | 1.00 (1%)  |
| `["random", "types", "(\"rand\", \"RandomDevice\", \"ImplicitFloat64\")"]` | 1.27 (25%) :x: | 1.00 (1%)  |
| `["random", "types", "(\"randexp\", \"RandomDevice\", \"Float64\")"]` | 1.28 (25%) :x: | 1.00 (1%)  |
| `["scalar", "acos", "(\"small\", \"negative argument\", \"Float64\")"]` | 1.07 (5%) :x: | 1.00 (1%)  |
| `["scalar", "acos", "(\"small\", \"positive argument\", \"Float64\")"]` | 1.07 (5%) :x: | 1.00 (1%)  |
| `["scalar", "arithmetic", "(\"add\", \"Complex{BigInt}\", \"UInt64\")"]` | 1.64 (50%) :x: | 1.00 (1%)  |
...
| `["string", "findfirst", "Char"]` | 1.46 (5%) :x: | 1.00 (1%)  |
| `["string", "findfirst", "String"]` | 1.32 (5%) :x: | 1.00 (1%)  |
...
| `["union", "array", "(\"skipmissing\", sum, Float64, true)"]` | 0.89 (5%) :white_check_mark: | 1.00 (1%)  |
...
```
Julia Version 1.1.0-DEV.449
Commit b7a7002 (2018-10-14 16:26 UTC)
Platform Info:
  ...
  CPU: Intel(R) Xeon(R) CPU E3-1241 v3 @ 3.50GHz: 
       ...
       #1  3501 MHz   54984885 s       5002 s    6051919 s  1676407986 s         21 s
       #2  3501 MHz  282401560 s        203 s    4482803 s  1453590761 s         13 s
       #3  3501 MHz   39515296 s       3205 s    3413295 s  1697551554 s         24 s
       #4  3501 MHz   36625898 s          0 s    4240351 s  1699325395 s         13 s
       
  Memory: 31.383651733398438 GB (4806.95703125 MB free)
  Uptime: 1.7419832e7 sec
