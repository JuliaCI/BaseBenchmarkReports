...
*Commit(s):* [JuliaLang/julia@27df04b5bec57ac5222773d93d7266c06b1472c3](https://github.com/JuliaLang/julia/commit/27df04b5bec57ac5222773d93d7266c06b1472c3) vs [JuliaLang/julia@3c9d75391c72d7c32eea75ff187ce77b2d5effc8](https://github.com/JuliaLang/julia/commit/3c9d75391c72d7c32eea75ff187ce77b2d5effc8)

*Triggered By:* [link](https://github.com/JuliaLang/julia/commit/27df04b5bec57ac5222773d93d7266c06b1472c3#commitcomment-21126792)
...
| `["array","index",("sumcolon","SubArray{Float32,2,Base.ReshapedArray{Float32,2,SubArray{Float32,3,BaseBenchmarks.ArrayBenchmarks.ArrayLS{Float32,3},Tuple{Colon,Colon,Colon},false},Tuple{Base.MultiplicativeInverses.SignedMultiplicativeInverse{Int64},Base.MultiplicativeInverses.SignedMultiplicativeInverse{Int64}}},Tuple{Colon,UnitRange{Int64}},false}")]` | 0.83 (50%)  | 0.86 (1%) :white_check_mark: |
| `["array","index",("sumcolon","SubArray{Int32,2,Base.ReshapedArray{Int32,2,SubArray{Int32,3,Array{Int32,3},Tuple{Colon,Colon,Colon},true},Tuple{}},Tuple{Colon,UnitRange{Int64}},true}")]` | 0.90 (50%)  | 0.86 (1%) :white_check_mark: |
...
| `["array","index",("sumlogical","SubArray{Int32,2,Base.ReshapedArray{Int32,2,SubArray{Int32,3,Array{Int32,3},Tuple{Colon,Colon,Colon},true},Tuple{}},Tuple{Colon,UnitRange{Int64}},true}")]` | 0.91 (50%)  | 0.92 (1%) :white_check_mark: |
| `["array","index",("sumlogical","SubArray{Int32,2,Base.ReshapedArray{Int32,2,SubArray{Int32,3,BaseBenchmarks.ArrayBenchmarks.ArrayLS{Int32,3},Tuple{Colon,Colon,Colon},false},Tuple{Base.MultiplicativeInverses.SignedMultiplicativeInverse{Int64},Base.MultiplicativeInverses.SignedMultiplicativeInverse{Int64}}},Tuple{Colon,UnitRange{Int64}},false}")]` | 0.90 (50%)  | 0.92 (1%) :white_check_mark: |
...
| `["array","index",("sumrange","SubArray{Int32,2,Base.ReshapedArray{Int32,2,SubArray{Int32,3,Array{Int32,3},Tuple{Colon,Colon,Colon},true},Tuple{}},Tuple{Colon,UnitRange{Int64}},true}")]` | 0.87 (50%)  | 0.89 (1%) :white_check_mark: |
...
| `["array","index",("sumvector","BaseBenchmarks.ArrayBenchmarks.ArrayLSLS{Float32,2}")]` | 0.86 (50%)  | 0.89 (1%) :white_check_mark: |
...
| `["array","index",("sumvector","SubArray{Float32,2,Base.ReshapedArray{Float32,2,SubArray{Float32,3,Array{Float32,3},Tuple{Colon,Colon,Colon},true},Tuple{}},Tuple{Colon,UnitRange{Int64}},true}")]` | 0.64 (50%)  | 0.88 (1%) :white_check_mark: |
| `["array","index",("sumvector","SubArray{Float32,2,Base.ReshapedArray{Float32,2,SubArray{Float32,3,BaseBenchmarks.ArrayBenchmarks.ArrayLS{Float32,3},Tuple{Colon,Colon,Colon},false},Tuple{Base.MultiplicativeInverses.SignedMultiplicativeInverse{Int64},Base.MultiplicativeInverses.SignedMultiplicativeInverse{Int64}}},Tuple{Colon,UnitRange{Int64}},false}")]` | 0.77 (50%)  | 0.88 (1%) :white_check_mark: |
...
| `["array","index",("sumvector","SubArray{Int32,2,Base.ReshapedArray{Int32,2,SubArray{Int32,3,Array{Int32,3},Tuple{Colon,Colon,Colon},true},Tuple{}},Tuple{Colon,UnitRange{Int64}},true}")]` | 0.72 (50%)  | 0.88 (1%) :white_check_mark: |
...
| `["array","index",("sumvector","SubArray{Int32,2,BaseBenchmarks.ArrayBenchmarks.ArrayLS{Int32,2},Tuple{Colon,Colon},false}")]` | 0.83 (50%)  | 0.88 (1%) :white_check_mark: |
...
| `["shootout","revcomp"]` | 0.91 (25%)  | 0.97 (1%) :white_check_mark: |
| `["simd",("sum_reduce","Float32",4096)]` | 1.31 (20%) :x: | 1.00 (1%)  |
| `["sparse","index",("spmat","array",10)]` | 0.90 (30%)  | 0.99 (1%) :white_check_mark: |
| `["sparse","index",("spmat","col","array",10)]` | 0.88 (30%)  | 0.98 (1%) :white_check_mark: |
| `["sparse","index",("spmat","col","range",1000)]` | 0.63 (30%) :white_check_mark: | 1.00 (1%)  |
...
```
Julia Version 0.5.1-pre+142
Commit 27df04b (2017-03-01 10:44 UTC)
Platform Info:
...
Memory: 31.383651733398438 GB (9219.08984375 MB free)
Uptime: 2.4134652e7 sec
Load Avg:  0.9228515625  0.998046875  1.0400390625
Intel(R) Xeon(R) CPU E3-1241 v3 @ 3.50GHz: 
       speed         user         nice          sys         idle          irq
#1  3501 MHz   49847884 s          0 s    7757945 s  2350720221 s         72 s
#2  3501 MHz  170786915 s          0 s    8223289 s  2230543300 s         25 s
#3  3501 MHz   40721266 s          0 s    4802854 s  2366854902 s         39 s
#4  3501 MHz   36603014 s          0 s    4739464 s  2371260454 s         13 s
...
Platform Info:
  ...
  WORD_SIZE: 64
           Ubuntu 14.04.4 LTS
  uname: Linux 3.13.0-85-generic #129-Ubuntu SMP Thu Mar 17 20:50:15 UTC 2016 x86_64 x86_64
Memory: 31.383651733398438 GB (9160.94921875 MB free)
Uptime: 2.4143212e7 sec
Load Avg:  1.0029296875  1.0146484375  1.04541015625
Intel(R) Xeon(R) CPU E3-1241 v3 @ 3.50GHz: 
       speed         user         nice          sys         idle          irq
#1  3501 MHz   49928240 s          0 s    7768850 s  2351481730 s         72 s
#2  3501 MHz  171582012 s          0 s    8241372 s  2230585407 s         25 s
#3  3501 MHz   40807652 s          0 s    4811490 s  2367615169 s         39 s
#4  3501 MHz   36678512 s          0 s    4747599 s  2372032238 s         13 s
