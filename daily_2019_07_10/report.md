...
*Commit(s):* [JuliaLang/julia@073cbbb4912fbc5ddd82163b31d18b203802fb47](https://github.com/JuliaLang/julia/commit/073cbbb4912fbc5ddd82163b31d18b203802fb47)

*Triggered By:* [link](https://github.com/JuliaLang/julia/commit/073cbbb4912fbc5ddd82163b31d18b203802fb47#commitcomment-34245632)

*Tag Predicate:* `ALL`

*Daily Job:* 2019-07-10 vs 2019-07-09
...
| `["collection", "queries & updates", "(\"IdDict\", \"String\", \"setindex!\", \"overwrite\")"]` | 0.58 (25%) :white_check_mark: | 1.00 (1%)  |
...
| `["random", "collections", "(\"rand\", \"ImplicitRNG\", \"'a':'z'\")"]` | 1.30 (25%) :x: | 1.00 (1%)  |
...
| `["scalar", "arithmetic", "(\"rem type\", \"Int64\", \"BigInt\")"]` | 0.48 (40%) :white_check_mark: | 1.00 (1%)  |
...
| `["scalar", "asinh", "(\"0 <= abs(x) < 2^-28\", \"positive argument\", \"Float32\")"]` | 1.86 (5%) :x: | 1.00 (1%)  |
...
| `["scalar", "atan2", "(\"abs(y/x) high\", \"y negative\", \"x positive\", \"Float64\")"]` | 1.37 (5%) :x: | 1.00 (1%)  |
...
| `["scalar", "expm1", "(\"one\", \"Float32\")"]` | 1.18 (5%) :x: | 1.00 (1%)  |
...
| `["sparse", "constructors", "(\"Bidiagonal\", 100)"]` | 1.30 (5%) :x: | 1.00 (1%)  |
| `["sparse", "constructors", "(\"Diagonal\", 100)"]` | 0.86 (5%) :white_check_mark: | 1.00 (1%)  |
...
| `["union", "array", "(\"map\", identity, Float64, true)"]` | 1.24 (5%) :x: | 1.00 (1%)  |
...
| `["union", "array", "(\"sort\", Union{Nothing, BigInt}, false)"]` | 0.88 (5%) :white_check_mark: | 1.00 (1%)  |
...
```
Julia Version 1.3.0-DEV.533
Commit 073cbbb (2019-07-10 01:50 UTC)
Platform Info:
  ...
  CPU: Intel(R) Xeon(R) CPU E3-1241 v3 @ 3.50GHz: 
       ...
       #1  3501 MHz   92063774 s       5036 s   10584749 s  3945423084 s         26 s
       #2  3501 MHz  598855518 s        208 s   10115497 s  3445454256 s         22 s
       #3  3501 MHz   75461976 s       3239 s    6344905 s  3972559061 s         30 s
       #4  3501 MHz   70771556 s         20 s    8933974 s  3973044421 s         21 s
       
  Memory: 31.383651733398438 GB (5285.53515625 MB free)
  Uptime: 4.0574286e7 sec
