...
*Commit(s):* [JuliaLang/julia@bf25dc546b7ffe9ca2394d9995d0be9f26e992f4](https://github.com/JuliaLang/julia/commit/bf25dc546b7ffe9ca2394d9995d0be9f26e992f4)

*Triggered By:* [link](https://github.com/JuliaLang/julia/commit/bf25dc546b7ffe9ca2394d9995d0be9f26e992f4#commitcomment-36857407)
...
| `["collection", "queries & updates", "(\"BitSet\", \"Int\", \"in\", \"true\")"]` | 1.28 (25%) :x: | 1.00 (1%)  |
| `["collection", "queries & updates", "(\"BitSet\", \"Int\", \"length\")"]` | 1.36 (25%) :x: | 1.00 (1%)  |
| `["collection", "queries & updates", "(\"Dict\", \"Any\", \"getindex\")"]` | 0.68 (25%) :white_check_mark: | 1.00 (1%)  |
...
| `["scalar", "atan", "(\"39/16 <= abs(x) < 2^66\", \"negative argument\", \"Float64\")"]` | 0.69 (5%) :white_check_mark: | 1.00 (1%)  |
| `["scalar", "atan", "(\"7/16 <= abs(x) < 11/16\", \"negative argument\", \"Float32\")"]` | 1.08 (5%) :x: | 1.00 (1%)  |
| `["scalar", "atan", "(\"7/16 <= abs(x) < 11/16\", \"positive argument\", \"Float64\")"]` | 0.87 (5%) :white_check_mark: | 1.00 (1%)  |
| `["scalar", "atan", "(\"very small\", \"negative argument\", \"Float64\")"]` | 0.63 (5%) :white_check_mark: | 1.00 (1%)  |
...
| `["scalar", "cbrt", "(\"medium\", \"negative argument\", \"Float64\")"]` | 1.23 (5%) :x: | 1.00 (1%)  |
...
| `["scalar", "cos", "(\"argument reduction (easy) abs(x) < 7π/4\", \"negative argument\", \"Float32\", \"cos_kernel\")"]` | 0.83 (5%) :white_check_mark: | 1.00 (1%)  |
| `["scalar", "cos", "(\"argument reduction (easy) abs(x) < 9π/4\", \"negative argument\", \"Float64\", \"cos_kernel\")"]` | 1.30 (5%) :x: | 1.00 (1%)  |
...
| `["scalar", "expm1", "(\"medium\", \"positive argument\", \"Float64\")"]` | 1.14 (5%) :x: | 1.00 (1%)  |
...
| `["scalar", "sin", "(\"argument reduction (hard) abs(x) < 8π/4\", \"negative argument\", \"Float64\", \"sin_kernel\")"]` | 0.84 (5%) :white_check_mark: | 1.00 (1%)  |
...
| `["scalar", "sincos", "(\"argument reduction (easy) abs(x) < 2π/4\", \"positive argument\", \"Float64\")"]` | 0.78 (5%) :white_check_mark: | 1.00 (1%)  |
...
| `["sparse", "matmul", "(\"At_mul_B\", \"dense 5x500, sparse 5x5 -> dense 500x5\")"]` | 0.69 (30%) :white_check_mark: | 1.00 (1%)  |
...
| `["union", "array", "(\"perf_sum\", Int8, false)"]` | 1.15 (5%) :x: | 1.00 (1%)  |
...
| `["union", "array", "(\"sort\", Union{Nothing, Int64}, false)"]` | 0.66 (5%) :white_check_mark: | 1.00 (1%)  |
...
```
Julia Version 1.5.0-DEV.87
Commit bf25dc5 (2020-01-18 00:10 UTC)
Platform Info:
  ...
  CPU: Intel(R) Xeon(R) CPU E3-1241 v3 @ 3.50GHz: 
       ...
       #1  3501 MHz  118570990 s       5050 s   13757336 s  5571431956 s         32 s
       #2  3501 MHz  871148059 s        217 s   16399854 s  4824975710 s         26 s
       #3  3501 MHz  102699140 s       3264 s    8173025 s  5601873224 s         36 s
       #4  3501 MHz   96230046 s         43 s   11693388 s  5602481169 s         25 s
       
  Memory: 31.383651733398438 GB (18858.16015625 MB free)
  Uptime: 5.7168043e7 sec
