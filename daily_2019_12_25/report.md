...
*Commit(s):* [JuliaLang/julia@f6b5e8ad58d68855a7d9f4d716b8d719726da1ce](https://github.com/JuliaLang/julia/commit/f6b5e8ad58d68855a7d9f4d716b8d719726da1ce)

*Triggered By:* [link](https://github.com/JuliaLang/julia/commit/f6b5e8ad58d68855a7d9f4d716b8d719726da1ce#commitcomment-36569192)
...
| `["collection", "queries & updates", "(\"Dict\", \"String\", \"in\", \"false\")"]` | 1.61 (25%) :x: | 1.00 (1%)  |
| `["collection", "set operations", "(\"BitSet\", \"Int\", \"union\", \"BitSet\")"]` | 1.36 (25%) :x: | 1.00 (1%)  |
| `["dates", "parse", "(\"DateTime\", \"ISODateTimeFormat\")"]` | 1.62 (5%) :x: | 1.00 (1%)  |
| `["find", "findall", "(\"ispos\", \"Array{Bool,1}\")"]` | 1.61 (5%) :x: | 1.00 (1%)  |
...
| `["scalar", "arithmetic", "(\"add\", \"BigInt\", \"Complex{BigInt}\")"]` | 1.77 (50%) :x: | 1.00 (1%)  |
| `["scalar", "asin", "(\"small\", \"negative argument\", \"Float32\")"]` | 1.07 (5%) :x: | 1.00 (1%)  |
| `["scalar", "asinh", "(\"0 <= abs(x) < 2^-28\", \"negative argument\", \"Float32\")"]` | 1.41 (5%) :x: | 1.00 (1%)  |
| `["scalar", "asinh", "(\"0 <= abs(x) < 2^-28\", \"positive argument\", \"Float32\")"]` | 1.39 (5%) :x: | 1.00 (1%)  |
| `["scalar", "asinh", "(\"2 <= abs(x) < 2^28\", \"negative argument\", \"Float32\")"]` | 1.22 (5%) :x: | 1.00 (1%)  |
| `["scalar", "asinh", "(\"2 <= abs(x) < 2^28\", \"positive argument\", \"Float32\")"]` | 1.22 (5%) :x: | 1.00 (1%)  |
| `["scalar", "asinh", "(\"2^-28 <= abs(x) < 2\", \"negative argument\", \"Float32\")"]` | 1.18 (5%) :x: | 1.00 (1%)  |
| `["scalar", "asinh", "(\"2^-28 <= abs(x) < 2\", \"positive argument\", \"Float32\")"]` | 1.18 (5%) :x: | 1.00 (1%)  |
| `["scalar", "asinh", "(\"very large\", \"negative argument\", \"Float32\")"]` | 1.79 (5%) :x: | 1.00 (1%)  |
| `["scalar", "asinh", "(\"very large\", \"positive argument\", \"Float32\")"]` | 1.85 (5%) :x: | 1.00 (1%)  |
| `["scalar", "asinh", "(\"very small\", \"negative argument\", \"Float32\")"]` | 1.56 (5%) :x: | 1.00 (1%)  |
| `["scalar", "asinh", "(\"very small\", \"positive argument\", \"Float32\")"]` | 1.63 (5%) :x: | 1.00 (1%)  |
| `["scalar", "asinh", "(\"zero\", \"Float32\")"]` | 1.63 (5%) :x: | 1.00 (1%)  |
...
| `["scalar", "predicate", "(\"isnan\", \"BigFloat\")"]` | 0.41 (40%) :white_check_mark: | 1.00 (1%)  |
...
| `["sparse", "index", "(\"spmat\", \"col\", \"range\", 1000)"]` | 1.38 (30%) :x: | 1.00 (1%)  |
...
| `["sparse", "transpose", "(\"adjoint\", (600, 600))"]` | 1.67 (30%) :x: | 1.00 (1%)  |
...
Commit f6b5e8a (2019-12-24 15:13 UTC)
Platform Info:
  ...
  CPU: Intel(R) Xeon(R) CPU E3-1241 v3 @ 3.50GHz: 
       ...
       #1  3501 MHz  115163580 s       5048 s   13412546 s  5368210439 s         31 s
       #2  3501 MHz  842845568 s        217 s   15633842 s  4646816174 s         26 s
       #3  3501 MHz   99254448 s       3261 s    7930078 s  5398321367 s         35 s
       #4  3501 MHz   93043851 s         40 s   11291640 s  5398982469 s         25 s
       
  Memory: 31.383651733398438 GB (14704.5234375 MB free)
  Uptime: 5.5094305e7 sec
