...
*Commit(s):* [JuliaLang/julia@eb18db5853627807291a81f5feeffbe7aa92cddc](https://github.com/JuliaLang/julia/commit/eb18db5853627807291a81f5feeffbe7aa92cddc)

*Triggered By:* [link](https://github.com/JuliaLang/julia/commit/eb18db5853627807291a81f5feeffbe7aa92cddc#commitcomment-31996366)

*Tag Predicate:* `ALL`

*Daily Job:* 2019-01-19 vs 2019-01-18
...
| `["collection", "queries & updates", "(\"Dict\", \"String\", \"in\", \"false\")"]` | 0.65 (25%) :white_check_mark: | 1.00 (1%)  |
| `["collection", "queries & updates", "(\"Vector\", \"String\", \"in\", \"false\")"]` | 1.91 (25%) :x: | 1.00 (1%)  |
| `["collection", "queries & updates", "(\"Vector\", \"String\", \"in\", \"true\")"]` | 1.92 (25%) :x: | 1.00 (1%)  |
...
| `["scalar", "arithmetic", "(\"mul\", \"Complex{Int64}\", \"Complex{BigFloat}\")"]` | 1.52 (50%) :x: | 1.00 (1%)  |
...
| `["scalar", "atan2", "(\"abs(y/x) safe (small)\", \"y positive\", \"x positive\", \"Float64\")"]` | 1.14 (5%) :x: | 1.00 (1%)  |
...
| `["scalar", "expm1", "(\"arg reduction I\", \"positive argument\", \"Float32\")"]` | 0.85 (5%) :white_check_mark: | 1.00 (1%)  |
...
| `["sparse", "constructors", "(\"Tridiagonal\", 1000)"]` | 1.12 (5%) :x: | 1.00 (1%)  |
...
| `["union", "array", "(\"broadcast\", abs, Int8, true)"]` | 1.13 (5%) :x: | 1.00 (1%)  |
| `["union", "array", "(\"broadcast\", identity, Complex{Float64}, true)"]` | 1.08 (5%) :x: | 1.00 (1%)  |
| `["union", "array", "(\"map\", *, Complex{Float64}, (true, true))"]` | 1.05 (5%) :x: | 1.00 (1%)  |
...
| `["union", "array", "(\"perf_simplecopy\", Complex{Float64}, false)"]` | 0.95 (5%) :white_check_mark: | 1.00 (1%)  |
...
| `["union", "array", "(\"skipmissing\", collect, Complex{Float64}, false)"]` | 0.93 (5%) :white_check_mark: | 1.00 (1%)  |
| `["union", "array", "(\"skipmissing\", collect, Float64, false)"]` | 0.93 (5%) :white_check_mark: | 1.00 (1%)  |
...
```
Julia Version 1.2.0-DEV.182
Commit eb18db5 (2019-01-18 19:39 UTC)
Platform Info:
  ...
  CPU: Intel(R) Xeon(R) CPU E3-1241 v3 @ 3.50GHz: 
       ...
       #1  3501 MHz   71759539 s       5013 s    7991125 s  2485651841 s         23 s
       #2  3501 MHz  414338167 s        203 s    6820683 s  2148481004 s         19 s
       #3  3501 MHz   55321396 s       3222 s    4689511 s  2509538512 s         26 s
       #4  3501 MHz   51706438 s          2 s    6076507 s  2511149741 s         17 s
       
  Memory: 31.383651733398438 GB (4474.82421875 MB free)
  Uptime: 2.5717146e7 sec
