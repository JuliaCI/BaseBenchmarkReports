...
*Commit(s):* [JuliaLang/julia@d33c5a5eaedb2b014125cc006ddd6aca7f207cd4](https://github.com/JuliaLang/julia/commit/d33c5a5eaedb2b014125cc006ddd6aca7f207cd4)

*Triggered By:* [link](https://github.com/JuliaLang/julia/commit/d33c5a5eaedb2b014125cc006ddd6aca7f207cd4#commitcomment-37933565)

*Tag Predicate:* `ALL`

*Daily Job:* 2020-03-20 vs 2020-03-19
...
| `["broadcast", "mix_scalar_tuple", "(5, \"scal_tup_x3\")"]` | 1.43 (5%) :x: | 1.00 (1%)  |
| `["broadcast", "mix_scalar_tuple", "(5, \"tup_tup\")"]` | 1.05 (5%) :x: | 1.00 (1%)  |
| `["collection", "queries & updates", "(\"BitSet\", \"Int\", \"in\", \"false\")"]` | 1.27 (25%) :x: | 1.00 (1%)  |
| `["collection", "queries & updates", "(\"BitSet\", \"Int\", \"push!\", \"overwrite\")"]` | 1.76 (25%) :x: | 1.00 (1%)  |
...
| `["io", "serialization", "(\"deserialize\", \"Vector{String}\")"]` | 2.39 (5%) :x: | 2.05 (1%) :x: |
| `["io", "serialization", "(\"serialize\", \"Vector{String}\")"]` | 3.06 (5%) :x: | 2.23 (1%) :x: |
...
| `["random", "types", "(\"rand\", \"MersenneTwister\", \"UInt8\")"]` | 0.53 (25%) :white_check_mark: | 1.00 (1%)  |
...
| `["scalar", "cos", "(\"argument reduction (hard) abs(x) < 2π/4\", \"negative argument\", \"Float32\", \"sin_kernel\")"]` | 1.30 (5%) :x: | 1.00 (1%)  |
...
| `["scalar", "expm1", "(\"huge\", \"positive argument\", \"Float3\")"]` | 1.47 (5%) :x: | 1.00 (1%)  |
...
| `["scalar", "expm1", "(\"zero\", \"Float32\")"]` | 0.65 (5%) :white_check_mark: | 1.00 (1%)  |
...
| `["scalar", "sin", "(\"argument reduction (hard) abs(x) < 4π/4\", \"negative argument\", \"Float64\", \"sin_kernel\")"]` | 0.70 (5%) :white_check_mark: | 1.00 (1%)  |
...
| `["union", "array", "(\"map\", identity, Bool, true)"]` | 1.16 (5%) :x: | 1.00 (1%)  |
...
Commit d33c5a5 (2020-03-19 20:38 UTC)
Platform Info:
  ...
  CPU: Intel(R) Xeon(R) CPU E3-1241 v3 @ 3.50GHz: 
       ...
       #1  3501 MHz  128852916 s       5056 s   14859629 s  6094268923 s         34 s
       #2  3501 MHz  962345800 s        217 s   18596393 s  5266590365 s         26 s
       #3  3501 MHz  113353808 s       3281 s    8807730 s  6125290276 s         36 s
       #4  3501 MHz  106305403 s         43 s   12582996 s  6126383896 s         26 s
       
  Memory: 31.383651733398438 GB (19084.07421875 MB free)
  Uptime: 6.252175e7 sec
