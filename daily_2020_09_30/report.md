...
*Commit(s):* [JuliaLang/julia@8a9666ae2278c61e021ed21864feb77d04a53dc7](https://github.com/JuliaLang/julia/commit/8a9666ae2278c61e021ed21864feb77d04a53dc7)

*Triggered By:* [link](https://github.com/JuliaLang/julia/commit/8a9666ae2278c61e021ed21864feb77d04a53dc7#commitcomment-42838021)

*Tag Predicate:* `ALL`

*Daily Job:* 2020-09-30 vs 2020-09-29
...
| `["collection", "queries & updates", "(\"Dict\", \"Any\", \"push!\", \"new\")"]` | 0.74 (25%) :white_check_mark: | 1.00 (1%)  |
| `["collection", "queries & updates", "(\"Dict\", \"Any\", \"setindex!\", \"new\")"]` | 0.73 (25%) :white_check_mark: | 1.00 (1%)  |
| `["collection", "queries & updates", "(\"Dict\", \"Int\", \"setindex!\", \"overwrite\")"]` | 0.66 (25%) :white_check_mark: | 1.00 (1%)  |
| `["find", "findnext", "(\"ispos\", \"Vector{Float64}\")"]` | 0.93 (5%) :white_check_mark: | 1.00 (1%)  |
| `["find", "findnext", "(\"ispos\", \"Vector{UInt64}\")"]` | 1.09 (5%) :x: | 1.00 (1%)  |
| `["io", "array_limit", "(\"display\", \"Matrix{Float64}(10000, 10000)\")"]` | 0.22 (5%) :white_check_mark: | 0.44 (1%) :white_check_mark: |
| `["io", "array_limit", "(\"display\", \"Matrix{Float64}(100000000, 1)\")"]` | 0.82 (5%) :white_check_mark: | 0.70 (1%) :white_check_mark: |
| `["io", "array_limit", "(\"display\", \"Vector{Float64}(100000000,)\")"]` | 0.82 (5%) :white_check_mark: | 0.70 (1%) :white_check_mark: |
...
| `["scalar", "acosh", "(\"2 <= abs(x) < 2^28\", \"positive argument\", \"Float32\")"]` | 0.85 (5%) :white_check_mark: | 1.00 (1%)  |
...
| `["scalar", "expm1", "(\"arg reduction I\", \"negative argument\", \"Float32\")"]` | 1.05 (5%) :x: | 1.00 (1%)  |
...
| `["scalar", "rem_pio2", "(\"argument reduction (hard) abs(x) < 2π/4\", \"negative argument\", \"Float64\")"]` | 1.14 (5%) :x: | 1.00 (1%)  |
...
| `["sparse", "constructors", "(\"IV\", 100)"]` | 0.80 (5%) :white_check_mark: | 1.00 (1%)  |
...
| `["union", "array", "(\"map\", identity, ComplexF64, true)"]` | 0.93 (5%) :white_check_mark: | 1.00 (1%)  |
...
| `["union", "array", "(\"skipmissing\", collect, Int64, false)"]` | 1.07 (5%) :x: | 1.00 (1%)  |
...
Commit 8a9666a (2020-09-29 22:33 UTC)
Platform Info:
  ...
  CPU: Intel(R) Xeon(R) CPU E3-1241 v3 @ 3.50GHz: 
       ...
       #1  3501 MHz   16188795 s        508 s    1786176 s  773180193 s          4 s
       #2  3501 MHz  123431860 s         22 s    2522356 s  666270836 s          3 s
       #3  3501 MHz   14749136 s        332 s    1084523 s  776220804 s          4 s
       #4  3501 MHz   13800948 s          4 s    1581268 s  776513132 s          3 s
       
  Memory: 31.383651733398438 GB (14418.15625 MB free)
  Uptime: 7.928369e7 sec
