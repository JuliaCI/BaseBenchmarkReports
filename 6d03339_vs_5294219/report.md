...
*Commit(s):* [JuliaLang/julia@6d033392e62619f32ed76f0c14ad384518b4353b](https://github.com/JuliaLang/julia/commit/6d033392e62619f32ed76f0c14ad384518b4353b) vs [JuliaLang/julia@5294219b0f9fd474838e65f8bab2352726825958](https://github.com/JuliaLang/julia/commit/5294219b0f9fd474838e65f8bab2352726825958)

*Triggered By:* [link](https://github.com/JuliaLang/julia/pull/33753#issuecomment-549209515)
...
| `["broadcast", "mix_scalar_tuple", "(10, \"scal_tup\")"]` | 1.69 (5%) :x: | 1.00 (1%)  |
...
| `["broadcast", "typeargs", "(\"tuple\", 5)"]` | 2.00 (5%) :x: | 1.00 (1%)  |
| `["collection", "set operations", "(\"BitSet\", \"Int\", \"symdiff!\", \"BitSet\")"]` | 0.53 (25%) :white_check_mark: | 1.00 (1%)  |
...
| `["random", "ranges", "(\"rand\", \"MersenneTwister\", \"UInt128\", \"RangeGenerator(1:18446744073709551615)\")"]` | 0.61 (25%) :white_check_mark: | 1.00 (1%)  |
| `["random", "ranges", "(\"rand\", \"MersenneTwister\", \"UInt64\", \"RangeGenerator(1:18446744073709551615)\")"]` | 1.52 (25%) :x: | 1.00 (1%)  |
| `["random", "types", "(\"randexp\", \"MersenneTwister\", \"Float16\")"]` | 1.91 (25%) :x: | 1.00 (1%)  |
| `["scalar", "acos", "(\"small\", \"positive argument\", \"Float64\")"]` | 0.94 (5%) :white_check_mark: | 1.00 (1%)  |
| `["scalar", "acos", "(\"zero\", \"Float32\")"]` | 0.94 (5%) :white_check_mark: | 1.00 (1%)  |
| `["scalar", "arithmetic", "(\"add\", \"BigInt\", \"BigInt\")"]` | 1.89 (50%) :x: | 1.00 (1%)  |
...
| `["scalar", "cos", "(\"argument reduction (hard) abs(x) < 2π/4\", \"negative argument\", \"Float32\", \"sin_kernel\")"]` | 3.38 (5%) :x: | 1.00 (1%)  |
| `["scalar", "cos", "(\"argument reduction (hard) abs(x) < 2π/4\", \"negative argument\", \"Float64\", \"sin_kernel\")"]` | 3.38 (5%) :x: | 1.00 (1%)  |
...
| `["scalar", "cos", "(\"argument reduction (hard) abs(x) < 6π/4\", \"negative argument\", \"Float64\", \"sin_kernel\")"]` | 2.46 (5%) :x: | 1.00 (1%)  |
| `["scalar", "cos", "(\"argument reduction (hard) abs(x) < 6π/4\", \"positive argument\", \"Float32\", \"sin_kernel\")"]` | 3.38 (5%) :x: | 1.00 (1%)  |
| `["scalar", "cos", "(\"argument reduction (hard) abs(x) < 6π/4\", \"positive argument\", \"Float64\", \"sin_kernel\")"]` | 3.38 (5%) :x: | 1.00 (1%)  |
...
| `["scalar", "mod2pi", "(\"argument reduction (easy) abs(x) < 2.0^20π/4\", \"negative argument\", \"Float64\")"]` | 1.46 (5%) :x: | 1.00 (1%)  |
| `["scalar", "mod2pi", "(\"argument reduction (easy) abs(x) < 9π/4\", \"negative argument\", \"Float64\")"]` | 1.38 (5%) :x: | 1.00 (1%)  |
...
| `["scalar", "mod2pi", "(\"argument reduction (hard) abs(x) < 8π/4\", \"positive argument\", \"Float64\")"]` | 2.08 (5%) :x: | 1.00 (1%)  |
| `["scalar", "predicate", "(\"isinteger\", \"Complex{BigFloat}\")"]` | 2.27 (40%) :x: | 1.00 (1%)  |
| `["scalar", "predicate", "(\"isinteger\", \"Complex{Float64}\")"]` | 1.31 (25%) :x: | 1.00 (1%)  |
...
| `["scalar", "sincos", "(\"argument reduction (hard) abs(x) < 4π/4\", \"positive argument\", \"Float64\")"]` | 3.15 (5%) :x: | 1.00 (1%)  |
...
| `["scalar", "sincos", "(\"argument reduction (hard) abs(x) < 6π/4\", \"positive argument\", \"Float64\")"]` | 3.23 (5%) :x: | 1.00 (1%)  |
...
| `["scalar", "sincos", "(\"argument reduction (hard) abs(x) < 8π/4\", \"positive argument\", \"Float32\")"]` | 3.23 (5%) :x: | 1.00 (1%)  |
...
| `["scalar", "sinh", "(\"22.0 <= abs(x) < 709.7822265633563\", \"negative argument\", \"Float64\")"]` | 3.23 (5%) :x: | 1.00 (1%)  |
...
| `["scalar", "sinh", "(\"very small\", \"negative argument\", \"Float32\")"]` | 1.46 (5%) :x: | 1.00 (1%)  |
...
| `["union", "array", "(\"broadcast\", abs, Float32, true)"]` | 0.86 (5%) :white_check_mark: | 1.00 (1%)  |
...
| `["union", "array", "(\"map\", identity, BigFloat, true)"]` | 0.82 (5%) :white_check_mark: | 1.00 (1%)  |
...
| `["union", "array", "(\"perf_sum3\", Int8, true)"]` | 0.95 (5%) :white_check_mark: | 1.00 (1%)  |
| `["union", "array", "(\"perf_sum4\", Complex{Float64}, true)"]` | 0.91 (5%) :white_check_mark: | 1.00 (1%)  |
| `["union", "array", "(\"perf_sum4\", Int8, false)"]` | 1.17 (5%) :x: | 1.00 (1%)  |
...
Commit 6d03339 (2019-11-04 01:48 UTC)
Platform Info:
  ...
  CPU: Intel(R) Xeon(R) CPU E3-1241 v3 @ 3.50GHz: 
       ...
       #1  3501 MHz  106879426 s       5047 s   12472002 s  4937135473 s         30 s
       #2  3501 MHz  757170414 s        214 s   13637604 s  4293441485 s         24 s
       #3  3501 MHz   90708720 s       3255 s    7400927 s  4966323150 s         34 s
       #4  3501 MHz   85038333 s         32 s   10563638 s  4966768871 s         23 s
       
  Memory: 31.383651733398438 GB (15718.44140625 MB free)
  Uptime: 5.0680733e7 sec
...
Platform Info:
  ...
  CPU: Intel(R) Xeon(R) CPU E3-1241 v3 @ 3.50GHz: 
              speed         user         nice          sys         idle          irq
       #1  3501 MHz  106980778 s       5047 s   12480291 s  4938349038 s         30 s
       #2  3501 MHz  758418354 s        214 s   13663219 s  4293495605 s         24 s
       #3  3501 MHz   90818245 s       3255 s    7405542 s  4967535984 s         34 s
       #4  3501 MHz   85135339 s         32 s   10568046 s  4967995037 s         23 s
       
  Memory: 31.383651733398438 GB (15389.5234375 MB free)
  Uptime: 5.0694012e7 sec
  Load Avg:  1.0029296875  1.0146484375  1.04541015625
  WORD_SIZE: 64
  LIBM: libopenlibm
  LLVM: libLLVM-6.0.1 (ORCJIT, haswell)
