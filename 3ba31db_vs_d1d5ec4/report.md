...
*Commit(s):* [JuliaLang/julia@3ba31db1681dc697b54dab4bff1bbb7f6d539a3f](https://github.com/JuliaLang/julia/commit/3ba31db1681dc697b54dab4bff1bbb7f6d539a3f) vs [JuliaLang/julia@d1d5ec4b637e7f934e1e9f1b961c9b902192a643](https://github.com/JuliaLang/julia/commit/d1d5ec4b637e7f934e1e9f1b961c9b902192a643)

*Triggered By:* [link](https://github.com/JuliaLang/julia/pull/34106#issuecomment-566291676)
...
| `["array", "setindex!", "(\"setindex!\", 3)"]` | 0.77 (5%) :white_check_mark: | 1.00 (1%)  |
...
| `["find", "findall", "(\"Array{Bool,1}\", \"50-50\")"]` | 0.95 (5%) :white_check_mark: | 1.00 (1%)  |
...
| `["random", "randstring", "(\"randstring\", \"MersenneTwister\", \"collect(UInt8, \\\"qwerty\\\"\", 100)"]` | 1.29 (25%) :x: | 1.00 (1%)  |
| `["random", "ranges", "(\"rand\", \"MersenneTwister\", \"BigInt\", \"RangeGenerator(1:2^10000)\")"]` | 1.29 (25%) :x: | 1.00 (1%)  |
| `["random", "ranges", "(\"rand\", \"MersenneTwister\", \"Int128\", \"RangeGenerator(1:18446744073709551616)\")"]` | 1.42 (25%) :x: | 1.00 (1%)  |
| `["random", "ranges", "(\"rand\", \"MersenneTwister\", \"UInt128\", \"RangeGenerator(1:18446744073709551615)\")"]` | 1.50 (25%) :x: | 1.00 (1%)  |
| `["random", "ranges", "(\"rand\", \"MersenneTwister\", \"UInt128\", \"RangeGenerator(1:18446744073709551616)\")"]` | 1.42 (25%) :x: | 1.00 (1%)  |
...
| `["scalar", "atan", "(\"0 <= abs(x) < 7/16\", \"negative argument\", \"Float64\")"]` | 0.92 (5%) :white_check_mark: | 1.00 (1%)  |
...
| `["scalar", "atanh", "(\"0.5 <= abs(x) < 1\", \"negative argument\", \"Float64\")"]` | 0.76 (5%) :white_check_mark: | 1.00 (1%)  |
...
| `["scalar", "atanh", "(\"2^-28 <= abs(x) < 0.5\", \"negative argument\", \"Float64\")"]` | 0.87 (5%) :white_check_mark: | 1.00 (1%)  |
...
| `["scalar", "cos", "(\"argument reduction (easy) abs(x) < 2π/4\", \"positive argument\", \"Float32\", \"sin_kernel\")"]` | 0.57 (5%) :white_check_mark: | 1.00 (1%)  |
...
| `["scalar", "cos", "(\"argument reduction (easy) abs(x) < 6π/4\", \"positive argument\", \"Float32\", \"sin_kernel\")"]` | 0.60 (5%) :white_check_mark: | 1.00 (1%)  |
| `["scalar", "cos", "(\"argument reduction (easy) abs(x) < 9π/4\", \"positive argument\", \"Float64\", \"cos_kernel\")"]` | 0.72 (5%) :white_check_mark: | 1.00 (1%)  |
...
| `["scalar", "expm1", "(\"medium\", \"negative argument\", \"Float32\")"]` | 0.63 (5%) :white_check_mark: | 1.00 (1%)  |
...
| `["sparse", "index", "(\"spmat\", \"row\", \"array\", 1000)"]` | 1.41 (30%) :x: | 1.00 (1%)  |
...
| `["union", "array", "(\"broadcast\", *, BigInt, (true, true))"]` | 0.89 (5%) :white_check_mark: | 1.00 (1%)  |
...
| `["union", "array", "(\"broadcast\", abs, BigInt, true)"]` | 0.90 (5%) :white_check_mark: | 1.00 (1%)  |
...
| `["union", "array", "(\"map\", abs, BigInt, true)"]` | 0.87 (5%) :white_check_mark: | 1.00 (1%)  |
...
| `["union", "array", "(\"perf_sum2\", BigInt, true)"]` | 0.83 (5%) :white_check_mark: | 1.00 (1%)  |
| `["union", "array", "(\"perf_sum2\", Bool, true)"]` | 0.93 (5%) :white_check_mark: | 1.00 (1%)  |
| `["union", "array", "(\"perf_sum2\", Int8, false)"]` | 1.25 (5%) :x: | 1.00 (1%)  |
| `["union", "array", "(\"perf_sum2\", Int8, true)"]` | 1.11 (5%) :x: | 1.00 (1%)  |
| `["union", "array", "(\"perf_sum3\", BigInt, true)"]` | 0.83 (5%) :white_check_mark: | 1.00 (1%)  |
...
| `["union", "array", "(\"perf_sum\", BigInt, true)"]` | 0.86 (5%) :white_check_mark: | 1.00 (1%)  |
...
Commit 3ba31db (2019-12-16 22:48 UTC)
Platform Info:
  ...
  CPU: Intel(R) Xeon(R) CPU E3-1241 v3 @ 3.50GHz: 
       ...
       #1  3501 MHz  113584544 s       5048 s   13245158 s  5299147247 s         31 s
       #2  3501 MHz  827487026 s        217 s   15285691 s  4591561178 s         26 s
       #3  3501 MHz   97657647 s       3260 s    7822013 s  5329067486 s         35 s
       #4  3501 MHz   91559755 s         39 s   11182170 s  5329624551 s         25 s
       
  Memory: 31.383651733398438 GB (15402.95703125 MB free)
  Uptime: 5.438427e7 sec
...
```
Julia Version 1.4.0-DEV.621
Commit d1d5ec4 (2019-12-16 22:24 UTC)
Platform Info:
  OS: Linux (x86_64-linux-gnu)
      Ubuntu 14.04.5 LTS
  uname: Linux 3.13.0-85-generic #129-Ubuntu SMP Thu Mar 17 20:50:15 UTC 2016 x86_64 x86_64
  CPU: Intel(R) Xeon(R) CPU E3-1241 v3 @ 3.50GHz: 
              speed         user         nice          sys         idle          irq
       #1  3501 MHz  113707386 s       5048 s   13254444 s  5300388247 s         31 s
       #2  3501 MHz  828775462 s        217 s   15311508 s  4591624998 s         26 s
       #3  3501 MHz   97783508 s       3260 s    7827626 s  5330313877 s         35 s
       #4  3501 MHz   91687874 s         39 s   11187662 s  5330868885 s         25 s
       
  Memory: 31.383651733398438 GB (15085.10546875 MB free)
  Uptime: 5.4398053e7 sec
