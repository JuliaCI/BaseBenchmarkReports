...
*Commit(s):* [JuliaLang/julia@f8f20453c4ca7a6aeb23a189a420dbff130679ce](https://github.com/JuliaLang/julia/commit/f8f20453c4ca7a6aeb23a189a420dbff130679ce)

*Triggered By:* [link](https://github.com/JuliaLang/julia/commit/f8f20453c4ca7a6aeb23a189a420dbff130679ce#commitcomment-31853359)

*Tag Predicate:* `ALL`

*Daily Job:* 2019-01-07 vs 2019-01-06
...
| `["collection", "queries & updates", "(\"Dict\", \"Int\", \"in\", \"false\")"]` | 0.51 (25%) :white_check_mark: | 1.00 (1%)  |
...
| `["random", "collections", "(\"rand\", \"MersenneTwister\", \"large Dict\")"]` | 0.67 (25%) :white_check_mark: | 1.00 (1%)  |
...
| `["scalar", "arithmetic", "(\"add\", \"UInt64\", \"Complex{BigInt}\")"]` | 1.56 (50%) :x: | 1.00 (1%)  |
| `["scalar", "asin", "(\"0.5 <= abs(x) < 0.975\", \"negative argument\", \"Float32\")"]` | 0.95 (5%) :white_check_mark: | 1.00 (1%)  |
| `["scalar", "asin", "(\"0.5 <= abs(x) < 0.975\", \"positive argument\", \"Float64\")"]` | 1.40 (5%) :x: | 1.00 (1%)  |
...
| `["scalar", "asinh", "(\"very small\", \"negative argument\", \"Float64\")"]` | 1.53 (5%) :x: | 1.00 (1%)  |
...
| `["scalar", "cosh", "(\"very large\", \"positive argument\", \"Float32\")"]` | 0.78 (5%) :white_check_mark: | 1.00 (1%)  |
...
| `["scalar", "exp2", "(\"2pow1023\", \"negative argument\", Float64)"]` | 1.41 (5%) :x: | 1.00 (1%)  |
...
| `["scalar", "exp2", "(\"very small\", \"positive argument\", \"Float64\")"]` | 1.06 (5%) :x: | 1.00 (1%)  |
...
| `["union", "array", "(\"broadcast\", abs, BigFloat, true)"]` | 0.95 (5%) :white_check_mark: | 1.00 (1%)  |
...
| `["union", "array", "(\"perf_binaryop\", *, BigFloat, (false, false))"]` | 1.15 (5%) :x: | 1.00 (1%)  |
| `["union", "array", "(\"perf_binaryop\", *, BigFloat, (false, true))"]` | 1.14 (5%) :x: | 1.00 (1%)  |
| `["union", "array", "(\"perf_binaryop\", *, BigFloat, (true, true))"]` | 1.13 (5%) :x: | 1.00 (1%)  |
...
```
Julia Version 1.2.0-DEV.109
Commit f8f2045 (2019-01-06 21:04 UTC)
Platform Info:
  ...
  CPU: Intel(R) Xeon(R) CPU E3-1241 v3 @ 3.50GHz: 
       ...
       #1  3501 MHz   70123568 s       5013 s    7775313 s  2384000384 s         23 s
       #2  3501 MHz  399285475 s        203 s    6557724 s  2060140645 s         18 s
       #3  3501 MHz   53707832 s       3220 s    4548036 s  2407658208 s         26 s
       #4  3501 MHz   50174088 s          2 s    5861160 s  2409306886 s         17 s
       
  Memory: 31.383651733398438 GB (4367.02734375 MB free)
  Uptime: 2.4680002e7 sec
