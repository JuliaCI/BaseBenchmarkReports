...
*Commit(s):* [JuliaLang/julia@5142abf4507525a7a02e7d984ce39802ee4fe134](https://github.com/JuliaLang/julia/commit/5142abf4507525a7a02e7d984ce39802ee4fe134)

*Triggered By:* [link](https://github.com/JuliaLang/julia/commit/5142abf4507525a7a02e7d984ce39802ee4fe134#commitcomment-40019137)

*Tag Predicate:* `ALL`

*Daily Job:* 2020-06-19 vs 2020-06-18
...
| `["array", "cat", "(\"catnd_setind\", 5)"]` | 1.32 (5%) :x: | 1.00 (1%)  |
| `["array", "cat", "4467"]` | 1.84 (5%) :x: | 1.00 (1%)  |
...
| `["collection", "initialization", "(\"Dict\", \"Int\", \"iterator\")"]` | 0.81 (25%)  | 0.74 (1%) :white_check_mark: |
| `["collection", "initialization", "(\"Dict\", \"String\", \"iterator\")"]` | 0.87 (25%)  | 0.93 (1%) :white_check_mark: |
| `["collection", "optimizations", "(\"Dict\", \"abstract\", \"Int8\")"]` | 1.01 (25%)  | 0.62 (1%) :white_check_mark: |
| `["collection", "optimizations", "(\"Dict\", \"abstract\", \"UInt16\")"]` | 0.91 (25%)  | 0.94 (1%) :white_check_mark: |
| `["collection", "optimizations", "(\"Dict\", \"concrete\", \"Int8\")"]` | 1.01 (25%)  | 0.62 (1%) :white_check_mark: |
| `["collection", "optimizations", "(\"Dict\", \"concrete\", \"UInt16\")"]` | 0.91 (25%)  | 0.94 (1%) :white_check_mark: |
...
| `["dates", "parse", "(\"Date\", \"ISODateFormat\")"]` | 0.67 (5%) :white_check_mark: | 1.00 (1%)  |
...
| `["io", "array_limit", "(\"display\", \"Array{Float64,1}(100000000,)\")"]` | 2.75 (5%) :x: | 1.00 (1%)  |
| `["io", "array_limit", "(\"display\", \"Array{Float64,2}(10000, 10000)\")"]` | 2.86 (5%) :x: | 0.96 (1%) :white_check_mark: |
| `["io", "array_limit", "(\"display\", \"Array{Float64,2}(100000000, 1)\")"]` | 2.76 (5%) :x: | 1.00 (1%)  |
| `["io", "serialization", "(\"deserialize\", \"Vector{String}\")"]` | 1.48 (5%) :x: | 1.00 (1%)  |
...
| `["parallel", "remotecall", "(\"identity\", 1024)"]` | 1.18 (5%) :x: | 1.00 (1%)  |
| `["parallel", "remotecall", "(\"identity\", 2)"]` | 1.20 (5%) :x: | 1.00 (1%)  |
| `["parallel", "remotecall", "(\"identity\", 4096)"]` | 1.17 (5%) :x: | 1.00 (1%)  |
| `["parallel", "remotecall", "(\"identity\", 512)"]` | 1.20 (5%) :x: | 1.00 (1%)  |
| `["parallel", "remotecall", "(\"identity\", 64)"]` | 1.19 (5%) :x: | 1.00 (1%)  |
...
| `["random", "ranges", "(\"RangeGenerator\", \"UInt128\", \"1:18446744073709551615\")"]` | 0.71 (25%) :white_check_mark: | 1.00 (1%)  |
...
| `["scalar", "cbrt", "(\"small\", \"positive argument\", \"Float64\")"]` | 1.13 (5%) :x: | 1.00 (1%)  |
...
| `["scalar", "sin", "(\"argument reduction (easy) abs(x) < 5π/4\", \"negative argument\", \"Float32\", \"sin_kernel\")"]` | 1.05 (5%) :x: | 1.00 (1%)  |
...
| `["scalar", "sincos", "(\"argument reduction (hard) abs(x) < 4π/4\", \"negative argument\", \"Float32\")"]` | 0.75 (5%) :white_check_mark: | 1.00 (1%)  |
...
| `["union", "array", "(\"perf_sum2\", BigInt, true)"]` | 0.86 (5%) :white_check_mark: | 1.00 (1%)  |
...
| `["union", "array", "(\"perf_sum3\", BigInt, true)"]` | 0.87 (5%) :white_check_mark: | 1.00 (1%)  |
...
| `["union", "array", "(\"perf_sum\", BigInt, true)"]` | 0.87 (5%) :white_check_mark: | 1.00 (1%)  |
...
```
Julia Version 1.6.0-DEV.271
Commit 5142abf (2020-06-19 01:37 UTC)
Platform Info:
  ...
  CPU: Intel(R) Xeon(R) CPU E3-1241 v3 @ 3.50GHz: 
       ...
       #1  3501 MHz  146078927 s       5056 s   16477546 s  6860071310 s         36 s
       #2  3501 MHz  1101539290 s        217 s   21987640 s  5909313922 s         27 s
       #3  3501 MHz  131032882 s       3312 s    9799974 s  6891754887 s         38 s
       #4  3501 MHz  123055995 s         43 s   14081314 s  6893528320 s         28 s
       
  Memory: 31.383651733398438 GB (18751.05078125 MB free)
  Uptime: 7.0384296e7 sec
