...
*Triggered By:* [link](https://github.com/JuliaLang/julia/commit/3c034d085a957418ae9efcab35a4e8cec9e267bb#commitcomment-36537612)
...
| `["array", "equality", "(\"isequal\", \"Array{Int64,1} isequal Array{Int64,1}\")"]` | 1.73 (5%) :x: | 1.00 (1%)  |
...
| `["collection", "queries & updates", "(\"Set\", \"Int\", \"in\", \"false\")"]` | 1.54 (25%) :x: | 1.00 (1%)  |
...
| `["misc", "bitshift", "(\"Int\", \"UInt\")"]` | 0.83 (5%) :white_check_mark: | 1.00 (1%)  |
...
| `["scalar", "sincos", "(\"argument reduction (easy) abs(x) < 9π/4\", \"positive argument\", \"Float32\")"]` | 1.52 (5%) :x: | 1.00 (1%)  |
...
| `["union", "array", "(\"broadcast\", *, Bool, (true, true))"]` | 0.89 (5%) :white_check_mark: | 1.00 (1%)  |
...
| `["union", "array", "(\"broadcast\", abs, BigFloat, true)"]` | 0.57 (5%) :white_check_mark: | 1.00 (1%)  |
...
Platform Info:
  ...
  CPU: Intel(R) Xeon(R) CPU E3-1241 v3 @ 3.50GHz: 
       ...
       #1  3501 MHz  114764007 s       5048 s   13362104 s  5342948865 s         31 s
       #2  3501 MHz  839036772 s        217 s   15541432 s  4624952886 s         26 s
       #3  3501 MHz   98851015 s       3260 s    7896420 s  5372997248 s         35 s
       #4  3501 MHz   92676520 s         39 s   11258779 s  5373621383 s         25 s
       
  Memory: 31.383651733398438 GB (15209.12890625 MB free)
  Uptime: 5.4836504e7 sec
  Load Avg:  0.94677734375  1.00830078125  1.0400390625
  WORD_SIZE: 64
  LIBM: libopenlibm
