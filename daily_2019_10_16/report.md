...
*Commit(s):* [JuliaLang/julia@3a206089d707af2ce89f0e7c3113f3d86bfbe4d7](https://github.com/JuliaLang/julia/commit/3a206089d707af2ce89f0e7c3113f3d86bfbe4d7)

*Triggered By:* [link](https://github.com/JuliaLang/julia/commit/3a206089d707af2ce89f0e7c3113f3d86bfbe4d7#commitcomment-35518109)

*Tag Predicate:* `ALL`

*Daily Job:* 2019-10-16 vs 2019-10-15
...
| `["array", "growth", "(\"push_single!\", 8)"]` | 0.72 (5%) :white_check_mark: | 1.00 (1%)  |
...
| `["broadcast", "sparse", "((10000000,), 2)"]` | 0.91 (5%) :white_check_mark: | 1.00 (1%)  |
...
| `["dates", "parse", "(\"DateTime\", \"RFC1123Format\", \"Lowercase\")"]` | 1.55 (5%) :x: | 1.00 (1%)  |
| `["dates", "parse", "(\"DateTime\", \"RFC1123Format\", \"Mixedcase\")"]` | 1.22 (5%) :x: | 1.00 (1%)  |
| `["dates", "parse", "(\"DateTime\", \"RFC1123Format\", \"Titlecase\")"]` | 1.42 (5%) :x: | 1.00 (1%)  |
| `["dates", "string", "Date"]` | 1.32 (5%) :x: | 1.00 (1%)  |
| `["find", "findnext", "(\"Array{Bool,1}\", \"50-50\")"]` | 0.33 (5%) :white_check_mark: | 1.00 (1%)  |
...
| `["random", "types", "(\"randn\", \"ImplicitRNG\", \"ImplicitFloat64\")"]` | 0.74 (25%) :white_check_mark: | 1.00 (1%)  |
...
| `["scalar", "expm1", "(\"large\", \"positive argument\", \"Float64\")"]` | 1.73 (5%) :x: | 1.00 (1%)  |
...
| `["scalar", "sinh", "(\"2f-12 <= abs(x) < 9f0\", \"positive argument\", \"Float32\")"]` | 0.92 (5%) :white_check_mark: | 1.00 (1%)  |
...
| `["sparse", "matmul", "(\"At_mul_B\", \"dense 500x5, sparse 500x500 -> dense 5x500\")"]` | 0.66 (30%) :white_check_mark: | 1.00 (1%)  |
| `["sparse", "matmul", "(\"At_mul_B\", \"dense 50x5, sparse 50x500 -> dense 5x500\")"]` | 0.67 (30%) :white_check_mark: | 1.00 (1%)  |
...
| `["union", "array", "(\"map\", *, Bool, (false, false))"]` | 1.45 (5%) :x: | 1.00 (1%)  |
| `["union", "array", "(\"map\", *, Bool, (false, true))"]` | 1.18 (5%) :x: | 1.00 (1%)  |
| `["union", "array", "(\"map\", *, Bool, (true, true))"]` | 1.35 (5%) :x: | 1.00 (1%)  |
| `["union", "array", "(\"map\", *, Complex{Float64}, (false, false))"]` | 1.25 (5%) :x: | 1.00 (1%)  |
| `["union", "array", "(\"map\", *, Complex{Float64}, (false, true))"]` | 1.42 (5%) :x: | 1.00 (1%)  |
| `["union", "array", "(\"map\", *, Complex{Float64}, (true, true))"]` | 1.38 (5%) :x: | 1.00 (1%)  |
| `["union", "array", "(\"map\", *, Int64, (false, false))"]` | 0.95 (5%) :white_check_mark: | 1.00 (1%)  |
| `["union", "array", "(\"map\", *, Int8, (false, false))"]` | 1.45 (5%) :x: | 1.00 (1%)  |
| `["union", "array", "(\"map\", *, Int8, (false, true))"]` | 1.21 (5%) :x: | 1.00 (1%)  |
| `["union", "array", "(\"map\", *, Int8, (true, true))"]` | 1.40 (5%) :x: | 1.00 (1%)  |
...
| `["union", "array", "(\"map\", identity, Float32, true)"]` | 1.23 (5%) :x: | 1.00 (1%)  |
...
| `["union", "array", "(\"perf_sum3\", Bool, false)"]` | 1.32 (5%) :x: | 1.00 (1%)  |
| `["union", "array", "(\"perf_sum3\", Bool, true)"]` | 1.20 (5%) :x: | 1.00 (1%)  |
| `["union", "array", "(\"perf_sum3\", Float64, true)"]` | 1.13 (5%) :x: | 1.00 (1%)  |
| `["union", "array", "(\"perf_sum3\", Int8, false)"]` | 1.99 (5%) :x: | 1.00 (1%)  |
| `["union", "array", "(\"perf_sum3\", Int8, true)"]` | 1.57 (5%) :x: | 1.00 (1%)  |
...
```
Julia Version 1.4.0-DEV.328
Commit 3a20608 (2019-10-15 22:37 UTC)
Platform Info:
  ...
  CPU: Intel(R) Xeon(R) CPU E3-1241 v3 @ 3.50GHz: 
       ...
       #1  3501 MHz  104693814 s       5044 s   12198961 s  4776088476 s         29 s
       #2  3501 MHz  730807072 s        214 s   13049857 s  4156667369 s         24 s
       #3  3501 MHz   88383646 s       3255 s    7226929 s  4805085872 s         34 s
       #4  3501 MHz   82886524 s         27 s   10266205 s  4805591502 s         22 s
       
  Memory: 31.383651733398438 GB (14963.69140625 MB free)
  Uptime: 4.904235e7 sec
