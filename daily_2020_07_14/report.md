...
*Commit(s):* [JuliaLang/julia@5f2bb1d194d220894d130db5be06bec68c726f0c](https://github.com/JuliaLang/julia/commit/5f2bb1d194d220894d130db5be06bec68c726f0c)

*Triggered By:* [link](https://github.com/JuliaLang/julia/commit/5f2bb1d194d220894d130db5be06bec68c726f0c#commitcomment-40578688)

*Tag Predicate:* `ALL`

*Daily Job:* 2020-07-14 vs 2020-07-13
...
| `["array", "any/all", "(\"all\", \"Vector{Float64}\")"]` | 1.49 (5%) :x: | 1.00 (1%)  |
...
| `["array", "index", "(\"sumcartesian_view\", \"SubArray{Int32,2,Base.ReshapedArray{Int32,2,SubArray{Int32,3,Array{Int32,3},Tuple{Base.Slice{Base.OneTo{Int64}},Base.Slice{Base.OneTo{Int64}},Base.Slice{Base.OneTo{Int64}}},true},Tuple{}},Tuple{Base.Slice{Base.OneTo{Int64}},UnitRange{Int64}},true}\")"]` | 1.58 (50%) :x: | 1.00 (1%)  |
...
| `["broadcast", "26942"]` | 1.98 (5%) :x: | 1.00 (1%)  |
...
| `["misc", "iterators", "zip(1:1000)"]` | 0.83 (5%) :white_check_mark: | 1.00 (1%)  |
...
| `["random", "ranges", "(\"RangeGenerator\", \"BigInt\", \"1:4294967295\")"]` | 0.62 (25%) :white_check_mark: | 1.00 (1%)  |
...
| `["scalar", "asin", "(\"zero\", \"Float64\")"]` | 1.25 (5%) :x: | 1.00 (1%)  |
...
| `["scalar", "exp2", "(\"small\", \"positive argument\", \"Float32\")"]` | 0.81 (5%) :white_check_mark: | 1.00 (1%)  |
...
| `["union", "array", "(\"broadcast\", identity, ComplexF64, true)"]` | 1.11 (5%) :x: | 1.00 (1%)  |
...
```
Julia Version 1.6.0-DEV.453
Commit 5f2bb1d (2020-07-13 20:55 UTC)
Platform Info:
  ...
  CPU: Intel(R) Xeon(R) CPU E3-1241 v3 @ 3.50GHz: 
       ...
       #1  3501 MHz  149936609 s       5056 s   16910943 s  7071302476 s         37 s
       #2  3501 MHz  1134533103 s        217 s   22783746 s  6091374239 s         28 s
       #3  3501 MHz  135183399 s       3322 s   10063916 s  7102828156 s         38 s
       #4  3501 MHz  126688385 s         43 s   14394734 s  7105399518 s         28 s
       
  Memory: 31.383651733398438 GB (19076.92578125 MB free)
  Uptime: 7.2544151e7 sec
