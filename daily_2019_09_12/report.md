...
*Commit(s):* [JuliaLang/julia@47f2800747e65df2720429436b94dc58a9fcb22c](https://github.com/JuliaLang/julia/commit/47f2800747e65df2720429436b94dc58a9fcb22c)

*Triggered By:* [link](https://github.com/JuliaLang/julia/commit/47f2800747e65df2720429436b94dc58a9fcb22c#commitcomment-35049044)

*Tag Predicate:* `ALL`

*Daily Job:* 2019-09-12 vs 2019-09-11
...
| `["array", "equality", "(\"isequal\", \"UnitRange{Int64}\")"]` | 1.07 (5%) :x: | 1.00 (1%)  |
...
| `["io", "array_limit", "(\"display\", \"Array{Float64,2}(10000, 10000)\")"]` | 0.95 (5%) :white_check_mark: | 0.91 (1%) :white_check_mark: |
| `["io", "serialization", "(\"deserialize\", \"Vector{String}\")"]` | 0.90 (5%) :white_check_mark: | 1.00 (1%)  |
| `["linalg", "factorization", "(\"eigen\", \"Diagonal\", 256)"]` | 0.42 (45%) :white_check_mark: | 1.00 (1%)  |
...
| `["random", "collections", "(\"rand\", \"ImplicitRNG\", \"large Vector\")"]` | 1.48 (25%) :x: | 1.00 (1%)  |
...
| `["scalar", "sinh", "(\"very small\", \"positive argument\", \"Float64\")"]` | 0.70 (5%) :white_check_mark: | 1.00 (1%)  |
...
| `["union", "array", "(\"perf_simplecopy\", Int8, true)"]` | 1.19 (5%) :x: | 1.00 (1%)  |
...
```
Julia Version 1.4.0-DEV.117
Commit 47f2800 (2019-09-12 02:05 UTC)
Platform Info:
  ...
  CPU: Intel(R) Xeon(R) CPU E3-1241 v3 @ 3.50GHz: 
       ...
       #1  3501 MHz  100287149 s       5043 s   11638947 s  4487956036 s         28 s
       #2  3501 MHz  688352124 s        208 s   11985702 s  3906779285 s         24 s
       #3  3501 MHz   83823318 s       3250 s    6933494 s  4516357680 s         33 s
       #4  3501 MHz   78617675 s         27 s    9821458 s  4516840257 s         22 s
       
  Memory: 31.383651733398438 GB (16107.3359375 MB free)
  Uptime: 4.6105032e7 sec
