...
*Commit(s):* [JuliaLang/julia@24ee8067dc6c39335d43e88e69221d90296ed487](https://github.com/JuliaLang/julia/commit/24ee8067dc6c39335d43e88e69221d90296ed487)

*Triggered By:* [link](https://github.com/JuliaLang/julia/commit/24ee8067dc6c39335d43e88e69221d90296ed487#commitcomment-33355923)

*Tag Predicate:* `ALL`

*Daily Job:* 2019-04-30 vs 2019-04-29
...
| `["array", "index", "(\"sumvector_view\", \"SubArray{Int32,2,Array{Int32,3},Tuple{Int64,Base.Slice{Base.OneTo{Int64}},Base.Slice{Base.OneTo{Int64}}},true}\")"]` | 1.95 (50%) :x: | 1.00 (1%)  |
...
| `["scalar", "acosh", "(\"one\", \"Float64\")"]` | 0.93 (5%) :white_check_mark: | 1.00 (1%)  |
| `["scalar", "arithmetic", "(\"rem type\", \"Bool\", \"BigInt\")"]` | 1.89 (40%) :x: | 1.00 (1%)  |
...
| `["scalar", "sinh", "(\"2f-12 <= abs(x) < 9f0\", \"positive argument\", \"Float32\")"]` | 1.16 (5%) :x: | 1.00 (1%)  |
| `["scalar", "tan", "(\"large\", \"negative argument\", \"Float32\")"]` | 1.08 (5%) :x: | 1.00 (1%)  |
| `["scalar", "tan", "(\"small\", \"positive argument\", \"Float32\")"]` | 1.06 (5%) :x: | 1.00 (1%)  |
| `["scalar", "tan", "(\"very small\", \"negative argument\", \"Float32\")"]` | 1.06 (5%) :x: | 1.00 (1%)  |
| `["scalar", "tan", "(\"very small\", \"positive argument\", \"Float64\")"]` | 1.50 (5%) :x: | 1.00 (1%)  |
...
| `["sparse", "constructors", "(\"Diagonal\", 100)"]` | 1.17 (5%) :x: | 1.00 (1%)  |
...
```
Julia Version 1.3.0-DEV.134
Commit 24ee806 (2019-04-30 00:23 UTC)
Platform Info:
  ...
  CPU: Intel(R) Xeon(R) CPU E3-1241 v3 @ 3.50GHz: 
       ...
       #1  3501 MHz   87060042 s       5026 s    9859951 s  3338763178 s         24 s
       #2  3501 MHz  549093995 s        203 s    9208902 s  2882934832 s         20 s
       #3  3501 MHz   70326246 s       3237 s    5863015 s  3365096848 s         30 s
       #4  3501 MHz   66065511 s         12 s    7798682 s  3366362236 s         18 s
       
  Memory: 31.383651733398438 GB (5212.8984375 MB free)
  Uptime: 3.4439498e7 sec
