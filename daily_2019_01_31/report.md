...
*Commit(s):* [JuliaLang/julia@62c411d4defca4ca41f72468f98a223ada8442e4](https://github.com/JuliaLang/julia/commit/62c411d4defca4ca41f72468f98a223ada8442e4)

*Triggered By:* [link](https://github.com/JuliaLang/julia/commit/62c411d4defca4ca41f72468f98a223ada8442e4#commitcomment-32127681)

*Tag Predicate:* `ALL`

*Daily Job:* 2019-01-31 vs 2019-01-30
...
| `["array", "equality", "(\"==\", \"Array{Int64,1}\")"]` | 1.17 (5%) :x: | 1.00 (1%)  |
...
| `["random", "ranges", "(\"RangeGenerator\", \"BigInt\", \"1:18446744073709551615\")"]` | 1.40 (25%) :x: | 1.00 (1%)  |
...
| `["scalar", "expm1", "(\"very small\", \"positive argument\", \"Float64\")"]` | 0.82 (5%) :white_check_mark: | 1.00 (1%)  |
| `["scalar", "expm1", "(\"zero\", \"Float32\")"]` | 0.94 (5%) :white_check_mark: | 1.00 (1%)  |
| `["scalar", "fastmath", "(\"add\", \"BigInt\")"]` | 1.60 (40%) :x: | 1.00 (1%)  |
...
| `["scalar", "sinh", "(\"2f-12 <= abs(x) < 9f0\", \"positive argument\", \"Float32\")"]` | 0.95 (5%) :white_check_mark: | 1.00 (1%)  |
...
| `["tuple", "reduction", "(\"sum\", (2, 2))"]` | 1.17 (5%) :x: | 1.00 (1%)  |
...
```
Julia Version 1.2.0-DEV.232
Commit 62c411d (2019-01-30 21:33 UTC)
Platform Info:
  ...
  CPU: Intel(R) Xeon(R) CPU E3-1241 v3 @ 3.50GHz: 
       ...
       #1  3501 MHz   73927498 s       5014 s    8249492 s  2586678142 s         23 s
       #2  3501 MHz  435067964 s        203 s    7165750 s  2231034478 s         19 s
       #3  3501 MHz   57459148 s       3226 s    4856208 s  2610846480 s         26 s
       #4  3501 MHz   53837171 s          2 s    6316375 s  2612346786 s         17 s
       
  Memory: 31.383651733398438 GB (5102.91796875 MB free)
  Uptime: 2.6754009e7 sec
