...
*Commit(s):* [JuliaLang/julia@7a45b7b6914797a73b51b55e656ee15b397ec72a](https://github.com/JuliaLang/julia/commit/7a45b7b6914797a73b51b55e656ee15b397ec72a) vs [JuliaLang/julia@6f5cefb1d231a267eb5e0aa46469c0ef53593e28](https://github.com/JuliaLang/julia/commit/6f5cefb1d231a267eb5e0aa46469c0ef53593e28)

*Triggered By:* [link](https://github.com/JuliaLang/julia/pull/32370#issuecomment-506041837)
...
| `["array", "growth", "(\"append!\", 2048)"]` | 0.86 (5%) :white_check_mark: | 1.00 (1%)  |
...
| `["collection", "queries & updates", "(\"IdDict\", \"String\", \"pop!\", \"specified\")"]` | 1.30 (25%) :x: | 1.00 (1%)  |
...
| `["scalar", "acos", "(\"small\", \"negative argument\", \"Float64\")"]` | 1.19 (5%) :x: | 1.00 (1%)  |
...
| `["scalar", "expm1", "(\"very small\", \"positive argument\", \"Float32\")"]` | 1.44 (5%) :x: | 1.00 (1%)  |
...
| `["scalar", "tanh", "(\"0 <= abs(x) < 2.0^-28\", \"negative argument\", \"Float64\")"]` | 1.12 (5%) :x: | 1.00 (1%)  |
...
| `["scalar", "tanh", "(\"zero\", \"Float64\")"]` | 1.94 (5%) :x: | 1.00 (1%)  |
...
| `["sparse", "matmul", "(\"At_mul_B!\", \"sparse 400x4000, dense 400x40 -> dense 4000x40\")"]` | 0.60 (30%) :white_check_mark: | 1.00 (1%)  |
...
| `["tuple", "reduction", "(\"sum\", (4,))"]` | 0.50 (5%) :white_check_mark: | 1.00 (1%)  |
...
| `["union", "array", "(\"perf_sum4\", BigInt, false)"]` | 0.81 (5%) :white_check_mark: | 1.00 (1%)  |
...
```
Julia Version 1.3.0-DEV.451
Commit 7a45b7b (2019-06-26 20:57 UTC)
Platform Info:
  ...
  CPU: Intel(R) Xeon(R) CPU E3-1241 v3 @ 3.50GHz: 
       ...
       #1  3501 MHz   49676348 s       2436 s   12231200 s  3868139982 s         13 s
       #2  3501 MHz  295812507 s         27 s    5365665 s  3638505070 s         19 s
       #3  3501 MHz   40694466 s       3174 s    4866204 s  3894197268 s         31 s
       #4  3501 MHz   39246076 s         16 s    3681018 s  3898340391 s         28 s
       
  Memory: 31.383651733398438 GB (5469.46875 MB free)
  Uptime: 3.942594e7 sec
...
Commit 6f5cefb (2019-06-26 20:49 UTC)
Platform Info:
  OS: Linux (x86_64-linux-gnu)
      Ubuntu 14.04.5 LTS
  uname: Linux 3.13.0-85-generic #129-Ubuntu SMP Thu Mar 17 20:50:15 UTC 2016 x86_64 x86_64
  CPU: Intel(R) Xeon(R) CPU E3-1241 v3 @ 3.50GHz: 
              speed         user         nice          sys         idle          irq
       #1  3501 MHz   49773828 s       2436 s   12239266 s  3869214284 s         13 s
       #2  3501 MHz  296912834 s         27 s    5379110 s  3638575442 s         19 s
       #3  3501 MHz   40802448 s       3174 s    4870904 s  3895268693 s         31 s
       #4  3501 MHz   39363648 s         16 s    3685534 s  3899402478 s         28 s
       
  Memory: 31.383651733398438 GB (5249.1796875 MB free)
  Uptime: 3.9437784e7 sec
  Load Avg:  1.0029296875  1.0146484375  1.04541015625
  WORD_SIZE: 64
  LIBM: libopenlibm
  LLVM: libLLVM-6.0.1 (ORCJIT, haswell)
