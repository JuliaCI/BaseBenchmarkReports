...
*Commit(s):* [JuliaLang/julia@2ba8578eb1dda53930334462e4e90c3ca41300f2](https://github.com/JuliaLang/julia/commit/2ba8578eb1dda53930334462e4e90c3ca41300f2) vs [JuliaLang/julia@a43c46b68796228838041a140356f96e6f76184b](https://github.com/JuliaLang/julia/commit/a43c46b68796228838041a140356f96e6f76184b)

*Triggered By:* [link](https://github.com/JuliaLang/julia/pull/21983#issuecomment-494300988)
...
| `["collection", "set operations", "(\"BitSet\", \"Int\", \"symdiff!\", \"big\")"]` | 0.71 (25%) :white_check_mark: | 1.00 (1%)  |
...
| `["random", "collections", "(\"rand\", \"RandomDevice\", \"small String\")"]` | 0.62 (25%) :white_check_mark: | 1.00 (1%)  |
...
| `["scalar", "arithmetic", "(\"rem type\", \"Char\", \"BigInt\")"]` | 1.82 (40%) :x: | 1.00 (1%)  |
...
| `["scalar", "cosh", "(\"0 <= abs(x) < 2.7755602085408512e-17\", \"negative argument\", \"Float64\")"]` | 0.76 (5%) :white_check_mark: | 1.00 (1%)  |
...
| `["scalar", "tan", "(\"small\", \"negative argument\", \"Float64\")"]` | 1.60 (5%) :x: | 1.00 (1%)  |
...
| `["sparse", "constructors", "(\"Diagonal\", 10)"]` | 1.29 (5%) :x: | 1.00 (1%)  |
...
| `["union", "array", "(\"perf_sum2\", BigInt, false)"]` | 0.63 (5%) :white_check_mark: | 1.00 (1%)  |
| `["union", "array", "(\"perf_sum2\", BigInt, true)"]` | 0.66 (5%) :white_check_mark: | 1.00 (1%)  |
| `["union", "array", "(\"perf_sum2\", Bool, true)"]` | 1.31 (5%) :x: | 1.00 (1%)  |
| `["union", "array", "(\"perf_sum2\", Float64, true)"]` | 0.84 (5%) :white_check_mark: | 1.00 (1%)  |
| `["union", "array", "(\"perf_sum3\", BigInt, false)"]` | 0.63 (5%) :white_check_mark: | 1.00 (1%)  |
| `["union", "array", "(\"perf_sum3\", BigInt, true)"]` | 0.66 (5%) :white_check_mark: | 1.00 (1%)  |
...
| `["union", "array", "(\"perf_sum4\", BigInt, false)"]` | 0.72 (5%) :white_check_mark: | 1.00 (1%)  |
| `["union", "array", "(\"perf_sum4\", BigInt, true)"]` | 0.74 (5%) :white_check_mark: | 1.00 (1%)  |
| `["union", "array", "(\"perf_sum\", BigInt, false)"]` | 0.64 (5%) :white_check_mark: | 1.00 (1%)  |
| `["union", "array", "(\"perf_sum\", BigInt, true)"]` | 0.67 (5%) :white_check_mark: | 1.00 (1%)  |
...
| `["union", "array", "(\"skipmissing\", sum, BigInt, false)"]` | 0.68 (5%) :white_check_mark: | 1.00 (1%)  |
| `["union", "array", "(\"skipmissing\", sum, Union{Missing, BigInt}, true)"]` | 0.71 (5%) :white_check_mark: | 1.00 (1%)  |
...
| `["union", "array", "(\"skipmissing\", sum, Union{Nothing, BigInt}, false)"]` | 0.66 (5%) :white_check_mark: | 1.00 (1%)  |
...
Commit 2ba8578 (2019-05-21 01:29 UTC)
Platform Info:
  ...
  CPU: Intel(R) Xeon(R) CPU E3-1241 v3 @ 3.50GHz: 
       ...
       #1  3501 MHz   47959601 s       2434 s   11203174 s  3556650205 s         13 s
       #2  3501 MHz  281476150 s         20 s    5084962 s  3337931067 s         19 s
       #3  3501 MHz   38973746 s       3171 s    4759593 s  3580708056 s         30 s
       #4  3501 MHz   37589961 s         15 s    3563348 s  3584774686 s         26 s
       
  Memory: 31.383651733398438 GB (4925.2109375 MB free)
  Uptime: 3.6272053e7 sec
...
Platform Info:
  ...
  CPU: Intel(R) Xeon(R) CPU E3-1241 v3 @ 3.50GHz: 
              speed         user         nice          sys         idle          irq
       #1  3501 MHz   48055323 s       2434 s   11211475 s  3557720772 s         13 s
       #2  3501 MHz  282583014 s         20 s    5098555 s  3337989040 s         19 s
       #3  3501 MHz   39072107 s       3171 s    4764084 s  3581783722 s         30 s
       #4  3501 MHz   37704799 s         15 s    3567711 s  3585834041 s         26 s
       
  Memory: 31.383651733398438 GB (4666.79296875 MB free)
  Uptime: 3.6283842e7 sec
