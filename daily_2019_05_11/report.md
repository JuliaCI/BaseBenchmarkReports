...
*Commit(s):* [JuliaLang/julia@7f2fa84e492af31cff31a6e46f676116a5c48dcc](https://github.com/JuliaLang/julia/commit/7f2fa84e492af31cff31a6e46f676116a5c48dcc)

*Triggered By:* [link](https://github.com/JuliaLang/julia/commit/7f2fa84e492af31cff31a6e46f676116a5c48dcc#commitcomment-33495549)

*Tag Predicate:* `ALL`

*Daily Job:* 2019-05-11 vs 2019-05-10
...
| `["array", "any/all", "(\"any\", \"Vector{Bool}\")"]` | 0.93 (5%) :white_check_mark: | 1.00 (1%)  |
| `["array", "comprehension", "(\"collect\", \"Array{Float64,1}\")"]` | 1.51 (5%) :x: | 1.00 (1%)  |
| `["array", "comprehension", "(\"collect\", \"StepRangeLen{Float64,Base.TwicePrecision{Float64},Base.TwicePrecision{Float64}}\")"]` | 1.26 (5%) :x: | 1.00 (1%)  |
| `["array", "comprehension", "(\"comprehension_collect\", \"Array{Float64,1}\")"]` | 1.42 (5%) :x: | 1.00 (1%)  |
...
| `["collection", "iteration", "(\"Set\", \"String\", \"iterate\")"]` | 1.30 (25%) :x: | 1.00 (1%)  |
...
| `["collection", "queries & updates", "(\"Set\", \"Any\", \"pop!\", \"specified\")"]` | 0.60 (25%) :white_check_mark: | 1.00 (1%)  |
| `["collection", "queries & updates", "(\"Set\", \"Any\", \"push!\", \"overwrite\")"]` | 0.53 (25%) :white_check_mark: | 1.00 (1%)  |
...
| `["find", "findnext", "(\"ispos\", \"Array{UInt64,1}\")"]` | 0.87 (5%) :white_check_mark: | 1.00 (1%)  |
...
| `["io", "array_limit", "(\"display\", \"Array{Float64,1}(100000000,)\")"]` | 1.23 (5%) :x: | 1.00 (1%)  |
| `["io", "array_limit", "(\"display\", \"Array{Float64,2}(10000, 10000)\")"]` | 1.06 (5%) :x: | 1.00 (1%)  |
| `["io", "array_limit", "(\"display\", \"Array{Float64,2}(100000000, 1)\")"]` | 1.23 (5%) :x: | 1.00 (1%)  |
...
| `["random", "collections", "(\"rand\", \"RandomDevice\", \"small Dict\")"]` | 1.26 (25%) :x: | 1.00 (1%)  |
| `["random", "ranges", "(\"rand\", \"MersenneTwister\", \"BigInt\", \"RangeGenerator(1:4294967297)\")"]` | 1.41 (25%) :x: | 1.00 (1%)  |
| `["random", "types", "(\"rand\", \"MersenneTwister\", \"Complex{Float16}\")"]` | 1.91 (25%) :x: | 1.00 (1%)  |
| `["random", "types", "(\"rand\", \"MersenneTwister\", \"Float16\")"]` | 1.72 (25%) :x: | 1.00 (1%)  |
| `["random", "types", "(\"rand\", \"MersenneTwister\", \"Float32\")"]` | 1.33 (25%) :x: | 1.00 (1%)  |
| `["random", "types", "(\"rand\", \"MersenneTwister\", \"Float64\")"]` | 1.33 (25%) :x: | 1.00 (1%)  |
...
| `["scalar", "asinh", "(\"zero\", \"Float64\")"]` | 0.55 (5%) :white_check_mark: | 1.00 (1%)  |
...
| `["scalar", "exp2", "(\"small\", \"positive argument\", \"Float32\")"]` | 1.33 (5%) :x: | 1.00 (1%)  |
...
| `["scalar", "expm1", "(\"huge\", \"positive argument\", \"Float64\")"]` | 1.47 (5%) :x: | 1.00 (1%)  |
| `["scalar", "expm1", "(\"large\", \"negative argument\", \"Float64\")"]` | 1.67 (5%) :x: | 1.00 (1%)  |
| `["scalar", "expm1", "(\"large\", \"positive argument\", \"Float32\")"]` | 0.94 (5%) :white_check_mark: | 1.00 (1%)  |
| `["scalar", "expm1", "(\"medium\", \"negative argument\", \"Float64\")"]` | 1.47 (5%) :x: | 1.00 (1%)  |
...
| `["union", "array", "(\"broadcast\", abs, Float32, true)"]` | 1.21 (5%) :x: | 1.00 (1%)  |
...
```
Julia Version 1.3.0-DEV.204
Commit 7f2fa84 (2019-05-10 21:35 UTC)
Platform Info:
  ...
  CPU: Intel(R) Xeon(R) CPU E3-1241 v3 @ 3.50GHz: 
       ...
       #1  3501 MHz   88710166 s       5028 s   10064918 s  3431702089 s         24 s
       #2  3501 MHz  565879362 s        203 s    9480508 s  2960840582 s         20 s
       #3  3501 MHz   72016131 s       3237 s    5971822 s  3458287038 s         30 s
       #4  3501 MHz   67598368 s         12 s    7948318 s  3459626617 s         19 s
       
  Memory: 31.383651733398438 GB (5782.84765625 MB free)
  Uptime: 3.5389784e7 sec
  Load Avg:  1.01025390625  1.02490234375  1.04541015625
  WORD_SIZE: 64
  LIBM: libopenlibm
