...
*Commit(s):* [JuliaLang/julia@7d48ecbfa1ffd6325443fb70c6f6b2451357432a](https://github.com/JuliaLang/julia/commit/7d48ecbfa1ffd6325443fb70c6f6b2451357432a)

*Triggered By:* [link](https://github.com/JuliaLang/julia/commit/7d48ecbfa1ffd6325443fb70c6f6b2451357432a#commitcomment-28816374)

*Tag Predicate:* `ALL`

*Daily Job:* 2018-05-02 vs 2018-05-01
...
| `["find", "findall", "(\"ispos\", \"Array{Int64,1}\")"]` | 0.78 (15%) :white_check_mark: | 1.00 (1%)  |
| `["find", "findnext", "(\"ispos\", \"Array{Bool,1}\")"]` | 0.80 (15%) :white_check_mark: | 1.00 (1%)  |
| `["find", "findprev", "(\"ispos\", \"Array{Bool,1}\")"]` | 0.78 (15%) :white_check_mark: | 1.00 (1%)  |
| `["random", "ranges", "(\"RangeGenerator\", \"BigInt\", \"1:1\")"]` | 0.65 (25%) :white_check_mark: | 1.00 (1%)  |
| `["scalar", "acos", "(\"small\", \"negative argument\", \"Float32\")"]` | 1.25 (15%) :x: | 1.00 (1%)  |
| `["scalar", "acos", "(\"small\", \"positive argument\", \"Float64\")"]` | 0.67 (15%) :white_check_mark: | 1.00 (1%)  |
| `["scalar", "arithmetic", "(\"add\", \"Complex{BigInt}\", \"Int64\")"]` | 1.57 (50%) :x: | 1.00 (1%)  |
| `["scalar", "arithmetic", "(\"sub\", \"Int64\", \"BigInt\")"]` | 0.45 (50%) :white_check_mark: | 1.00 (1%)  |
| `["scalar", "asin", "(\"0.5 <= abs(x) < 0.975\", \"positive argument\", \"Float64\")"]` | 0.80 (15%) :white_check_mark: | 1.00 (1%)  |
| `["scalar", "asin", "(\"small\", \"negative argument\", \"Float32\")"]` | 1.27 (15%) :x: | 1.00 (1%)  |
| `["scalar", "asin", "(\"small\", \"positive argument\", \"Float32\")"]` | 1.33 (15%) :x: | 1.00 (1%)  |
| `["scalar", "asin", "(\"zero\", \"Float32\")"]` | 1.27 (15%) :x: | 1.00 (1%)  |
...
| `["scalar", "cbrt", "(\"large\", \"negative argument\", \"Float32\")"]` | 1.27 (15%) :x: | 1.00 (1%)  |
...
| `["scalar", "floatexp", "(\"exp\", \"underflow\", \"Float64\")"]` | 1.53 (40%) :x: | 1.00 (1%)  |
| `["scalar", "predicate", "(\"isfinite\", \"Complex{Float32}\")"]` | 1.27 (25%) :x: | 1.00 (1%)  |
| `["scalar", "predicate", "(\"isless\", \"BigFloat\")"]` | 2.00 (40%) :x: | 1.00 (1%)  |
| `["scalar", "sin", "(\"no reduction\", \"positive argument\", \"Float32\", \"sin_kernel\")"]` | 1.61 (15%) :x: | 1.00 (1%)  |
...
| `["union", "array", "(\"perf_countnothing\", Int8, true)"]` | 0.73 (15%) :white_check_mark: | 1.00 (1%)  |
| `["union", "array", "(\"perf_simplecopy\", Int8, true)"]` | 0.76 (15%) :white_check_mark: | 1.00 (1%)  |
...
```
Julia Version 0.7.0-DEV.4973
Commit 7d48ecb (2018-05-02 00:43 UTC)
Platform Info:
  ...
  CPU: Intel(R) Xeon(R) CPU E3-1241 v3 @ 3.50GHz: 
       ...
       #1  3501 MHz    8146614 s        261 s    1034485 s  297428264 s          3 s
       #2  3501 MHz   46597618 s          0 s     689939 s  259837063 s          0 s
       #3  3501 MHz    5434157 s       2371 s     545283 s  300845122 s          4 s
       #4  3501 MHz    5318467 s          0 s     689318 s  301031295 s          1 s
       
  Memory: 31.383651733398438 GB (4326.09765625 MB free)
  Uptime: 3.073346e6 sec
