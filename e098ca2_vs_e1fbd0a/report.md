...
*Commit(s):* [JuliaLang/julia@e098ca25724989212ab351b45e70f7cc0d73621a](https://github.com/JuliaLang/julia/commit/e098ca25724989212ab351b45e70f7cc0d73621a) vs [JuliaLang/julia@e1fbd0a217285dd1f0e39f572dea4d793d02dab4](https://github.com/JuliaLang/julia/commit/e1fbd0a217285dd1f0e39f572dea4d793d02dab4)

*Triggered By:* [link](https://github.com/JuliaLang/julia/pull/29843#issuecomment-435409821)
...
| `["find", "findnext", "(\"ispos\", \"Array{UInt64,1}\")"]` | 1.27 (5%) :x: | 1.00 (1%)  |
...
| `["scalar", "arithmetic", "(\"add\", \"Int64\", \"Complex{BigInt}\")"]` | 1.67 (50%) :x: | 1.00 (1%)  |
...
| `["scalar", "atan2", "(\"abs(y/x) high\", \"y positive\", \"x positive\", \"Float32\")"]` | 1.25 (5%) :x: | 1.00 (1%)  |
| `["scalar", "atan2", "(\"x one\", \"Float32\")"]` | 1.31 (5%) :x: | 1.00 (1%)  |
...
| `["scalar", "cosh", "(\"zero\", \"Float32\")"]` | 0.83 (5%) :white_check_mark: | 1.00 (1%)  |
...
| `["union", "array", "(\"perf_sum4\", Complex{Float64}, true)"]` | 0.81 (5%) :white_check_mark: | 1.00 (1%)  |
...
```
Julia Version 1.1.0-DEV.608
Commit e098ca2 (2018-11-02 15:04 UTC)
Platform Info:
  ...
  CPU: Intel(R) Xeon(R) CPU E3-1241 v3 @ 3.50GHz: 
       ...
       #1  3501 MHz   37922508 s       2410 s    6144234 s  1851605695 s         10 s
       #2  3501 MHz  200178459 s         12 s    3565235 s  1696114016 s         16 s
       #3  3501 MHz   29040226 s       3135 s    3349371 s  1867288585 s         24 s
       #4  3501 MHz   27924533 s         11 s    2632880 s  1870053086 s         19 s
       
  Memory: 31.383651733398438 GB (4186.95703125 MB free)
  Uptime: 1.9014778e7 sec
...
```
Julia Version 1.1.0-DEV.604
Commit e1fbd0a (2018-11-02 15:04 UTC)
Platform Info:
  OS: Linux (x86_64-linux-gnu)
      Ubuntu 14.04.5 LTS
  uname: Linux 3.13.0-85-generic #129-Ubuntu SMP Thu Mar 17 20:50:15 UTC 2016 x86_64 x86_64
  CPU: Intel(R) Xeon(R) CPU E3-1241 v3 @ 3.50GHz: 
              speed         user         nice          sys         idle          irq
       #1  3501 MHz   38040397 s       2410 s    6155102 s  1852720617 s         10 s
       #2  3501 MHz  201328147 s         12 s    3581292 s  1696196222 s         16 s
       #3  3501 MHz   29180180 s       3135 s    3356764 s  1868388656 s         24 s
       #4  3501 MHz   28043128 s         11 s    2640390 s  1871174810 s         19 s
       
  Memory: 31.383651733398438 GB (4306.9296875 MB free)
  Uptime: 1.9027262e7 sec
  Load Avg:  1.0029296875  1.0146484375  1.04541015625
  WORD_SIZE: 64
  LIBM: libopenlibm
  LLVM: libLLVM-6.0.1 (ORCJIT, haswell)
