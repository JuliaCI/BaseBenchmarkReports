...
*Commit(s):* [JuliaLang/julia@8ec8d10e0c33ab4ccdda1fe012b0fbb98035ba4c](https://github.com/JuliaLang/julia/commit/8ec8d10e0c33ab4ccdda1fe012b0fbb98035ba4c) vs [JuliaLang/julia@ee2211c1b6a8311a900ab1fa7102775d2983eef0](https://github.com/JuliaLang/julia/commit/ee2211c1b6a8311a900ab1fa7102775d2983eef0)

*Triggered By:* [link](https://github.com/JuliaLang/julia/pull/26990#issuecomment-386764601)
...
| `["array", "growth", "(\"append!\", 256)"]` | 1.28 (15%) :x: | 1.00 (1%)  |
...
| `["collection", "queries & updates", "(\"BitSet\", \"Int\", \"length\")"]` | 0.70 (25%) :white_check_mark: | 1.00 (1%)  |
...
| `["collection", "queries & updates", "(\"Vector\", \"Any\", \"setindex!\")"]` | 0.68 (25%) :white_check_mark: | 1.00 (1%)  |
| `["collection", "set operations", "(\"BitSet\", \"Int\", \"union!\", \"big\")"]` | 1.31 (25%) :x: | 1.00 (1%)  |
| `["find", "findall", "(\"ispos\", \"Array{Bool,1}\")"]` | 0.80 (15%) :white_check_mark: | 1.00 (1%)  |
| `["misc", "bitshift", "(\"Int\", \"Int\")"]` | 0.71 (15%) :white_check_mark: | 1.00 (1%)  |
...
| `["scalar", "arithmetic", "(\"add\", \"Complex{Int64}\", \"Float32\")"]` | 1.71 (50%) :x: | 1.00 (1%)  |
| `["scalar", "arithmetic", "(\"add\", \"Int64\", \"BigInt\")"]` | 1.75 (50%) :x: | 1.00 (1%)  |
| `["scalar", "asin", "(\"0.5 <= abs(x) < 0.975\", \"positive argument\", \"Float64\")"]` | 1.29 (15%) :x: | 1.00 (1%)  |
| `["scalar", "atan", "(\"19/16 <= abs(x) < 39/16\", \"negative argument\", \"Float64\")"]` | 1.23 (15%) :x: | 1.00 (1%)  |
...
| `["scalar", "atan2", "(\"y infinite\", \"y negative\", \"x infinite\", \"x positive\", \"Float32\")"]` | 0.77 (15%) :white_check_mark: | 1.00 (1%)  |
| `["scalar", "atan2", "(\"y infinite\", \"y positive\", \"x infinite\", \"x positive\", \"Float32\")"]` | 0.77 (15%) :white_check_mark: | 1.00 (1%)  |
...
| `["tuple", "reduction", "(\"minimum\", (4, 4))"]` | 0.72 (15%) :white_check_mark: | 1.00 (1%)  |
...
| `["union", "array", "(\"perf_countnothing\", BigInt, false)"]` | 0.71 (15%) :white_check_mark: | 1.00 (1%)  |
...
```
Julia Version 0.7.0-DEV.5010
Commit 8ec8d10 (2018-05-05 00:15 UTC)
Platform Info:
  ...
  CPU: Intel(R) Xeon(R) CPU E3-1241 v3 @ 3.50GHz: 
       ...
       #1  3501 MHz    3309243 s        245 s     750470 s  327152791 s          3 s
       #2  3501 MHz   24017803 s          0 s     451688 s  306913565 s          3 s
       #3  3501 MHz    3046177 s       2385 s     559696 s  327962816 s          5 s
       #4  3501 MHz    2882057 s          2 s     362478 s  328548385 s          1 s
       
  Memory: 31.383651733398438 GB (13214.6015625 MB free)
  Uptime: 3.319519e6 sec
...
```
Julia Version 0.7.0-DEV.5007
Commit ee2211c (2018-05-04 21:10 UTC)
Platform Info:
  OS: Linux (x86_64-linux-gnu)
      Ubuntu 14.04.4 LTS
  uname: Linux 3.13.0-85-generic #129-Ubuntu SMP Thu Mar 17 20:50:15 UTC 2016 x86_64 x86_64
  CPU: Intel(R) Xeon(R) CPU E3-1241 v3 @ 3.50GHz: 
              speed         user         nice          sys         idle          irq
       #1  3501 MHz    3400000 s        245 s     760769 s  327952787 s          3 s
       #2  3501 MHz   24842110 s          0 s     461169 s  306983319 s          3 s
       #3  3501 MHz    3137072 s       2385 s     566968 s  328768192 s          6 s
       #4  3501 MHz    2990035 s          2 s     370084 s  329336576 s          1 s
       
  Memory: 31.383651733398438 GB (12898.265625 MB free)
  Uptime: 3.328563e6 sec
