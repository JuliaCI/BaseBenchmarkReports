...
*Commit(s):* [JuliaLang/julia@4441245e096431c4210010ee4163cd009ade5ce5](https://github.com/JuliaLang/julia/commit/4441245e096431c4210010ee4163cd009ade5ce5)

*Triggered By:* [link](https://github.com/JuliaLang/julia/commit/4441245e096431c4210010ee4163cd009ade5ce5#commitcomment-39931631)

*Tag Predicate:* `ALL`

*Daily Job:* 2020-06-16 vs 2020-06-15
...
| `["collection", "queries & updates", "(\"Set\", \"String\", \"in\", \"true\")"]` | 1.36 (25%) :x: | 1.00 (1%)  |
| `["collection", "set operations", "(\"BitSet\", \"Int\", \"union\", \"BitSet\")"]` | 1.39 (25%) :x: | 1.00 (1%)  |
| `["collection", "set operations", "(\"BitSet\", \"Int\", \"union\", \"BitSet\", \"BitSet\")"]` | 1.26 (25%) :x: | 1.00 (1%)  |
| `["find", "findall", "(\"Array{Bool,1}\", \"10-90\")"]` | 1.08 (5%) :x: | 1.00 (1%)  |
| `["find", "findall", "(\"Array{Bool,1}\", \"50-50\")"]` | 1.09 (5%) :x: | 1.00 (1%)  |
...
| `["misc", "repeat", "(200, 1, 24)"]` | 0.35 (5%) :white_check_mark: | 0.48 (1%) :white_check_mark: |
| `["misc", "repeat", "(200, 24, 1)"]` | 0.40 (5%) :white_check_mark: | 1.33 (1%) :x: |
...
| `["random", "collections", "(\"rand!\", \"MersenneTwister\", \"small Vector\")"]` | 1.27 (25%) :x: | 1.00 (1%)  |
| `["random", "collections", "(\"rand\", \"MersenneTwister\", \"large String\")"]` | 1.46 (25%) :x: | 1.00 (1%)  |
| `["random", "collections", "(\"rand\", \"MersenneTwister\", \"small String\")"]` | 1.60 (25%) :x: | 1.00 (1%)  |
| `["random", "ranges", "(\"rand\", \"MersenneTwister\", \"UInt128\", \"RangeGenerator(1:170141183460469231731687303715884105728)\")"]` | 1.52 (25%) :x: | 1.00 (1%)  |
...
| `["union", "array", "(\"broadcast\", identity, Float32, true)"]` | 1.09 (5%) :x: | 1.00 (1%)  |
...
| `["union", "array", "(\"map\", abs, Int64, true)"]` | 1.34 (5%) :x: | 1.00 (1%)  |
...
Commit 4441245 (2020-06-15 20:24 UTC)
Platform Info:
  ...
  CPU: Intel(R) Xeon(R) CPU E3-1241 v3 @ 3.50GHz: 
       ...
       #1  3501 MHz  144968799 s       5056 s   16394975 s  6835316850 s         35 s
       #2  3501 MHz  1094803988 s        217 s   21811669 s  5890253970 s         27 s
       #3  3501 MHz  129937574 s       3312 s    9750822 s  6866903737 s         38 s
       #4  3501 MHz  121999266 s         43 s   14019001 s  6868659589 s         28 s
       
  Memory: 31.383651733398438 GB (19471.58984375 MB free)
  Uptime: 7.0124186e7 sec
