...
*Commit(s):* [JuliaLang/julia@93bbe0833b4918c0231c217b34c717eb0b1ad8bb](https://github.com/JuliaLang/julia/commit/93bbe0833b4918c0231c217b34c717eb0b1ad8bb)

*Triggered By:* [link](https://github.com/JuliaLang/julia/commit/93bbe0833b4918c0231c217b34c717eb0b1ad8bb#commitcomment-42755187)

*Tag Predicate:* `ALL`

*Daily Job:* 2020-09-27 vs 2020-09-26
...
| `["array", "equality", "(\"isequal\", \"Vector{Bool}\")"]` | 1.11 (5%) :x: | 1.00 (1%)  |
...
| `["collection", "initialization", "(\"Dict\", \"Any\", \"loop\", \"sizehint!\")"]` | 1.29 (25%) :x: | 1.00 (1%)  |
...
| `["io", "array_limit", "(\"display\", \"Matrix{Float64}(10000, 10000)\")"]` | 0.89 (5%) :white_check_mark: | 0.97 (1%) :white_check_mark: |
...
| `["scalar", "cos", "(\"no reduction\", \"negative argument\", \"Float32\", \"cos_kernel\")"]` | 1.33 (5%) :x: | 1.00 (1%)  |
...
| `["sparse", "constructors", "(\"Bidiagonal\", 100)"]` | 1.40 (5%) :x: | 1.00 (1%)  |
...
| `["union", "array", "(\"broadcast\", identity, ComplexF64, false)"]` | 1.54 (5%) :x: | 1.00 (1%)  |
...
| `["union", "array", "(\"perf_sum2\", Int8, false)"]` | 1.08 (5%) :x: | 1.00 (1%)  |
...
Commit 93bbe08 (2020-09-26 14:27 UTC)
Platform Info:
  ...
  CPU: Intel(R) Xeon(R) CPU E3-1241 v3 @ 3.50GHz: 
       ...
       #1  3501 MHz   16137224 s        507 s    1782494 s  770645002 s          4 s
       #2  3501 MHz  123036715 s         22 s    2513819 s  664082925 s          3 s
       #3  3501 MHz   14699814 s        332 s    1081943 s  773686594 s          4 s
       #4  3501 MHz   13753254 s          4 s    1573951 s  773983413 s          3 s
       
  Memory: 31.383651733398438 GB (14522.9375 MB free)
  Uptime: 7.9024474e7 sec
  Load Avg:  1.02  1.02  1.05
  WORD_SIZE: 64
  LIBM: libopenlibm
