...
*Commit(s):* [JuliaLang/julia@b29d95119d1f1bd485ba015c2bbfc9b08fcc09b9](https://github.com/JuliaLang/julia/commit/b29d95119d1f1bd485ba015c2bbfc9b08fcc09b9)

*Triggered By:* [link](https://github.com/JuliaLang/julia/commit/b29d95119d1f1bd485ba015c2bbfc9b08fcc09b9#commitcomment-35984158)

*Tag Predicate:* `ALL`

*Daily Job:* 2019-11-16 vs 2019-11-15
...
| `["collection", "set operations", "(\"BitSet\", \"Int\", \"intersect!\", \"small\")"]` | 1.56 (25%) :x: | 1.00 (1%)  |
...
| `["scalar", "arithmetic", "(\"sub\", \"Complex{BigInt}\", \"BigInt\")"]` | 1.62 (50%) :x: | 1.00 (1%)  |
...
| `["scalar", "predicate", "(\"isless\", \"BigFloat\")"]` | 0.40 (40%) :white_check_mark: | 1.00 (1%)  |
...
| `["scalar", "sinh", "(\"0 <= abs(x) < 2.0^-28\", \"positive argument\", \"Float64\")"]` | 1.32 (5%) :x: | 1.00 (1%)  |
...
| `["scalar", "sinh", "(\"zero\", \"Float64\")"]` | 0.84 (5%) :white_check_mark: | 1.00 (1%)  |
| `["scalar", "tan", "(\"medium\", \"positive argument\", \"Float32\")"]` | 1.29 (5%) :x: | 1.00 (1%)  |
...
| `["sparse", "matmul", "(\"A_mul_B\", \"dense 5x50, sparse 50x500 -> dense 5x500\")"]` | 1.42 (30%) :x: | 1.00 (1%)  |
...
Platform Info:
  ...
  CPU: Intel(R) Xeon(R) CPU E3-1241 v3 @ 3.50GHz: 
       ...
       #1  3501 MHz  108558310 s       5047 s   12670022 s  5039405173 s         30 s
       #2  3501 MHz  777176108 s        217 s   14091748 s  4377305651 s         25 s
       #3  3501 MHz   92506122 s       3255 s    7524026 s  5068695512 s         34 s
       #4  3501 MHz   86654728 s         32 s   10737520 s  5069241160 s         24 s
       
  Memory: 31.383651733398438 GB (15730.80859375 MB free)
  Uptime: 5.172451e7 sec
