...
*Commit(s):* [JuliaLang/julia@cc00b429a3480cdfd0b35e57f206d1c5598ca354](https://github.com/JuliaLang/julia/commit/cc00b429a3480cdfd0b35e57f206d1c5598ca354) vs [JuliaLang/julia@da964d6178c5b22e9dc4b1dd8489f052f4b73e94](https://github.com/JuliaLang/julia/commit/da964d6178c5b22e9dc4b1dd8489f052f4b73e94)

*Triggered By:* [link](https://github.com/JuliaLang/julia/pull/29380#issuecomment-424950865)
...
| `["collection", "queries & updates", "(\"Set\", \"Int\", \"pop!\", \"unspecified\")"]` | 2.17 (25%) :x: | 1.00 (1%)  |
| `["collection", "queries & updates", "(\"Vector\", \"Any\", \"pop!\", \"unspecified\")"]` | 0.57 (25%) :white_check_mark: | 1.00 (1%)  |
| `["dates", "arithmetic", "(\"Date\", \"Year\")"]` | 1.21 (5%) :x: | 1.00 (1%)  |
| `["dates", "parse", "(\"DateTime\", \"ISODateTimeFormat\")"]` | 0.94 (5%) :white_check_mark: | 1.00 (1%)  |
| `["dates", "parse", "(\"DateTime\", \"RFC1123Format\", \"Lowercase\")"]` | 0.71 (5%) :white_check_mark: | 1.00 (1%)  |
| `["dates", "parse", "(\"DateTime\", \"RFC1123Format\", \"Mixedcase\")"]` | 0.74 (5%) :white_check_mark: | 1.00 (1%)  |
| `["dates", "parse", "(\"DateTime\", \"RFC1123Format\", \"Titlecase\")"]` | 0.72 (5%) :white_check_mark: | 1.00 (1%)  |
...
| `["scalar", "asinh", "(\"zero\", \"Float32\")"]` | 0.67 (5%) :white_check_mark: | 1.00 (1%)  |
...
| `["scalar", "atan2", "(\"abs(y/x) high\", \"y negative\", \"x positive\", \"Float64\")"]` | 0.54 (5%) :white_check_mark: | 1.00 (1%)  |
...
| `["scalar", "sinh", "(\"0 <= abs(x) < 2.0^-28\", \"negative argument\", \"Float64\")"]` | 0.59 (5%) :white_check_mark: | 1.00 (1%)  |
...
| `["sparse", "constructors", "(\"IV\", 10)"]` | 1.52 (5%) :x: | 1.00 (1%)  |
| `["sparse", "constructors", "(\"IV\", 100)"]` | 1.19 (5%) :x: | 1.00 (1%)  |
| `["sparse", "index", "(\"spmat\", \"col\", \"range\", 10)"]` | 1.62 (30%) :x: | 1.00 (1%)  |
| `["sparse", "index", "(\"spmat\", \"col\", \"range\", 100)"]` | 1.47 (30%) :x: | 1.00 (1%)  |
| `["sparse", "index", "(\"spmat\", \"col\", \"range\", 1000)"]` | 1.46 (30%) :x: | 1.00 (1%)  |
...
| `["union", "array", "(\"perf_sum3\", Float32, true)"]` | 0.78 (5%) :white_check_mark: | 1.00 (1%)  |
...
| `["union", "array", "(\"skipmissing\", sum, Complex{Float64}, true)"]` | 0.88 (5%) :white_check_mark: | 1.00 (1%)  |
...
Commit cc00b42 (2018-09-26 23:05 UTC)
Platform Info:
  ...
  CPU: Intel(R) Xeon(R) CPU E3-1241 v3 @ 3.50GHz: 
       ...
       #1  3501 MHz   33150872 s       2407 s    5031866 s  1543496443 s          8 s
       #2  3501 MHz  159922210 s          7 s    2901759 s  1422236148 s         14 s
       #3  3501 MHz   24440607 s       3131 s    2940830 s  1557519452 s         21 s
       #4  3501 MHz   23416880 s         11 s    2310730 s  1559945832 s         15 s
       
  Memory: 31.383651733398438 GB (4849.74609375 MB free)
  Uptime: 1.5864422e7 sec
...
Platform Info:
  ...
  CPU: Intel(R) Xeon(R) CPU E3-1241 v3 @ 3.50GHz: 
              speed         user         nice          sys         idle          irq
       #1  3501 MHz   33271139 s       2407 s    5043042 s  1544615543 s          8 s
       #2  3501 MHz  161060225 s          7 s    2916990 s  1422337461 s         14 s
       #3  3501 MHz   24545999 s       3131 s    2947781 s  1558660841 s         22 s
       #4  3501 MHz   23549626 s         11 s    2317730 s  1561060534 s         15 s
       
  Memory: 31.383651733398438 GB (4420.21875 MB free)
  Uptime: 1.5876974e7 sec
