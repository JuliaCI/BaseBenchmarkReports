...
*Triggered By:* [link](https://github.com/JuliaLang/julia/commit/f4c777972e58d25d4636480d8e5ca30066a6235e#commitcomment-31437670)

*Tag Predicate:* `ALL`

*Daily Job:* 2018-11-25 vs 2018-11-24
...
| `["array", "growth", "(\"append!\", 256)"]` | 1.18 (5%) :x: | 1.00 (1%)  |
| `["array", "growth", "(\"prerend!\", 256)"]` | 1.07 (5%) :x: | 1.00 (1%)  |
| `["array", "index", "(\"sumrange_view\", \"1.0:0.00010001000100010001:2.0\")"]` | 2.05 (50%) :x: | 1.00 (1%)  |
...
| `["collection", "deletion", "(\"Vector\", \"Any\", \"filter!\")"]` | 0.55 (25%) :white_check_mark: | 1.00 (1%)  |
...
| `["scalar", "sincos", "(\"argument reduction (easy) abs(x) < 4π/4\", \"positive argument\", \"Float64\")"]` | 1.23 (5%) :x: | 1.00 (1%)  |
...
| `["union", "array", "(\"map\", *, Int64, (false, true))"]` | 1.17 (5%) :x: | 1.00 (1%)  |
...
| `["union", "array", "(\"skipmissing\", collect, Float64, true)"]` | 0.94 (5%) :white_check_mark: | 1.00 (1%)  |
...
Platform Info:
  ...
  CPU: Intel(R) Xeon(R) CPU E3-1241 v3 @ 3.50GHz: 
       ...
       #1  3501 MHz   62987065 s       5007 s    6912893 s  2021325870 s         22 s
       #2  3501 MHz  345528582 s        203 s    5563049 s  1743725122 s         17 s
       #3  3501 MHz   46914438 s       3212 s    3986136 s  2043803443 s         25 s
       #4  3501 MHz   43609392 s          0 s    5076524 s  2045607021 s         15 s
       
  Memory: 31.383651733398438 GB (5081.57421875 MB free)
  Uptime: 2.0965397e7 sec
