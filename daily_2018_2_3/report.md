...
*Commit(s):* [JuliaLang/julia@f37d8d7a60c7b58dcbb3980b0e7725259f1ef571](https://github.com/JuliaLang/julia/commit/f37d8d7a60c7b58dcbb3980b0e7725259f1ef571)

*Triggered By:* [link](https://github.com/JuliaLang/julia/commit/f37d8d7a60c7b58dcbb3980b0e7725259f1ef571#commitcomment-27309645)

*Tag Predicate:* `ALL`

*Daily Job:* 2018-02-03 vs 2018-02-01
...
| `["array", "growth", "(\"prerend!\", 8)"]` | 1.20 (15%) :x: | 1.00 (1%)  |
...
| `["scalar", "arithmetic", "(\"sub\", \"UInt64\", \"Complex{BigInt}\")"]` | 2.06 (50%) :x: | 1.00 (1%)  |
...
| `["scalar", "atan2", "(\"abs(y/x) safe (large)\", \"y positive\", \"x positive\", \"Float32\")"]` | 1.27 (15%) :x: | 1.00 (1%)  |
| `["scalar", "atan2", "(\"abs(y/x) safe (small)\", \"y positive\", \"x negative\", \"Float32\")"]` | 0.78 (15%) :white_check_mark: | 1.00 (1%)  |
| `["scalar", "cos", "(\"argument reduction (easy) abs(x) < 3π/4\", \"negative argument\", \"Float64\", \"sin_kernel\")"]` | 1.21 (15%) :x: | 1.00 (1%)  |
...
| `["scalar", "sinh", "(\"very large\", \"positive argument\", \"Float64\")"]` | 0.62 (15%) :white_check_mark: | 1.00 (1%)  |
| `["shootout", "binary_trees"]` | 1.08 (15%)  | 1.17 (1%) :x: |
...
Commit f37d8d7 (2018-02-03 03:17 UTC)
Platform Info:
  ...
  CPU: Intel(R) Xeon(R) CPU E3-1241 v3 @ 3.50GHz: 
       ...
       #1  3501 MHz  116570762 s          0 s   20551604 s  5176237601 s        101 s
       #2  3501 MHz  503813394 s          0 s   12918730 s  4809131938 s         26 s
       #3  3501 MHz   96296703 s          0 s   11002562 s  5219090981 s         86 s
       #4  3501 MHz   92228567 s          0 s   11197177 s  5222956331 s         22 s
       
  Memory: 31.383651733398438 GB (6499.65234375 MB free)
  Uptime: 5.3289031e7 sec
