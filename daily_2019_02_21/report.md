...
*Commit(s):* [JuliaLang/julia@cc3b6ddf92babc708966f38c6e013a3671f5491e](https://github.com/JuliaLang/julia/commit/cc3b6ddf92babc708966f38c6e013a3671f5491e)

*Triggered By:* [link](https://github.com/JuliaLang/julia/commit/cc3b6ddf92babc708966f38c6e013a3671f5491e#commitcomment-32404382)

*Tag Predicate:* `ALL`

*Daily Job:* 2019-02-21 vs 2019-02-20
...
| `["collection", "queries & updates", "(\"BitSet\", \"Int\", \"pop!\", \"specified\")"]` | 1.41 (25%) :x: | 1.00 (1%)  |
| `["collection", "queries & updates", "(\"Dict\", \"Int\", \"length\")"]` | 0.71 (25%) :white_check_mark: | 1.00 (1%)  |
| `["collection", "queries & updates", "(\"IdDict\", \"Any\", \"pop!\", \"specified\")"]` | 1.29 (25%) :x: | 1.00 (1%)  |
| `["collection", "queries & updates", "(\"IdDict\", \"Any\", \"push!\", \"new\")"]` | 1.30 (25%) :x: | 1.00 (1%)  |
| `["collection", "queries & updates", "(\"IdDict\", \"Int\", \"getindex\")"]` | 0.51 (25%) :white_check_mark: | 1.00 (1%)  |
| `["collection", "queries & updates", "(\"Set\", \"Any\", \"pop!\", \"specified\")"]` | 0.69 (25%) :white_check_mark: | 1.00 (1%)  |
| `["collection", "queries & updates", "(\"Set\", \"Any\", \"push!\", \"overwrite\")"]` | 0.63 (25%) :white_check_mark: | 1.00 (1%)  |
| `["collection", "queries & updates", "(\"Vector\", \"Int\", \"length\")"]` | 2.00 (25%) :x: | 1.00 (1%)  |
...
| `["io", "array_limit", "(\"display\", \"Array{Float64,1}(100000000,)\")"]` | 1.02 (5%)  | 0.98 (1%) :white_check_mark: |
...
| `["random", "types", "(\"rand\", \"RandomDevice\", \"Float64\")"]` | 1.40 (25%) :x: | 1.00 (1%)  |
| `["random", "types", "(\"rand\", \"RandomDevice\", \"Int64\")"]` | 2.53 (25%) :x: | 1.00 (1%)  |
| `["random", "types", "(\"randn\", \"MersenneTwister\", \"Complex{Float16}\")"]` | 0.51 (25%) :white_check_mark: | 1.00 (1%)  |
...
| `["scalar", "atan", "(\"very small\", \"negative argument\", \"Float64\")"]` | 0.74 (5%) :white_check_mark: | 1.00 (1%)  |
...
| `["sparse", "matmul", "(\"A_mul_B\", \"dense 5x500, sparse 500x500 -> dense 5x500\")"]` | 1.34 (30%) :x: | 1.00 (1%)  |
...
```
Julia Version 1.2.0-DEV.359
Commit cc3b6dd (2019-02-21 02:42 UTC)
Platform Info:
  ...
  CPU: Intel(R) Xeon(R) CPU E3-1241 v3 @ 3.50GHz: 
       ...
       #1  3501 MHz   77402886 s       5015 s    8677840 s  2763698815 s         23 s
       #2  3501 MHz  460097314 s        203 s    7644455 s  2386774124 s         19 s
       #3  3501 MHz   60563715 s       3228 s    5108479 s  2788726072 s         27 s
       #4  3501 MHz   56747880 s          7 s    6660330 s  2790278138 s         17 s
       
  Memory: 31.383651733398438 GB (5052.43359375 MB free)
  Uptime: 2.856761e7 sec
