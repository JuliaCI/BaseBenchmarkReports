...
*Commit(s):* [JuliaLang/julia@c0e6b5ba8125f86d377edc2c8297365bf6427caf](https://github.com/JuliaLang/julia/commit/c0e6b5ba8125f86d377edc2c8297365bf6427caf)

*Triggered By:* [link](https://github.com/JuliaLang/julia/commit/c0e6b5ba8125f86d377edc2c8297365bf6427caf#commitcomment-28610677)

*Tag Predicate:* `ALL`

*Daily Job:* 2018-04-17 vs 2018-04-16
...
|----|------------|--------------|
| `["array", "accumulate", "(\"cumsum!\", \"Float64\", \"dim2\")"]` | 1.17 (15%) :x: | 1.00 (1%)  |
| `["array", "any/all", "(\"any\", \"Array{Float64,1}\")"]` | 1.17 (15%) :x: | 1.00 (1%)  |
| `["array", "equality", "(\"isequal\", \"Array{Int64,1} isequal Array{Int64,1}\")"]` | 1.71 (15%) :x: | 1.00 (1%)  |
| `["array", "reductions", "(\"sumabs\", \"Int64\")"]` | 1.27 (15%) :x: | 1.00 (1%)  |
| `["broadcast", "typeargs", "(\"tuple\", 10)"]` | 0.74 (15%) :white_check_mark: | 0.00 (1%) :white_check_mark: |
| `["broadcast", "typeargs", "(\"tuple\", 3)"]` | 1.14 (15%)  | Inf (1%) :x: |
| `["collection", "queries & updates", "(\"Set\", \"Any\", \"pop!\", \"unspecified\")"]` | 0.72 (25%) :white_check_mark: | 1.00 (1%)  |
| `["collection", "set operations", "(\"Set\", \"Int\", \"⊆\", \"self\")"]` | 0.63 (25%) :white_check_mark: | 1.00 (1%)  |
| `["dates", "arithmetic", "(\"DateTime\", \"Second\")"]` | 0.78 (15%) :white_check_mark: | 1.00 (1%)  |
| `["find", "findall", "(\"Array{Bool,1}\", \"10-90\")"]` | 0.81 (15%) :white_check_mark: | 1.00 (1%)  |
| `["find", "findnext", "(\"Array{Bool,1}\", \"50-50\")"]` | 3.75 (15%) :x: | 1.00 (1%)  |
...
| `["scalar", "arithmetic", "(\"mul\", \"BigInt\", \"Int64\")"]` | 1.67 (50%) :x: | 1.00 (1%)  |
...
| `["scalar", "atan", "(\"very small\", \"positive argument\", \"Float32\")"]` | 1.25 (15%) :x: | 1.00 (1%)  |
| `["scalar", "atan2", "(\"abs(y/x) safe (large)\", \"y positive\", \"x negative\", \"Float32\")"]` | 0.77 (15%) :white_check_mark: | 1.00 (1%)  |
...
| `["scalar", "cosh", "(\"0 <= abs(x) < 0.00024414062f0\", \"negative argument\", \"Float32\")"]` | 0.81 (15%) :white_check_mark: | 1.00 (1%)  |
...
| `["scalar", "predicate", "(\"isequal\", \"UInt64\")"]` | 0.74 (25%) :white_check_mark: | 1.00 (1%)  |
...
| `["scalar", "sincos", "(\"argument reduction (easy) abs(x) < 4π/4\", \"positive argument\", \"Float32\")"]` | 0.85 (15%) :white_check_mark: | 1.00 (1%)  |
...
| `["scalar", "sincos", "(\"argument reduction (easy) abs(x) < 8π/4\", \"positive argument\", \"Float32\")"]` | 0.73 (15%) :white_check_mark: | 1.00 (1%)  |
...
| `["tuple", "reduction", "(\"sumabs\", (2,))"]` | 0.82 (15%) :white_check_mark: | 1.00 (1%)  |
...
```
Julia Version 0.7.0-DEV.4888
Commit c0e6b5b (2018-04-16 19:19 UTC)
Platform Info:
  ...
  CPU: Intel(R) Xeon(R) CPU E3-1241 v3 @ 3.50GHz: 
       ...
       #1  3501 MHz    3381888 s        259 s     482355 s  173514700 s          1 s
       #2  3501 MHz   25858949 s          0 s     389870 s  151406034 s          0 s
       #3  3501 MHz    2964750 s       2368 s     306050 s  174161549 s          2 s
       #4  3501 MHz    2913329 s          0 s     399994 s  174266871 s          1 s
       
  Memory: 31.383651733398438 GB (16696.65625 MB free)
  Uptime: 1.777684e6 sec
  Load Avg:  0.98193359375  1.0087890625  1.0400390625
  WORD_SIZE: 64
  LIBM: libopenlibm
