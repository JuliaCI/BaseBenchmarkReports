...
*Commit(s):* [JuliaLang/julia@634ba9164a1549a42412e0ec3e972e1b32465db0](https://github.com/JuliaLang/julia/commit/634ba9164a1549a42412e0ec3e972e1b32465db0) vs [JuliaLang/julia@4aea3d2b7cc829d08f2c9048c9136299d7fd2c49](https://github.com/JuliaLang/julia/commit/4aea3d2b7cc829d08f2c9048c9136299d7fd2c49)

*Triggered By:* [link](https://github.com/JuliaLang/julia/pull/29444#issuecomment-431382948)
...
| `["array", "cat", "(\"catnd\", 5)"]` | 1.11 (5%) :x: | 1.01 (1%) :x: |
...
| `["broadcast", "mix_scalar_tuple", "(5, \"scal_tup_x3\")"]` | 0.73 (5%) :white_check_mark: | 1.00 (1%)  |
| `["collection", "iteration", "(\"BitSet\", \"Int\", \"iterate second\")"]` | 1.26 (25%) :x: | 1.00 (1%)  |
...
| `["dates", "accessor", "minute"]` | 0.75 (5%) :white_check_mark: | 1.00 (1%)  |
...
| `["problem", "monte carlo", "euro_option_devec"]` | 0.77 (5%) :white_check_mark: | 1.00 (1%)  |
| `["problem", "simplex", "simplex"]` | 0.91 (5%) :white_check_mark: | 1.00 (1%)  |
| `["random", "ranges", "(\"rand\", \"MersenneTwister\", \"BigInt\", \"RangeGenerator(1:4294967295)\")"]` | 1.31 (25%) :x: | 1.00 (1%)  |
| `["random", "types", "(\"rand\", \"MersenneTwister\", \"UInt16\")"]` | 0.67 (25%) :white_check_mark: | 1.00 (1%)  |
...
| `["scalar", "cosh", "(\"very large\", \"negative argument\", \"Float32\")"]` | 0.53 (5%) :white_check_mark: | 1.00 (1%)  |
...
| `["scalar", "sincos", "(\"no reduction\", \"negative argument\", \"Float32\")"]` | 1.09 (5%) :x: | 1.00 (1%)  |
...
| `["union", "array", "(\"perf_sum2\", Float32, true)"]` | 0.81 (5%) :white_check_mark: | 1.00 (1%)  |
| `["union", "array", "(\"perf_sum2\", Float64, true)"]` | 1.22 (5%) :x: | 1.00 (1%)  |
| `["union", "array", "(\"perf_sum3\", Bool, false)"]` | 1.10 (5%) :x: | 1.00 (1%)  |
| `["union", "array", "(\"perf_sum3\", Bool, true)"]` | 1.40 (5%) :x: | 1.00 (1%)  |
...
| `["union", "array", "(\"perf_sum4\", BigInt, true)"]` | 1.18 (5%) :x: | 1.00 (1%)  |
...
| `["union", "array", "(\"skipmissing\", sum, Complex{Float64}, true)"]` | 1.06 (5%) :x: | 1.00 (1%)  |
...
```
Julia Version 1.0.2-pre.76
Commit 634ba91 (2018-10-19 14:26 UTC)
Platform Info:
  ...
  CPU: Intel(R) Xeon(R) CPU E3-1241 v3 @ 3.50GHz: 
       ...
       #1  3501 MHz   56247196 s       5002 s    6171492 s  1713294731 s         21 s
       #2  3501 MHz  290855526 s        203 s    4636867 s  1483316248 s         14 s
       #3  3501 MHz   40784260 s       3205 s    3503972 s  1734509554 s         24 s
       #4  3501 MHz   37769340 s          0 s    4347404 s  1736390578 s         14 s
       
  Memory: 31.383651733398438 GB (4913.86328125 MB free)
  Uptime: 1.7803419e7 sec
...
Platform Info:
  ...
  CPU: Intel(R) Xeon(R) CPU E3-1241 v3 @ 3.50GHz: 
              speed         user         nice          sys         idle          irq
       #1  3501 MHz   56379900 s       5002 s    6181856 s  1714422780 s         21 s
       #2  3501 MHz  291990938 s        203 s    4652812 s  1483439985 s         14 s
       #3  3501 MHz   40901977 s       3205 s    3511412 s  1735658510 s         24 s
       #4  3501 MHz   37884867 s          0 s    4354505 s  1737542712 s         14 s
       
  Memory: 31.383651733398438 GB (4449.41015625 MB free)
  Uptime: 1.7816177e7 sec
