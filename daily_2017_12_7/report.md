...
*Commit(s):* [JuliaLang/julia@622ab915e080b10862f4548f670467b18db55cdd](https://github.com/JuliaLang/julia/commit/622ab915e080b10862f4548f670467b18db55cdd)

*Triggered By:* [link](https://github.com/JuliaLang/julia/commit/622ab915e080b10862f4548f670467b18db55cdd#commitcomment-26106345)

*Tag Predicate:* `ALL`

*Daily Job:* 2017-12-07 vs 2017-12-06
...
| `["array", "index", "(\"sumvector_view\", \"SubArray{Float32,2,Array{Float32,2},Tuple{Base.Slice{Base.OneTo{Int64}},Base.Slice{Base.OneTo{Int64}}},true}\")"]` | 1.83 (50%) :x: | 1.00 (1%)  |
...
| `["linalg", "factorization", "(\"lu\", \"Tridiagonal\", 1024)"]` | 1.45 (45%) :x: | 1.00 (1%)  |
...
| `["scalar", "acos", "(\"one\", \"negative argument\", \"Float32\")"]` | 1.27 (15%) :x: | 1.00 (1%)  |
| `["scalar", "acos", "(\"one\", \"positive argument\", \"Float32\")"]` | 1.27 (15%) :x: | 1.00 (1%)  |
| `["scalar", "atan", "(\"39/16 <= abs(x) < 2^66\", \"positive argument\", \"Float64\")"]` | 0.82 (15%) :white_check_mark: | 1.00 (1%)  |
...
| `["scalar", "predicate", "(\"isfinite\", \"Complex{Float64}\")"]` | 0.63 (25%) :white_check_mark: | 1.00 (1%)  |
| `["scalar", "rem_pio2", "(\"argument reduction (easy) abs(x) < 4π/4\", \"negative argument\", \"Float64\")"]` | 1.67 (15%) :x: | 1.00 (1%)  |
| `["scalar", "sin", "(\"no reduction\", \"zero\", \"Float32\")"]` | 0.68 (15%) :white_check_mark: | 1.00 (1%)  |
...
| `["scalar", "sincos", "(\"argument reduction (easy) abs(x) < 4π/4\", \"negative argument\", \"Float64\")"]` | 1.29 (15%) :x: | 1.00 (1%)  |
...
| `["scalar", "sincos", "(\"argument reduction (paynehanek) abs(x) > 2.0^20*π/2\", \"negative argument\", \"Float64\")"]` | 1.23 (15%) :x: | 1.00 (1%)  |
| `["sparse", "arithmetic", "(\"unary minus\", (20000, 20000))"]` | 1.33 (30%) :x: | 1.00 (1%)  |
| `["sparse", "transpose", "(\"adjoint!\", (20000, 10000))"]` | 1.43 (30%) :x: | 1.00 (1%)  |
...
| `["string", "readuntil", "barbarian backtrack"]` | 1.18 (15%) :x: | 1.00 (1%)  |
| `["union", "array", "(\"perf_countnothing\", \"Array{Union{Void, Int8},1}\")"]` | 0.70 (15%) :white_check_mark: | 1.00 (1%)  |
...
Platform Info:
  ...
  CPU: Intel(R) Xeon(R) CPU E3-1241 v3 @ 3.50GHz: 
       ...
       #1  3501 MHz  106496457 s          0 s   18812308 s  4688101618 s         98 s
       #2  3501 MHz  456115656 s          0 s   12041126 s  4356513829 s         23 s
       #3  3501 MHz   89947516 s          0 s   10288616 s  4724913573 s         82 s
       #4  3501 MHz   86002928 s          0 s   10476808 s  4728662275 s         21 s
       
  Memory: 31.383651733398438 GB (2596.87890625 MB free)
  Uptime: 4.8274632e7 sec
