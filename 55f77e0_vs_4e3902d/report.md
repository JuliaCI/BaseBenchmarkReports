...
*Commit(s):* [JuliaLang/julia@55f77e09e123128e2fb1525b1260ce4fe8a0c2c9](https://github.com/JuliaLang/julia/commit/55f77e09e123128e2fb1525b1260ce4fe8a0c2c9) vs [JuliaLang/julia@4e3902d6240d08bbd07032ccf99d2992239a6f8f](https://github.com/JuliaLang/julia/commit/4e3902d6240d08bbd07032ccf99d2992239a6f8f)

*Triggered By:* [link](https://github.com/JuliaLang/julia/pull/27434#issuecomment-400201660)
...
| `["array", "setindex!", "(\"setindex!\", 2)"]` | 1.00 (15%)  | 0.95 (1%) :white_check_mark: |
| `["array", "setindex!", "(\"setindex!\", 3)"]` | 0.97 (15%)  | 0.95 (1%) :white_check_mark: |
| `["array", "setindex!", "(\"setindex!\", 4)"]` | 0.96 (15%)  | 0.95 (1%) :white_check_mark: |
| `["array", "setindex!", "(\"setindex!\", 5)"]` | 1.00 (15%)  | 0.95 (1%) :white_check_mark: |
| `["collection", "set operations", "(\"BitSet\", \"Int\", \"symdiff!\", \"big\")"]` | 1.44 (25%) :x: | 1.00 (1%)  |
| `["collection", "set operations", "(\"Set\", \"Int\", \"==\", \"self\")"]` | 0.54 (25%) :white_check_mark: | 1.00 (1%)  |
| `["dates", "arithmetic", "(\"DateTime\", \"Year\")"]` | 0.75 (15%) :white_check_mark: | 1.00 (1%)  |
...
| `["scalar", "arithmetic", "(\"sub\", \"BigInt\", \"Int64\")"]` | 1.68 (50%) :x: | 1.00 (1%)  |
...
| `["scalar", "cosh", "(\"9f0 <= abs(x) < 88.72283f0\", \"positive argument\", \"Float32\")"]` | 0.85 (15%) :white_check_mark: | 1.00 (1%)  |
| `["scalar", "expm1", "(\"arg reduction I\", \"positive argument\", \"Float32\")"]` | 1.18 (15%) :x: | 1.00 (1%)  |
...
| `["union", "array", "(\"perf_simplecopy\", Bool, true)"]` | 1.29 (15%) :x: | 1.00 (1%)  |
