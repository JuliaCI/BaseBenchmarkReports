...
*Triggered By:* [link](https://github.com/JuliaLang/julia/commit/96ce5ba22122280b67991849acdb17b36603224f#commitcomment-31258367)

*Tag Predicate:* `ALL`

*Daily Job:* 2018-11-12 vs 2018-11-11
...
| `["find", "findnext", "(\"ispos\", \"Array{Float64,1}\")"]` | 1.21 (5%) :x: | 1.00 (1%)  |
...
| `["random", "collections", "(\"rand\", \"ImplicitRNG\", \"small Set\")"]` | 1.34 (25%) :x: | 1.00 (1%)  |
...
| `["scalar", "arithmetic", "(\"add\", \"BigFloat\", \"Complex{BigFloat}\")"]` | 1.52 (50%) :x: | 1.00 (1%)  |
...
| `["scalar", "atan", "(\"very large\", \"negative argument\", \"Float32\")"]` | 0.68 (5%) :white_check_mark: | 1.00 (1%)  |
...
| `["scalar", "cosh", "(\"0 <= abs(x) < 0.00024414062f0\", \"positive argument\", \"Float32\")"]` | 0.68 (5%) :white_check_mark: | 1.00 (1%)  |
...
| `["scalar", "fastmath", "(\"add\", \"BigFloat\")"]` | 1.59 (40%) :x: | 1.00 (1%)  |
...
| `["string", "repeat", "repeat str len 1"]` | 0.76 (5%) :white_check_mark: | 1.00 (1%)  |
...
| `["union", "array", "(\"skipmissing\", sum, Complex{Float64}, true)"]` | 1.10 (5%) :x: | 1.00 (1%)  |
| `["union", "array", "(\"skipmissing\", sum, Float32, true)"]` | 1.10 (5%) :x: | 1.00 (1%)  |
| `["union", "array", "(\"skipmissing\", sum, Float64, true)"]` | 0.81 (5%) :white_check_mark: | 1.00 (1%)  |
...
Platform Info:
  ...
  CPU: Intel(R) Xeon(R) CPU E3-1241 v3 @ 3.50GHz: 
       ...
       #1  3501 MHz   61352062 s       5006 s    6692855 s  1911071972 s         22 s
       #2  3501 MHz  330354969 s        203 s    5294621 s  1646897860 s         16 s
       #3  3501 MHz   45281759 s       3212 s    3845772 s  1933367550 s         25 s
       #4  3501 MHz   42067284 s          0 s    4858072 s  1935160442 s         14 s
       
  Memory: 31.383651733398438 GB (4800.859375 MB free)
  Uptime: 1.9842036e7 sec
