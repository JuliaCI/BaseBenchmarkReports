...
*Triggered By:* [link](https://github.com/JuliaLang/julia/commit/c9805191e32fde9d4aa55e59493178f47444926e#commitcomment-38277101)

*Tag Predicate:* `ALL`

*Daily Job:* 2020-04-04 vs 2020-04-03
...
| `["collection", "queries & updates", "(\"Set\", \"Any\", \"pop!\", \"specified\")"]` | 2.22 (25%) :x: | 1.00 (1%)  |
| `["collection", "queries & updates", "(\"Set\", \"Any\", \"push!\", \"new\")"]` | 1.98 (25%) :x: | 1.00 (1%)  |
| `["collection", "queries & updates", "(\"Set\", \"Any\", \"push!\", \"overwrite\")"]` | 2.30 (25%) :x: | 1.00 (1%)  |
...
| `["scalar", "cos", "(\"argument reduction (hard) abs(x) < 6π/4\", \"negative argument\", \"Float64\", \"sin_kernel\")"]` | 0.69 (5%) :white_check_mark: | 1.00 (1%)  |
...
| `["simd", "(\"axpy!\", \"Int32\", 4096)"]` | 1.21 (20%) :x: | 1.00 (1%)  |
...
| `["sparse", "index", "(\"spmat\", \"row\", \"OneTo\", 10)"]` | 0.58 (30%) :white_check_mark: | 1.00 (1%)  |
...
| `["union", "array", "(\"map\", abs, Bool, true)"]` | 0.87 (5%) :white_check_mark: | 1.00 (1%)  |
...
Platform Info:
  ...
  CPU: Intel(R) Xeon(R) CPU E3-1241 v3 @ 3.50GHz: 
       ...
       #1  3501 MHz  131067794 s       5056 s   15068352 s  6221151694 s         34 s
       #2  3501 MHz  981845473 s        217 s   19052151 s  5376121143 s         26 s
       #3  3501 MHz  115698912 s       3286 s    8952818 s  6252040154 s         37 s
       #4  3501 MHz  108553737 s         43 s   12861691 s  6253191058 s         26 s
       
  Memory: 31.383651733398438 GB (19658.5 MB free)
  Uptime: 6.3817079e7 sec
  Load Avg:  1.0830078125  1.0419921875  1.05224609375
  WORD_SIZE: 64
  LIBM: libopenlibm
