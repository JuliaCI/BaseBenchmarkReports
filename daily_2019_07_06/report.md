...
*Commit(s):* [JuliaLang/julia@e6379daa19c7da91f1cd6d3bcf5424f495d67d02](https://github.com/JuliaLang/julia/commit/e6379daa19c7da91f1cd6d3bcf5424f495d67d02)

*Triggered By:* [link](https://github.com/JuliaLang/julia/commit/e6379daa19c7da91f1cd6d3bcf5424f495d67d02#commitcomment-34203402)

*Tag Predicate:* `ALL`

*Daily Job:* 2019-07-06 vs 2019-07-05
...
| `["array", "index", "(\"mapr_access\", \"BaseBenchmarks.ArrayBenchmarks.ArrayLF{Float32,2}\")"]` | 1.60 (50%) :x: | 1.00 (1%)  |
| `["array", "index", "(\"sumcartesian\", \"1:100000\")"]` | 1.60 (50%) :x: | 1.00 (1%)  |
...
| `["collection", "deletion", "(\"Dict\", \"Int\", \"filter!\")"]` | 1.29 (25%) :x: | 1.00 (1%)  |
...
| `["collection", "deletion", "(\"Vector\", \"String\", \"filter!\")"]` | 0.67 (25%) :white_check_mark: | 1.00 (1%)  |
| `["collection", "deletion", "(\"Vector\", \"String\", \"filter\")"]` | 0.51 (25%) :white_check_mark: | 0.48 (1%) :white_check_mark: |
| `["collection", "queries & updates", "(\"Set\", \"String\", \"in\", \"true\")"]` | 1.30 (25%) :x: | 1.00 (1%)  |
| `["collection", "queries & updates", "(\"Set\", \"String\", \"push!\", \"new\")"]` | 0.75 (25%) :white_check_mark: | 1.00 (1%)  |
| `["collection", "set operations", "(\"Vector\", \"Int\", \"intersect\", \"BitSet\")"]` | 0.88 (25%)  | 1.76 (1%) :x: |
| `["collection", "set operations", "(\"Vector\", \"Int\", \"intersect\", \"BitSet\", \"BitSet\")"]` | 0.89 (25%)  | 1.75 (1%) :x: |
| `["collection", "set operations", "(\"Vector\", \"Int\", \"intersect\", \"Set\")"]` | 0.93 (25%)  | 1.76 (1%) :x: |
| `["collection", "set operations", "(\"Vector\", \"Int\", \"intersect\", \"Set\", \"Set\")"]` | 0.94 (25%)  | 1.75 (1%) :x: |
| `["collection", "set operations", "(\"Vector\", \"Int\", \"intersect\", \"Vector\")"]` | 0.93 (25%)  | 1.62 (1%) :x: |
| `["collection", "set operations", "(\"Vector\", \"Int\", \"intersect\", \"Vector\", \"Vector\")"]` | 0.94 (25%)  | 1.52 (1%) :x: |
| `["collection", "set operations", "(\"Vector\", \"Int\", \"setdiff\", \"BitSet\")"]` | 0.75 (25%) :white_check_mark: | 0.68 (1%) :white_check_mark: |
| `["collection", "set operations", "(\"Vector\", \"Int\", \"setdiff\", \"Set\")"]` | 0.74 (25%) :white_check_mark: | 0.68 (1%) :white_check_mark: |
| `["collection", "set operations", "(\"Vector\", \"Int\", \"setdiff\", \"Vector\")"]` | 0.74 (25%) :white_check_mark: | 0.68 (1%) :white_check_mark: |
...
| `["misc", "18129"]` | 1.00 (5%)  | 0.78 (1%) :white_check_mark: |
...
| `["random", "ranges", "(\"rand\", \"MersenneTwister\", \"Int32\", \"RangeGenerator(1:1)\")"]` | 2.53 (25%) :x: | 1.00 (1%)  |
| `["random", "ranges", "(\"rand\", \"MersenneTwister\", \"UInt64\", \"RangeGenerator(1:4294967297)\")"]` | 1.32 (25%) :x: | 1.00 (1%)  |
...
| `["scalar", "expm1", "(\"arg reduction II\", \"positive argument\", \"Float32\")"]` | 0.85 (5%) :white_check_mark: | 1.00 (1%)  |
...
| `["scalar", "predicate", "(\"isfinite\", \"Float32\")"]` | 1.31 (25%) :x: | 1.00 (1%)  |
...
| `["sparse", "constructors", "(\"Bidiagonal\", 10)"]` | 0.07 (5%) :white_check_mark: | 0.32 (1%) :white_check_mark: |
| `["sparse", "constructors", "(\"Bidiagonal\", 100)"]` | 0.08 (5%) :white_check_mark: | 0.30 (1%) :white_check_mark: |
| `["sparse", "constructors", "(\"Bidiagonal\", 1000)"]` | 0.15 (5%) :white_check_mark: | 0.29 (1%) :white_check_mark: |
...
| `["sparse", "constructors", "(\"SymTridiagonal\", 10)"]` | 0.07 (5%) :white_check_mark: | 0.31 (1%) :white_check_mark: |
| `["sparse", "constructors", "(\"SymTridiagonal\", 100)"]` | 0.13 (5%) :white_check_mark: | 0.29 (1%) :white_check_mark: |
| `["sparse", "constructors", "(\"SymTridiagonal\", 1000)"]` | 0.14 (5%) :white_check_mark: | 0.29 (1%) :white_check_mark: |
| `["sparse", "constructors", "(\"Tridiagonal\", 10)"]` | 0.07 (5%) :white_check_mark: | 0.31 (1%) :white_check_mark: |
| `["sparse", "constructors", "(\"Tridiagonal\", 100)"]` | 0.14 (5%) :white_check_mark: | 0.29 (1%) :white_check_mark: |
| `["sparse", "constructors", "(\"Tridiagonal\", 1000)"]` | 0.14 (5%) :white_check_mark: | 0.29 (1%) :white_check_mark: |
...
| `["union", "array", "(\"perf_simplecopy\", Int8, false)"]` | 0.94 (5%) :white_check_mark: | 1.00 (1%)  |
...
| `["union", "array", "(\"skipmissing\", sum, Int8, false)"]` | 1.10 (5%) :x: | 1.00 (1%)  |
...
```
Julia Version 1.3.0-DEV.519
Commit e6379da (2019-07-05 19:41 UTC)
Platform Info:
  ...
  CPU: Intel(R) Xeon(R) CPU E3-1241 v3 @ 3.50GHz: 
       ...
       #1  3501 MHz   91614173 s       5036 s   10536046 s  3911409879 s         26 s
       #2  3501 MHz  594267145 s        208 s   10046004 s  3415567584 s         22 s
       #3  3501 MHz   75024079 s       3239 s    6317324 s  3938466925 s         30 s
       #4  3501 MHz   70371646 s         17 s    8860012 s  3939006466 s         21 s
       
  Memory: 31.383651733398438 GB (5792.25390625 MB free)
  Uptime: 4.0228585e7 sec
