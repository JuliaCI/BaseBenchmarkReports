...
*Commit(s):* [JuliaLang/julia@b28496a7ae8cc0d7c3d175d2fba8757f2978d788](https://github.com/JuliaLang/julia/commit/b28496a7ae8cc0d7c3d175d2fba8757f2978d788)

*Triggered By:* [link](https://github.com/JuliaLang/julia/commit/b28496a7ae8cc0d7c3d175d2fba8757f2978d788#commitcomment-29394887)

*Tag Predicate:* `ALL`

*Daily Job:* 2018-06-18 vs 2018-06-17
...
| `["broadcast", "typeargs", "(\"tuple\", 10)"]` | 1.43 (15%) :x: | 1.00 (1%)  |
| `["collection", "deletion", "(\"Dict\", \"Any\", \"pop!\")"]` | 23.56 (25%) :x: | 1.00 (1%)  |
| `["collection", "deletion", "(\"Set\", \"Any\", \"pop!\")"]` | 23.41 (25%) :x: | 1.00 (1%)  |
| `["collection", "queries & updates", "(\"Dict\", \"Any\", \"pop!\", \"unspecified\")"]` | 16.85 (25%) :x: | 1.00 (1%)  |
| `["collection", "queries & updates", "(\"Set\", \"Any\", \"pop!\", \"unspecified\")"]` | 18.36 (25%) :x: | 1.00 (1%)  |
...
| `["misc", "bitshift", "(\"Int\", \"Int\")"]` | 0.67 (15%) :white_check_mark: | 1.00 (1%)  |
...
| `["scalar", "expm1", "(\"arg reduction I\", \"positive argument\", \"Float64\")"]` | 1.39 (15%) :x: | 1.00 (1%)  |
| `["scalar", "intfuncs", "(\"nextpow2\", \"BigInt\", \"+\")"]` | 1.45 (40%) :x: | 1.00 (1%)  |
| `["scalar", "intfuncs", "(\"nextpow2\", \"BigInt\", \"-\")"]` | 1.44 (40%) :x: | 1.00 (1%)  |
| `["scalar", "sin", "(\"argument reduction (easy) abs(x) < 9π/4\", \"negative argument\", \"Float32\", \"sin_kernel\")"]` | 0.81 (15%) :white_check_mark: | 1.00 (1%)  |
...
| `["union", "array", "(\"map\", abs, Complex{Float64}, false)"]` | 1.23 (15%) :x: | 1.00 (1%)  |
...
```
Julia Version 0.7.0-alpha.149
Commit b28496a (2018-06-18 03:27 UTC)
Platform Info:
  ...
  CPU: Intel(R) Xeon(R) CPU E3-1241 v3 @ 3.50GHz: 
       ...
       #1  3501 MHz   29659831 s        277 s    3194125 s  678578670 s          6 s
       #2  3501 MHz  129337623 s          0 s    1800118 s  582155416 s          3 s
       #3  3501 MHz   17018413 s       2375 s    1447428 s  694503249 s          9 s
       #4  3501 MHz   15956272 s          0 s    1708985 s  695444341 s          6 s
       
  Memory: 31.383651733398438 GB (4909.28125 MB free)
  Uptime: 7.136888e6 sec
