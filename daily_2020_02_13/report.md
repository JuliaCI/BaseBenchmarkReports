...
*Commit(s):* [JuliaLang/julia@83fd1e83a1a38a16dc9b570ca2c27b87b73e1486](https://github.com/JuliaLang/julia/commit/83fd1e83a1a38a16dc9b570ca2c27b87b73e1486)

*Triggered By:* [link](https://github.com/JuliaLang/julia/commit/83fd1e83a1a38a16dc9b570ca2c27b87b73e1486#commitcomment-37266753)

*Tag Predicate:* `ALL`

*Daily Job:* 2020-02-13 vs 2020-02-12
...
| `["collection", "queries & updates", "(\"Set\", \"Any\", \"in\", \"false\")"]` | 0.67 (25%) :white_check_mark: | 1.00 (1%)  |
| `["collection", "queries & updates", "(\"Set\", \"Any\", \"in\", \"true\")"]` | 0.54 (25%) :white_check_mark: | 1.00 (1%)  |
| `["collection", "queries & updates", "(\"Vector\", \"Int\", \"getindex\")"]` | 1.71 (25%) :x: | 1.00 (1%)  |
| `["find", "findall", "(\"BitArray{1}\", \"10-90\")"]` | 1.05 (5%) :x: | 1.00 (1%)  |
| `["find", "findprev", "(\"ispos\", \"Array{UInt64,1}\")"]` | 0.94 (5%) :white_check_mark: | 1.00 (1%)  |
| `["io", "array_limit", "(\"display\", \"Array{Float64,2}(10000, 10000)\")"]` | 0.89 (5%) :white_check_mark: | 0.91 (1%) :white_check_mark: |
...
| `["random", "ranges", "(\"RangeGenerator\", \"UInt64\", \"1:4294967295\")"]` | 2.11 (25%) :x: | 1.00 (1%)  |
...
| `["scalar", "atan2", "(\"abs(y/x) safe (large)\", \"y negative\", \"x positive\", \"Float32\")"]` | 0.72 (5%) :white_check_mark: | 1.00 (1%)  |
...
| `["string", "readuntil", "no backtracking"]` | 0.87 (5%) :white_check_mark: | 1.00 (1%)  |
| `["string", "readuntil", "target length 1"]` | 0.90 (5%) :white_check_mark: | 1.00 (1%)  |
| `["tuple", "linear algebra", "(\"matmat\", (8, 8), (8, 8))"]` | 1.94 (5%) :x: | 1.00 (1%)  |
...
| `["tuple", "reduction", "(\"sumabs\", (8,))"]` | 0.85 (5%) :white_check_mark: | 1.00 (1%)  |
...
| `["union", "array", "(\"broadcast\", *, Float64, (false, false))"]` | 1.74 (5%) :x: | 1.00 (1%)  |
...
| `["union", "array", "(\"broadcast\", abs, Int64, true)"]` | 0.86 (5%) :white_check_mark: | 1.00 (1%)  |
...
| `["union", "array", "(\"map\", abs, BigInt, true)"]` | 0.92 (5%) :white_check_mark: | 1.00 (1%)  |
| `["union", "array", "(\"map\", abs, Float32, true)"]` | 0.86 (5%) :white_check_mark: | 1.00 (1%)  |
| `["union", "array", "(\"map\", abs, Float64, true)"]` | 1.47 (5%) :x: | 1.00 (1%)  |
...
| `["union", "array", "(\"map\", identity, Float32, true)"]` | 1.15 (5%) :x: | 1.00 (1%)  |
| `["union", "array", "(\"map\", identity, Int64, false)"]` | 0.94 (5%) :white_check_mark: | 1.00 (1%)  |
| `["union", "array", "(\"map\", identity, Int64, true)"]` | 0.75 (5%) :white_check_mark: | 1.00 (1%)  |
...
| `["union", "array", "(\"perf_sum3\", Bool, true)"]` | 1.27 (5%) :x: | 1.00 (1%)  |
...
| `["union", "array", "(\"skipmissing\", sum, Union{Nothing, Int64}, false)"]` | 1.90 (5%) :x: | 1.00 (1%)  |
...
```
Julia Version 1.5.0-DEV.265
Commit 83fd1e8 (2020-02-12 21:48 UTC)
Platform Info:
  ...
  CPU: Intel(R) Xeon(R) CPU E3-1241 v3 @ 3.50GHz: 
       ...
       #1  3501 MHz  122821548 s       5052 s   14197075 s  5790982509 s         33 s
       #2  3501 MHz  910003626 s        217 s   17330837 s  5009724781 s         26 s
       #3  3501 MHz  107037066 s       3272 s    8421218 s  5821806885 s         36 s
       #4  3501 MHz  100356000 s         43 s   12104640 s  5822391602 s         26 s
       
  Memory: 31.383651733398438 GB (18745.1484375 MB free)
  Uptime: 5.9415092e7 sec
