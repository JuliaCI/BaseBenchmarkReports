...
*Commit(s):* [JuliaLang/julia@b4c370dd05ac33d0c8c02b440b861e8582d1fc74](https://github.com/JuliaLang/julia/commit/b4c370dd05ac33d0c8c02b440b861e8582d1fc74)

*Triggered By:* [link](https://github.com/JuliaLang/julia/commit/b4c370dd05ac33d0c8c02b440b861e8582d1fc74#commitcomment-30488508)

*Tag Predicate:* `ALL`

*Daily Job:* 2018-09-13 vs 2018-09-12
...
| `["array", "reductions", "(\"Statistics.mean\", \"Float64\")"]` | 0.92 (5%) :white_check_mark: | 1.00 (1%)  |
...
| `["array", "reductions", "(\"sum\", \"Int64\")"]` | 0.91 (5%) :white_check_mark: | 1.00 (1%)  |
...
| `["array", "setindex!", "(\"setindex!\", 1)"]` | 0.46 (5%) :white_check_mark: | 1.00 (1%)  |
| `["array", "setindex!", "(\"setindex!\", 2)"]` | 0.44 (5%) :white_check_mark: | 1.00 (1%)  |
| `["array", "setindex!", "(\"setindex!\", 3)"]` | 0.46 (5%) :white_check_mark: | 1.00 (1%)  |
| `["array", "setindex!", "(\"setindex!\", 4)"]` | 0.46 (5%) :white_check_mark: | 1.00 (1%)  |
| `["array", "setindex!", "(\"setindex!\", 5)"]` | 0.45 (5%) :white_check_mark: | 1.00 (1%)  |
...
| `["broadcast", "fusion", "(\"Float64\", (1000, 1000), 3)"]` | 0.90 (5%) :white_check_mark: | 1.00 (1%)  |
...
| `["collection", "iteration", "(\"Vector\", \"Int\", \"iterate\")"]` | 0.58 (25%) :white_check_mark: | 1.00 (1%)  |
| `["collection", "set operations", "(\"BitSet\", \"Int\", \"union\", \"Vector\")"]` | 0.69 (25%) :white_check_mark: | 1.00 (1%)  |
| `["dates", "accessor", "hour"]` | 1.31 (5%) :x: | 1.00 (1%)  |
...
| `["find", "findnext", "(\"ispos\", \"Array{UInt8,1}\")"]` | 1.12 (5%) :x: | 1.00 (1%)  |
| `["find", "findprev", "(\"ispos\", \"Array{Bool,1}\")"]` | 1.06 (5%) :x: | 1.00 (1%)  |
| `["find", "findprev", "(\"ispos\", \"Array{Int8,1}\")"]` | 1.19 (5%) :x: | 1.00 (1%)  |
...
| `["scalar", "atan2", "(\"y infinite\", \"y positive\", \"x infinite\", \"x negative\", \"Float32\")"]` | 0.89 (5%) :white_check_mark: | 1.00 (1%)  |
...
| `["scalar", "expm1", "(\"huge\", \"positive argument\", \"Float64\")"]` | 1.53 (5%) :x: | 1.00 (1%)  |
...
| `["scalar", "sin", "(\"argument reduction (hard) abs(x) < 6π/4\", \"positive argument\", \"Float32\", \"cos_kernel\")"]` | 1.14 (5%) :x: | 1.00 (1%)  |
...
| `["scalar", "sin", "(\"argument reduction (hard) abs(x) < 8π/4\", \"positive argument\", \"Float32\", \"sin_kernel\")"]` | 1.14 (5%) :x: | 1.00 (1%)  |
...
| `["scalar", "sin", "(\"no reduction\", \"negative argument\", \"Float32\", \"sin_kernel\")"]` | 1.20 (5%) :x: | 1.00 (1%)  |
...
```
Julia Version 1.1.0-DEV.247
Commit b4c370d (2018-09-12 21:35 UTC)
Platform Info:
  ...
  CPU: Intel(R) Xeon(R) CPU E3-1241 v3 @ 3.50GHz: 
       ...
       #1  3501 MHz   49293865 s       4998 s    5378985 s  1406900112 s         19 s
       #2  3501 MHz  233392499 s        203 s    3634124 s  1227134218 s          9 s
       #3  3501 MHz   33643634 s       3198 s    2967881 s  1427553082 s         22 s
       #4  3501 MHz   31260254 s          0 s    3634194 s  1429083432 s         10 s
       
  Memory: 31.383651733398438 GB (4957.28125 MB free)
  Uptime: 1.4654494e7 sec
