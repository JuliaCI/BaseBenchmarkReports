...
*Commit(s):* [JuliaLang/julia@f39cdc0c7da8230b102051681c9378ce15d90235](https://github.com/JuliaLang/julia/commit/f39cdc0c7da8230b102051681c9378ce15d90235)

*Triggered By:* [link](https://github.com/JuliaLang/julia/commit/f39cdc0c7da8230b102051681c9378ce15d90235#commitcomment-36186706)

*Tag Predicate:* `ALL`

*Daily Job:* 2019-11-29 vs 2019-11-28
...
| `["misc", "fastmath many args"]` | 1.70 (5%) :x: | 1.00 (1%)  |
| `["misc", "repeat", "(200, 1, 24)"]` | 0.88 (5%) :white_check_mark: | 1.00 (1%)  |
| `["problem", "seismic", "(\"seismic\", \"Float64\")"]` | 1.07 (5%) :x: | 1.00 (1%)  |
| `["random", "ranges", "(\"RangeGenerator\", \"UInt64\", \"1:4294967295\")"]` | 1.35 (25%) :x: | 1.00 (1%)  |
...
| `["scalar", "arithmetic", "(\"rem type\", \"Bool\", \"BigInt\")"]` | 2.04 (40%) :x: | 1.00 (1%)  |
| `["scalar", "arithmetic", "(\"sub\", \"Complex{BigInt}\", \"BigInt\")"]` | 1.52 (50%) :x: | 1.00 (1%)  |
...
| `["scalar", "atan2", "(\"abs(y/x) small\", \"y positive\", \"x positive\", \"Float64\")"]` | 0.55 (5%) :white_check_mark: | 1.00 (1%)  |
...
| `["scalar", "cosh", "(\"0 <= abs(x) < 2.7755602085408512e-17\", \"positive argument\", \"Float64\")"]` | 1.47 (5%) :x: | 1.00 (1%)  |
...
| `["scalar", "sin", "(\"argument reduction (easy) abs(x) < 5π/4\", \"positive argument\", \"Float32\", \"sin_kernel\")"]` | 0.75 (5%) :white_check_mark: | 1.00 (1%)  |
...
| `["tuple", "reduction", "(\"sumabs\", (4,))"]` | 1.56 (5%) :x: | 1.00 (1%)  |
...
| `["union", "array", "(\"skipmissing\", collect, Union{Missing, Int8}, true)"]` | 1.07 (5%) :x: | 1.00 (1%)  |
...
| `["union", "array", "(\"sort\", Bool, false)"]` | 1.09 (5%) :x: | 1.00 (1%)  |
...
```
Julia Version 1.4.0-DEV.531
Commit f39cdc0 (2019-11-29 01:27 UTC)
Platform Info:
  ...
  CPU: Intel(R) Xeon(R) CPU E3-1241 v3 @ 3.50GHz: 
       ...
       #1  3501 MHz  110686902 s       5048 s   12904857 s  5149129030 s         31 s
       #2  3501 MHz  798462974 s        217 s   14593473 s  4467763225 s         26 s
       #3  3501 MHz   94631724 s       3258 s    7642606 s  5178749304 s         34 s
       #4  3501 MHz   88681516 s         34 s   10939260 s  5179237809 s         24 s
       
  Memory: 31.383651733398438 GB (14913.19921875 MB free)
  Uptime: 5.284796e7 sec
