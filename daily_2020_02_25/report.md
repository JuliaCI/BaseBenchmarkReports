...
*Commit(s):* [JuliaLang/julia@ef0e0f2923fbbf6f88d01d9a8f97d62c0c33bdbd](https://github.com/JuliaLang/julia/commit/ef0e0f2923fbbf6f88d01d9a8f97d62c0c33bdbd)

*Triggered By:* [link](https://github.com/JuliaLang/julia/commit/ef0e0f2923fbbf6f88d01d9a8f97d62c0c33bdbd#commitcomment-37469060)
...
| `["io", "array_limit", "(\"display\", \"Array{Float64,2}(10000, 10000)\")"]` | 1.19 (5%) :x: | 1.14 (1%) :x: |
...
| `["parallel", "remotecall", "(\"identity\", 1024)"]` | 0.97 (5%)  | 0.98 (1%) :white_check_mark: |
...
| `["random", "collections", "(\"rand\", \"RandomDevice\", \"small String\")"]` | 1.40 (25%) :x: | 1.00 (1%)  |
...
| `["random", "types", "(\"rand\", \"ImplicitRNG\", \"Float64\")"]` | 1.35 (25%) :x: | 1.00 (1%)  |
| `["random", "types", "(\"randexp\", \"RandomDevice\", \"Float64\")"]` | 1.38 (25%) :x: | 1.00 (1%)  |
...
| `["scalar", "arithmetic", "(\"rem type\", \"UInt64\", \"BigInt\")"]` | 1.65 (40%) :x: | 1.00 (1%)  |
| `["scalar", "arithmetic", "(\"sub\", \"BigInt\", \"Complex{Float64}\")"]` | 1.56 (50%) :x: | 1.00 (1%)  |
...
| `["scalar", "atan", "(\"very large\", \"positive argument\", \"Float32\")"]` | 1.67 (5%) :x: | 1.00 (1%)  |
...
| `["sparse", "index", "(\"spmat\", \"OneTo\", 10)"]` | 1.32 (30%) :x: | 1.00 (1%)  |
...
| `["tuple", "index", "(\"sumelt\", \"NTuple\", 8, Float32)"]` | 1.50 (40%) :x: | 1.00 (1%)  |
...
| `["union", "array", "(\"map\", identity, Complex{Float64}, true)"]` | 1.25 (5%) :x: | 1.00 (1%)  |
...
| `["union", "array", "(\"perf_sum2\", Float64, true)"]` | 0.74 (5%) :white_check_mark: | 1.00 (1%)  |
...
```
Julia Version 1.5.0-DEV.338
Commit ef0e0f2 (2020-02-24 22:36 UTC)
Platform Info:
  ...
  CPU: Intel(R) Xeon(R) CPU E3-1241 v3 @ 3.50GHz: 
       ...
       #1  3501 MHz  124646667 s       5052 s   14409870 s  5892360505 s         33 s
       #2  3501 MHz  925562299 s        217 s   17722083 s  5097350246 s         26 s
       #3  3501 MHz  108957458 s       3277 s    8522443 s  5923324074 s         36 s
       #4  3501 MHz  102114951 s         43 s   12266664 s  5924023887 s         26 s
       
  Memory: 31.383651733398438 GB (18827.0 MB free)
  Uptime: 6.045154e7 sec
