...
*Triggered By:* [link](https://github.com/JuliaLang/julia/commit/d0365753fb57f57bcea097c05de8c07aef706561#commitcomment-35283983)

*Tag Predicate:* `ALL`

*Daily Job:* 2019-09-29 vs 2019-09-25
...
| `["array", "setindex!", "(\"setindex!\", 5)"]` | 1.79 (5%) :x: | 1.00 (1%)  |
...
| `["collection", "iteration", "(\"Set\", \"Int\", \"iterate second\")"]` | 1.44 (25%) :x: | 1.00 (1%)  |
| `["collection", "iteration", "(\"Set\", \"Int\", \"iterate\")"]` | 1.47 (25%) :x: | 1.00 (1%)  |
| `["collection", "queries & updates", "(\"Set\", \"Any\", \"in\", \"true\")"]` | 1.35 (25%) :x: | 1.00 (1%)  |
| `["collection", "queries & updates", "(\"Set\", \"Int\", \"first\")"]` | 1.42 (25%) :x: | 1.00 (1%)  |
...
| `["random", "types", "(\"randexp!\", \"ImplicitRNG\", \"Float64\")"]` | 1.36 (25%) :x: | 1.00 (1%)  |
...
| `["scalar", "atanh", "(\"very small\", \"positive argument\", \"Float32\")"]` | 1.63 (5%) :x: | 1.00 (1%)  |
...
| `["string", "readuntil", "barbarian backtrack"]` | 1.22 (5%) :x: | 1.00 (1%)  |
...
Platform Info:
  ...
  CPU: Intel(R) Xeon(R) CPU E3-1241 v3 @ 3.50GHz: 
       ...
       #1  3501 MHz  102514136 s       5044 s   11913022 s  4637022742 s         28 s
       #2  3501 MHz  706665104 s        212 s   12472250 s  4039684437 s         24 s
       #3  3501 MHz   86052861 s       3254 s    7068654 s  4665809388 s         33 s
       #4  3501 MHz   80768916 s         27 s   10061924 s  4666175180 s         22 s
       
  Memory: 31.383651733398438 GB (14713.4375 MB free)
  Uptime: 4.7623854e7 sec
