...
*Commit(s):* [JuliaLang/julia@2931ff9a146f1d0ec93e2e7a07d5ff12d3adb7e6](https://github.com/JuliaLang/julia/commit/2931ff9a146f1d0ec93e2e7a07d5ff12d3adb7e6) vs [JuliaLang/julia@576769a6eef04ba018a93405ce39c4ad18ef32e3](https://github.com/JuliaLang/julia/commit/576769a6eef04ba018a93405ce39c4ad18ef32e3)

*Triggered By:* [link](https://github.com/JuliaLang/julia/pull/35384#issuecomment-655602685)
...
| `["array", "convert", "(\"Int\", \"Float64\")"]` | 0.83 (5%) :white_check_mark: | 1.00 (1%)  |
| `["array", "equality", "(\"==\", \"Vector{Float32}\")"]` | 0.85 (5%) :white_check_mark: | 1.00 (1%)  |
| `["array", "equality", "(\"==\", \"Vector{Int64}\")"]` | 0.91 (5%) :white_check_mark: | 1.00 (1%)  |
| `["array", "equality", "(\"isequal\", \"Vector{Int64} isequal Vector{Float32}\")"]` | 1.33 (5%) :x: | 1.00 (1%)  |
...
| `["collection", "deletion", "(\"Set\", \"Any\", \"pop!\")"]` | 1.67 (25%) :x: | 1.00 (1%)  |
...
| `["parallel", "remotecall", "(\"identity\", 2)"]` | 0.90 (5%) :white_check_mark: | 1.00 (1%)  |
...
| `["parallel", "remotecall", "(\"identity\", 64)"]` | 0.91 (5%) :white_check_mark: | 1.00 (1%)  |
| `["problem", "grigoriadis khachiyan", "grigoriadis_khachiyan"]` | 0.93 (5%) :white_check_mark: | 1.00 (1%)  |
| `["problem", "json", "parse_json"]` | 0.72 (5%) :white_check_mark: | 1.00 (1%)  |
...
| `["scalar", "cos", "(\"argument reduction (hard) abs(x) < 8π/4\", \"negative argument\", \"Float32\", \"cos_kernel\")"]` | 0.91 (5%) :white_check_mark: | 1.00 (1%)  |
...
| `["scalar", "sinh", "(\"22.0 <= abs(x) < 709.7822265633563\", \"negative argument\", \"Float64\")"]` | 0.85 (5%) :white_check_mark: | 1.00 (1%)  |
...
| `["sparse", "constructors", "(\"IV\", 100)"]` | 1.34 (5%) :x: | 1.00 (1%)  |
...
| `["union", "array", "(\"broadcast\", identity, ComplexF64, true)"]` | 0.71 (5%) :white_check_mark: | 1.00 (1%)  |
...
| `["union", "array", "(\"map\", identity, ComplexF64, true)"]` | 0.79 (5%) :white_check_mark: | 1.00 (1%)  |
...
| `["union", "array", "(\"perf_sum2\", Float64, true)"]` | 0.70 (5%) :white_check_mark: | 1.00 (1%)  |
...
| `["union", "array", "(\"skipmissing\", sum, Union{Nothing, ComplexF64}, false)"]` | 0.58 (5%) :white_check_mark: | 1.00 (1%)  |
...
Commit 2931ff9 (2020-07-08 15:49 UTC)
Platform Info:
  ...
  CPU: Intel(R) Xeon(R) CPU E3-1241 v3 @ 3.50GHz: 
       ...
       #1  3501 MHz   60360814 s       2454 s   21928764 s  7100928487 s         21 s
       #2  3501 MHz  383081429 s         62 s    8126391 s  6811012479 s         29 s
       #3  3501 MHz   51496240 s       3252 s    6046999 s  7143336277 s         40 s
       #4  3501 MHz   49599123 s         19 s    4618242 s  7150845342 s         39 s
       
  Memory: 31.383651733398438 GB (21306.109375 MB free)
  Uptime: 7.206988e7 sec
...
```
Julia Version 1.6.0-DEV.404
Commit 576769a (2020-07-08 12:56 UTC)
Platform Info:
  OS: Linux (x86_64-linux-gnu)
      Ubuntu 14.04.5 LTS
  uname: Linux 3.13.0-85-generic #129-Ubuntu SMP Thu Mar 17 20:50:15 UTC 2016 x86_64 x86_64
  CPU: Intel(R) Xeon(R) CPU E3-1241 v3 @ 3.50GHz: 
              speed         user         nice          sys         idle          irq
       #1  3501 MHz   60499553 s       2454 s   21939064 s  7102203243 s         21 s
       #2  3501 MHz  384397634 s         62 s    8153189 s  6811097391 s         29 s
       #3  3501 MHz   51666685 s       3252 s    6053371 s  7144587700 s         40 s
       #4  3501 MHz   49745598 s         19 s    4624066 s  7152121652 s         39 s
       
  Memory: 31.383651733398438 GB (19800.28125 MB free)
  Uptime: 7.208417e7 sec
  Load Avg:  1.0029296875  1.0146484375  1.04541015625
  WORD_SIZE: 64
  LIBM: libopenlibm
  LLVM: libLLVM-9.0.1 (ORCJIT, haswell)
