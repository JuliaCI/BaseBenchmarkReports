...
*Commit(s):* [tkf/julia@4ef7eb8692c1b5a29c07fb574c19cf1d26d9c09b](https://github.com/tkf/julia/commit/4ef7eb8692c1b5a29c07fb574c19cf1d26d9c09b) vs [JuliaLang/julia@464397e7141d744cb95da8f9b3e8b1d5c7062b9f](https://github.com/JuliaLang/julia/commit/464397e7141d744cb95da8f9b3e8b1d5c7062b9f)

*Triggered By:* [link](https://github.com/JuliaLang/julia/pull/29634#issuecomment-440591703)
...
| `["array", "comprehension", "(\"collect\", \"Array{Float64,1}\")"]` | 1.71 (5%) :x: | 1.00 (1%)  |
| `["array", "comprehension", "(\"collect\", \"StepRangeLen{Float64,Base.TwicePrecision{Float64},Base.TwicePrecision{Float64}}\")"]` | 1.38 (5%) :x: | 1.00 (1%)  |
| `["array", "comprehension", "(\"comprehension_collect\", \"Array{Float64,1}\")"]` | 1.59 (5%) :x: | 1.00 (1%)  |
| `["array", "comprehension", "(\"comprehension_collect\", \"StepRangeLen{Float64,Base.TwicePrecision{Float64},Base.TwicePrecision{Float64}}\")"]` | 1.37 (5%) :x: | 1.00 (1%)  |
...
| `["array", "subarray", "(\"lucompletepivCopy!\", 1000)"]` | 1.19 (5%) :x: | 1.00 (1%)  |
...
| `["collection", "iteration", "(\"IdDict\", \"String\", \"iterate\")"]` | 1.43 (25%) :x: | 1.00 (1%)  |
| `["collection", "queries & updates", "(\"Dict\", \"String\", \"getindex\")"]` | 1.28 (25%) :x: | 1.00 (1%)  |
| `["collection", "queries & updates", "(\"Set\", \"Any\", \"push!\", \"overwrite\")"]` | 1.39 (25%) :x: | 1.00 (1%)  |
...
| `["find", "findnext", "(\"ispos\", \"Array{Float64,1}\")"]` | 0.83 (5%) :white_check_mark: | 1.00 (1%)  |
| `["find", "findprev", "(\"ispos\", \"Array{Int64,1}\")"]` | 1.08 (5%) :x: | 1.00 (1%)  |
| `["find", "findprev", "(\"ispos\", \"Array{Int8,1}\")"]` | 1.14 (5%) :x: | 1.00 (1%)  |
| `["linalg", "arithmetic", "(\"sqrt\", \"NPDUpperTriangular\", 1024)"]` | 2.10 (45%) :x: | 1.00 (1%)  |
...
| `["random", "collections", "(\"rand\", \"MersenneTwister\", \"large Vector\")"]` | 1.33 (25%) :x: | 1.00 (1%)  |
| `["random", "collections", "(\"rand\", \"MersenneTwister\", \"small Dict\")"]` | 1.36 (25%) :x: | 1.00 (1%)  |
| `["random", "ranges", "(\"rand\", \"MersenneTwister\", \"BigInt\", \"RangeGenerator(1:4294967295)\")"]` | 1.30 (25%) :x: | 1.00 (1%)  |
| `["random", "ranges", "(\"rand\", \"MersenneTwister\", \"Int128\", \"RangeGenerator(1:18446744073709551616)\")"]` | 0.71 (25%) :white_check_mark: | 1.00 (1%)  |
| `["random", "types", "(\"randexp\", \"MersenneTwister\", \"Float16\")"]` | 1.29 (25%) :x: | 1.00 (1%)  |
...
| `["sparse", "index", "(\"spmat\", \"integer\", 1000)"]` | 1.37 (30%) :x: | 1.00 (1%)  |
...
| `["union", "array", "(\"broadcast\", *, BigInt, (false, false))"]` | 0.73 (5%) :white_check_mark: | 1.00 (1%)  |
...
| `["union", "array", "(\"broadcast\", identity, Float32, false)"]` | 0.93 (5%) :white_check_mark: | 1.00 (1%)  |
...
| `["union", "array", "(\"map\", *, BigInt, (true, true))"]` | 0.81 (5%) :white_check_mark: | 1.00 (1%)  |
...
| `["union", "array", "(\"perf_simplecopy\", Float32, true)"]` | 1.24 (5%) :x: | 1.00 (1%)  |
...
| `["union", "array", "(\"perf_sum4\", BigInt, true)"]` | 0.83 (5%) :white_check_mark: | 1.00 (1%)  |
...
| `["union", "array", "(\"skipmissing\", sum, Complex{Float64}, true)"]` | 0.91 (5%) :white_check_mark: | 1.00 (1%)  |
| `["union", "array", "(\"skipmissing\", sum, Float32, true)"]` | 1.26 (5%) :x: | 1.00 (1%)  |
...
```
Julia Version 1.1.0-DEV.735
Commit 4ef7eb8 (2018-11-21 06:30 UTC)
Platform Info:
  ...
  CPU: Intel(R) Xeon(R) CPU E3-1241 v3 @ 3.50GHz: 
       ...
       #1  3501 MHz   38677681 s       2414 s    6657361 s  2011852528 s         10 s
       #2  3501 MHz  207058420 s         14 s    3713451 s  1851040062 s         16 s
       #3  3501 MHz   29797302 s       3136 s    3415450 s  2028492037 s         24 s
       #4  3501 MHz   28610966 s         11 s    2698345 s  2031335030 s         19 s
       
  Memory: 31.383651733398438 GB (4754.4453125 MB free)
  Uptime: 2.0635587e7 sec
...
```
Julia Version 1.1.0-DEV.700
Commit 464397e (2018-11-21 05:14 UTC)
Platform Info:
  OS: Linux (x86_64-linux-gnu)
      Ubuntu 14.04.5 LTS
  uname: Linux 3.13.0-85-generic #129-Ubuntu SMP Thu Mar 17 20:50:15 UTC 2016 x86_64 x86_64
  CPU: Intel(R) Xeon(R) CPU E3-1241 v3 @ 3.50GHz: 
              speed         user         nice          sys         idle          irq
       #1  3501 MHz   38792080 s       2414 s    6668370 s  2012946620 s         10 s
       #2  3501 MHz  208205843 s         14 s    3729418 s  1851099915 s         16 s
       #3  3501 MHz   29923016 s       3136 s    3422589 s  2029582451 s         24 s
       #4  3501 MHz   28720527 s         11 s    2705069 s  2032442215 s         19 s
       
  Memory: 31.383651733398438 GB (4365.9609375 MB free)
  Uptime: 2.0647827e7 sec
  Load Avg:  1.0029296875  1.0146484375  1.04541015625
  WORD_SIZE: 64
  LIBM: libopenlibm
  LLVM: libLLVM-6.0.1 (ORCJIT, haswell)
