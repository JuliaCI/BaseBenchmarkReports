...
*Commit(s):* [JuliaLang/julia@98ee67c4c9e0fc21d56641511d15c505d8eddd28](https://github.com/JuliaLang/julia/commit/98ee67c4c9e0fc21d56641511d15c505d8eddd28)

*Triggered By:* [link](https://github.com/JuliaLang/julia/commit/98ee67c4c9e0fc21d56641511d15c505d8eddd28#commitcomment-38451792)
...
| `["array", "growth", "(\"prerend!\", 8)"]` | 1.24 (5%) :x: | 1.00 (1%)  |
...
| `["collection", "queries & updates", "(\"BitSet\", \"Int\", \"first\")"]` | 1.33 (25%) :x: | 1.00 (1%)  |
| `["collection", "queries & updates", "(\"Dict\", \"String\", \"in\", \"true\")"]` | 1.91 (25%) :x: | 1.00 (1%)  |
| `["collection", "queries & updates", "(\"Set\", \"Any\", \"push!\", \"overwrite\")"]` | 1.26 (25%) :x: | 1.00 (1%)  |
| `["dates", "query", "(\"daysofweekinmonth\", \"Date\")"]` | 1.35 (25%) :x: | 1.00 (1%)  |
...
| `["misc", "fastmath many args"]` | 1.75 (5%) :x: | 1.00 (1%)  |
...
| `["scalar", "arithmetic", "(\"rem type\", \"UInt64\", \"BigInt\")"]` | 2.04 (40%) :x: | 1.00 (1%)  |
...
| `["scalar", "cos", "(\"argument reduction (easy) abs(x) < 3π/4\", \"positive argument\", \"Float64\", \"sin_kernel\")"]` | 1.58 (5%) :x: | 1.00 (1%)  |
...
| `["scalar", "cos", "(\"argument reduction (easy) abs(x) < 6π/4\", \"positive argument\", \"Float32\", \"sin_kernel\")"]` | 0.69 (5%) :white_check_mark: | 1.00 (1%)  |
...
| `["simd", "(\"auto_axpy!\", \"Int32\", 4095)"]` | 1.25 (20%) :x: | 1.00 (1%)  |
| `["simd", "(\"auto_axpy!\", \"Int32\", 4096)"]` | 1.25 (20%) :x: | 1.00 (1%)  |
...
| `["sparse", "index", "(\"spmat\", \"integer\", 1000)"]` | 2.00 (30%) :x: | 1.00 (1%)  |
...
| `["union", "array", "(\"map\", abs, Float64, true)"]` | 1.41 (5%) :x: | 1.00 (1%)  |
...
| `["union", "array", "(\"skipmissing\", collect, Union{Nothing, Complex{Float64}}, false)"]` | 0.95 (5%) :white_check_mark: | 1.00 (1%)  |
...
```
Julia Version 1.5.0-DEV.617
Commit 98ee67c (2020-04-13 00:32 UTC)
Platform Info:
  ...
  CPU: Intel(R) Xeon(R) CPU E3-1241 v3 @ 3.50GHz: 
       ...
       #1  3501 MHz  133029656 s       5056 s   15241574 s  6296619390 s         35 s
       #2  3501 MHz  998388066 s        217 s   19445204 s  5436907310 s         26 s
       #3  3501 MHz  117640987 s       3291 s    9055972 s  6327564225 s         37 s
       #4  3501 MHz  110427377 s         43 s   13019365 s  6328835650 s         26 s
       
  Memory: 31.383651733398438 GB (19038.14453125 MB free)
  Uptime: 6.4594707e7 sec
