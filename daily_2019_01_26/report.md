...
*Commit(s):* [JuliaLang/julia@b0427fc1b44adf8069e23e5bbaba194148eda4e5](https://github.com/JuliaLang/julia/commit/b0427fc1b44adf8069e23e5bbaba194148eda4e5)

*Triggered By:* [link](https://github.com/JuliaLang/julia/commit/b0427fc1b44adf8069e23e5bbaba194148eda4e5#commitcomment-32074263)

*Tag Predicate:* `ALL`

*Daily Job:* 2019-01-26 vs 2019-01-25
...
| `["array", "reductions", "(\"Statistics.mean\", \"Float64\")"]` | 0.94 (5%) :white_check_mark: | 1.00 (1%)  |
...
| `["collection", "optimizations", "(\"Set\", \"abstract\", \"Nothing\")"]` | 0.70 (25%) :white_check_mark: | 1.00 (1%)  |
...
| `["collection", "queries & updates", "(\"Dict\", \"Int\", \"push!\", \"new\")"]` | 0.61 (25%) :white_check_mark: | 1.00 (1%)  |
...
| `["find", "findnext", "(\"ispos\", \"Array{Float32,1}\")"]` | 1.12 (5%) :x: | 1.00 (1%)  |
...
| `["random", "collections", "(\"rand\", \"ImplicitRNG\", \"large Set\")"]` | 1.35 (25%) :x: | 1.00 (1%)  |
...
| `["scalar", "expm1", "(\"large\", \"negative argument\", \"Float32\")"]` | 1.16 (5%) :x: | 1.00 (1%)  |
...
| `["simd", "(\"loop_fields!\", \"Float32\", \"BaseBenchmarks.SIMDBenchmarks.ImmutableFields\", 4095)"]` | 1.23 (20%) :x: | 1.00 (1%)  |
...
| `["sparse", "index", "(\"spmat\", \"row\", \"array\", 1000)"]` | 1.84 (30%) :x: | 1.00 (1%)  |
| `["sparse", "index", "(\"spmat\", \"row\", \"logical\", 1000)"]` | 2.07 (30%) :x: | 1.00 (1%)  |
| `["sparse", "matmul", "(\"At_mul_B!\", \"dense 40x4000, sparse 40x40 -> dense 4000x40\")"]` | 1.68 (30%) :x: | 1.00 (1%)  |
...
| `["union", "array", "(\"perf_sum4\", BigInt, true)"]` | 0.91 (5%) :white_check_mark: | 1.00 (1%)  |
...
| `["union", "array", "(\"perf_sum\", Int8, true)"]` | 0.78 (5%) :white_check_mark: | 1.00 (1%)  |
| `["union", "array", "(\"skipmissing\", collect, Float64, false)"]` | 0.94 (5%) :white_check_mark: | 1.00 (1%)  |
| `["union", "array", "(\"skipmissing\", sum, Union{Missing, Bool}, true)"]` | 0.87 (5%) :white_check_mark: | 1.00 (1%)  |
...
Platform Info:
  ...
  CPU: Intel(R) Xeon(R) CPU E3-1241 v3 @ 3.50GHz: 
       ...
       #1  3501 MHz   73321659 s       5014 s    8176204 s  2546221887 s         23 s
       #2  3501 MHz  429283938 s        203 s    7066879 s  2195712556 s         19 s
       #3  3501 MHz   56868914 s       3224 s    4803384 s  2570291012 s         26 s
       #4  3501 MHz   53233197 s          2 s    6221083 s  2571883794 s         17 s
       
  Memory: 31.383651733398438 GB (5018.18359375 MB free)
  Uptime: 2.6341778e7 sec
