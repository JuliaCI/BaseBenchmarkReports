...
*Commit(s):* [JuliaLang/julia@1d918dd8d5bf6316458f4ea480d521ac005713b0](https://github.com/JuliaLang/julia/commit/1d918dd8d5bf6316458f4ea480d521ac005713b0)

*Triggered By:* [link](https://github.com/JuliaLang/julia/commit/1d918dd8d5bf6316458f4ea480d521ac005713b0#commitcomment-37032921)

*Tag Predicate:* `ALL`

*Daily Job:* 2020-01-30 vs 2020-01-29
...
| `["find", "findall", "(\"Array{Bool,1}\", \"50-50\")"]` | 0.84 (5%) :white_check_mark: | 1.00 (1%)  |
...
| `["io", "array_limit", "(\"display\", \"Array{Float64,2}(10000, 10000)\")"]` | 0.86 (5%) :white_check_mark: | 0.91 (1%) :white_check_mark: |
...
| `["random", "ranges", "(\"RangeGenerator\", \"Int128\", \"1:4294967297\")"]` | 1.79 (25%) :x: | 1.00 (1%)  |
...
| `["random", "types", "(\"randn!\", \"ImplicitRNG\", \"Float64\")"]` | 1.38 (25%) :x: | 1.00 (1%)  |
...
| `["scalar", "arithmetic", "(\"rem type\", \"Char\", \"BigInt\")"]` | 1.45 (40%) :x: | 1.00 (1%)  |
| `["scalar", "asinh", "(\"very large\", \"positive argument\", \"Float64\")"]` | 0.93 (5%) :white_check_mark: | 1.00 (1%)  |
| `["scalar", "atan", "(\"7/16 <= abs(x) < 11/16\", \"negative argument\", \"Float64\")"]` | 1.61 (5%) :x: | 1.00 (1%)  |
...
| `["scalar", "exp2", "(\"very small\", \"positive argument\", \"Float64\")"]` | 0.88 (5%) :white_check_mark: | 1.00 (1%)  |
...
| `["scalar", "sin", "(\"no reduction\", \"zero\", \"Float64\")"]` | 2.07 (5%) :x: | 1.00 (1%)  |
| `["scalar", "sincos", "(\"argument reduction (easy) abs(x) < 2π/4\", \"negative argument\", \"Float32\")"]` | 0.94 (5%) :white_check_mark: | 1.00 (1%)  |
| `["scalar", "sincos", "(\"argument reduction (easy) abs(x) < 4π/4\", \"negative argument\", \"Float32\")"]` | 0.87 (5%) :white_check_mark: | 1.00 (1%)  |
...
| `["union", "array", "(\"broadcast\", abs, Bool, true)"]` | 1.17 (5%) :x: | 1.00 (1%)  |
| `["union", "array", "(\"broadcast\", abs, Complex{Float64}, false)"]` | 1.08 (5%) :x: | 1.00 (1%)  |
| `["union", "array", "(\"broadcast\", abs, Float64, true)"]` | 1.16 (5%) :x: | 1.00 (1%)  |
| `["union", "array", "(\"broadcast\", abs, Int64, true)"]` | 1.15 (5%) :x: | 1.00 (1%)  |
| `["union", "array", "(\"broadcast\", identity, BigFloat, true)"]` | 1.15 (5%) :x: | 1.00 (1%)  |
...
| `["union", "array", "(\"broadcast\", identity, Int64, true)"]` | 1.33 (5%) :x: | 1.00 (1%)  |
| `["union", "array", "(\"broadcast\", identity, Int8, true)"]` | 0.86 (5%) :white_check_mark: | 1.00 (1%)  |
...
| `["union", "array", "(\"map\", abs, BigFloat, false)"]` | 0.95 (5%) :white_check_mark: | 1.00 (1%)  |
...
| `["union", "array", "(\"map\", identity, Bool, true)"]` | 1.11 (5%) :x: | 1.00 (1%)  |
...
| `["union", "array", "(\"perf_sum3\", Int64, true)"]` | 0.90 (5%) :white_check_mark: | 1.00 (1%)  |
| `["union", "array", "(\"perf_sum3\", Int8, true)"]` | 1.31 (5%) :x: | 1.00 (1%)  |
| `["union", "array", "(\"perf_sum\", Float64, true)"]` | 1.25 (5%) :x: | 1.00 (1%)  |
...
```
Julia Version 1.5.0-DEV.201
Commit 1d918dd (2020-01-30 02:10 UTC)
Platform Info:
  ...
  CPU: Intel(R) Xeon(R) CPU E3-1241 v3 @ 3.50GHz: 
       ...
       #1  3501 MHz  120435475 s       5052 s   13947467 s  5672903759 s         32 s
       #2  3501 MHz  889183835 s        217 s   16826871 s  4910170695 s         26 s
       #3  3501 MHz  104650958 s       3267 s    8291470 s  5703447209 s         36 s
       #4  3501 MHz   98061964 s         43 s   11895310 s  5704046135 s         26 s
       
  Memory: 31.383651733398438 GB (18543.03515625 MB free)
  Uptime: 5.8205345e7 sec
