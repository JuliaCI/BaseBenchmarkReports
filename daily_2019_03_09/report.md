...
*Commit(s):* [JuliaLang/julia@60457def0675e65d6cf0823d9aa10c40fb4a92a0](https://github.com/JuliaLang/julia/commit/60457def0675e65d6cf0823d9aa10c40fb4a92a0)

*Triggered By:* [link](https://github.com/JuliaLang/julia/commit/60457def0675e65d6cf0823d9aa10c40fb4a92a0#commitcomment-32664507)

*Tag Predicate:* `ALL`

*Daily Job:* 2019-03-09 vs 2019-03-08
...
| `["collection", "deletion", "(\"Dict\", \"Int\", \"pop!\")"]` | 2.03 (25%) :x: | 1.00 (1%)  |
| `["collection", "deletion", "(\"Vector\", \"Int\", \"filter!\")"]` | 1.34 (25%) :x: | 1.00 (1%)  |
| `["collection", "iteration", "(\"Dict\", \"Any\", \"iterate second\")"]` | 1.37 (25%) :x: | 1.00 (1%)  |
...
| `["collection", "queries & updates", "(\"Dict\", \"String\", \"in\", \"true\")"]` | 1.31 (25%) :x: | 1.00 (1%)  |
| `["collection", "queries & updates", "(\"Set\", \"Int\", \"first\")"]` | 1.29 (25%) :x: | 1.00 (1%)  |
| `["collection", "queries & updates", "(\"Set\", \"Int\", \"in\", \"false\")"]` | 1.39 (25%) :x: | 1.00 (1%)  |
| `["collection", "set operations", "(\"BitSet\", \"Int\", \"intersect!\", \"BitSet\")"]` | 1.32 (25%) :x: | 1.00 (1%)  |
| `["collection", "set operations", "(\"Set\", \"Int\", \"⊆\", \"Vector\")"]` | 1.43 (25%) :x: | 1.00 (1%)  |
...
| `["find", "findprev", "(\"ispos\", \"Array{UInt64,1}\")"]` | 1.25 (5%) :x: | 1.00 (1%)  |
...
| `["random", "collections", "(\"rand\", \"ImplicitRNG\", \"small Set\")"]` | 1.63 (25%) :x: | 1.00 (1%)  |
...
| `["scalar", "asin", "(\"zero\", \"Float32\")"]` | 0.64 (5%) :white_check_mark: | 1.00 (1%)  |
...
| `["union", "array", "(\"broadcast\", abs, Float32, false)"]` | 1.12 (5%) :x: | 1.00 (1%)  |
| `["union", "array", "(\"broadcast\", abs, Float64, false)"]` | 1.09 (5%) :x: | 1.00 (1%)  |
| `["union", "array", "(\"broadcast\", identity, Float64, false)"]` | 1.11 (5%) :x: | 1.00 (1%)  |
...
| `["union", "array", "(\"perf_sum2\", Complex{Float64}, true)"]` | 1.15 (5%) :x: | 1.00 (1%)  |
...
Platform Info:
  ...
  CPU: Intel(R) Xeon(R) CPU E3-1241 v3 @ 3.50GHz: 
       ...
       #1  3501 MHz   79810450 s       5019 s    8989735 s  2898974227 s         24 s
       #2  3501 MHz  482316239 s        203 s    8051185 s  2502338365 s         19 s
       #3  3501 MHz   62992228 s       3228 s    5309804 s  2924322348 s         27 s
       #4  3501 MHz   59099530 s          7 s    6928384 s  2925833992 s         17 s
       
  Memory: 31.383651733398438 GB (5429.96875 MB free)
  Uptime: 2.9950674e7 sec
