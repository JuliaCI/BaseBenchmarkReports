...
*Commit(s):* [JuliaLang/julia@89b80571a7589cf8ed1bbf397ebd82249fbf0252](https://github.com/JuliaLang/julia/commit/89b80571a7589cf8ed1bbf397ebd82249fbf0252)

*Triggered By:* [link](https://github.com/JuliaLang/julia/commit/89b80571a7589cf8ed1bbf397ebd82249fbf0252#commitcomment-34470900)

*Tag Predicate:* `ALL`

*Daily Job:* 2019-07-28 vs 2019-07-27
...
| `["array", "reductions", "(\"perf_reduce\", \"Int64\")"]` | 0.85 (5%) :white_check_mark: | 1.00 (1%)  |
...
| `["io", "array_limit", "(\"display\", \"Array{Float64,1}(100000000,)\")"]` | 1.08 (5%) :x: | 0.98 (1%) :white_check_mark: |
| `["io", "array_limit", "(\"display\", \"Array{Float64,2}(10000, 10000)\")"]` | 1.23 (5%) :x: | 1.09 (1%) :x: |
| `["io", "array_limit", "(\"display\", \"Array{Float64,2}(100000000, 1)\")"]` | 1.08 (5%) :x: | 0.98 (1%) :white_check_mark: |
...
| `["random", "types", "(\"randexp\", \"ImplicitRNG\", \"ImplicitFloat64\")"]` | 0.68 (25%) :white_check_mark: | 1.00 (1%)  |
| `["random", "types", "(\"randn\", \"ImplicitRNG\", \"ImplicitFloat64\")"]` | 0.65 (25%) :white_check_mark: | 1.00 (1%)  |
...
| `["scalar", "arithmetic", "(\"rem type\", \"Char\", \"BigInt\")"]` | 1.62 (40%) :x: | 1.00 (1%)  |
...
| `["sparse", "index", "(\"spmat\", \"col\", \"range\", 10)"]` | 0.54 (30%) :white_check_mark: | 1.00 (1%)  |
| `["sparse", "index", "(\"spmat\", \"col\", \"range\", 100)"]` | 0.56 (30%) :white_check_mark: | 1.00 (1%)  |
| `["sparse", "index", "(\"spmat\", \"col\", \"range\", 1000)"]` | 0.54 (30%) :white_check_mark: | 1.00 (1%)  |
...
| `["union", "array", "(\"perf_sum\", Float64, true)"]` | 1.08 (5%) :x: | 1.00 (1%)  |
...
```
Julia Version 1.3.0-alpha.24
Commit 89b8057 (2019-07-27 13:00 UTC)
Platform Info:
  ...
  CPU: Intel(R) Xeon(R) CPU E3-1241 v3 @ 3.50GHz: 
       ...
       #1  3501 MHz   94461278 s       5037 s   10895800 s  4097959773 s         27 s
       #2  3501 MHz  625490543 s        208 s   10578152 s  3573842148 s         22 s
       #3  3501 MHz   77851530 s       3243 s    6493082 s  4125563744 s         31 s
       #4  3501 MHz   73050101 s         20 s    9184882 s  4125968649 s         22 s
       
  Memory: 31.383651733398438 GB (14542.9375 MB free)
  Uptime: 4.2130341e7 sec
