...
*Commit(s):* [JuliaLang/julia@507312d5bf921066e270e1bb15b322a14b8ab822](https://github.com/JuliaLang/julia/commit/507312d5bf921066e270e1bb15b322a14b8ab822)

*Triggered By:* [link](https://github.com/JuliaLang/julia/commit/507312d5bf921066e270e1bb15b322a14b8ab822#commitcomment-33556659)

*Tag Predicate:* `ALL`

*Daily Job:* 2019-05-16 vs 2019-05-15
...
| `["array", "comprehension", "(\"collect\", \"Array{Float64,1}\")"]` | 1.22 (5%) :x: | 1.00 (1%)  |
| `["array", "comprehension", "(\"collect\", \"StepRangeLen{Float64,Base.TwicePrecision{Float64},Base.TwicePrecision{Float64}}\")"]` | 1.17 (5%) :x: | 1.00 (1%)  |
| `["array", "comprehension", "(\"comprehension_collect\", \"Array{Float64,1}\")"]` | 1.24 (5%) :x: | 1.00 (1%)  |
| `["array", "comprehension", "(\"comprehension_collect\", \"StepRangeLen{Float64,Base.TwicePrecision{Float64},Base.TwicePrecision{Float64}}\")"]` | 1.17 (5%) :x: | 1.00 (1%)  |
...
| `["array", "growth", "(\"prerend!\", 256)"]` | 1.21 (5%) :x: | 1.00 (1%)  |
...
| `["broadcast", "sparse", "((10000000,), 2)"]` | 1.10 (5%) :x: | 1.00 (1%)  |
| `["collection", "deletion", "(\"IdDict\", \"Any\", \"filter!\")"]` | 1.54 (25%) :x: | 1.00 (1%)  |
| `["collection", "iteration", "(\"BitSet\", \"Int\", \"iterate\")"]` | 1.33 (25%) :x: | 1.00 (1%)  |
| `["collection", "iteration", "(\"Set\", \"String\", \"iterate\")"]` | 1.33 (25%) :x: | 1.00 (1%)  |
| `["collection", "queries & updates", "(\"Set\", \"Any\", \"pop!\", \"specified\")"]` | 0.67 (25%) :white_check_mark: | 1.00 (1%)  |
| `["collection", "queries & updates", "(\"Set\", \"Any\", \"push!\", \"overwrite\")"]` | 0.46 (25%) :white_check_mark: | 1.00 (1%)  |
...
| `["micro", "printfd"]` | 0.49 (5%) :white_check_mark: | 1.00 (1%)  |
| `["misc", "18129"]` | 1.07 (5%) :x: | 1.00 (1%)  |
| `["misc", "23042", "Complex{Float32}"]` | 1.19 (5%) :x: | 1.00 (1%)  |
...
| `["problem", "ziggurat", "ziggurat"]` | 1.17 (5%) :x: | 1.00 (1%)  |
| `["random", "collections", "(\"rand\", \"ImplicitRNG\", \"large Dict\")"]` | 1.47 (25%) :x: | 1.00 (1%)  |
| `["random", "collections", "(\"rand\", \"ImplicitRNG\", \"small Set\")"]` | 1.32 (25%) :x: | 1.00 (1%)  |
| `["random", "types", "(\"rand\", \"MersenneTwister\", \"Complex{Int32}\")"]` | 1.33 (25%) :x: | 1.00 (1%)  |
...
| `["scalar", "arithmetic", "(\"rem type\", \"Bool\", \"BigInt\")"]` | 1.53 (40%) :x: | 1.00 (1%)  |
...
| `["scalar", "atanh", "(\"2^-28 <= abs(x) < 0.5\", \"negative argument\", \"Float64\")"]` | 1.11 (5%) :x: | 1.00 (1%)  |
| `["scalar", "atanh", "(\"2^-28 <= abs(x) < 0.5\", \"positive argument\", \"Float64\")"]` | 1.11 (5%) :x: | 1.00 (1%)  |
| `["scalar", "atanh", "(\"one\", \"Float64\")"]` | 1.19 (5%) :x: | 1.00 (1%)  |
...
| `["union", "array", "(\"perf_sum4\", BigFloat, false)"]` | 1.17 (5%) :x: | 1.00 (1%)  |
| `["union", "array", "(\"perf_sum4\", BigFloat, true)"]` | 1.13 (5%) :x: | 1.00 (1%)  |
| `["union", "array", "(\"perf_sum4\", BigInt, true)"]` | 1.14 (5%) :x: | 1.00 (1%)  |
...
```
Julia Version 1.3.0-DEV.227
Commit 507312d (2019-05-16 00:18 UTC)
Platform Info:
  ...
  CPU: Intel(R) Xeon(R) CPU E3-1241 v3 @ 3.50GHz: 
       ...
       #1  3501 MHz   89441242 s       5031 s   10152037 s  3473979748 s         24 s
       #2  3501 MHz  573637642 s        203 s    9598282 s  2996147539 s         21 s
       #3  3501 MHz   72779129 s       3237 s    6030192 s  3500648302 s         30 s
       #4  3501 MHz   68313244 s         12 s    8013735 s  3502018467 s         19 s
       
  Memory: 31.383651733398438 GB (4797.328125 MB free)
  Uptime: 3.582186e7 sec
