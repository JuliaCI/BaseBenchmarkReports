...
*Commit(s):* [JuliaLang/julia@f4c23dfb145af5ec98e600f9bb7143b9c8558449](https://github.com/JuliaLang/julia/commit/f4c23dfb145af5ec98e600f9bb7143b9c8558449)

*Triggered By:* [link](https://github.com/JuliaLang/julia/commit/f4c23dfb145af5ec98e600f9bb7143b9c8558449#commitcomment-34957593)

*Tag Predicate:* `ALL`

*Daily Job:* 2019-09-05 vs 2019-09-04
...
|----|------------|--------------|
| `["array", "any/all", "(\"all\", \"Vector{Bool}\")"]` | 0.93 (5%) :white_check_mark: | 1.00 (1%)  |
...
| `["array", "reductions", "(\"perf_mapreduce\", \"Int64\")"]` | 0.86 (5%) :white_check_mark: | 1.00 (1%)  |
...
| `["linalg", "arithmetic", "(\"-\", \"LowerTriangular\", \"LowerTriangular\", 256)"]` | 2.47 (45%) :x: | 1.00 (1%)  |
...
| `["random", "types", "(\"randexp\", \"ImplicitRNG\", \"ImplicitFloat64\")"]` | 0.74 (25%) :white_check_mark: | 1.00 (1%)  |
...
| `["scalar", "acosh", "(\"2 <= abs(x) < 2^28\", \"positive argument\", \"Float64\")"]` | 1.32 (5%) :x: | 1.00 (1%)  |
| `["scalar", "acosh", "(\"very large\", \"positive argument\", \"Float64\")"]` | 1.56 (5%) :x: | 1.00 (1%)  |
| `["scalar", "arithmetic", "(\"rem type\", \"Bool\", \"BigInt\")"]` | 1.41 (40%) :x: | 1.00 (1%)  |
| `["scalar", "arithmetic", "(\"sub\", \"BigFloat\", \"Complex{BigInt}\")"]` | 1.69 (50%) :x: | 1.00 (1%)  |
| `["scalar", "asinh", "(\"very large\", \"negative argument\", \"Float64\")"]` | 1.07 (5%) :x: | 1.00 (1%)  |
| `["scalar", "asinh", "(\"zero\", \"Float64\")"]` | 0.84 (5%) :white_check_mark: | 1.00 (1%)  |
...
| `["scalar", "sinh", "(\"very large\", \"positive argument\", \"Float32\")"]` | 1.15 (5%) :x: | 1.00 (1%)  |
| `["sparse", "constructors", "(\"Bidiagonal\", 100)"]` | 0.84 (5%) :white_check_mark: | 1.00 (1%)  |
| `["sparse", "constructors", "(\"Diagonal\", 100)"]` | 0.92 (5%) :white_check_mark: | 1.00 (1%)  |
| `["sparse", "constructors", "(\"IJV\", 100)"]` | 1.06 (5%) :x: | 1.00 (1%)  |
| `["sparse", "constructors", "(\"Tridiagonal\", 100)"]` | 1.19 (5%) :x: | 1.00 (1%)  |
...
```
Julia Version 1.4.0-DEV.91
Commit f4c23df (2019-09-05 01:41 UTC)
Platform Info:
  ...
  CPU: Intel(R) Xeon(R) CPU E3-1241 v3 @ 3.50GHz: 
       ...
       #1  3501 MHz   99549206 s       5042 s   11543504 s  4428397148 s         28 s
       #2  3501 MHz  679610968 s        208 s   11781915 s  3855272182 s         24 s
       #3  3501 MHz   83033603 s       3248 s    6873289 s  4456727036 s         33 s
       #4  3501 MHz   77907522 s         27 s    9720890 s  4457211408 s         22 s
       
  Memory: 31.383651733398438 GB (15655.015625 MB free)
  Uptime: 4.5499934e7 sec
