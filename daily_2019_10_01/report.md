...
*Commit(s):* [JuliaLang/julia@2859b11a1227a40bdebe940699c2e35484e880e6](https://github.com/JuliaLang/julia/commit/2859b11a1227a40bdebe940699c2e35484e880e6)

*Triggered By:* [link](https://github.com/JuliaLang/julia/commit/2859b11a1227a40bdebe940699c2e35484e880e6#commitcomment-35304224)

*Tag Predicate:* `ALL`

*Daily Job:* 2019-10-01 vs 2019-09-30
...
| `["array", "growth", "(\"push_single!\", 2048)"]` | 0.20 (5%) :white_check_mark: | 0.62 (1%) :white_check_mark: |
| `["array", "growth", "(\"push_single!\", 256)"]` | 0.06 (5%) :white_check_mark: | 0.17 (1%) :white_check_mark: |
| `["array", "growth", "(\"push_single!\", 8)"]` | 0.01 (5%) :white_check_mark: | 0.01 (1%) :white_check_mark: |
...
| `["array", "subarray", "(\"lucompletepivCopy!\", 100)"]` | 1.99 (5%) :x: | 1.00 (1%)  |
| `["array", "subarray", "(\"lucompletepivCopy!\", 1000)"]` | 2.01 (5%) :x: | 1.00 (1%)  |
| `["array", "subarray", "(\"lucompletepivCopy!\", 250)"]` | 2.13 (5%) :x: | 1.00 (1%)  |
| `["array", "subarray", "(\"lucompletepivCopy!\", 500)"]` | 2.16 (5%) :x: | 1.00 (1%)  |
| `["array", "subarray", "(\"lucompletepivSub!\", 100)"]` | 2.17 (5%) :x: | 1.00 (1%)  |
| `["array", "subarray", "(\"lucompletepivSub!\", 1000)"]` | 2.32 (5%) :x: | 1.00 (1%)  |
| `["array", "subarray", "(\"lucompletepivSub!\", 250)"]` | 2.42 (5%) :x: | 1.00 (1%)  |
| `["array", "subarray", "(\"lucompletepivSub!\", 500)"]` | 2.51 (5%) :x: | 1.00 (1%)  |
...
| `["find", "findprev", "(\"ispos\", \"Array{Bool,1}\")"]` | 1.14 (5%) :x: | 1.00 (1%)  |
...
| `["random", "types", "(\"randn\", \"ImplicitRNG\", \"ImplicitFloat64\")"]` | 0.68 (25%) :white_check_mark: | 1.00 (1%)  |
| `["scalar", "acos", "(\"0.5 <= abs(x) < 1\", \"positive argument\", \"Float64\")"]` | 1.07 (5%) :x: | 1.00 (1%)  |
| `["scalar", "acosh", "(\"one\", \"Float64\")"]` | 1.31 (5%) :x: | 1.00 (1%)  |
| `["scalar", "arithmetic", "(\"rem type\", \"Bool\", \"BigInt\")"]` | 0.59 (40%) :white_check_mark: | 1.00 (1%)  |
| `["scalar", "arithmetic", "(\"rem type\", \"Int64\", \"BigInt\")"]` | 1.76 (40%) :x: | 1.00 (1%)  |
...
```
Julia Version 1.4.0-DEV.215
Commit 2859b11 (2019-10-01 02:50 UTC)
Platform Info:
  ...
  CPU: Intel(R) Xeon(R) CPU E3-1241 v3 @ 3.50GHz: 
       ...
       #1  3501 MHz  102705940 s       5044 s   11940774 s  4649026186 s         28 s
       #2  3501 MHz  709180902 s        212 s   12529681 s  4049348746 s         24 s
       #3  3501 MHz   86287745 s       3254 s    7081688 s  4677808283 s         33 s
       #4  3501 MHz   80964157 s         27 s   10079805 s  4678203821 s         22 s
       
  Memory: 31.383651733398438 GB (14323.28125 MB free)
  Uptime: 4.7746369e7 sec
