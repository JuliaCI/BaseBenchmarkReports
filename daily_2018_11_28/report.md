...
*Commit(s):* [JuliaLang/julia@4f8a7b965a98c307f48820c35ca98f9d754096a9](https://github.com/JuliaLang/julia/commit/4f8a7b965a98c307f48820c35ca98f9d754096a9)

*Triggered By:* [link](https://github.com/JuliaLang/julia/commit/4f8a7b965a98c307f48820c35ca98f9d754096a9#commitcomment-31478548)

*Tag Predicate:* `ALL`

*Daily Job:* 2018-11-28 vs 2018-11-27
...
| `["array", "cat", "(\"hcat\", 500)"]` | 0.94 (5%) :white_check_mark: | 1.00 (1%)  |
...
| `["find", "findprev", "(\"ispos\", \"Array{Bool,1}\")"]` | 0.88 (5%) :white_check_mark: | 1.00 (1%)  |
...
| `["parallel", "remotecall", "(\"identity\", 1024)"]` | 1.15 (5%) :x: | 1.00 (1%)  |
| `["parallel", "remotecall", "(\"identity\", 2)"]` | 1.15 (5%) :x: | 1.00 (1%)  |
| `["parallel", "remotecall", "(\"identity\", 4096)"]` | 1.14 (5%) :x: | 1.00 (1%)  |
| `["parallel", "remotecall", "(\"identity\", 512)"]` | 1.15 (5%) :x: | 1.00 (1%)  |
| `["parallel", "remotecall", "(\"identity\", 64)"]` | 1.15 (5%) :x: | 1.00 (1%)  |
...
| `["scalar", "arithmetic", "(\"div\", \"Complex{BigFloat}\", \"UInt64\")"]` | 1.63 (50%) :x: | 1.00 (1%)  |
...
| `["scalar", "exp2", "(\"small\", \"positive argument\", \"Float32\")"]` | 0.83 (5%) :white_check_mark: | 1.00 (1%)  |
...
| `["union", "array", "(\"perf_binaryop\", *, Float64, (false, false))"]` | 0.87 (5%) :white_check_mark: | 1.00 (1%)  |
...
| `["union", "array", "(\"skipmissing\", sum, Bool, true)"]` | 1.16 (5%) :x: | 1.00 (1%)  |
...
```
Julia Version 1.1.0-DEV.723
Commit 4f8a7b9 (2018-11-27 23:21 UTC)
Platform Info:
  ...
  CPU: Intel(R) Xeon(R) CPU E3-1241 v3 @ 3.50GHz: 
       ...
       #1  3501 MHz   63353436 s       5008 s    6965976 s  2046743818 s         22 s
       #2  3501 MHz  349043441 s        203 s    5628417 s  1766010801 s         17 s
       #3  3501 MHz   47285026 s       3214 s    4015184 s  2069280167 s         26 s
       #4  3501 MHz   43974577 s          0 s    5123761 s  2071057946 s         15 s
       
  Memory: 31.383651733398438 GB (5187.8515625 MB free)
  Uptime: 2.1224312e7 sec
