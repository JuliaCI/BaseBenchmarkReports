...
*Commit(s):* [JuliaLang/julia@6baa701c571ff3dd976e45fb9892d5430993edb5](https://github.com/JuliaLang/julia/commit/6baa701c571ff3dd976e45fb9892d5430993edb5)

*Triggered By:* [link](https://github.com/JuliaLang/julia/commit/6baa701c571ff3dd976e45fb9892d5430993edb5#commitcomment-37981449)

*Tag Predicate:* `ALL`

*Daily Job:* 2020-03-23 vs 2020-03-22
...
| `["find", "findall", "(\"BitArray{1}\", \"50-50\")"]` | 1.14 (5%) :x: | 1.00 (1%)  |
...
| `["random", "collections", "(\"rand\", \"ImplicitRNG\", \"large Set\")"]` | 1.41 (25%) :x: | 1.00 (1%)  |
| `["random", "ranges", "(\"rand\", \"MersenneTwister\", \"BigInt\", \"RangeGenerator(1:2^10000)\")"]` | 1.35 (25%) :x: | 1.00 (1%)  |
| `["random", "types", "(\"rand\", \"MersenneTwister\", \"Complex{Int16}\")"]` | 0.55 (25%) :white_check_mark: | 1.00 (1%)  |
| `["random", "types", "(\"rand\", \"MersenneTwister\", \"Complex{UInt32}\")"]` | 1.35 (25%) :x: | 1.00 (1%)  |
| `["random", "types", "(\"randn!\", \"MersenneTwister\", \"Complex{Float32}\")"]` | 0.73 (25%) :white_check_mark: | 1.00 (1%)  |
...
| `["scalar", "atan2", "(\"x one\", \"Float64\")"]` | 0.74 (5%) :white_check_mark: | 1.00 (1%)  |
...
| `["scalar", "cos", "(\"argument reduction (easy) abs(x) < 6π/4\", \"positive argument\", \"Float32\", \"sin_kernel\")"]` | 1.63 (5%) :x: | 1.00 (1%)  |
| `["scalar", "cos", "(\"argument reduction (easy) abs(x) < 7π/4\", \"negative argument\", \"Float64\", \"cos_kernel\")"]` | 0.55 (5%) :white_check_mark: | 1.00 (1%)  |
...
| `["scalar", "sin", "(\"argument reduction (easy) abs(x) < 4π/4\", \"positive argument\", \"Float64\", \"sin_kernel\")"]` | 1.21 (5%) :x: | 1.00 (1%)  |
...
| `["sparse", "transpose", "(\"adjoint\", (600, 400))"]` | 0.57 (30%) :white_check_mark: | 1.00 (1%)  |
...
| `["union", "array", "(\"map\", identity, Complex{Float64}, true)"]` | 1.15 (5%) :x: | 1.00 (1%)  |
...
| `["union", "array", "(\"perf_simplecopy\", Bool, false)"]` | 0.89 (5%) :white_check_mark: | 1.00 (1%)  |
...
```
Julia Version 1.5.0-DEV.493
Commit 6baa701 (2020-03-22 19:58 UTC)
Platform Info:
  ...
  CPU: Intel(R) Xeon(R) CPU E3-1241 v3 @ 3.50GHz: 
       ...
       #1  3501 MHz  129290302 s       5056 s   14893905 s  6119681015 s         34 s
       #2  3501 MHz  966340628 s        217 s   18680835 s  5288430488 s         26 s
       #3  3501 MHz  113816575 s       3284 s    8830642 s  6150656243 s         37 s
       #4  3501 MHz  106741159 s         43 s   12657709 s  6151743487 s         26 s
       
  Memory: 31.383651733398438 GB (18823.23046875 MB free)
  Uptime: 6.2780988e7 sec
