...
*Commit(s):* [JuliaLang/julia@7b000e5ba651dc1db54eb52d3b85208635adaf7a](https://github.com/JuliaLang/julia/commit/7b000e5ba651dc1db54eb52d3b85208635adaf7a) vs [JuliaLang/julia@ea58d3cb6dc71daf14daaa8301afa740e8a7e202](https://github.com/JuliaLang/julia/commit/ea58d3cb6dc71daf14daaa8301afa740e8a7e202)

*Triggered By:* [link](https://github.com/JuliaLang/julia/pull/33979#issuecomment-567116269)
...
|----|------------|--------------|
| `["array", "any/all", "(\"any\", \"Array{Int16,1} generator\")"]` | 0.94 (5%) :white_check_mark: | 1.00 (1%)  |
...
| `["dates", "accessor", "month"]` | 0.93 (5%) :white_check_mark: | 1.00 (1%)  |
...
| `["io", "array_limit", "(\"display\", \"Array{Float64,1}(100000000,)\")"]` | 1.02 (5%)  | 1.01 (1%) :x: |
| `["io", "array_limit", "(\"display\", \"Array{Float64,2}(10000, 10000)\")"]` | 0.98 (5%)  | 0.96 (1%) :white_check_mark: |
| `["io", "array_limit", "(\"display\", \"Array{Float64,2}(100000000, 1)\")"]` | 1.02 (5%)  | 1.01 (1%) :x: |
...
| `["random", "ranges", "(\"rand\", \"MersenneTwister\", \"BigInt\", \"RangeGenerator(1:18446744073709551616)\")"]` | 1.39 (25%) :x: | 1.00 (1%)  |
| `["random", "types", "(\"rand\", \"MersenneTwister\", \"Complex{Float64}\")"]` | 1.56 (25%) :x: | 1.00 (1%)  |
...
| `["scalar", "arithmetic", "(\"add\", \"Int64\", \"BigInt\")"]` | 1.58 (50%) :x: | 1.00 (1%)  |
| `["scalar", "arithmetic", "(\"rem type\", \"UInt64\", \"BigInt\")"]` | 1.54 (40%) :x: | 1.00 (1%)  |
| `["scalar", "arithmetic", "(\"sub\", \"UInt64\", \"BigInt\")"]` | 1.86 (50%) :x: | 1.00 (1%)  |
| `["scalar", "asinh", "(\"0 <= abs(x) < 2^-28\", \"positive argument\", \"Float32\")"]` | 1.87 (5%) :x: | 1.00 (1%)  |
| `["scalar", "asinh", "(\"2^-28 <= abs(x) < 2\", \"positive argument\", \"Float32\")"]` | 1.09 (5%) :x: | 1.00 (1%)  |
...
| `["scalar", "atan", "(\"19/16 <= abs(x) < 39/16\", \"negative argument\", \"Float32\")"]` | 1.11 (5%) :x: | 1.00 (1%)  |
...
| `["scalar", "atan", "(\"39/16 <= abs(x) < 2^66\", \"positive argument\", \"Float64\")"]` | 0.79 (5%) :white_check_mark: | 1.00 (1%)  |
...
| `["scalar", "mod2pi", "(\"argument reduction (easy) abs(x) < 7π/4\", \"positive argument\", \"Float64\")"]` | 0.93 (5%) :white_check_mark: | 1.00 (1%)  |
...
| `["scalar", "sin", "(\"argument reduction (hard) abs(x) < 2π/4\", \"negative argument\", \"Float64\", \"cos_kernel\")"]` | 0.93 (5%) :white_check_mark: | 1.00 (1%)  |
...
| `["union", "array", "(\"perf_sum3\", Int64, true)"]` | 0.92 (5%) :white_check_mark: | 1.00 (1%)  |
...
| `["union", "array", "(\"perf_sum\", Float64, true)"]` | 0.90 (5%) :white_check_mark: | 1.00 (1%)  |
...
Commit 7b000e5 (2019-12-18 13:57 UTC)
Platform Info:
  ...
  CPU: Intel(R) Xeon(R) CPU E3-1241 v3 @ 3.50GHz: 
       ...
       #1  3501 MHz   54370950 s       2445 s   16652685 s  5364546503 s         16 s
       #2  3501 MHz  336296993 s         47 s    6625839 s  5106851348 s         25 s
       #3  3501 MHz   45504043 s       3207 s    5384599 s  5398495373 s         37 s
       #4  3501 MHz   43821940 s         16 s    4182582 s  5403623697 s         34 s
       
  Memory: 31.383651733398438 GB (13470.76953125 MB free)
  Uptime: 5.4532932e7 sec
...
```
Julia Version 1.3.1-pre.1
Commit ea58d3c (2019-12-16 22:53 UTC)
Platform Info:
  OS: Linux (x86_64-linux-gnu)
      Ubuntu 14.04.5 LTS
  uname: Linux 3.13.0-85-generic #129-Ubuntu SMP Thu Mar 17 20:50:15 UTC 2016 x86_64 x86_64
  CPU: Intel(R) Xeon(R) CPU E3-1241 v3 @ 3.50GHz: 
              speed         user         nice          sys         idle          irq
       #1  3501 MHz   54492627 s       2445 s   16661265 s  5365727265 s         16 s
       #2  3501 MHz  337524850 s         47 s    6650905 s  5106913853 s         25 s
       #3  3501 MHz   45601808 s       3207 s    5389029 s  5399708071 s         37 s
       #4  3501 MHz   43915769 s         16 s    4186916 s  5404840964 s         34 s
       
  Memory: 31.383651733398438 GB (13952.25 MB free)
  Uptime: 5.454609e7 sec
  Load Avg:  1.0029296875  1.0146484375  1.04541015625
  WORD_SIZE: 64
  LIBM: libopenlibm
  LLVM: libLLVM-6.0.1 (ORCJIT, haswell)
