...
*Commit(s):* [JuliaLang/julia@573cf74895f6a41f081324996b8d6773ee3ce83c](https://github.com/JuliaLang/julia/commit/573cf74895f6a41f081324996b8d6773ee3ce83c)

*Triggered By:* [link](https://github.com/JuliaLang/julia/commit/573cf74895f6a41f081324996b8d6773ee3ce83c#commitcomment-31785493)

*Tag Predicate:* `ALL`

*Daily Job:* 2018-12-27 vs 2018-12-23
...
| `["find", "findprev", "(\"BitArray{1}\", \"10-90\")"]` | 1.05 (5%) :x: | 1.00 (1%)  |
...
| `["io", "array_limit", "(\"display\", \"Array{Float64,2}(10000, 10000)\")"]` | 0.95 (5%) :white_check_mark: | 1.00 (1%)  |
...
| `["random", "collections", "(\"rand\", \"ImplicitRNG\", \"large Dict\")"]` | 0.69 (25%) :white_check_mark: | 1.00 (1%)  |
...
| `["random", "ranges", "(\"rand\", \"MersenneTwister\", \"BigInt\", \"RangeGenerator(1:4294967295)\")"]` | 0.75 (25%) :white_check_mark: | 1.00 (1%)  |
...
| `["scalar", "acosh", "(\"1 <= abs(x) < 2\", \"positive argument\", \"Float32\")"]` | 1.25 (5%) :x: | 1.00 (1%)  |
| `["scalar", "acosh", "(\"2 <= abs(x) < 2^28\", \"positive argument\", \"Float32\")"]` | 1.29 (5%) :x: | 1.00 (1%)  |
| `["scalar", "arithmetic", "(\"add\", \"UInt64\", \"Complex{BigInt}\")"]` | 1.57 (50%) :x: | 1.00 (1%)  |
| `["scalar", "arithmetic", "(\"sub\", \"Int64\", \"BigInt\")"]` | 1.81 (50%) :x: | 1.00 (1%)  |
...
| `["scalar", "atan", "(\"11/16 <= abs(x) < 19/16\", \"positive argument\", \"Float32\")"]` | 0.84 (5%) :white_check_mark: | 1.00 (1%)  |
...
| `["scalar", "atan", "(\"7/16 <= abs(x) < 11/16\", \"negative argument\", \"Float32\")"]` | 1.46 (5%) :x: | 1.00 (1%)  |
...
| `["scalar", "atan", "(\"very small\", \"positive argument\", \"Float64\")"]` | 1.71 (5%) :x: | 1.00 (1%)  |
...
| `["scalar", "cos", "(\"argument reduction (paynehanek) abs(x) > 2.0^20*π/2\", \"positive argument\", \"Float32\", \"sin_kernel\")"]` | 0.93 (5%) :white_check_mark: | 1.00 (1%)  |
...
| `["scalar", "expm1", "(\"arg reduction II\", \"positive argument\", \"Float32\")"]` | 1.15 (5%) :x: | 1.00 (1%)  |
| `["scalar", "expm1", "(\"arg reduction I\", \"positive argument\", \"Float32\")"]` | 1.15 (5%) :x: | 1.00 (1%)  |
| `["scalar", "expm1", "(\"one\", \"Float32\")"]` | 1.12 (5%) :x: | 1.00 (1%)  |
...
| `["scalar", "sin", "(\"argument reduction (paynehanek) abs(x) > 2.0^20*π/2\", \"negative argument\", \"Float32\", \"sin_kernel\")"]` | 0.87 (5%) :white_check_mark: | 1.00 (1%)  |
...
```
Julia Version 1.2.0-DEV.65
Commit 573cf74 (2018-12-27 02:41 UTC)
Platform Info:
  ...
  CPU: Intel(R) Xeon(R) CPU E3-1241 v3 @ 3.50GHz: 
       ...
       #1  3501 MHz   68301037 s       5012 s    7573423 s  2291211794 s         22 s
       #2  3501 MHz  386458458 s        203 s    6331988 s  1978238921 s         18 s
       #3  3501 MHz   52324949 s       3218 s    4428134 s  2314201427 s         26 s
       #4  3501 MHz   48884658 s          0 s    5659561 s  2315912765 s         16 s
       
  Memory: 31.383651733398438 GB (6675.2890625 MB free)
  Uptime: 2.3729879e7 sec
