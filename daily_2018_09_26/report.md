...
*Commit(s):* [JuliaLang/julia@8d6c1cebfd5cd97ebe33c9b84aa0f82335ed41a9](https://github.com/JuliaLang/julia/commit/8d6c1cebfd5cd97ebe33c9b84aa0f82335ed41a9)

*Triggered By:* [link](https://github.com/JuliaLang/julia/commit/8d6c1cebfd5cd97ebe33c9b84aa0f82335ed41a9#commitcomment-30649503)

*Tag Predicate:* `ALL`

*Daily Job:* 2018-09-26 vs 2018-09-25
...
| `["array", "growth", "(\"prerend!\", 256)"]` | 1.34 (5%) :x: | 1.00 (1%)  |
| `["array", "growth", "(\"push_multiple!\", 8)"]` | 0.73 (5%) :white_check_mark: | 1.00 (1%)  |
| `["array", "index", "2d"]` | 1.19 (5%) :x: | 1.00 (1%)  |
...
| `["collection", "iteration", "(\"Set\", \"Int\", \"iterate\")"]` | 0.61 (25%) :white_check_mark: | 1.00 (1%)  |
| `["collection", "queries & updates", "(\"Vector\", \"Any\", \"pop!\", \"unspecified\")"]` | 1.26 (25%) :x: | 1.00 (1%)  |
...
| `["random", "types", "(\"randn\", \"RandomDevice\", \"ImplicitFloat64\")"]` | 1.39 (25%) :x: | 1.00 (1%)  |
...
| `["scalar", "atan2", "(\"abs(y/x) safe (small)\", \"y positive\", \"x negative\", \"Float64\")"]` | 1.37 (5%) :x: | 1.00 (1%)  |
...
| `["scalar", "expm1", "(\"huge\", \"positive argument\", \"Float64\")"]` | 0.54 (5%) :white_check_mark: | 1.00 (1%)  |
...
```
Julia Version 1.1.0-DEV.322
Commit 8d6c1ce (2018-09-25 21:45 UTC)
Platform Info:
  ...
  CPU: Intel(R) Xeon(R) CPU E3-1241 v3 @ 3.50GHz: 
       ...
       #1  3501 MHz   51614737 s       5000 s    5659632 s  1516367833 s         21 s
       #2  3501 MHz  255203454 s        203 s    3995832 s  1317191003 s         11 s
       #3  3501 MHz   36027346 s       3200 s    3152682 s  1537211534 s         22 s
       #4  3501 MHz   33473192 s          0 s    3875307 s  1538829624 s         11 s
       
  Memory: 31.383651733398438 GB (4945.30078125 MB free)
  Uptime: 1.5777739e7 sec
