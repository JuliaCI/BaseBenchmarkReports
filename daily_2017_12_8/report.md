...
*Commit(s):* [JuliaLang/julia@037b8185d0c95f48877afd0a3d262a6ac0e0b4a4](https://github.com/JuliaLang/julia/commit/037b8185d0c95f48877afd0a3d262a6ac0e0b4a4)

*Triggered By:* [link](https://github.com/JuliaLang/julia/commit/037b8185d0c95f48877afd0a3d262a6ac0e0b4a4#commitcomment-26132353)

*Tag Predicate:* `ALL`

*Daily Job:* 2017-12-08 vs 2017-12-07
...
| `["dates", "arithmetic", "(\"DateTime\", \"Year\")"]` | 0.56 (15%) :white_check_mark: | 1.00 (1%)  |
| `["scalar", "acos", "(\"one\", \"negative argument\", \"Float32\")"]` | 0.79 (15%) :white_check_mark: | 1.00 (1%)  |
| `["scalar", "acos", "(\"one\", \"positive argument\", \"Float32\")"]` | 0.79 (15%) :white_check_mark: | 1.00 (1%)  |
| `["scalar", "atan", "(\"7/16 <= abs(x) < 11/16\", \"positive argument\", \"Float64\")"]` | 0.82 (15%) :white_check_mark: | 1.00 (1%)  |
| `["scalar", "rem_pio2", "(\"argument reduction (easy) abs(x) < 4π/4\", \"negative argument\", \"Float64\")"]` | 0.60 (15%) :white_check_mark: | 1.00 (1%)  |
...
| `["scalar", "sincos", "(\"argument reduction (paynehanek) abs(x) > 2.0^20*π/2\", \"negative argument\", \"Float64\")"]` | 0.81 (15%) :white_check_mark: | 1.00 (1%)  |
| `["string", "join"]` | 1.44 (40%) :x: | 1.00 (1%)  |
| `["string", "readuntil", "barbarian backtrack"]` | 0.85 (15%) :white_check_mark: | 1.00 (1%)  |
| `["tuple", "reduction", "(\"minimum\", (8,))"]` | 1.82 (15%) :x: | 1.00 (1%)  |
...
```
Julia Version 0.7.0-DEV.2793
Commit 037b818 (2017-12-07 20:47 UTC)
Platform Info:
  ...
  CPU: Intel(R) Xeon(R) CPU E3-1241 v3 @ 3.50GHz: 
       ...
       #1  3501 MHz  106931488 s          0 s   18864164 s  4696448272 s         99 s
       #2  3501 MHz  456774920 s          0 s   12052503 s  4364704444 s         23 s
       #3  3501 MHz   90033108 s          0 s   10298781 s  4733678829 s         82 s
       #4  3501 MHz   86089334 s          0 s   10485220 s  4737429771 s         21 s
       
  Memory: 31.383651733398438 GB (2900.4140625 MB free)
  Uptime: 4.8363269e7 sec
