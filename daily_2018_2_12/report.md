...
*Commit(s):* [JuliaLang/julia@11c08ad3363561b18938d7cd96755d3afa4f1bc8](https://github.com/JuliaLang/julia/commit/11c08ad3363561b18938d7cd96755d3afa4f1bc8)

*Triggered By:* [link](https://github.com/JuliaLang/julia/commit/11c08ad3363561b18938d7cd96755d3afa4f1bc8#commitcomment-27497243)

*Tag Predicate:* `ALL`

*Daily Job:* 2018-02-12 vs 2018-02-10
...
|----|------------|--------------|
| `["array", "any/all", "(\"all\", \"Array{Float64,1} generator\")"]` | 0.85 (15%) :white_check_mark: | 1.00 (1%)  |
...
| `["collection", "optimizations", "(\"Set\", \"abstract\", \"Bool\")"]` | 0.69 (25%) :white_check_mark: | 1.00 (1%)  |
| `["collection", "optimizations", "(\"Set\", \"concrete\", \"Bool\")"]` | 0.69 (25%) :white_check_mark: | 1.00 (1%)  |
...
| `["scalar", "acosh", "(\"one\", \"Float32\")"]` | 0.74 (15%) :white_check_mark: | 1.00 (1%)  |
| `["scalar", "acosh", "(\"one\", \"Float64\")"]` | 0.71 (15%) :white_check_mark: | 1.00 (1%)  |
| `["scalar", "arithmetic", "(\"add\", \"Complex{BigFloat}\", \"UInt64\")"]` | 1.50 (50%) :x: | 1.00 (1%)  |
...
| `["scalar", "atan2", "(\"abs(y/x) high\", \"y negative\", \"x positive\", \"Float32\")"]` | 0.84 (15%) :white_check_mark: | 1.00 (1%)  |
| `["scalar", "atan2", "(\"abs(y/x) safe (small)\", \"y negative\", \"x negative\", \"Float64\")"]` | 0.75 (15%) :white_check_mark: | 1.00 (1%)  |
| `["scalar", "atan2", "(\"abs(y/x) safe (small)\", \"y positive\", \"x negative\", \"Float32\")"]` | 0.79 (15%) :white_check_mark: | 1.00 (1%)  |
| `["scalar", "atan2", "(\"y infinite\", \"y negative\", \"x finite\", \"x negative\", \"Float32\")"]` | 0.71 (15%) :white_check_mark: | 1.00 (1%)  |
| `["scalar", "cos", "(\"argument reduction (hard) abs(x) < 2π/4\", \"negative argument\", \"Float64\", \"sin_kernel\")"]` | 1.19 (15%) :x: | 1.00 (1%)  |
| `["scalar", "cos", "(\"argument reduction (hard) abs(x) < 2π/4\", \"positive argument\", \"Float32\", \"sin_kernel\")"]` | 1.22 (15%) :x: | 1.00 (1%)  |
| `["scalar", "fastmath", "(\"add\", \"BigInt\")"]` | 1.65 (40%) :x: | 1.00 (1%)  |
| `["scalar", "mod2pi", "(\"argument reduction (easy) abs(x) < 2.0^20π/4\", \"negative argument\", \"Float64\")"]` | 0.83 (15%) :white_check_mark: | 1.00 (1%)  |
| `["scalar", "sin", "(\"no reduction\", \"zero\", \"Float32\")"]` | 0.75 (15%) :white_check_mark: | 1.00 (1%)  |
| `["scalar", "sincos", "(\"argument reduction (easy) abs(x) < 2.0^20π/4\", \"negative argument\", \"Float32\")"]` | 1.54 (15%) :x: | 1.00 (1%)  |
| `["scalar", "sincos", "(\"argument reduction (easy) abs(x) < 2.0^20π/4\", \"positive argument\", \"Float32\")"]` | 1.54 (15%) :x: | 1.00 (1%)  |
...
| `["scalar", "sincos", "(\"argument reduction (hard) abs(x) < 4π/4\", \"negative argument\", \"Float32\")"]` | 1.91 (15%) :x: | 1.00 (1%)  |
| `["scalar", "sincos", "(\"no reduction\", \"negative argument\", \"Float32\")"]` | 0.81 (15%) :white_check_mark: | 1.00 (1%)  |
| `["shootout", "mandelbrot"]` | 1.00 (15%)  | 1.06 (1%) :x: |
...
| `["union", "array", "(\"perf_countnothing\", Float32, true)"]` | 0.71 (15%) :white_check_mark: | 1.00 (1%)  |
...
```
Julia Version 0.7.0-DEV.3953
Commit 11c08ad (2018-02-11 20:25 UTC)
Platform Info:
  ...
  CPU: Intel(R) Xeon(R) CPU E3-1241 v3 @ 3.50GHz: 
       ...
       #1  3501 MHz  117601532 s          0 s   20789736 s  5252404465 s        102 s
       #2  3501 MHz  513798734 s          0 s   13062130 s  4876644899 s         26 s
       #3  3501 MHz   97372063 s          0 s   11115615 s  5295553986 s         86 s
       #4  3501 MHz   93221706 s          0 s   11314793 s  5299494852 s         22 s
       
  Memory: 31.383651733398438 GB (5804.80078125 MB free)
  Uptime: 5.4065843e7 sec
