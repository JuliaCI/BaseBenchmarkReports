...
*Commit(s):* [JuliaLang/julia@faafb786ed1e3c895722df8a96355b8a454b36c3](https://github.com/JuliaLang/julia/commit/faafb786ed1e3c895722df8a96355b8a454b36c3)

*Triggered By:* [link](https://github.com/JuliaLang/julia/commit/faafb786ed1e3c895722df8a96355b8a454b36c3#commitcomment-38946011)

*Tag Predicate:* `ALL`

*Daily Job:* 2020-05-05 vs 2020-05-04
...
|----|------------|--------------|
| `["array", "any/all", "(\"any\", \"Array{Int16,1} generator\")"]` | 0.92 (5%) :white_check_mark: | 1.00 (1%)  |
| `["array", "cat", "4467"]` | 0.93 (5%) :white_check_mark: | 1.00 (1%)  |
| `["array", "convert", "(\"Float64\", \"Int\")"]` | 1.36 (5%) :x: | 1.00 (1%)  |
...
| `["array", "reductions", "(\"mean\", \"Float64\")"]` | 1.09 (5%) :x: | Inf (1%) :x: |
| `["array", "reductions", "(\"mean\", \"Int64\")"]` | 7.88 (5%) :x: | Inf (1%) :x: |
...
| `["find", "findall", "(\"Array{Bool,1}\", \"50-50\")"]` | 0.95 (5%)  | 0.98 (1%) :white_check_mark: |
| `["find", "findall", "(\"BitArray{1}\", \"50-50\")"]` | 0.89 (5%) :white_check_mark: | 0.98 (1%) :white_check_mark: |
| `["find", "findnext", "(\"ispos\", \"Array{Bool,1}\")"]` | 0.97 (5%)  | 0.96 (1%) :white_check_mark: |
| `["find", "findnext", "(\"ispos\", \"Array{Float64,1}\")"]` | 1.11 (5%) :x: | 1.00 (1%)  |
| `["find", "findnext", "(\"ispos\", \"Array{Int8,1}\")"]` | 0.89 (5%) :white_check_mark: | 1.00 (1%)  |
| `["find", "findprev", "(\"Array{Bool,1}\", \"50-50\")"]` | 0.28 (5%) :white_check_mark: | 1.00 (1%)  |
...
| `["problem", "monte carlo", "euro_option_devec"]` | 1.05 (5%) :x: | 1.00 (1%)  |
| `["problem", "raytrace", "raytrace"]` | 0.92 (5%) :white_check_mark: | 1.00 (1%)  |
| `["problem", "seismic", "(\"seismic\", \"Float64\")"]` | 0.93 (5%) :white_check_mark: | 1.00 (1%)  |
| `["random", "collections", "(\"rand\", \"ImplicitRNG\", \"large Set\")"]` | 1.32 (25%) :x: | 1.00 (1%)  |
| `["random", "collections", "(\"rand\", \"ImplicitRNG\", \"small Set\")"]` | 1.48 (25%) :x: | 1.00 (1%)  |
| `["random", "ranges", "(\"rand\", \"MersenneTwister\", \"BigInt\", \"RangeGenerator(1:1)\")"]` | 1.29 (25%) :x: | 1.00 (1%)  |
...
| `["scalar", "arithmetic", "(\"rem type\", \"Char\", \"BigInt\")"]` | 1.81 (40%) :x: | 1.00 (1%)  |
...
| `["scalar", "cos", "(\"argument reduction (easy) abs(x) < 2.0^20π/4\", \"positive argument\", \"Float64\", \"cos_kernel\")"]` | 0.89 (5%) :white_check_mark: | 1.00 (1%)  |
...
| `["scalar", "cos", "(\"argument reduction (hard) abs(x) < 2π/4\", \"positive argument\", \"Float32\", \"sin_kernel\")"]` | 0.75 (5%) :white_check_mark: | 1.00 (1%)  |
...
| `["scalar", "cos", "(\"no reduction\", \"zero\", \"Float64\")"]` | 1.40 (5%) :x: | 1.00 (1%)  |
...
| `["sparse", "index", "(\"spmat\", \"col\", \"logical\", 100)"]` | 1.02 (30%)  | 1.03 (1%) :x: |
| `["sparse", "index", "(\"spmat\", \"logical\", 100)"]` | 1.07 (30%)  | 1.03 (1%) :x: |
| `["sparse", "index", "(\"spmat\", \"logical\", 1000)"]` | 0.99 (30%)  | 0.98 (1%) :white_check_mark: |
| `["sparse", "index", "(\"spmat\", \"row\", \"logical\", 100)"]` | 1.12 (30%)  | 1.28 (1%) :x: |
| `["sparse", "index", "(\"spmat\", \"row\", \"logical\", 1000)"]` | 0.94 (30%)  | 0.99 (1%) :white_check_mark: |
| `["sparse", "index", "(\"spvec\", \"logical\", 10000)"]` | 1.02 (30%)  | 1.03 (1%) :x: |
...
| `["union", "array", "(\"perf_sum2\", Float32, true)"]` | 1.09 (5%) :x: | 1.00 (1%)  |
...
| `["union", "array", "(\"perf_sum\", Float32, true)"]` | 1.46 (5%) :x: | 1.00 (1%)  |
| `["union", "array", "(\"perf_sum\", Float64, true)"]` | 0.76 (5%) :white_check_mark: | 1.00 (1%)  |
| `["union", "array", "(\"skipmissing\", collect, BigInt, false)"]` | 0.92 (5%) :white_check_mark: | 1.00 (1%)  |
...
```
Julia Version 1.5.0-DEV.841
Commit faafb78 (2020-05-05 01:05 UTC)
Platform Info:
  ...
  CPU: Intel(R) Xeon(R) CPU E3-1241 v3 @ 3.50GHz: 
       ...
       #1  3501 MHz  137804998 s       5056 s   15699364 s  6481063167 s         35 s
       #2  3501 MHz  1036793440 s        217 s   20385678 s  5587470385 s         26 s
       #3  3501 MHz  122630993 s       3297 s    9308000 s  6511992252 s         38 s
       #4  3501 MHz  115196543 s         43 s   13366944 s  6513665542 s         27 s
       
  Memory: 31.383651733398438 GB (18686.09765625 MB free)
  Uptime: 6.6495752e7 sec
