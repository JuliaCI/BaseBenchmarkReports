...
*Commit(s):* [JuliaLang/julia@6a20ad7eaa9da44088569dcd13596c619d026dd1](https://github.com/JuliaLang/julia/commit/6a20ad7eaa9da44088569dcd13596c619d026dd1)

*Triggered By:* [link](https://github.com/JuliaLang/julia/commit/6a20ad7eaa9da44088569dcd13596c619d026dd1#commitcomment-34998167)

*Tag Predicate:* `ALL`

*Daily Job:* 2019-09-09 vs 2019-09-08
...
| `["array", "index", "(\"sumcolon\", \"100000:-1:1\")"]` | 1.82 (50%) :x: | 1.00 (1%)  |
...
| `["collection", "iteration", "(\"Dict\", \"String\", \"iterate\")"]` | 0.60 (25%) :white_check_mark: | 1.00 (1%)  |
| `["collection", "queries & updates", "(\"Dict\", \"Any\", \"pop!\", \"specified\")"]` | 0.72 (25%) :white_check_mark: | 1.00 (1%)  |
| `["collection", "queries & updates", "(\"Dict\", \"Any\", \"push!\", \"overwrite\")"]` | 0.73 (25%) :white_check_mark: | 1.00 (1%)  |
| `["collection", "queries & updates", "(\"Dict\", \"Any\", \"setindex!\", \"overwrite\")"]` | 0.74 (25%) :white_check_mark: | 1.00 (1%)  |
...
| `["collection", "set operations", "(\"BitSet\", \"Int\", \"setdiff!\", \"BitSet\")"]` | 0.62 (25%) :white_check_mark: | 1.00 (1%)  |
| `["collection", "set operations", "(\"BitSet\", \"Int\", \"setdiff!\", \"big\")"]` | 0.74 (25%) :white_check_mark: | 1.00 (1%)  |
...
| `["problem", "monte carlo", "euro_option_devec"]` | 1.24 (5%) :x: | 1.00 (1%)  |
...
| `["scalar", "arithmetic", "(\"rem type\", \"UInt64\", \"BigInt\")"]` | 1.41 (40%) :x: | 1.00 (1%)  |
| `["scalar", "arithmetic", "(\"sub\", \"BigFloat\", \"Complex{BigInt}\")"]` | 1.51 (50%) :x: | 1.00 (1%)  |
...
| `["scalar", "atan", "(\"39/16 <= abs(x) < 2^66\", \"negative argument\", \"Float64\")"]` | 0.82 (5%) :white_check_mark: | 1.00 (1%)  |
...
| `["scalar", "atan2", "(\"abs(y/x) safe (large)\", \"y negative\", \"x positive\", \"Float32\")"]` | 0.82 (5%) :white_check_mark: | 1.00 (1%)  |
...
| `["scalar", "expm1", "(\"very small\", \"positive argument\", \"Float64\")"]` | 0.68 (5%) :white_check_mark: | 1.00 (1%)  |
...
| `["sparse", "constructors", "(\"Bidiagonal\", 100)"]` | 0.80 (5%) :white_check_mark: | 1.00 (1%)  |
...
| `["union", "array", "(\"perf_simplecopy\", Float32, true)"]` | 0.80 (5%) :white_check_mark: | 1.00 (1%)  |
...
| `["union", "array", "(\"perf_sum2\", Int8, true)"]` | 1.22 (5%) :x: | 1.00 (1%)  |
...
| `["union", "array", "(\"skipmissing\", sum, Union{Missing, Float64}, true)"]` | 1.19 (5%) :x: | 1.00 (1%)  |
...
Commit 6a20ad7 (2019-09-08 06:58 UTC)
Platform Info:
  ...
  CPU: Intel(R) Xeon(R) CPU E3-1241 v3 @ 3.50GHz: 
       ...
       #1  3501 MHz   99979479 s       5043 s   11602258 s  4462410040 s         28 s
       #2  3501 MHz  684578250 s        208 s   11901613 s  3884721275 s         24 s
       #3  3501 MHz   83486413 s       3250 s    6912346 s  4490787515 s         33 s
       #4  3501 MHz   78304569 s         27 s    9765755 s  4491317408 s         22 s
       
  Memory: 31.383651733398438 GB (15893.51171875 MB free)
  Uptime: 4.5845678e7 sec
  Load Avg:  0.93115234375  1.0029296875  1.0400390625
  WORD_SIZE: 64
  LIBM: libopenlibm
