...
*Commit(s):* [JuliaLang/julia@cfe4f098bcd7b49a82e1727f7837bb4bdd2e3198](https://github.com/JuliaLang/julia/commit/cfe4f098bcd7b49a82e1727f7837bb4bdd2e3198)

*Triggered By:* [link](https://github.com/JuliaLang/julia/commit/cfe4f098bcd7b49a82e1727f7837bb4bdd2e3198#commitcomment-28500741)

*Tag Predicate:* `ALL`

*Daily Job:* 2018-04-10 vs 2018-04-09
...
| `["broadcast", "typeargs", "(\"array\", 10)"]` | 1.08 (15%)  | 1.10 (1%) :x: |
...
| `["broadcast", "typeargs", "(\"tuple\", 5)"]` | 1.25 (15%) :x: | Inf (1%) :x: |
| `["collection", "iteration", "(\"Dict\", \"Int\", \"done\")"]` | 0.67 (25%) :white_check_mark: | 1.00 (1%)  |
...
| `["random", "ranges", "(\"rand\", \"MersenneTwister\", \"Int\", \"1:1000\")"]` | 1.40 (25%) :x: | 1.00 (1%)  |
| `["random", "types", "(\"rand!\", \"RandomDevice\", \"Float64\")"]` | 1.26 (25%) :x: | 1.00 (1%)  |
...
| `["scalar", "arithmetic", "(\"mul\", \"BigInt\", \"Int64\")"]` | 1.70 (50%) :x: | 1.00 (1%)  |
...
| `["scalar", "asin", "(\"0.5 <= abs(x) < 0.975\", \"positive argument\", \"Float64\")"]` | 0.74 (15%) :white_check_mark: | 1.00 (1%)  |
...
| `["scalar", "asinh", "(\"very small\", \"positive argument\", \"Float64\")"]` | 0.84 (15%) :white_check_mark: | 1.00 (1%)  |
...
| `["scalar", "atan", "(\"39/16 <= abs(x) < 2^66\", \"negative argument\", \"Float32\")"]` | 0.83 (15%) :white_check_mark: | 1.00 (1%)  |
...
| `["scalar", "cos", "(\"argument reduction (easy) abs(x) < 6π/4\", \"positive argument\", \"Float32\", \"sin_kernel\")"]` | 0.84 (15%) :white_check_mark: | 1.00 (1%)  |
...
| `["scalar", "cosh", "(\"0 <= abs(x) < 0.00024414062f0\", \"positive argument\", \"Float32\")"]` | 1.16 (15%) :x: | 1.00 (1%)  |
| `["scalar", "cosh", "(\"very large\", \"positive argument\", \"Float32\")"]` | 1.21 (15%) :x: | 1.00 (1%)  |
| `["scalar", "cosh", "(\"very small\", \"positive argument\", \"Float32\")"]` | 1.22 (15%) :x: | 1.00 (1%)  |
| `["scalar", "cosh", "(\"zero\", \"Float32\")"]` | 1.22 (15%) :x: | 1.00 (1%)  |
| `["scalar", "expm1", "(\"very small\", \"negative argument\", \"Float32\")"]` | 0.63 (15%) :white_check_mark: | 1.00 (1%)  |
| `["scalar", "fastmath", "(\"mul\", \"BigInt\")"]` | 1.67 (40%) :x: | 1.00 (1%)  |
| `["scalar", "floatexp", "(\"ldexp\", \"norm -> norm\", \"Float64\")"]` | 1.53 (40%) :x: | 1.00 (1%)  |
| `["scalar", "sin", "(\"argument reduction (hard) abs(x) < 8π/4\", \"negative argument\", \"Float64\", \"sin_kernel\")"]` | 1.23 (15%) :x: | 1.00 (1%)  |
| `["scalar", "sincos", "(\"argument reduction (easy) abs(x) < 3π/4\", \"positive argument\", \"Float64\")"]` | 1.22 (15%) :x: | 1.00 (1%)  |
...
| `["union", "array", "(\"broadcast\", abs, Complex{Float64}, true)"]` | 0.81 (15%) :white_check_mark: | 1.00 (1%)  |
...
| `["union", "array", "(\"perf_countnothing\", Bool, true)"]` | 1.17 (15%) :x: | 1.00 (1%)  |
...
```
Julia Version 0.7.0-DEV.4835
Commit cfe4f09 (2018-04-09 20:52 UTC)
Platform Info:
  ...
  CPU: Intel(R) Xeon(R) CPU E3-1241 v3 @ 3.50GHz: 
       ...
       #1  3501 MHz    1727820 s        256 s     271579 s  115014286 s          1 s
       #2  3501 MHz   14983122 s          0 s     240930 s  101953863 s          0 s
       #3  3501 MHz    1757426 s       2368 s     188258 s  115089874 s          1 s
       #4  3501 MHz    1690798 s          0 s     250364 s  115191387 s          1 s
       
  Memory: 31.383651733398438 GB (20359.5859375 MB free)
  Uptime: 1.172614e6 sec
