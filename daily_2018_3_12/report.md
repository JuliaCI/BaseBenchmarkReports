...
*Commit(s):* [JuliaLang/julia@6a02edfae865054cdc643580ba5fc5269c1654a9](https://github.com/JuliaLang/julia/commit/6a02edfae865054cdc643580ba5fc5269c1654a9)

*Triggered By:* [link](https://github.com/JuliaLang/julia/commit/6a02edfae865054cdc643580ba5fc5269c1654a9#commitcomment-28041239)

*Tag Predicate:* `ALL`

*Daily Job:* 2018-03-12 vs 2018-03-10
...
| `["array", "any/all", "(\"any\", \"UnitRange{Int64}\")"]` | 0.81 (15%) :white_check_mark: | 1.00 (1%)  |
| `["array", "setindex!", "(\"setindex!\", 5)"]` | 0.84 (15%) :white_check_mark: | 1.00 (1%)  |
| `["broadcast", "typeargs", "(\"array\", 10)"]` | 0.66 (15%) :white_check_mark: | 1.00 (1%)  |
...
| `["scalar", "acosh", "(\"one\", \"Float64\")"]` | 0.79 (15%) :white_check_mark: | 1.00 (1%)  |
...
| `["scalar", "exp2", "(\"2pow3\", \"positive argument\", \"Float64\")"]` | 1.59 (15%) :x: | 1.00 (1%)  |
| `["scalar", "expm1", "(\"huge\", \"positive argument\", \"Float64\")"]` | 0.65 (15%) :white_check_mark: | 1.00 (1%)  |
| `["scalar", "expm1", "(\"one\", \"Float32\")"]` | 1.34 (15%) :x: | 1.00 (1%)  |
| `["scalar", "floatexp", "(\"exp\", \"overflow\", \"Float32\")"]` | 0.38 (40%) :white_check_mark: | 1.00 (1%)  |
| `["scalar", "mod2pi", "(\"argument reduction (hard) abs(x) < 6π/4\", \"negative argument\", \"Float64\")"]` | 1.17 (15%) :x: | 1.00 (1%)  |
| `["scalar", "rem_pio2", "(\"argument reduction (easy) abs(x) < 2π/4\", \"negative argument\", \"Float64\")"]` | 0.74 (15%) :white_check_mark: | 1.00 (1%)  |
...
| `["scalar", "tanh", "(\"2.0^-28 <= abs(x) < 1.0\", \"negative argument\", \"Float64\")"]` | 1.20 (15%) :x: | 1.00 (1%)  |
...
```
Julia Version 0.7.0-DEV.4542
Commit 6a02edf (2018-03-12 00:40 UTC)
Platform Info:
  ...
  CPU: Intel(R) Xeon(R) CPU E3-1241 v3 @ 3.50GHz: 
       ...
       #1  3501 MHz  122811790 s          0 s   21663170 s  5486906624 s        105 s
       #2  3501 MHz  542705117 s          0 s   13488997 s  5088759422 s         26 s
       #3  3501 MHz  100657129 s          0 s   11482351 s  5533369031 s         88 s
       #4  3501 MHz   96268871 s          0 s   11660478 s  5537578860 s         23 s
       
  Memory: 31.383651733398438 GB (5838.06640625 MB free)
  Uptime: 5.6481467e7 sec
