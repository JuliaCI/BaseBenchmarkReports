...
*Commit(s):* [JuliaLang/julia@40d72ad113a53c2dfe5a345c54ff9deabea06516](https://github.com/JuliaLang/julia/commit/40d72ad113a53c2dfe5a345c54ff9deabea06516)

*Triggered By:* [link](https://github.com/JuliaLang/julia/commit/40d72ad113a53c2dfe5a345c54ff9deabea06516#commitcomment-33539366)

*Tag Predicate:* `ALL`

*Daily Job:* 2019-05-15 vs 2019-05-14
...
| `["array", "comprehension", "(\"collect\", \"Array{Float64,1}\")"]` | 1.26 (5%) :x: | 1.00 (1%)  |
...
| `["array", "comprehension", "(\"comprehension_collect\", \"StepRangeLen{Float64,Base.TwicePrecision{Float64},Base.TwicePrecision{Float64}}\")"]` | 1.12 (5%) :x: | 1.00 (1%)  |
...
| `["collection", "queries & updates", "(\"Dict\", \"Int\", \"pop!\", \"specified\")"]` | 0.69 (25%) :white_check_mark: | 1.00 (1%)  |
| `["collection", "queries & updates", "(\"Dict\", \"Int\", \"pop!\", \"unspecified\")"]` | 0.58 (25%) :white_check_mark: | 1.00 (1%)  |
| `["collection", "queries & updates", "(\"Dict\", \"Int\", \"push!\", \"new\")"]` | 0.46 (25%) :white_check_mark: | 1.00 (1%)  |
| `["collection", "queries & updates", "(\"Dict\", \"Int\", \"setindex!\", \"new\")"]` | 0.47 (25%) :white_check_mark: | 1.00 (1%)  |
| `["collection", "queries & updates", "(\"Set\", \"Int\", \"first\")"]` | 1.33 (25%) :x: | 1.00 (1%)  |
| `["collection", "set operations", "(\"BitSet\", \"Int\", \"==\", \"BitSet\")"]` | 0.68 (25%) :white_check_mark: | 1.00 (1%)  |
...
| `["misc", "iterators", "zip(1:1000, 1:1000, 1:1000, 1:1000)"]` | 1.11 (5%) :x: | 1.00 (1%)  |
...
| `["scalar", "atanh", "(\"0.5 <= abs(x) < 1\", \"positive argument\", \"Float32\")"]` | 0.93 (5%) :white_check_mark: | 1.00 (1%)  |
...
| `["scalar", "atanh", "(\"2^-28 <= abs(x) < 0.5\", \"positive argument\", \"Float64\")"]` | 0.90 (5%) :white_check_mark: | 1.00 (1%)  |
| `["scalar", "atanh", "(\"one\", \"Float64\")"]` | 0.84 (5%) :white_check_mark: | 1.00 (1%)  |
...
| `["scalar", "cosh", "(\"0.00024414062f0 <= abs(x) < 9f0\", \"positive argument\", \"Float32\")"]` | 0.76 (5%) :white_check_mark: | 1.00 (1%)  |
...
| `["scalar", "sincos", "(\"argument reduction (easy) abs(x) < 8π/4\", \"positive argument\", \"Float32\")"]` | 0.76 (5%) :white_check_mark: | 1.00 (1%)  |
...
| `["union", "array", "(\"map\", abs, Float64, true)"]` | 0.83 (5%) :white_check_mark: | 1.00 (1%)  |
...
| `["union", "array", "(\"skipmissing\", collect, Union{Nothing, Complex{Float64}}, false)"]` | 1.05 (5%) :x: | 1.00 (1%)  |
...
```
Julia Version 1.3.0-DEV.221
Commit 40d72ad (2019-05-14 22:11 UTC)
Platform Info:
  ...
  CPU: Intel(R) Xeon(R) CPU E3-1241 v3 @ 3.50GHz: 
       ...
       #1  3501 MHz   89123307 s       5031 s   10122895 s  3465687171 s         24 s
       #2  3501 MHz  570279902 s        203 s    9553950 s  2990889505 s         21 s
       #3  3501 MHz   72466261 s       3237 s    6012234 s  3492318990 s         30 s
       #4  3501 MHz   68019064 s         12 s    7995860 s  3493672174 s         19 s
       
  Memory: 31.383651733398438 GB (5473.45703125 MB free)
  Uptime: 3.5735219e7 sec
