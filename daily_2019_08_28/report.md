...
*Commit(s):* [JuliaLang/julia@ef75269f86132fd07e3c8799c0a46f297de2066d](https://github.com/JuliaLang/julia/commit/ef75269f86132fd07e3c8799c0a46f297de2066d)

*Triggered By:* [link](https://github.com/JuliaLang/julia/commit/ef75269f86132fd07e3c8799c0a46f297de2066d#commitcomment-34858836)

*Tag Predicate:* `ALL`

*Daily Job:* 2019-08-28 vs 2019-08-27
...
| `["broadcast", "26942"]` | 0.81 (5%) :white_check_mark: | 1.00 (1%)  |
...
| `["collection", "set operations", "(\"BitSet\", \"Int\", \"union!\", \"Vector\")"]` | 0.63 (25%) :white_check_mark: | 1.00 (1%)  |
| `["collection", "set operations", "(\"BitSet\", \"Int\", \"union\", \"Vector\")"]` | 0.70 (25%) :white_check_mark: | 1.00 (1%)  |
| `["collection", "set operations", "(\"BitSet\", \"Int\", \"union\", \"Vector\", \"Vector\")"]` | 0.73 (25%) :white_check_mark: | 1.00 (1%)  |
...
| `["io", "array_limit", "(\"display\", \"Array{Float64,1}(100000000,)\")"]` | 0.90 (5%) :white_check_mark: | 1.74 (1%) :x: |
| `["io", "array_limit", "(\"display\", \"Array{Float64,2}(10000, 10000)\")"]` | 1.07 (5%) :x: | 1.65 (1%) :x: |
| `["io", "array_limit", "(\"display\", \"Array{Float64,2}(100000000, 1)\")"]` | 0.89 (5%) :white_check_mark: | 1.73 (1%) :x: |
...
| `["scalar", "arithmetic", "(\"sub\", \"UInt64\", \"BigInt\")"]` | 2.02 (50%) :x: | 1.00 (1%)  |
...
| `["scalar", "atan", "(\"very small\", \"negative argument\", \"Float32\")"]` | 0.84 (5%) :white_check_mark: | 1.00 (1%)  |
...
| `["scalar", "cbrt", "(\"large\", \"negative argument\", \"Float32\")"]` | 1.15 (5%) :x: | 1.00 (1%)  |
...
| `["scalar", "fastmath", "(\"sub\", \"BigFloat\")"]` | 1.40 (40%) :x: | 1.00 (1%)  |
...
| `["scalar", "sincos", "(\"argument reduction (easy) abs(x) < 9π/4\", \"positive argument\", \"Float32\")"]` | 0.68 (5%) :white_check_mark: | 1.00 (1%)  |
| `["scalar", "sincos", "(\"argument reduction (hard) abs(x) < 4π/4\", \"negative argument\", \"Float32\")"]` | 0.87 (5%) :white_check_mark: | 1.00 (1%)  |
| `["sparse", "constructors", "(\"Bidiagonal\", 100)"]` | 1.16 (5%) :x: | 1.00 (1%)  |
| `["sparse", "constructors", "(\"IJV\", 10)"]` | 0.49 (5%) :white_check_mark: | 1.00 (1%)  |
| `["sparse", "constructors", "(\"IJV\", 100)"]` | 0.30 (5%) :white_check_mark: | 1.00 (1%)  |
| `["sparse", "constructors", "(\"IJV\", 1000)"]` | 0.78 (5%) :white_check_mark: | 1.00 (1%)  |
...
```
Julia Version 1.4.0-DEV.59
Commit ef75269 (2019-08-28 02:25 UTC)
Platform Info:
  ...
  CPU: Intel(R) Xeon(R) CPU E3-1241 v3 @ 3.50GHz: 
       ...
       #1  3501 MHz   98686524 s       5042 s   11428599 s  4360421370 s         28 s
       #2  3501 MHz  669594051 s        208 s   11549024 s  3796476714 s         24 s
       #3  3501 MHz   82166126 s       3248 s    6798469 s  4388638981 s         32 s
       #4  3501 MHz   77071929 s         24 s    9615877 s  4389135577 s         22 s
       
  Memory: 31.383651733398438 GB (14557.515625 MB free)
  Uptime: 4.4809026e7 sec
