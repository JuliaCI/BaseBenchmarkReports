...
*Commit(s):* [JuliaLang/julia@8fa0645ef103db98257f8409bdd8e98d1f42d851](https://github.com/JuliaLang/julia/commit/8fa0645ef103db98257f8409bdd8e98d1f42d851)

*Triggered By:* [link](https://github.com/JuliaLang/julia/commit/8fa0645ef103db98257f8409bdd8e98d1f42d851#commitcomment-32083728)

*Tag Predicate:* `ALL`

*Daily Job:* 2019-01-28 vs 2019-01-27
...
| `["find", "findprev", "(\"Array{Bool,1}\", \"50-50\")"]` | 0.65 (5%) :white_check_mark: | 1.00 (1%)  |
| `["find", "findprev", "(\"BitArray{1}\", \"50-50\")"]` | 1.09 (5%) :x: | 1.00 (1%)  |
| `["io", "array_limit", "(\"display\", \"Array{Float64,2}(10000, 10000)\")"]` | 0.83 (5%) :white_check_mark: | 0.96 (1%) :white_check_mark: |
| `["linalg", "arithmetic", "(\"sqrt\", \"NPDUpperTriangular\", 1024)"]` | 2.04 (45%) :x: | 1.00 (1%)  |
...
| `["misc", "23042", "Complex{Float64}"]` | 1.06 (5%) :x: | 1.00 (1%)  |
...
| `["scalar", "atanh", "(\"0.5 <= abs(x) < 1\", \"positive argument\", \"Float32\")"]` | 1.05 (5%) :x: | 1.00 (1%)  |
...
| `["scalar", "expm1", "(\"arg reduction II\", \"positive argument\", \"Float32\")"]` | 1.38 (5%) :x: | 1.00 (1%)  |
...
| `["scalar", "expm1", "(\"medium\", \"negative argument\", \"Float32\")"]` | 1.22 (5%) :x: | 1.00 (1%)  |
...
| `["union", "array", "(\"map\", abs, Bool, true)"]` | 1.24 (5%) :x: | 1.00 (1%)  |
...
Commit 8fa0645 (2019-01-28 01:13 UTC)
Platform Info:
  ...
  CPU: Intel(R) Xeon(R) CPU E3-1241 v3 @ 3.50GHz: 
       ...
       #1  3501 MHz   73555792 s       5014 s    8200805 s  2561242147 s         23 s
       #2  3501 MHz  431620201 s        203 s    7102489 s  2208645767 s         19 s
       #3  3501 MHz   57111597 s       3226 s    4820625 s  2585327846 s         26 s
       #4  3501 MHz   53475194 s          2 s    6267565 s  2586872453 s         17 s
       
  Memory: 31.383651733398438 GB (5044.52734375 MB free)
  Uptime: 2.6494864e7 sec
