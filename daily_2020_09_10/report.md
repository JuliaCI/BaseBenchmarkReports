...
*Commit(s):* [JuliaLang/julia@c7b17fe3a652af2d08e59477a04d17bdafc6d87f](https://github.com/JuliaLang/julia/commit/c7b17fe3a652af2d08e59477a04d17bdafc6d87f)

*Triggered By:* [link](https://github.com/JuliaLang/julia/commit/c7b17fe3a652af2d08e59477a04d17bdafc6d87f#commitcomment-42176637)

*Tag Predicate:* `ALL`

*Daily Job:* 2020-09-10 vs 2020-09-09
...
| `["array", "equality", "(\"==\", \"Vector{Int64}\")"]` | 1.12 (5%) :x: | 1.00 (1%)  |
| `["array", "equality", "(\"isequal\", \"Vector{Bool}\")"]` | 0.91 (5%) :white_check_mark: | 1.00 (1%)  |
...
| `["collection", "set operations", "(\"BitSet\", \"Int\", \"intersect\")"]` | 1.40 (25%) :x: | 1.00 (1%)  |
...
| `["collection", "set operations", "(\"BitSet\", \"Int\", \"setdiff\", \"BitSet\")"]` | 1.34 (25%) :x: | 1.00 (1%)  |
| `["collection", "set operations", "(\"BitSet\", \"Int\", \"setdiff\", \"Vector\")"]` | 1.26 (25%) :x: | 1.00 (1%)  |
| `["collection", "set operations", "(\"BitSet\", \"Int\", \"symdiff\")"]` | 1.40 (25%) :x: | 1.00 (1%)  |
...
| `["collection", "set operations", "(\"BitSet\", \"Int\", \"union\", \"BitSet\", \"BitSet\")"]` | 1.25 (25%) :x: | 1.00 (1%)  |
...
| `["problem", "raytrace", "raytrace"]` | 1.98 (5%) :x: | 1.00 (1%)  |
| `["random", "collections", "(\"rand\", \"ImplicitRNG\", \"small Set\")"]` | 1.29 (25%) :x: | 1.00 (1%)  |
| `["random", "ranges", "(\"RangeGenerator\", \"BigInt\", \"1:4294967297\")"]` | 1.57 (25%) :x: | 1.00 (1%)  |
...
| `["scalar", "arithmetic", "(\"add\", \"BigInt\", \"Complex{BigInt}\")"]` | 1.88 (50%) :x: | 1.00 (1%)  |
| `["scalar", "arithmetic", "(\"mul\", \"UInt64\", \"BigInt\")"]` | 1.62 (50%) :x: | 1.00 (1%)  |
| `["scalar", "arithmetic", "(\"sub\", \"BigInt\", \"BigInt\")"]` | 0.48 (50%) :white_check_mark: | 1.00 (1%)  |
| `["scalar", "asin", "(\"0.5 <= abs(x) < 0.975\", \"positive argument\", \"Float32\")"]` | 1.16 (5%) :x: | 1.00 (1%)  |
| `["scalar", "asin", "(\"abs(x) < 0.5\", \"negative argument\", \"Float32\")"]` | 1.25 (5%) :x: | 1.00 (1%)  |
| `["scalar", "asin", "(\"abs(x) < 0.5\", \"positive argument\", \"Float32\")"]` | 1.25 (5%) :x: | 1.00 (1%)  |
...
| `["scalar", "mod2pi", "(\"argument reduction (easy) abs(x) < 2.0^20π/4\", \"positive argument\", \"Float64\")"]` | 0.87 (5%) :white_check_mark: | 1.00 (1%)  |
...
| `["scalar", "tanh", "(\"very small\", \"negative argument\", \"Float64\")"]` | 0.84 (5%) :white_check_mark: | 1.00 (1%)  |
...
| `["shootout", "meteor_contest"]` | 1.04 (5%)  | 1.02 (1%) :x: |
...
| `["sparse", "index", "(\"spmat\", \"row\", \"OneTo\", 1000)"]` | 1.30 (30%) :x: | 1.00 (1%)  |
...
| `["union", "array", "(\"skipmissing\", collect, Union{Nothing, Float32}, false)"]` | 1.07 (5%) :x: | 1.00 (1%)  |
| `["union", "array", "(\"skipmissing\", sum, Union{Missing, Bool}, true)"]` | 1.01 (5%)  | 0.83 (1%) :white_check_mark: |
| `["union", "array", "(\"skipmissing\", sum, Union{Missing, ComplexF64}, true)"]` | 1.01 (5%)  | 1.13 (1%) :x: |
...
| `["union", "array", "(\"skipmissing\", sum, Union{Missing, Int8}, true)"]` | 1.05 (5%)  | 0.83 (1%) :white_check_mark: |
...
```
Julia Version 1.6.0-DEV.882
Commit c7b17fe (2020-09-09 22:41 UTC)
Platform Info:
  ...
  CPU: Intel(R) Xeon(R) CPU E3-1241 v3 @ 3.50GHz: 
       ...
       #1  3501 MHz  158673084 s       5069 s   17544264 s  7562671989 s         39 s
       #2  3501 MHz  1208000913 s        220 s   24596832 s  6516909959 s         29 s
       #3  3501 MHz  144241523 s       3325 s   10622023 s  7593285008 s         40 s
       #4  3501 MHz  134971207 s         43 s   15506574 s  7595981165 s         28 s
       
  Memory: 31.383651733398438 GB (14448.99609375 MB free)
  Uptime: 7.7555294e7 sec
