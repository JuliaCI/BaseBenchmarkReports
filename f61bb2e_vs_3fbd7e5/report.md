...
*Commit(s):* [JuliaLang/julia@f61bb2e192e566434caa6c3d9dfa8af7c2044ddb](https://github.com/JuliaLang/julia/commit/f61bb2e192e566434caa6c3d9dfa8af7c2044ddb) vs [JuliaLang/julia@3fbd7e55cc0f5974bbc4889cb5efacd213ee579b](https://github.com/JuliaLang/julia/commit/3fbd7e55cc0f5974bbc4889cb5efacd213ee579b)

*Triggered By:* [link](https://github.com/JuliaLang/julia/pull/31626#issuecomment-480319054)
...
| `["collection", "queries & updates", "(\"Set\", \"Int\", \"first\")"]` | 0.73 (25%) :white_check_mark: | 1.00 (1%)  |
...
| `["find", "findprev", "(\"ispos\", \"Array{UInt8,1}\")"]` | 0.84 (5%) :white_check_mark: | 1.00 (1%)  |
...
| `["misc", "bitshift", "(\"Int\", \"Int\")"]` | 2.00 (5%) :x: | 1.00 (1%)  |
...
| `["problem", "ziggurat", "ziggurat"]` | 0.82 (5%) :white_check_mark: | 1.00 (1%)  |
| `["random", "collections", "(\"rand\", \"ImplicitRNG\", \"large Set\")"]` | 0.70 (25%) :white_check_mark: | 1.00 (1%)  |
| `["random", "collections", "(\"rand\", \"ImplicitRNG\", \"small BitSet\")"]` | 0.74 (25%) :white_check_mark: | 1.00 (1%)  |
...
| `["scalar", "atan", "(\"7/16 <= abs(x) < 11/16\", \"negative argument\", \"Float32\")"]` | 1.64 (5%) :x: | 1.00 (1%)  |
...
| `["scalar", "atan2", "(\"abs(y/x) safe (small)\", \"y negative\", \"x positive\", \"Float32\")"]` | 1.23 (5%) :x: | 1.00 (1%)  |
...
| `["scalar", "tan", "(\"very small\", \"positive argument\", \"Float64\")"]` | 0.73 (5%) :white_check_mark: | 1.00 (1%)  |
| `["scalar", "tan", "(\"zero\", \"Float64\")"]` | 0.50 (5%) :white_check_mark: | 1.00 (1%)  |
| `["scalar", "tanh", "(\"2.0^-28 <= abs(x) < 1.0\", \"negative argument\", \"Float64\")"]` | 1.06 (5%) :x: | 1.00 (1%)  |
| `["shootout", "pidigits"]` | 0.93 (5%) :white_check_mark: | 1.00 (1%)  |
| `["sparse", "index", "(\"spmat\", \"row\", \"array\", 1000)"]` | 0.62 (30%) :white_check_mark: | 1.00 (1%)  |
| `["sparse", "index", "(\"spmat\", \"row\", \"logical\", 1000)"]` | 0.60 (30%) :white_check_mark: | 1.00 (1%)  |
...
| `["tuple", "reduction", "(\"sum\", (4, 4))"]` | 0.63 (5%) :white_check_mark: | 1.00 (1%)  |
...
| `["union", "array", "(\"perf_sum\", Float64, true)"]` | 0.89 (5%) :white_check_mark: | 1.00 (1%)  |
| `["union", "array", "(\"skipmissing\", sum, Float64, false)"]` | 0.76 (5%) :white_check_mark: | 1.00 (1%)  |
...
```
Julia Version 1.2.0-DEV.659
Commit f61bb2e (2019-04-05 15:29 UTC)
Platform Info:
  ...
  CPU: Intel(R) Xeon(R) CPU E3-1241 v3 @ 3.50GHz: 
       ...
       #1  3501 MHz   46396626 s       2433 s   10027492 s  3165672024 s         12 s
       #2  3501 MHz  267520684 s         14 s    4829151 s  2957356501 s         19 s
       #3  3501 MHz   37377358 s       3161 s    4534690 s  3187617300 s         27 s
       #4  3501 MHz   36058261 s         14 s    3407189 s  3191476434 s         25 s
       
  Memory: 31.383651733398438 GB (4624.66015625 MB free)
  Uptime: 3.2321489e7 sec
...
```
Julia Version 1.2.0-DEV.657
Commit 3fbd7e5 (2019-04-05 13:20 UTC)
Platform Info:
  OS: Linux (x86_64-linux-gnu)
      Ubuntu 14.04.5 LTS
  uname: Linux 3.13.0-85-generic #129-Ubuntu SMP Thu Mar 17 20:50:15 UTC 2016 x86_64 x86_64
  CPU: Intel(R) Xeon(R) CPU E3-1241 v3 @ 3.50GHz: 
              speed         user         nice          sys         idle          irq
       #1  3501 MHz   46501777 s       2433 s   10035952 s  3166796682 s         12 s
       #2  3501 MHz  268681360 s         14 s    4842686 s  2957424441 s         19 s
       #3  3501 MHz   37488186 s       3161 s    4539321 s  3188744140 s         27 s
       #4  3501 MHz   36161392 s         14 s    3411542 s  3192611376 s         25 s
       
  Memory: 31.383651733398438 GB (4809.671875 MB free)
  Uptime: 3.2333916e7 sec
