...
*Commit(s):* [JuliaLang/julia@58c0ed57dc796a9bb0759ce49781d97b8474eee3](https://github.com/JuliaLang/julia/commit/58c0ed57dc796a9bb0759ce49781d97b8474eee3)

*Triggered By:* [link](https://github.com/JuliaLang/julia/commit/58c0ed57dc796a9bb0759ce49781d97b8474eee3#commitcomment-31459826)

*Tag Predicate:* `ALL`

*Daily Job:* 2018-11-27 vs 2018-11-26
...
| `["broadcast", "mix_scalar_tuple", "(5, \"scal_tup_x3\")"]` | 1.30 (5%) :x: | 1.00 (1%)  |
| `["broadcast", "typeargs", "(\"array\", 5)"]` | 1.07 (5%) :x: | 1.00 (1%)  |
| `["collection", "deletion", "(\"Vector\", \"Any\", \"filter!\")"]` | 1.84 (25%) :x: | 1.00 (1%)  |
| `["collection", "iteration", "(\"IdDict\", \"Any\", \"iterate\")"]` | 1.33 (25%) :x: | 1.00 (1%)  |
| `["collection", "iteration", "(\"IdDict\", \"String\", \"iterate\")"]` | 1.37 (25%) :x: | 1.00 (1%)  |
| `["collection", "iteration", "(\"Set\", \"String\", \"iterate second\")"]` | 1.26 (25%) :x: | 1.00 (1%)  |
| `["collection", "set operations", "(\"BitSet\", \"Int\", \"union!\", \"big\")"]` | 1.28 (25%) :x: | 1.00 (1%)  |
| `["collection", "set operations", "(\"BitSet\", \"Int\", \"union\", \"BitSet\", \"BitSet\")"]` | 1.29 (25%) :x: | 1.00 (1%)  |
...
| `["problem", "spellcheck", "spellcheck"]` | 1.16 (5%) :x: | 1.00 (1%)  |
| `["problem", "stockcorr", "stockcorr"]` | 1.07 (5%) :x: | 1.00 (1%)  |
| `["problem", "ziggurat", "ziggurat"]` | 1.19 (5%) :x: | 1.00 (1%)  |
| `["random", "collections", "(\"rand\", \"ImplicitRNG\", \"large Dict\")"]` | 1.41 (25%) :x: | 1.00 (1%)  |
| `["random", "collections", "(\"rand\", \"ImplicitRNG\", \"small Set\")"]` | 1.42 (25%) :x: | 1.00 (1%)  |
| `["random", "collections", "(\"rand\", \"MersenneTwister\", \"small Set\")"]` | 1.37 (25%) :x: | 1.00 (1%)  |
...
| `["scalar", "arithmetic", "(\"sub\", \"Complex{BigInt}\", \"Int64\")"]` | 1.54 (50%) :x: | 1.00 (1%)  |
...
| `["scalar", "sincos", "(\"argument reduction (easy) abs(x) < 2.0^20π/4\", \"negative argument\", \"Float32\")"]` | 0.84 (5%) :white_check_mark: | 1.00 (1%)  |
...
```
Julia Version 1.1.0-DEV.720
Commit 58c0ed5 (2018-11-26 20:39 UTC)
Platform Info:
  ...
  CPU: Intel(R) Xeon(R) CPU E3-1241 v3 @ 3.50GHz: 
       ...
       #1  3501 MHz   63231188 s       5008 s    6947532 s  2038306180 s         22 s
       #2  3501 MHz  347895688 s        203 s    5606543 s  1758592089 s         17 s
       #3  3501 MHz   47160704 s       3214 s    4005498 s  2060820099 s         25 s
       #4  3501 MHz   43852013 s          0 s    5109206 s  2062605794 s         15 s
       
  Memory: 31.383651733398438 GB (4977.58984375 MB free)
  Uptime: 2.1138341e7 sec
