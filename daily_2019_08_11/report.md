...
*Commit(s):* [JuliaLang/julia@d5db35b967796095635879eccc983acc873ff62d](https://github.com/JuliaLang/julia/commit/d5db35b967796095635879eccc983acc873ff62d)

*Triggered By:* [link](https://github.com/JuliaLang/julia/commit/d5db35b967796095635879eccc983acc873ff62d#commitcomment-34646877)

*Tag Predicate:* `ALL`

*Daily Job:* 2019-08-11 vs 2019-08-10
...
| `["array", "index", "(\"sumcolon\", \"100000:-1:1\")"]` | 1.72 (50%) :x: | 1.00 (1%)  |
...
| `["collection", "deletion", "(\"Dict\", \"Int\", \"filter!\")"]` | 1.52 (25%) :x: | 1.00 (1%)  |
...
| `["io", "array_limit", "(\"display\", \"Array{Float64,2}(100000000, 1)\")"]` | 0.94 (5%) :white_check_mark: | 1.01 (1%)  |
...
| `["scalar", "atan", "(\"39/16 <= abs(x) < 2^66\", \"negative argument\", \"Float64\")"]` | 1.05 (5%) :x: | 1.00 (1%)  |
...
| `["scalar", "cos", "(\"argument reduction (easy) abs(x) < 9π/4\", \"negative argument\", \"Float64\", \"cos_kernel\")"]` | 1.15 (5%) :x: | 1.00 (1%)  |
...
```
Julia Version 1.3.0-alpha.96
Commit d5db35b (2019-08-10 20:08 UTC)
Platform Info:
  ...
  CPU: Intel(R) Xeon(R) CPU E3-1241 v3 @ 3.50GHz: 
       ...
       #1  3501 MHz   95958962 s       5038 s   11122735 s  4216894709 s         27 s
       #2  3501 MHz  642967171 s        208 s   10994936 s  3676851969 s         24 s
       #3  3501 MHz   79412989 s       3245 s    6599536 s  4244830379 s         31 s
       #4  3501 MHz   74482774 s         22 s    9351046 s  4245251166 s         22 s
       
  Memory: 31.383651733398438 GB (15164.171875 MB free)
  Uptime: 4.3340185e7 sec
