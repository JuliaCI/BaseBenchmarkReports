...
*Commit(s):* [JuliaLang/julia@97f142f9da3046737169197fef8fe5bcc75d92d7](https://github.com/JuliaLang/julia/commit/97f142f9da3046737169197fef8fe5bcc75d92d7)

*Triggered By:* [link](https://github.com/JuliaLang/julia/commit/97f142f9da3046737169197fef8fe5bcc75d92d7#commitcomment-35703348)

*Tag Predicate:* `ALL`

*Daily Job:* 2019-10-29 vs 2019-10-28
...
| `["array", "convert", "(\"Float64\", \"Int\")"]` | 1.31 (5%) :x: | 1.00 (1%)  |
...
| `["array", "index", "(\"sumcolon\", \"1:100000\")"]` | 1.60 (50%) :x: | 1.00 (1%)  |
...
| `["collection", "queries & updates", "(\"Set\", \"Int\", \"push!\", \"overwrite\")"]` | 0.45 (25%) :white_check_mark: | 1.00 (1%)  |
...
| `["linalg", "blas", "scal"]` | 1.48 (40%) :x: | 1.00 (1%)  |
...
| `["random", "ranges", "(\"rand\", \"MersenneTwister\", \"Int16\", \"RangeGenerator(1:1)\")"]` | 1.53 (25%) :x: | 1.00 (1%)  |
| `["random", "types", "(\"rand!\", \"MersenneTwister\", \"Complex{Float64}\")"]` | 1.81 (25%) :x: | 1.00 (1%)  |
| `["random", "types", "(\"randexp\", \"MersenneTwister\", \"Float32\")"]` | 0.71 (25%) :white_check_mark: | 1.00 (1%)  |
...
| `["sparse", "matmul", "(\"A_mul_B\", \"dense 5x500, sparse 500x500 -> dense 5x500\")"]` | 1.43 (30%) :x: | 1.00 (1%)  |
| `["sparse", "matmul", "(\"At_mul_B!\", \"dense 400x400, sparse 400x40 -> dense 400x40\")"]` | 1.33 (30%) :x: | 1.00 (1%)  |
| `["sparse", "matmul", "(\"At_mul_B!\", \"dense 40x4000, sparse 40x40 -> dense 4000x40\")"]` | 1.36 (30%) :x: | 1.00 (1%)  |
| `["sparse", "matmul", "(\"At_mul_B\", \"dense 500x5, sparse 500x50 -> dense 5x50\")"]` | 1.58 (30%) :x: | 1.00 (1%)  |
| `["sparse", "matmul", "(\"At_mul_B\", \"dense 500x5, sparse 500x500 -> dense 5x500\")"]` | 1.71 (30%) :x: | 1.00 (1%)  |
| `["sparse", "matmul", "(\"At_mul_B\", \"dense 50x5, sparse 50x500 -> dense 5x500\")"]` | 1.71 (30%) :x: | 1.00 (1%)  |
| `["sparse", "matmul", "(\"At_mul_B\", \"dense 50x50, sparse 50x50 -> dense 50x50\")"]` | 1.65 (30%) :x: | 1.00 (1%)  |
| `["sparse", "matmul", "(\"At_mul_B\", \"dense 5x5, sparse 5x500 -> dense 5x500\")"]` | 1.70 (30%) :x: | 1.00 (1%)  |
| `["sparse", "matmul", "(\"At_mul_B\", \"dense 5x50, sparse 5x50 -> dense 50x50\")"]` | 1.66 (30%) :x: | 1.00 (1%)  |
...
| `["union", "array", "(\"broadcast\", abs, Int64, true)"]` | 1.29 (5%) :x: | 1.00 (1%)  |
...
| `["union", "array", "(\"broadcast\", identity, Float32, false)"]` | 1.20 (5%) :x: | 1.00 (1%)  |
...
| `["union", "array", "(\"map\", identity, BigFloat, true)"]` | 1.28 (5%) :x: | 1.00 (1%)  |
...
```
Julia Version 1.4.0-DEV.386
Commit 97f142f (2019-10-29 02:43 UTC)
Platform Info:
  ...
  CPU: Intel(R) Xeon(R) CPU E3-1241 v3 @ 3.50GHz: 
       ...
       #1  3501 MHz  106064779 s       5044 s   12389710 s  4886601219 s         30 s
       #2  3501 MHz  747102533 s        214 s   13422768 s  4252214591 s         24 s
       #3  3501 MHz   89823129 s       3255 s    7350212 s  4915766074 s         34 s
       #4  3501 MHz   84205987 s         32 s   10439653 s  4916291258 s         23 s
       
  Memory: 31.383651733398438 GB (15371.63671875 MB free)
  Uptime: 5.0165473e7 sec
