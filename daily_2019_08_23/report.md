...
*Commit(s):* [JuliaLang/julia@5ae63b884036508fc08561df9ef6827bae884569](https://github.com/JuliaLang/julia/commit/5ae63b884036508fc08561df9ef6827bae884569)

*Triggered By:* [link](https://github.com/JuliaLang/julia/commit/5ae63b884036508fc08561df9ef6827bae884569#commitcomment-34802986)

*Tag Predicate:* `ALL`

*Daily Job:* 2019-08-23 vs 2019-08-22
...
| `["misc", "iterators", "sum(flatten(collect((i,i+1) for i in 1:1000))"]` | 1.19 (5%) :x: | 1.00 (1%)  |
...
| `["scalar", "arithmetic", "(\"mul\", \"Float32\", \"Float32\")"]` | 1.31 (25%) :x: | 1.00 (1%)  |
...
| `["scalar", "asinh", "(\"0 <= abs(x) < 2^-28\", \"negative argument\", \"Float64\")"]` | 0.83 (5%) :white_check_mark: | 1.00 (1%)  |
...
| `["scalar", "atan2", "(\"abs(y/x) safe (small)\", \"y positive\", \"x positive\", \"Float32\")"]` | 1.21 (5%) :x: | 1.00 (1%)  |
| `["scalar", "atan2", "(\"x one\", \"Float32\")"]` | 1.63 (5%) :x: | 1.00 (1%)  |
...
| `["scalar", "tan", "(\"very small\", \"negative argument\", \"Float64\")"]` | 0.67 (5%) :white_check_mark: | 1.00 (1%)  |
...
| `["sparse", "constructors", "(\"Tridiagonal\", 100)"]` | 0.85 (5%) :white_check_mark: | 1.00 (1%)  |
...
| `["union", "array", "(\"perf_sum2\", Complex{Float64}, true)"]` | 0.80 (5%) :white_check_mark: | 1.00 (1%)  |
...
```
Julia Version 1.4.0-DEV.35
Commit 5ae63b8 (2019-08-22 23:11 UTC)
Platform Info:
  ...
  CPU: Intel(R) Xeon(R) CPU E3-1241 v3 @ 3.50GHz: 
       ...
       #1  3501 MHz   97892185 s       5041 s   11346513 s  4318179799 s         28 s
       #2  3501 MHz  660987548 s        208 s   11385664 s  3762060942 s         24 s
       #3  3501 MHz   81349706 s       3245 s    6744353 s  4346345900 s         32 s
       #4  3501 MHz   76315905 s         24 s    9506604 s  4346871516 s         22 s
       
  Memory: 31.383651733398438 GB (14785.3046875 MB free)
  Uptime: 4.4377035e7 sec
  Load Avg:  0.87548828125  0.994140625  1.03466796875
  WORD_SIZE: 64
  LIBM: libopenlibm
