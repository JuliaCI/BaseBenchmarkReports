...
*Commit(s):* [JuliaLang/julia@5ce94d8d2774019a8704e03b69ff2b99647551e5](https://github.com/JuliaLang/julia/commit/5ce94d8d2774019a8704e03b69ff2b99647551e5)

*Triggered By:* [link](https://github.com/JuliaLang/julia/commit/5ce94d8d2774019a8704e03b69ff2b99647551e5#commitcomment-33152327)

*Tag Predicate:* `ALL`

*Daily Job:* 2019-04-12 vs 2019-04-10
...
| `["array", "growth", "(\"prerend!\", 8)"]` | 0.79 (5%) :white_check_mark: | 1.00 (1%)  |
...
| `["dates", "parse", "(\"DateTime\", \"RFC1123Format\", \"Lowercase\")"]` | 1.46 (5%) :x: | 1.00 (1%)  |
| `["dates", "parse", "(\"DateTime\", \"RFC1123Format\", \"Mixedcase\")"]` | 1.35 (5%) :x: | 1.00 (1%)  |
| `["dates", "parse", "(\"DateTime\", \"RFC1123Format\", \"Titlecase\")"]` | 1.47 (5%) :x: | 1.00 (1%)  |
...
| `["find", "findprev", "(\"Array{Bool,1}\", \"50-50\")"]` | 0.22 (5%) :white_check_mark: | 1.00 (1%)  |
...
| `["io", "array_limit", "(\"display\", \"Array{Float64,1}(100000000,)\")"]` | 0.99 (5%)  | 0.99 (1%) :white_check_mark: |
...
| `["scalar", "exp2", "(\"very small\", \"positive argument\", \"Float64\")"]` | 1.19 (5%) :x: | 1.00 (1%)  |
...
| `["scalar", "expm1", "(\"arg reduction I\", \"positive argument\", \"Float32\")"]` | 1.12 (5%) :x: | 1.00 (1%)  |
| `["scalar", "expm1", "(\"huge\", \"positive argument\", \"Float3\")"]` | 1.19 (5%) :x: | 1.00 (1%)  |
| `["scalar", "expm1", "(\"large\", \"negative argument\", \"Float32\")"]` | 1.11 (5%) :x: | 1.00 (1%)  |
| `["scalar", "expm1", "(\"large\", \"positive argument\", \"Float32\")"]` | 1.28 (5%) :x: | 1.00 (1%)  |
| `["scalar", "expm1", "(\"medium\", \"negative argument\", \"Float32\")"]` | 1.39 (5%) :x: | 1.00 (1%)  |
| `["scalar", "expm1", "(\"medium\", \"negative argument\", \"Float64\")"]` | 0.94 (5%) :white_check_mark: | 1.00 (1%)  |
| `["scalar", "expm1", "(\"medium\", \"positive argument\", \"Float32\")"]` | 1.28 (5%) :x: | 1.00 (1%)  |
| `["scalar", "expm1", "(\"one\", \"Float32\")"]` | 0.93 (5%) :white_check_mark: | 1.00 (1%)  |
...
| `["scalar", "predicate", "(\"isless\", \"Int64\")"]` | 1.31 (25%) :x: | 1.00 (1%)  |
...
| `["union", "array", "(\"broadcast\", identity, Complex{Float64}, false)"]` | 1.08 (5%) :x: | 1.00 (1%)  |
...
| `["union", "array", "(\"perf_sum2\", BigInt, true)"]` | 0.95 (5%) :white_check_mark: | 1.00 (1%)  |
...
| `["union", "array", "(\"perf_sum4\", BigInt, false)"]` | 2.02 (5%) :x: | 1.00 (1%)  |
| `["union", "array", "(\"perf_sum4\", BigInt, true)"]` | 2.02 (5%) :x: | 1.00 (1%)  |
...
```
Julia Version 1.3.0-DEV.6
Commit 5ce94d8 (2019-04-11 23:18 UTC)
Platform Info:
  ...
  CPU: Intel(R) Xeon(R) CPU E3-1241 v3 @ 3.50GHz: 
       ...
       #1  3501 MHz   84237557 s       5022 s    9544866 s  3186748191 s         24 s
       #2  3501 MHz  522067287 s        203 s    8767231 s  2754995611 s         19 s
       #3  3501 MHz   67434730 s       3232 s    5693445 s  3212697759 s         28 s
       #4  3501 MHz   63399412 s         12 s    7502217 s  3213979181 s         18 s
       
  Memory: 31.383651733398438 GB (4544.546875 MB free)
  Uptime: 3.2884325e7 sec
