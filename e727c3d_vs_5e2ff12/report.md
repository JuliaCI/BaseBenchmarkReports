...
*Commit(s):* [JuliaLang/julia@e727c3df84ec47934ea748945d1caece93c713e3](https://github.com/JuliaLang/julia/commit/e727c3df84ec47934ea748945d1caece93c713e3) vs [JuliaLang/julia@5e2ff127f861ead7b08ce782b830069d77c97f2f](https://github.com/JuliaLang/julia/commit/5e2ff127f861ead7b08ce782b830069d77c97f2f)

*Triggered By:* [link](https://github.com/JuliaLang/julia/pull/25496#issuecomment-357849698)
...
| `["array", "index", "(\"sumrange\", \"BitArray{2}\")"]` | 1.61 (50%) :x: | 1.00 (1%)  |
| `["broadcast", "sparse", "((1000, 1000), 2)"]` | 1.19 (15%) :x: | 1.00 (1%)  |
| `["broadcast", "typeargs", "(\"tuple\", 10)"]` | 0.82 (15%) :white_check_mark: | 1.00 (1%)  |
| `["collection", "queries & updates", "(\"Vector\", \"Any\", \"getindex\")"]` | 0.65 (25%) :white_check_mark: | 1.00 (1%)  |
...
| `["scalar", "arithmetic", "(\"sub\", \"Complex{Int64}\", \"Complex{BigInt}\")"]` | 2.06 (50%) :x: | 1.00 (1%)  |
| `["scalar", "arithmetic", "(\"sub\", \"Int64\", \"Complex{BigInt}\")"]` | 1.75 (50%) :x: | 1.00 (1%)  |
...
| `["scalar", "atan2", "(\"y infinite\", \"y negative\", \"x finite\", \"x negative\", \"Float64\")"]` | 0.59 (15%) :white_check_mark: | 1.00 (1%)  |
| `["scalar", "cos", "(\"argument reduction (easy) abs(x) < 8π/4\", \"positive argument\", \"Float32\", \"cos_kernel\")"]` | 1.25 (15%) :x: | 1.00 (1%)  |
| `["scalar", "cos", "(\"argument reduction (easy) abs(x) < 8π/4\", \"positive argument\", \"Float64\", \"cos_kernel\")"]` | 1.29 (15%) :x: | 1.00 (1%)  |
| `["scalar", "cos", "(\"argument reduction (easy) abs(x) < 9π/4\", \"positive argument\", \"Float32\", \"cos_kernel\")"]` | 1.25 (15%) :x: | 1.00 (1%)  |
| `["scalar", "cos", "(\"argument reduction (easy) abs(x) < 9π/4\", \"positive argument\", \"Float64\", \"cos_kernel\")"]` | 1.25 (15%) :x: | 1.00 (1%)  |
...
| `["scalar", "sincos", "(\"argument reduction (easy) abs(x) < 2π/4\", \"negative argument\", \"Float64\")"]` | 0.84 (15%) :white_check_mark: | 1.00 (1%)  |
...
| `["scalar", "sincos", "(\"argument reduction (easy) abs(x) < 9π/4\", \"positive argument\", \"Float32\")"]` | 0.74 (15%) :white_check_mark: | 1.00 (1%)  |
| `["scalar", "sincos", "(\"argument reduction (easy) abs(x) < 9π/4\", \"positive argument\", \"Float64\")"]` | 0.78 (15%) :white_check_mark: | 1.00 (1%)  |
| `["simd", "(\"sum_reduce\", \"Float64\", 4096)"]` | 1.26 (20%) :x: | 1.00 (1%)  |
| `["sparse", "matmul", "(\"A_mul_B\", \"sparse 500x5, dense 5x5 -> dense 500x5\")"]` | 1.45 (30%) :x: | 1.00 (1%)  |
...
```
Julia Version 0.7.0-DEV.3418
Commit e727c3d (2018-01-15 21:36 UTC)
Platform Info:
  ...
  CPU: Intel(R) Xeon(R) CPU E3-1241 v3 @ 3.50GHz: 
       ...
       #1  3501 MHz  113748882 s          0 s   20044151 s  5024575359 s        100 s
       #2  3501 MHz  482082123 s          0 s   12592522 s  4675843363 s         24 s
       #3  3501 MHz   93881093 s          0 s   10730864 s  5066419637 s         84 s
       #4  3501 MHz   89836552 s          0 s   10930247 s  5070252446 s         21 s
       
  Memory: 31.383651733398438 GB (4015.4296875 MB free)
  Uptime: 5.1734698e7 sec
...
Commit 5e2ff12 (2018-01-15 17:38 UTC)
Platform Info:
  OS: Linux (x86_64-linux-gnu)
      Ubuntu 14.04.4 LTS
  uname: Linux 3.13.0-85-generic #129-Ubuntu SMP Thu Mar 17 20:50:15 UTC 2016 x86_64 x86_64
  CPU: Intel(R) Xeon(R) CPU E3-1241 v3 @ 3.50GHz: 
              speed         user         nice          sys         idle          irq
       #1  3501 MHz  113837818 s          0 s   20054462 s  5025437311 s        100 s
       #2  3501 MHz  482975288 s          0 s   12602401 s  4675904301 s         24 s
       #3  3501 MHz   93966129 s          0 s   10738578 s  5067290893 s         84 s
       #4  3501 MHz   89940932 s          0 s   10938062 s  5071104601 s         21 s
       
  Memory: 31.383651733398438 GB (4309.09375 MB free)
  Uptime: 5.1744347e7 sec
  Load Avg:  1.0029296875  1.0166015625  1.04443359375
  WORD_SIZE: 64
  BLAS: libopenblas (USE64BITINT DYNAMIC_ARCH NO_AFFINITY Haswell)
  LAPACK: libopenblas64_
  LIBM: libopenlibm
