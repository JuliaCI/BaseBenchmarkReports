...
*Commit(s):* [JuliaLang/julia@09cf111437da400a82357564b3de521c1d377896](https://github.com/JuliaLang/julia/commit/09cf111437da400a82357564b3de521c1d377896) vs [JuliaLang/julia@c690489cf429c47a23d1da89e3dfc52290f24309](https://github.com/JuliaLang/julia/commit/c690489cf429c47a23d1da89e3dfc52290f24309)

*Triggered By:* [link](https://github.com/JuliaLang/julia/pull/32556#issuecomment-510616403)
...
| `["array", "setindex!", "(\"setindex!\", 3)"]` | 1.46 (5%) :x: | 1.00 (1%)  |
| `["array", "subarray", "(\"lucompletepivCopy!\", 1000)"]` | 0.77 (5%) :white_check_mark: | 1.00 (1%)  |
| `["array", "subarray", "(\"lucompletepivCopy!\", 250)"]` | 0.64 (5%) :white_check_mark: | 1.00 (1%)  |
| `["array", "subarray", "(\"lucompletepivCopy!\", 500)"]` | 0.74 (5%) :white_check_mark: | 1.00 (1%)  |
| `["array", "subarray", "(\"lucompletepivSub!\", 1000)"]` | 0.82 (5%) :white_check_mark: | 1.00 (1%)  |
| `["array", "subarray", "(\"lucompletepivSub!\", 250)"]` | 0.61 (5%) :white_check_mark: | 1.00 (1%)  |
| `["array", "subarray", "(\"lucompletepivSub!\", 500)"]` | 0.79 (5%) :white_check_mark: | 1.00 (1%)  |
...
| `["collection", "set operations", "(\"BitSet\", \"Int\", \"setdiff!\", \"small\")"]` | 0.72 (25%) :white_check_mark: | 1.00 (1%)  |
...
| `["dates", "parse", "(\"DateTime\", \"RFC1123Format\", \"Mixedcase\")"]` | 0.64 (5%) :white_check_mark: | 1.00 (1%)  |
...
| `["io", "array_limit", "(\"display\", \"Array{Float64,1}(100000000,)\")"]` | 1.10 (5%) :x: | 0.99 (1%) :white_check_mark: |
| `["io", "array_limit", "(\"display\", \"Array{Float64,2}(10000, 10000)\")"]` | 0.91 (5%) :white_check_mark: | 0.91 (1%) :white_check_mark: |
| `["io", "array_limit", "(\"display\", \"Array{Float64,2}(100000000, 1)\")"]` | 1.10 (5%) :x: | 0.99 (1%) :white_check_mark: |
| `["io", "read", "readstring"]` | 1.05 (5%) :x: | 1.00 (1%)  |
| `["io", "serialization", "(\"deserialize\", \"Matrix{Float64}\")"]` | 0.93 (5%) :white_check_mark: | 1.00 (1%)  |
| `["io", "serialization", "(\"deserialize\", \"Vector{String}\")"]` | 1.18 (5%) :x: | 1.00 (1%)  |
| `["io", "serialization", "(\"serialize\", \"Vector{String}\")"]` | 1.16 (5%) :x: | 1.00 (1%)  |
| `["io", "skipchars"]` | 0.93 (5%) :white_check_mark: | 1.00 (1%)  |
| `["linalg", "arithmetic", "(\"-\", \"Matrix\", \"Matrix\", 256)"]` | 2.51 (45%) :x: | 1.00 (1%)  |
| `["linalg", "blas", "scal"]` | 1.47 (40%) :x: | 1.00 (1%)  |
...
| `["problem", "grigoriadis khachiyan", "grigoriadis_khachiyan"]` | 0.72 (5%) :white_check_mark: | 1.00 (1%)  |
| `["problem", "json", "parse_json"]` | 1.10 (5%) :x: | 1.00 (1%)  |
| `["problem", "laplacian", "laplace_iter_sub"]` | 0.66 (5%) :white_check_mark: | 1.00 (1%)  |
| `["problem", "laplacian", "laplace_iter_vec"]` | 0.60 (5%) :white_check_mark: | 1.00 (1%)  |
| `["problem", "laplacian", "laplace_sparse_matvec"]` | 0.94 (5%) :white_check_mark: | 1.00 (1%)  |
| `["problem", "raytrace", "raytrace"]` | 0.90 (5%) :white_check_mark: | 1.00 (1%)  |
...
| `["scalar", "asinh", "(\"very large\", \"negative argument\", \"Float32\")"]` | 0.77 (5%) :white_check_mark: | 1.00 (1%)  |
| `["scalar", "asinh", "(\"very large\", \"positive argument\", \"Float32\")"]` | 0.75 (5%) :white_check_mark: | 1.00 (1%)  |
...
| `["scalar", "sinh", "(\"very small\", \"negative argument\", \"Float64\")"]` | 0.80 (5%) :white_check_mark: | 1.00 (1%)  |
...
| `["sparse", "sparse solves", "least squares (default), vector rhs"]` | 0.85 (5%) :white_check_mark: | 1.00 (1%)  |
| `["sparse", "sparse solves", "least squares (qr), matrix rhs"]` | 0.87 (5%) :white_check_mark: | 1.00 (1%)  |
| `["sparse", "sparse solves", "least squares (qr), vector rhs"]` | 0.85 (5%) :white_check_mark: | 1.00 (1%)  |
...
| `["sparse", "sparse solves", "square system (lu), vector rhs"]` | 0.78 (5%) :white_check_mark: | 1.00 (1%)  |
...
| `["union", "array", "(\"perf_sum4\", BigInt, false)"]` | 0.56 (5%) :white_check_mark: | 1.00 (1%)  |
...
| `["union", "array", "(\"skipmissing\", collect, Union{Nothing, BigInt}, false)"]` | 1.09 (5%) :x: | 1.00 (1%)  |
...
```
Julia Version 1.3.0-DEV.538
Commit 09cf111 (2019-07-11 19:11 UTC)
Platform Info:
  ...
  CPU: Intel(R) Xeon(R) CPU E3-1241 v3 @ 3.50GHz: 
       ...
       #1  3501 MHz   92278841 s       5036 s   10609052 s  3959498490 s         26 s
       #2  3501 MHz  601295858 s        208 s   10150117 s  3457308899 s         22 s
       #3  3501 MHz   75664482 s       3239 s    6357818 s  3986680272 s         30 s
       #4  3501 MHz   71000129 s         20 s    8963250 s  3987105273 s         21 s
       
  Memory: 31.383651733398438 GB (10942.91015625 MB free)
  Uptime: 4.0717694e7 sec
...
```
Julia Version 1.3.0-DEV.536
Commit c690489 (2019-07-11 19:11 UTC)
Platform Info:
  OS: Linux (x86_64-linux-gnu)
      Ubuntu 14.04.5 LTS
  uname: Linux 3.13.0-85-generic #129-Ubuntu SMP Thu Mar 17 20:50:15 UTC 2016 x86_64 x86_64
  CPU: Intel(R) Xeon(R) CPU E3-1241 v3 @ 3.50GHz: 
              speed         user         nice          sys         idle          irq
       #1  3501 MHz   92385418 s       5036 s   10616906 s  3960571675 s         26 s
       #2  3501 MHz  602409739 s        208 s   10163048 s  3457373389 s         22 s
       #3  3501 MHz   75778782 s       3239 s    6363072 s  3987751986 s         30 s
       #4  3501 MHz   71096141 s         20 s    8967744 s  3988196085 s         21 s
       
  Memory: 31.383651733398438 GB (9665.40625 MB free)
  Uptime: 4.0729611e7 sec
  Load Avg:  1.0029296875  1.0146484375  1.04541015625
  WORD_SIZE: 64
  LIBM: libopenlibm
  LLVM: libLLVM-6.0.1 (ORCJIT, haswell)
