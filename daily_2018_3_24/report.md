...
*Commit(s):* [JuliaLang/julia@78c7d8736942181eb71087769d98503446e5bc60](https://github.com/JuliaLang/julia/commit/78c7d8736942181eb71087769d98503446e5bc60)

*Triggered By:* [link](https://github.com/JuliaLang/julia/commit/78c7d8736942181eb71087769d98503446e5bc60#commitcomment-28247319)

*Tag Predicate:* `ALL`

*Daily Job:* 2018-03-24 vs 2018-03-21
...
| `["array", "comprehension", "(\"comprehension_iteration\", \"StepRangeLen{Float64,Base.TwicePrecision{Float64},Base.TwicePrecision{Float64}}\")"]` | 0.84 (15%) :white_check_mark: | 1.00 (1%)  |
...
| `["broadcast", "mix_scalar_tuple", "(3, \"scal_tup_x3\")"]` | 1.44 (15%) :x: | 1.00 (1%)  |
| `["broadcast", "mix_scalar_tuple", "(5, \"scal_tup_x3\")"]` | 1.20 (15%) :x: | 1.00 (1%)  |
| `["broadcast", "typeargs", "(\"array\", 10)"]` | 1.09 (15%)  | 1.10 (1%) :x: |
| `["broadcast", "typeargs", "(\"array\", 3)"]` | 1.06 (15%)  | 1.14 (1%) :x: |
| `["broadcast", "typeargs", "(\"array\", 5)"]` | 1.08 (15%)  | 1.13 (1%) :x: |
| `["broadcast", "typeargs", "(\"tuple\", 10)"]` | 1.25 (15%) :x: | 1.00 (1%)  |
| `["broadcast", "typeargs", "(\"tuple\", 3)"]` | 1.09 (15%)  | Inf (1%) :x: |
| `["collection", "queries & updates", "(\"Dict\", \"Any\", \"getindex\")"]` | 0.72 (25%) :white_check_mark: | 1.00 (1%)  |
| `["collection", "queries & updates", "(\"Dict\", \"Int\", \"in\", \"true\")"]` | 0.71 (25%) :white_check_mark: | 1.00 (1%)  |
| `["find", "findall", "(\"Array{Bool,1}\", \"10-90\")"]` | 0.80 (15%) :white_check_mark: | 1.00 (1%)  |
| `["find", "findall", "(\"ispos\", \"Array{Int64,1}\")"]` | 1.31 (15%) :x: | 1.00 (1%)  |
...
| `["scalar", "atan2", "(\"abs(y/x) high\", \"y negative\", \"x positive\", \"Float64\")"]` | 1.50 (15%) :x: | 1.00 (1%)  |
| `["scalar", "atan2", "(\"abs(y/x) safe (large)\", \"y negative\", \"x positive\", \"Float32\")"]` | 0.75 (15%) :white_check_mark: | 1.00 (1%)  |
...
| `["scalar", "cos", "(\"argument reduction (hard) abs(x) < 8π/4\", \"positive argument\", \"Float32\", \"cos_kernel\")"]` | 0.69 (15%) :white_check_mark: | 1.00 (1%)  |
...
| `["scalar", "cosh", "(\"very small\", \"positive argument\", \"Float32\")"]` | 0.82 (15%) :white_check_mark: | 1.00 (1%)  |
| `["scalar", "fastmath", "(\"mul\", \"Complex{BigInt}\")"]` | 0.55 (40%) :white_check_mark: | 1.00 (1%)  |
| `["scalar", "fastmath", "(\"mul\", \"Complex{Int64}\")"]` | 0.56 (40%) :white_check_mark: | 1.00 (1%)  |
...
| `["scalar", "sincos", "(\"argument reduction (easy) abs(x) < 4π/4\", \"negative argument\", \"Float64\")"]` | 1.18 (15%) :x: | 1.00 (1%)  |
...
| `["scalar", "tanh", "(\"very small\", \"positive argument\", \"Float32\")"]` | 0.59 (15%) :white_check_mark: | 1.00 (1%)  |
...
Commit 78c7d87 (2018-03-23 22:25 UTC)
Platform Info:
  ...
  CPU: Intel(R) Xeon(R) CPU E3-1241 v3 @ 3.50GHz: 
       ...
       #1  3501 MHz  123512256 s          0 s   21857464 s  5589264571 s        108 s
       #2  3501 MHz  547814541 s          0 s   13620876 s  5187093794 s         27 s
       #3  3501 MHz  101304635 s          0 s   11598606 s  5636192260 s         90 s
       #4  3501 MHz   96904548 s          0 s   11774404 s  5640417956 s         24 s
       
  Memory: 31.383651733398438 GB (5576.5625 MB free)
  Uptime: 5.7517924e7 sec
