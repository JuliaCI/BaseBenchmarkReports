...
*Commit(s):* [JuliaLang/julia@4412dd4d92fb4e86d67973b48703bc1fcc0656d9](https://github.com/JuliaLang/julia/commit/4412dd4d92fb4e86d67973b48703bc1fcc0656d9)

*Triggered By:* [link](https://github.com/JuliaLang/julia/commit/4412dd4d92fb4e86d67973b48703bc1fcc0656d9#commitcomment-30744906)

*Tag Predicate:* `ALL`

*Daily Job:* 2018-10-03 vs 2018-10-02
...
| `["collection", "iteration", "(\"Dict\", \"String\", \"iterate\")"]` | 1.43 (25%) :x: | 1.00 (1%)  |
| `["collection", "set operations", "(\"BitSet\", \"Int\", \"setdiff!\", \"small\")"]` | 1.30 (25%) :x: | 1.00 (1%)  |
| `["dates", "accessor", "year"]` | 1.08 (5%) :x: | 1.00 (1%)  |
| `["dates", "query", "(\"daysofweekinmonth\", \"Date\")"]` | 1.38 (25%) :x: | 1.00 (1%)  |
...
| `["random", "ranges", "(\"rand\", \"MersenneTwister\", \"Int128\", \"RangeGenerator(1:18446744073709551615)\")"]` | 1.58 (25%) :x: | 1.00 (1%)  |
...
| `["random", "ranges", "(\"rand\", \"MersenneTwister\", \"UInt128\", \"RangeGenerator(1:18446744073709551616)\")"]` | 1.64 (25%) :x: | 1.00 (1%)  |
...
| `["scalar", "arithmetic", "(\"add\", \"Complex{BigInt}\", \"UInt64\")"]` | 1.55 (50%) :x: | 1.00 (1%)  |
...
| `["scalar", "exp2", "(\"2pow127\", \"negative argument\", Float32)"]` | 1.80 (5%) :x: | 1.00 (1%)  |
...
| `["scalar", "sinh", "(\"0 <= abs(x) < 2.0^-28\", \"positive argument\", \"Float64\")"]` | 0.70 (5%) :white_check_mark: | 1.00 (1%)  |
...
| `["union", "array", "(\"perf_simplecopy\", Complex{Float64}, false)"]` | 1.05 (5%) :x: | 1.00 (1%)  |
...
Commit 4412dd4 (2018-10-03 01:06 UTC)
Platform Info:
  ...
  CPU: Intel(R) Xeon(R) CPU E3-1241 v3 @ 3.50GHz: 
       ...
       #1  3501 MHz   52977150 s       5001 s    5811051 s  1575178206 s         21 s
       #2  3501 MHz  265950513 s        203 s    4184819 s  1366687201 s         11 s
       #3  3501 MHz   37407056 s       3202 s    3253021 s  1596166661 s         22 s
       #4  3501 MHz   34759635 s          0 s    4022114 s  1597792713 s         12 s
       
  Memory: 31.383651733398438 GB (4191.59375 MB free)
  Uptime: 1.6382501e7 sec
