...
*Commit(s):* [JuliaLang/julia@9b7ea2f0b3bf4f1062eb2cee86f3cfcb197e54eb](https://github.com/JuliaLang/julia/commit/9b7ea2f0b3bf4f1062eb2cee86f3cfcb197e54eb)

*Triggered By:* [link](https://github.com/JuliaLang/julia/commit/9b7ea2f0b3bf4f1062eb2cee86f3cfcb197e54eb#commitcomment-36685991)

*Tag Predicate:* `ALL`

*Daily Job:* 2020-01-07 vs 2020-01-06
...
|----|------------|--------------|
| `["array", "any/all", "(\"all\", \"Array{Int16,1}\")"]` | 1.07 (5%) :x: | 1.00 (1%)  |
...
| `["array", "index", "(\"sumelt\", \"SubArray{Float64,3,Array{Float64,3},Tuple{UnitRange{Int64},UnitRange{Int64},UnitRange{Int64}},false}\")"]` | 1.77 (50%) :x: | 1.00 (1%)  |
...
| `["dates", "string", "DateTime"]` | 0.80 (5%) :white_check_mark: | 1.00 (1%)  |
...
| `["scalar", "arithmetic", "(\"rem type\", \"UInt64\", \"BigInt\")"]` | 1.70 (40%) :x: | 1.00 (1%)  |
...
| `["scalar", "asinh", "(\"2 <= abs(x) < 2^28\", \"positive argument\", \"Float32\")"]` | 1.15 (5%) :x: | 1.00 (1%)  |
...
| `["scalar", "atan2", "(\"abs(y/x) safe (large)\", \"y positive\", \"x positive\", \"Float64\")"]` | 1.29 (5%) :x: | 1.00 (1%)  |
...
| `["union", "array", "(\"skipmissing\", collect, Int64, false)"]` | 0.92 (5%) :white_check_mark: | 1.00 (1%)  |
...
| `["union", "array", "(\"skipmissing\", sum, Int8, false)"]` | 0.91 (5%) :white_check_mark: | 1.00 (1%)  |
| `["union", "array", "(\"skipmissing\", sum, Union{Missing, Bool}, true)"]` | 0.87 (5%) :white_check_mark: | 1.00 (1%)  |
| `["union", "array", "(\"skipmissing\", sum, Union{Missing, Complex{Float64}}, true)"]` | 1.16 (5%) :x: | 1.00 (1%)  |
...
Commit 9b7ea2f (2020-01-07 01:14 UTC)
Platform Info:
  ...
  CPU: Intel(R) Xeon(R) CPU E3-1241 v3 @ 3.50GHz: 
       ...
       #1  3501 MHz  117119380 s       5050 s   13610104 s  5478159401 s         31 s
       #2  3501 MHz  862111748 s        217 s   16061436 s  4739375574 s         26 s
       #3  3501 MHz  101221899 s       3261 s    8061127 s  5508495322 s         35 s
       #4  3501 MHz   94865482 s         43 s   11523174 s  5509098230 s         25 s
       
  Memory: 31.383651733398438 GB (14830.421875 MB free)
  Uptime: 5.62176e7 sec
