...
*Commit(s):* [JuliaLang/julia@425c53d33cfe38e57051f784b4260ca0b799ad9a](https://github.com/JuliaLang/julia/commit/425c53d33cfe38e57051f784b4260ca0b799ad9a)

*Triggered By:* [link](https://github.com/JuliaLang/julia/commit/425c53d33cfe38e57051f784b4260ca0b799ad9a#commitcomment-33370028)

*Tag Predicate:* `ALL`

*Daily Job:* 2019-05-01 vs 2019-04-30
...
| `["array", "index", "(\"mapr_access\", \"Array{Float32,2}\")"]` | 0.92 (50%)  | 0.00 (1%) :white_check_mark: |
| `["array", "index", "(\"mapr_access\", \"Array{Int32,2}\")"]` | 0.90 (50%)  | 0.00 (1%) :white_check_mark: |
| `["array", "index", "(\"mapr_access\", \"BaseBenchmarks.ArrayBenchmarks.ArrayLSLS{Float32,2}\")"]` | 0.92 (50%)  | 0.00 (1%) :white_check_mark: |
| `["array", "index", "(\"mapr_access\", \"BaseBenchmarks.ArrayBenchmarks.ArrayLSLS{Int32,2}\")"]` | 0.92 (50%)  | 0.00 (1%) :white_check_mark: |
| `["array", "index", "(\"mapr_access\", \"BaseBenchmarks.ArrayBenchmarks.ArrayLS{Float32,2}\")"]` | 0.92 (50%)  | 0.00 (1%) :white_check_mark: |
| `["array", "index", "(\"mapr_access\", \"BaseBenchmarks.ArrayBenchmarks.ArrayLS{Int32,2}\")"]` | 0.91 (50%)  | 0.00 (1%) :white_check_mark: |
...
| `["collection", "deletion", "(\"Vector\", \"Any\", \"filter!\")"]` | 0.45 (25%) :white_check_mark: | 1.00 (1%)  |
...
| `["misc", "iterators", "zip(1:1000, 1:1000)"]` | 1.12 (5%) :x: | 1.00 (1%)  |
| `["misc", "parse", "DateTime"]` | 0.94 (5%) :white_check_mark: | 1.00 (1%)  |
| `["misc", "repeat", "(200, 24, 1)"]` | 0.76 (5%) :white_check_mark: | 1.00 (1%)  |
...
| `["scalar", "arithmetic", "(\"rem type\", \"Int64\", \"BigInt\")"]` | 1.59 (40%) :x: | 1.00 (1%)  |
...
| `["scalar", "atan2", "(\"abs(y/x) safe (large)\", \"y negative\", \"x negative\", \"Float32\")"]` | 0.75 (5%) :white_check_mark: | 1.00 (1%)  |
| `["scalar", "atan2", "(\"abs(y/x) safe (large)\", \"y negative\", \"x positive\", \"Float32\")"]` | 0.77 (5%) :white_check_mark: | 1.00 (1%)  |
...
| `["scalar", "sinh", "(\"very small\", \"positive argument\", \"Float64\")"]` | 1.56 (5%) :x: | 1.00 (1%)  |
...
| `["scalar", "tan", "(\"very small\", \"positive argument\", \"Float64\")"]` | 0.67 (5%) :white_check_mark: | 1.00 (1%)  |
...
```
Julia Version 1.3.0-DEV.143
Commit 425c53d (2019-04-30 20:03 UTC)
Platform Info:
  ...
  CPU: Intel(R) Xeon(R) CPU E3-1241 v3 @ 3.50GHz: 
       ...
       #1  3501 MHz   87167440 s       5026 s    9876237 s  3347253922 s         24 s
       #2  3501 MHz  550209562 s        203 s    9228378 s  2890430497 s         20 s
       #3  3501 MHz   70440479 s       3237 s    5870169 s  3373609529 s         30 s
       #4  3501 MHz   66162899 s         12 s    7810406 s  3374882034 s         18 s
       
  Memory: 31.383651733398438 GB (5500.08203125 MB free)
  Uptime: 3.4525862e7 sec
