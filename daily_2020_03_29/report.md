...
*Commit(s):* [JuliaLang/julia@b637cb786a644979f6ad2752e11206d08c8ce683](https://github.com/JuliaLang/julia/commit/b637cb786a644979f6ad2752e11206d08c8ce683)

*Triggered By:* [link](https://github.com/JuliaLang/julia/commit/b637cb786a644979f6ad2752e11206d08c8ce683#commitcomment-38118906)

*Tag Predicate:* `ALL`

*Daily Job:* 2020-03-29 vs 2020-03-28
...
| `["array", "growth", "(\"push_single!\", 8)"]` | 1.19 (5%) :x: | 1.00 (1%)  |
...
| `["collection", "queries & updates", "(\"Vector\", \"Int\", \"pop!\", \"unspecified\")"]` | 1.91 (25%) :x: | 1.00 (1%)  |
| `["dates", "parse", "(\"DateTime\", \"RFC1123Format\", \"Mixedcase\")"]` | 1.06 (5%) :x: | 1.00 (1%)  |
| `["find", "findnext", "(\"ispos\", \"Array{Int64,1}\")"]` | 1.10 (5%) :x: | 1.00 (1%)  |
...
| `["io", "array_limit", "(\"display\", \"Array{Float64,2}(10000, 10000)\")"]` | 1.03 (5%)  | 0.96 (1%) :white_check_mark: |
...
| `["random", "ranges", "(\"RangeGenerator\", \"UInt64\", \"1:4294967295\")"]` | 1.33 (25%) :x: | 1.00 (1%)  |
...
| `["scalar", "acosh", "(\"very large\", \"positive argument\", \"Float64\")"]` | 0.89 (5%) :white_check_mark: | 1.00 (1%)  |
| `["scalar", "arithmetic", "(\"add\", \"UInt64\", \"BigInt\")"]` | 1.58 (50%) :x: | 1.00 (1%)  |
...
| `["simd", "(\"auto_axpy!\", \"Int32\", 4095)"]` | 1.23 (20%) :x: | 1.00 (1%)  |
| `["simd", "(\"axpy!\", \"Int32\", 4095)"]` | 1.24 (20%) :x: | 1.00 (1%)  |
...
| `["union", "array", "(\"map\", abs, Float64, true)"]` | 1.33 (5%) :x: | 1.00 (1%)  |
...
| `["union", "array", "(\"skipmissing\", collect, Union{Missing, Complex{Float64}}, true)"]` | 1.13 (5%) :x: | 1.00 (1%)  |
...
| `["union", "array", "(\"skipmissing\", sum, Union{Missing, Float64}, true)"]` | 1.29 (5%) :x: | 1.00 (1%)  |
| `["union", "array", "(\"skipmissing\", sum, Union{Nothing, Bool}, false)"]` | 0.63 (5%) :white_check_mark: | 1.00 (1%)  |
| `["union", "array", "(\"skipmissing\", sum, Union{Nothing, Int8}, false)"]` | 1.60 (5%) :x: | 1.00 (1%)  |
...
Commit b637cb7 (2020-03-28 19:29 UTC)
Platform Info:
  ...
  CPU: Intel(R) Xeon(R) CPU E3-1241 v3 @ 3.50GHz: 
       ...
       #1  3501 MHz  130188086 s       5056 s   14974578 s  6170440019 s         34 s
       #2  3501 MHz  974221060 s        217 s   18861639 s  5332177993 s         26 s
       #3  3501 MHz  114746846 s       3284 s    8886736 s  6201396311 s         37 s
       #4  3501 MHz  107659553 s         43 s   12773877 s  6202444974 s         26 s
       
  Memory: 31.383651733398438 GB (18902.73828125 MB free)
  Uptime: 6.3299232e7 sec
