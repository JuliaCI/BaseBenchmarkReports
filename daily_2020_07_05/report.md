...
*Commit(s):* [JuliaLang/julia@25073d6f7fe1f8811fd5e4495251873a847e644f](https://github.com/JuliaLang/julia/commit/25073d6f7fe1f8811fd5e4495251873a847e644f)

*Triggered By:* [link](https://github.com/JuliaLang/julia/commit/25073d6f7fe1f8811fd5e4495251873a847e644f#commitcomment-40372604)
...
| `["array", "comprehension", "(\"collect\", \"Vector{Float64}\")"]` | 1.53 (5%) :x: | 1.00 (1%)  |
...
| `["collection", "set operations", "(\"BitSet\", \"Int\", \"union\", \"Vector\", \"Vector\")"]` | 1.25 (25%) :x: | 1.00 (1%)  |
...
| `["io", "array_limit", "(\"display\", \"Matrix{Float64}(10000, 10000)\")"]` | 0.94 (5%) :white_check_mark: | 0.97 (1%) :white_check_mark: |
...
| `["scalar", "predicate", "(\"isequal\", \"Complex{BigInt}\")"]` | 1.56 (40%) :x: | 1.00 (1%)  |
...
| `["scalar", "tanh", "(\"very small\", \"positive argument\", \"Float64\")"]` | 0.80 (5%) :white_check_mark: | 1.00 (1%)  |
...
| `["union", "array", "(\"broadcast\", abs, BigFloat, false)"]` | 0.67 (5%) :white_check_mark: | 1.00 (1%)  |
...
| `["union", "array", "(\"perf_simplecopy\", ComplexF64, true)"]` | 1.35 (5%) :x: | 1.00 (1%)  |
...
```
Julia Version 1.6.0-DEV.369
Commit 25073d6 (2020-07-04 22:51 UTC)
Platform Info:
  ...
  CPU: Intel(R) Xeon(R) CPU E3-1241 v3 @ 3.50GHz: 
       ...
       #1  3501 MHz  148550039 s       5056 s   16753854 s  6995242675 s         37 s
       #2  3501 MHz  1122654596 s        217 s   22503827 s  6025807914 s         28 s
       #3  3501 MHz  133699270 s       3317 s    9955719 s  7026834411 s         38 s
       #4  3501 MHz  125384880 s         43 s   14291621 s  7029089446 s         28 s
       
  Memory: 31.383651733398438 GB (20426.265625 MB free)
  Uptime: 7.1766438e7 sec
