...
*Commit(s):* [JuliaLang/julia@cfc3b6be4f956d70d88be57f6b7cb6e9dbfea4c8](https://github.com/JuliaLang/julia/commit/cfc3b6be4f956d70d88be57f6b7cb6e9dbfea4c8) vs [JuliaLang/julia@86b7e2cd6977ceea8f7050439d1e917416b59d84](https://github.com/JuliaLang/julia/commit/86b7e2cd6977ceea8f7050439d1e917416b59d84)

*Triggered By:* [link](https://github.com/JuliaLang/julia/pull/29796#issuecomment-432896370)
...
| `["array", "index", "(\"sumelt\", \"1:100000\")"]` | 1.64 (50%) :x: | 1.00 (1%)  |
| `["array", "reductions", "(\"BaseBenchmarks.ArrayBenchmarks.perf_mapreduce\", \"Int64\")"]` | 1.08 (5%) :x: | 1.00 (1%)  |
...
| `["collection", "deletion", "(\"Vector\", \"Any\", \"filter!\")"]` | 1.88 (25%) :x: | 1.00 (1%)  |
...
| `["problem", "spellcheck", "spellcheck"]` | 1.07 (5%) :x: | 1.05 (1%) :x: |
...
| `["scalar", "arithmetic", "(\"sub\", \"Int64\", \"BigInt\")"]` | 1.87 (50%) :x: | 1.00 (1%)  |
...
| `["scalar", "atan2", "(\"abs(y/x) high\", \"y negative\", \"x positive\", \"Float64\")"]` | 1.40 (5%) :x: | 1.00 (1%)  |
...
| `["scalar", "cos", "(\"argument reduction (paynehanek) abs(x) > 2.0^20*π/2\", \"negative argument\", \"Float32\", \"sin_kernel\")"]` | 1.16 (5%) :x: | 1.00 (1%)  |
...
| `["union", "array", "(\"broadcast\", abs, Complex{Float64}, false)"]` | 1.09 (5%) :x: | 1.00 (1%)  |
| `["union", "array", "(\"map\", *, BigFloat, (false, true))"]` | 1.06 (5%) :x: | 1.00 (1%)  |
| `["union", "array", "(\"map\", *, BigFloat, (true, true))"]` | 1.05 (5%) :x: | 1.00 (1%)  |
| `["union", "array", "(\"map\", *, Complex{Float64}, (false, true))"]` | 1.07 (5%) :x: | 1.00 (1%)  |
| `["union", "array", "(\"map\", abs, BigInt, false)"]` | 1.12 (5%) :x: | 1.00 (1%)  |
| `["union", "array", "(\"map\", abs, BigInt, true)"]` | 1.13 (5%) :x: | 1.00 (1%)  |
...
| `["union", "array", "(\"perf_simplecopy\", Float64, false)"]` | 1.12 (5%) :x: | 1.00 (1%)  |
...
```
Julia Version 1.1.0-DEV.540
Commit cfc3b6b (2018-10-25 02:47 UTC)
Platform Info:
  ...
  CPU: Intel(R) Xeon(R) CPU E3-1241 v3 @ 3.50GHz: 
       ...
       #1  3501 MHz   35916878 s       2410 s    5833248 s  1780630002 s         10 s
       #2  3501 MHz  184890940 s         12 s    3324342 s  1638191355 s         15 s
       #3  3501 MHz   27106276 s       3134 s    3192195 s  1795904736 s         23 s
       #4  3501 MHz   26039150 s         11 s    2507196 s  1798554838 s         18 s
       
  Memory: 31.383651733398438 GB (4807.1328125 MB free)
  Uptime: 1.8279465e7 sec
...
Commit 86b7e2c (2018-10-25 02:30 UTC)
Platform Info:
  OS: Linux (x86_64-linux-gnu)
      Ubuntu 14.04.5 LTS
  uname: Linux 3.13.0-85-generic #129-Ubuntu SMP Thu Mar 17 20:50:15 UTC 2016 x86_64 x86_64
  CPU: Intel(R) Xeon(R) CPU E3-1241 v3 @ 3.50GHz: 
              speed         user         nice          sys         idle          irq
       #1  3501 MHz   36038176 s       2410 s    5844006 s  1781703321 s         10 s
       #2  3501 MHz  186014938 s         12 s    3339720 s  1638261030 s         15 s
       #3  3501 MHz   27219001 s       3134 s    3199522 s  1796993755 s         23 s
       #4  3501 MHz   26166323 s         11 s    2514299 s  1799629937 s         18 s
       
  Memory: 31.383651733398438 GB (4545.703125 MB free)
  Uptime: 1.8291564e7 sec
