...
*Commit(s):* [JuliaLang/julia@0ec17276a6055fea31971eaad109d5888b9edd16](https://github.com/JuliaLang/julia/commit/0ec17276a6055fea31971eaad109d5888b9edd16)

*Triggered By:* [link](https://github.com/JuliaLang/julia/commit/0ec17276a6055fea31971eaad109d5888b9edd16#commitcomment-32142677)

*Tag Predicate:* `ALL`

*Daily Job:* 2019-02-01 vs 2019-01-31
...
| `["array", "cat", "(\"hcat\", 5)"]` | 1.54 (5%) :x: | 1.00 (1%)  |
...
| `["array", "index", "(\"sumvector_view\", \"Array{Float32,2}\")"]` | 1.71 (50%) :x: | 1.00 (1%)  |
...
| `["array", "index", "(\"sumvector_view\", \"SubArray{Int32,2,Array{Int32,2},Tuple{Base.Slice{Base.OneTo{Int64}},Base.Slice{Base.OneTo{Int64}}},true}\")"]` | 1.65 (50%) :x: | 1.00 (1%)  |
...
| `["find", "findprev", "(\"ispos\", \"Array{UInt8,1}\")"]` | 0.83 (5%) :white_check_mark: | 1.00 (1%)  |
| `["io", "array_limit", "(\"display\", \"Array{Float64,2}(100000000, 1)\")"]` | 1.06 (5%) :x: | 0.99 (1%)  |
...
| `["random", "ranges", "(\"rand\", \"MersenneTwister\", \"BigInt\", \"RangeGenerator(1:4294967295)\")"]` | 1.42 (25%) :x: | 1.00 (1%)  |
...
| `["scalar", "expm1", "(\"arg reduction II\", \"negative argument\", \"Float32\")"]` | 0.66 (5%) :white_check_mark: | 1.00 (1%)  |
| `["scalar", "expm1", "(\"arg reduction II\", \"negative argument\", \"Float64\")"]` | 0.94 (5%) :white_check_mark: | 1.00 (1%)  |
| `["scalar", "expm1", "(\"arg reduction II\", \"positive argument\", \"Float32\")"]` | 0.73 (5%) :white_check_mark: | 1.00 (1%)  |
...
| `["scalar", "expm1", "(\"large\", \"negative argument\", \"Float32\")"]` | 0.64 (5%) :white_check_mark: | 1.00 (1%)  |
...
| `["scalar", "expm1", "(\"medium\", \"negative argument\", \"Float32\")"]` | 0.64 (5%) :white_check_mark: | 1.00 (1%)  |
...
| `["scalar", "expm1", "(\"very small\", \"positive argument\", \"Float32\")"]` | 0.78 (5%) :white_check_mark: | 1.00 (1%)  |
| `["scalar", "expm1", "(\"very small\", \"positive argument\", \"Float64\")"]` | 0.78 (5%) :white_check_mark: | 1.00 (1%)  |
| `["scalar", "expm1", "(\"zero\", \"Float32\")"]` | 0.82 (5%) :white_check_mark: | 1.00 (1%)  |
...
| `["union", "array", "(\"skipmissing\", sum, Union{Missing, Float32}, true)"]` | 0.94 (5%) :white_check_mark: | 1.00 (1%)  |
...
```
Julia Version 1.2.0-DEV.242
Commit 0ec1727 (2019-02-01 02:45 UTC)
Platform Info:
  ...
  CPU: Intel(R) Xeon(R) CPU E3-1241 v3 @ 3.50GHz: 
       ...
       #1  3501 MHz   74499028 s       5014 s    8300291 s  2595011209 s         23 s
       #2  3501 MHz  436285381 s        203 s    7182977 s  2238785245 s         19 s
       #3  3501 MHz   57593074 s       3226 s    4864259 s  2619689475 s         26 s
       #4  3501 MHz   53956042 s          2 s    6326619 s  2621200664 s         17 s
       
  Memory: 31.383651733398438 GB (5199.6328125 MB free)
  Uptime: 2.6843876e7 sec
