...
*Commit(s):* [JuliaLang/julia@c4c93ea692e9972a97a3f7149d79c92ad5d8106d](https://github.com/JuliaLang/julia/commit/c4c93ea692e9972a97a3f7149d79c92ad5d8106d)

*Triggered By:* [link](https://github.com/JuliaLang/julia/commit/c4c93ea692e9972a97a3f7149d79c92ad5d8106d#commitcomment-28387806)

*Tag Predicate:* `ALL`

*Daily Job:* 2018-04-03 vs 2018-04-02
...
| `["broadcast", "typeargs", "(\"tuple\", 10)"]` | 1.02 (15%)  | Inf (1%) :x: |
...
| `["scalar", "acos", "(\"0.5 <= abs(x) < 1\", \"negative argument\", \"Float32\")"]` | 1.22 (15%) :x: | 1.00 (1%)  |
...
| `["scalar", "fastmath", "(\"mul\", \"Complex{BigInt}\")"]` | 0.58 (40%) :white_check_mark: | 1.00 (1%)  |
| `["scalar", "sincos", "(\"argument reduction (easy) abs(x) < 2π/4\", \"negative argument\", \"Float64\")"]` | 0.85 (15%) :white_check_mark: | 1.00 (1%)  |
...
| `["scalar", "tan", "(\"large\", \"negative argument\", \"Float32\")"]` | 1.15 (15%) :x: | 1.00 (1%)  |
...
Commit c4c93ea (2018-04-02 15:45 UTC)
Platform Info:
  ...
  CPU: Intel(R) Xeon(R) CPU E3-1241 v3 @ 3.50GHz: 
       ...
       #1  3501 MHz     848716 s        254 s     125588 s   55704145 s          0 s
       #2  3501 MHz    7479738 s          0 s     115708 s   49158038 s          0 s
       #3  3501 MHz     924962 s       2368 s      95865 s   55680530 s          1 s
       #4  3501 MHz     812086 s          0 s     132946 s   55776666 s          1 s
       
  Memory: 31.383651733398438 GB (20764.5234375 MB free)
  Uptime: 567965.0 sec
