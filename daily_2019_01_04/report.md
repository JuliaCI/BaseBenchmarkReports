...
*Commit(s):* [JuliaLang/julia@43faeacce3ade5fe175079bfa2bf9cab3328ad93](https://github.com/JuliaLang/julia/commit/43faeacce3ade5fe175079bfa2bf9cab3328ad93)

*Triggered By:* [link](https://github.com/JuliaLang/julia/commit/43faeacce3ade5fe175079bfa2bf9cab3328ad93#commitcomment-31836575)

*Tag Predicate:* `ALL`

*Daily Job:* 2019-01-04 vs 2019-01-03
...
| `["array", "index", "(\"mapr_access\", \"SubArray{Float32,2,Base.ReshapedArray{Float32,2,SubArray{Float32,3,Array{Float32,3},Tuple{Base.Slice{Base.OneTo{Int64}},Base.Slice{Base.OneTo{Int64}},Base.Slice{Base.OneTo{Int64}}},true},Tuple{}},Tuple{Base.Slice{Base.OneTo{Int64}},UnitRange{Int64}},true}\")"]` | 0.06 (50%) :white_check_mark: | 0.08 (1%) :white_check_mark: |
...
| `["array", "index", "(\"mapr_access\", \"SubArray{Int32,2,Base.ReshapedArray{Int32,2,SubArray{Int32,3,Array{Int32,3},Tuple{Base.Slice{Base.OneTo{Int64}},Base.Slice{Base.OneTo{Int64}},Base.Slice{Base.OneTo{Int64}}},true},Tuple{}},Tuple{Base.Slice{Base.OneTo{Int64}},UnitRange{Int64}},true}\")"]` | 0.06 (50%) :white_check_mark: | 0.09 (1%) :white_check_mark: |
...
| `["collection", "queries & updates", "(\"Vector\", \"Int\", \"push!\")"]` | 1.26 (25%) :x: | 1.00 (1%)  |
| `["collection", "set operations", "(\"Vector\", \"Int\", \"⊆\", \"Set\")"]` | 1.92 (25%) :x: | 1.00 (1%)  |
...
| `["misc", "23042", "Complex{Float32}"]` | 0.83 (5%) :white_check_mark: | 1.00 (1%)  |
...
| `["scalar", "atanh", "(\"very small\", \"positive argument\", \"Float32\")"]` | 1.21 (5%) :x: | 1.00 (1%)  |
...
| `["union", "array", "(\"map\", identity, Int8, true)"]` | 0.82 (5%) :white_check_mark: | 1.00 (1%)  |
...
| `["union", "array", "(\"perf_sum\", BigFloat, false)"]` | 0.92 (5%) :white_check_mark: | 1.00 (1%)  |
...
```
Julia Version 1.2.0-DEV.92
Commit 43faeac (2019-01-03 23:36 UTC)
Platform Info:
  ...
  CPU: Intel(R) Xeon(R) CPU E3-1241 v3 @ 3.50GHz: 
       ...
       #1  3501 MHz   69752920 s       5013 s    7720707 s  2358598881 s         22 s
       #2  3501 MHz  395828518 s        203 s    6489072 s  2037793959 s         18 s
       #3  3501 MHz   53314022 s       3220 s    4515688 s  2382212013 s         26 s
       #4  3501 MHz   49811815 s          0 s    5809713 s  2383861783 s         17 s
       
  Memory: 31.383651733398438 GB (4180.75390625 MB free)
  Uptime: 2.4421119e7 sec
  Load Avg:  1.03955078125  1.04296875  1.0458984375
  WORD_SIZE: 64
  LIBM: libopenlibm
