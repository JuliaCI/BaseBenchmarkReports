...
*Commit(s):* [JuliaLang/julia@3058112b0e09acae3305bd2f102657c8b059f7a2](https://github.com/JuliaLang/julia/commit/3058112b0e09acae3305bd2f102657c8b059f7a2)

*Triggered By:* [link](https://github.com/JuliaLang/julia/commit/3058112b0e09acae3305bd2f102657c8b059f7a2#commitcomment-37288018)

*Tag Predicate:* `ALL`

*Daily Job:* 2020-02-14 vs 2020-02-13
...
| `["array", "reductions", "(\"sum\", \"Int64\")"]` | 1.12 (5%) :x: | 1.00 (1%)  |
...
| `["collection", "queries & updates", "(\"Vector\", \"Any\", \"setindex!\")"]` | 1.55 (25%) :x: | 1.00 (1%)  |
| `["collection", "queries & updates", "(\"Vector\", \"Int\", \"getindex\")"]` | 0.58 (25%) :white_check_mark: | 1.00 (1%)  |
| `["dates", "parse", "(\"Date\", \"DateFormat\")"]` | 1.05 (5%) :x: | 1.00 (1%)  |
| `["find", "findall", "(\"Array{Bool,1}\", \"10-90\")"]` | 1.19 (5%) :x: | 1.00 (1%)  |
...
| `["random", "ranges", "(\"RangeGenerator\", \"UInt64\", \"1:4294967295\")"]` | 0.60 (25%) :white_check_mark: | 1.00 (1%)  |
...
| `["scalar", "atanh", "(\"0.5 <= abs(x) < 1\", \"negative argument\", \"Float64\")"]` | 0.93 (5%) :white_check_mark: | 1.00 (1%)  |
...
| `["scalar", "cos", "(\"argument reduction (easy) abs(x) < 6π/4\", \"negative argument\", \"Float64\", \"sin_kernel\")"]` | 0.89 (5%) :white_check_mark: | 1.00 (1%)  |
...
| `["scalar", "cos", "(\"argument reduction (hard) abs(x) < 6π/4\", \"negative argument\", \"Float64\", \"sin_kernel\")"]` | 0.74 (5%) :white_check_mark: | 1.00 (1%)  |
...
| `["scalar", "cosh", "(\"very large\", \"positive argument\", \"Float64\")"]` | 1.44 (5%) :x: | 1.00 (1%)  |
...
| `["scalar", "predicate", "(\"isfinite\", \"BigFloat\")"]` | 1.41 (40%) :x: | 1.00 (1%)  |
...
| `["sparse", "matmul", "(\"At_mul_B!\", \"sparse 40x400, dense 40x400 -> dense 400x400\")"]` | 1.52 (30%) :x: | 1.00 (1%)  |
| `["sparse", "matmul", "(\"At_mul_B\", \"sparse 50x500, dense 50x5 -> dense 500x5\")"]` | 1.33 (30%) :x: | 1.00 (1%)  |
| `["sparse", "transpose", "(\"adjoint\", (20000, 20000))"]` | 1.39 (30%) :x: | 1.00 (1%)  |
...
| `["union", "array", "(\"broadcast\", *, Float64, (false, false))"]` | 0.57 (5%) :white_check_mark: | 1.00 (1%)  |
| `["union", "array", "(\"broadcast\", *, Float64, (false, true))"]` | 0.83 (5%) :white_check_mark: | 1.00 (1%)  |
| `["union", "array", "(\"broadcast\", *, Float64, (true, true))"]` | 1.22 (5%) :x: | 1.00 (1%)  |
| `["union", "array", "(\"broadcast\", abs, Int8, true)"]` | 0.83 (5%) :white_check_mark: | 1.00 (1%)  |
...
| `["union", "array", "(\"perf_sum3\", Float64, true)"]` | 0.80 (5%) :white_check_mark: | 1.00 (1%)  |
...
| `["union", "array", "(\"skipmissing\", collect, Union{Nothing, Complex{Float64}}, false)"]` | 0.94 (5%) :white_check_mark: | 1.00 (1%)  |
| `["union", "array", "(\"skipmissing\", sum, Union{Missing, Complex{Float64}}, true)"]` | 1.26 (5%) :x: | 1.00 (1%)  |
| `["union", "array", "(\"skipmissing\", sum, Union{Nothing, Bool}, false)"]` | 0.64 (5%) :white_check_mark: | 1.00 (1%)  |
| `["union", "array", "(\"skipmissing\", sum, Union{Nothing, Int8}, false)"]` | 1.69 (5%) :x: | 1.00 (1%)  |
...
```
Julia Version 1.5.0-DEV.268
Commit 3058112 (2020-02-13 20:04 UTC)
Platform Info:
  ...
  CPU: Intel(R) Xeon(R) CPU E3-1241 v3 @ 3.50GHz: 
       ...
       #1  3501 MHz  122981556 s       5052 s   14214965 s  5799401353 s         33 s
       #2  3501 MHz  911311811 s        217 s   17363481 s  5016993738 s         26 s
       #3  3501 MHz  107196198 s       3272 s    8429400 s  5830247596 s         36 s
       #4  3501 MHz  100496742 s         43 s   12118438 s  5830845129 s         26 s
       
  Memory: 31.383651733398438 GB (18889.03125 MB free)
  Uptime: 5.950125e7 sec
