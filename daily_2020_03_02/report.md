...
*Commit(s):* [JuliaLang/julia@a523fcf1b94646830e938067953227433fc2af70](https://github.com/JuliaLang/julia/commit/a523fcf1b94646830e938067953227433fc2af70)

*Triggered By:* [link](https://github.com/JuliaLang/julia/commit/a523fcf1b94646830e938067953227433fc2af70#commitcomment-37571485)

*Tag Predicate:* `ALL`

*Daily Job:* 2020-03-02 vs 2020-03-01
...
| `["collection", "initialization", "(\"Vector\", \"Int\", \"loop\")"]` | 0.73 (25%) :white_check_mark: | 1.00 (1%)  |
| `["collection", "initialization", "(\"Vector\", \"Int\", \"loop\", \"sizehint!\")"]` | 0.69 (25%) :white_check_mark: | 1.00 (1%)  |
| `["collection", "iteration", "(\"IdDict\", \"String\", \"iterate\")"]` | 1.35 (25%) :x: | 1.00 (1%)  |
...
| `["misc", "allocation elision view", "no conditional"]` | 0.75 (5%) :white_check_mark: | 1.00 (1%)  |
...
| `["random", "types", "(\"rand\", \"ImplicitRNG\", \"ImplicitFloat64\")"]` | 1.35 (25%) :x: | 1.00 (1%)  |
...
| `["scalar", "cos", "(\"argument reduction (easy) abs(x) < 8π/4\", \"positive argument\", \"Float32\", \"cos_kernel\")"]` | 0.85 (5%) :white_check_mark: | 1.00 (1%)  |
| `["scalar", "cos", "(\"argument reduction (hard) abs(x) < 4π/4\", \"positive argument\", \"Float32\", \"cos_kernel\")"]` | 1.10 (5%) :x: | 1.00 (1%)  |
| `["scalar", "cos", "(\"argument reduction (hard) abs(x) < 6π/4\", \"negative argument\", \"Float32\", \"sin_kernel\")"]` | 1.19 (5%) :x: | 1.00 (1%)  |
...
| `["union", "array", "(\"broadcast\", abs, Int8, true)"]` | 0.79 (5%) :white_check_mark: | 1.00 (1%)  |
...
| `["union", "array", "(\"map\", identity, Float32, true)"]` | 1.22 (5%) :x: | 1.00 (1%)  |
...
| `["union", "array", "(\"perf_simplecopy\", Int64, false)"]` | 1.56 (5%) :x: | 1.00 (1%)  |
...
| `["union", "array", "(\"skipmissing\", collect, Int64, false)"]` | 0.71 (5%) :white_check_mark: | 1.00 (1%)  |
| `["union", "array", "(\"skipmissing\", collect, Union{Missing, Int64}, true)"]` | 0.81 (5%) :white_check_mark: | 1.00 (1%)  |
...
Platform Info:
  ...
  CPU: Intel(R) Xeon(R) CPU E3-1241 v3 @ 3.50GHz: 
       ...
       #1  3501 MHz  126117262 s       5055 s   14548613 s  5942864443 s         33 s
       #2  3501 MHz  938704381 s        217 s   18021265 s  5136117360 s         26 s
       #3  3501 MHz  110541770 s       3277 s    8601542 s  5973850907 s         36 s
       #4  3501 MHz  103628508 s         43 s   12363350 s  5974613973 s         26 s
       
  Memory: 31.383651733398438 GB (18238.13671875 MB free)
  Uptime: 6.0973943e7 sec
