...
*Commit(s):* [JuliaLang/julia@a6c7c1bdd6211380422bc9d0ab2d8eaf7a7c0def](https://github.com/JuliaLang/julia/commit/a6c7c1bdd6211380422bc9d0ab2d8eaf7a7c0def)

*Triggered By:* [link](https://github.com/JuliaLang/julia/commit/a6c7c1bdd6211380422bc9d0ab2d8eaf7a7c0def#commitcomment-33435526)

*Tag Predicate:* `ALL`

*Daily Job:* 2019-05-07 vs 2019-05-06
...
| `["array", "equality", "(\"isequal\", \"Array{Int64,1} isequal Array{Int64,1}\")"]` | 1.14 (5%) :x: | 1.00 (1%)  |
...
| `["array", "setindex!", "(\"setindex!\", 1)"]` | 0.51 (5%) :white_check_mark: | 0.25 (1%) :white_check_mark: |
...
| `["array", "setindex!", "(\"setindex!\", 4)"]` | 0.54 (5%) :white_check_mark: | 0.25 (1%) :white_check_mark: |
| `["array", "setindex!", "(\"setindex!\", 5)"]` | 0.51 (5%) :white_check_mark: | 0.25 (1%) :white_check_mark: |
...
| `["broadcast", "mix_scalar_tuple", "(10, \"scal_tup_x3\")"]` | 0.68 (5%) :white_check_mark: | 1.00 (1%)  |
...
| `["dates", "parse", "(\"DateTime\", \"RFC1123Format\", \"Mixedcase\")"]` | 0.80 (5%) :white_check_mark: | 1.00 (1%)  |
...
| `["find", "findnext", "(\"ispos\", \"Array{Int8,1}\")"]` | 1.13 (5%) :x: | 1.00 (1%)  |
...
| `["io", "array_limit", "(\"display\", \"Array{Float64,2}(10000, 10000)\")"]` | 1.06 (5%) :x: | 1.04 (1%) :x: |
...
| `["random", "types", "(\"rand\", \"MersenneTwister\", \"Complex{UInt32}\")"]` | 0.60 (25%) :white_check_mark: | 1.00 (1%)  |
| `["scalar", "acos", "(\"abs(x) < 0.5\", \"negative argument\", \"Float64\")"]` | 0.93 (5%) :white_check_mark: | 1.00 (1%)  |
| `["scalar", "acos", "(\"small\", \"positive argument\", \"Float64\")"]` | 0.94 (5%) :white_check_mark: | 1.00 (1%)  |
| `["scalar", "arithmetic", "(\"rem type\", \"Bool\", \"BigInt\")"]` | 1.76 (40%) :x: | 1.00 (1%)  |
...
| `["scalar", "asin", "(\"small\", \"negative argument\", \"Float64\")"]` | 0.75 (5%) :white_check_mark: | 1.00 (1%)  |
...
| `["scalar", "exp2", "(\"2pow127\", \"positive argument\", Float32)"]` | 0.76 (5%) :white_check_mark: | 1.00 (1%)  |
...
| `["scalar", "exp2", "(\"one\", \"Float32\")"]` | 0.83 (5%) :white_check_mark: | 1.00 (1%)  |
...
| `["scalar", "exp2", "(\"very small\", \"negative argument\", \"Float32\")"]` | 0.89 (5%) :white_check_mark: | 1.00 (1%)  |
...
| `["scalar", "expm1", "(\"arg reduction II\", \"negative argument\", \"Float64\")"]` | 0.87 (5%) :white_check_mark: | 1.00 (1%)  |
...
| `["scalar", "expm1", "(\"arg reduction I\", \"positive argument\", \"Float64\")"]` | 0.81 (5%) :white_check_mark: | 1.00 (1%)  |
| `["scalar", "expm1", "(\"huge\", \"positive argument\", \"Float64\")"]` | 0.88 (5%) :white_check_mark: | 1.00 (1%)  |
| `["scalar", "expm1", "(\"large\", \"negative argument\", \"Float32\")"]` | 0.70 (5%) :white_check_mark: | 1.00 (1%)  |
| `["scalar", "expm1", "(\"large\", \"negative argument\", \"Float64\")"]` | 0.89 (5%) :white_check_mark: | 1.00 (1%)  |
| `["scalar", "expm1", "(\"large\", \"positive argument\", \"Float32\")"]` | 0.76 (5%) :white_check_mark: | 1.00 (1%)  |
| `["scalar", "expm1", "(\"large\", \"positive argument\", \"Float64\")"]` | 0.79 (5%) :white_check_mark: | 1.00 (1%)  |
| `["scalar", "expm1", "(\"medium\", \"negative argument\", \"Float32\")"]` | 0.70 (5%) :white_check_mark: | 1.00 (1%)  |
| `["scalar", "expm1", "(\"medium\", \"negative argument\", \"Float64\")"]` | 0.88 (5%) :white_check_mark: | 1.00 (1%)  |
| `["scalar", "expm1", "(\"medium\", \"positive argument\", \"Float32\")"]` | 0.76 (5%) :white_check_mark: | 1.00 (1%)  |
...
| `["scalar", "expm1", "(\"small\", \"positive argument\", \"Float64\")"]` | 0.89 (5%) :white_check_mark: | 1.00 (1%)  |
| `["scalar", "expm1", "(\"very small\", \"negative argument\", \"Float32\")"]` | 0.84 (5%) :white_check_mark: | 1.00 (1%)  |
| `["scalar", "expm1", "(\"very small\", \"negative argument\", \"Float64\")"]` | 0.79 (5%) :white_check_mark: | 1.00 (1%)  |
...
| `["scalar", "tanh", "(\"1.0 <= abs(x) < 22.0\", \"positive argument\", \"Float64\")"]` | 0.89 (5%) :white_check_mark: | 1.00 (1%)  |
...
| `["string", "repeat", "repeat char 2"]` | 1.24 (5%) :x: | 1.00 (1%)  |
...
| `["union", "array", "(\"perf_binaryop\", *, BigInt, (false, true))"]` | 0.78 (5%) :white_check_mark: | 1.00 (1%)  |
| `["union", "array", "(\"perf_binaryop\", *, BigInt, (true, true))"]` | 0.78 (5%) :white_check_mark: | 1.00 (1%)  |
...
| `["union", "array", "(\"skipmissing\", sum, Union{Missing, BigInt}, true)"]` | 0.87 (5%) :white_check_mark: | 1.00 (1%)  |
...
```
Julia Version 1.3.0-DEV.181
Commit a6c7c1b (2019-05-06 22:53 UTC)
Platform Info:
  ...
  CPU: Intel(R) Xeon(R) CPU E3-1241 v3 @ 3.50GHz: 
       ...
       #1  3501 MHz   87813014 s       5028 s    9971130 s  3398214647 s         24 s
       #2  3501 MHz  556935424 s        203 s    9347180 s  2935379938 s         20 s
       #3  3501 MHz   71110700 s       3237 s    5915923 s  3424705182 s         30 s
       #4  3501 MHz   66762953 s         12 s    7880403 s  3425997499 s         19 s
       
  Memory: 31.383651733398438 GB (5114.66796875 MB free)
  Uptime: 3.5044169e7 sec
