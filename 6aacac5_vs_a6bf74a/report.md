...
*Commit(s):* [JuliaLang/julia@6aacac507b1af74024b8fa14025502ea6bcee1e8](https://github.com/JuliaLang/julia/commit/6aacac507b1af74024b8fa14025502ea6bcee1e8) vs [JuliaLang/julia@a6bf74a2f9d69f31060d6294ab0e59bf61ce26d8](https://github.com/JuliaLang/julia/commit/a6bf74a2f9d69f31060d6294ab0e59bf61ce26d8)

*Triggered By:* [link](https://github.com/JuliaLang/julia/pull/34106#issuecomment-566065477)
...
| `["array", "reductions", "(\"mean\", \"Int64\")"]` | 1.11 (5%) :x: | 1.00 (1%)  |
...
| `["collection", "set operations", "(\"BitSet\", \"Int\", \"==\", \"BitSet\")"]` | 1.90 (25%) :x: | 1.00 (1%)  |
...
| `["linalg", "arithmetic", "(\"-\", \"Matrix\", \"Matrix\", 256)"]` | 2.52 (45%) :x: | 1.00 (1%)  |
...
| `["random", "ranges", "(\"RangeGenerator\", \"UInt128\", \"1:170141183460469231731687303715884105728\")"]` | 0.61 (25%) :white_check_mark: | 1.00 (1%)  |
...
| `["scalar", "cos", "(\"argument reduction (easy) abs(x) < 7π/4\", \"negative argument\", \"Float32\", \"cos_kernel\")"]` | 1.28 (5%) :x: | 1.00 (1%)  |
...
| `["scalar", "expm1", "(\"medium\", \"negative argument\", \"Float32\")"]` | 0.65 (5%) :white_check_mark: | 1.00 (1%)  |
...
| `["scalar", "rem_pio2", "(\"argument reduction (hard) abs(x) < 4π/4\", \"positive argument\", \"Float64\")"]` | 0.93 (5%) :white_check_mark: | 1.00 (1%)  |
...
| `["scalar", "sin", "(\"argument reduction (easy) abs(x) < 3π/4\", \"positive argument\", \"Float64\", \"cos_kernel\")"]` | 2.04 (5%) :x: | 1.00 (1%)  |
| `["scalar", "sin", "(\"argument reduction (easy) abs(x) < 7π/4\", \"positive argument\", \"Float64\", \"sin_kernel\")"]` | 1.79 (5%) :x: | 1.00 (1%)  |
...
| `["union", "array", "(\"broadcast\", *, Float32, (false, false))"]` | 1.09 (5%) :x: | 1.00 (1%)  |
...
| `["union", "array", "(\"broadcast\", *, Float64, (false, true))"]` | 1.24 (5%) :x: | 1.00 (1%)  |
...
| `["union", "array", "(\"broadcast\", identity, Float64, true)"]` | 1.29 (5%) :x: | 1.00 (1%)  |
...
| `["union", "array", "(\"skipmissing\", collect, Float32, false)"]` | 0.94 (5%) :white_check_mark: | 1.00 (1%)  |
| `["union", "array", "(\"skipmissing\", collect, Union{Missing, Float32}, true)"]` | 0.88 (5%) :white_check_mark: | 1.00 (1%)  |
...
Commit 6aacac5 (2019-12-16 13:27 UTC)
Platform Info:
  ...
  CPU: Intel(R) Xeon(R) CPU E3-1241 v3 @ 3.50GHz: 
       ...
       #1  3501 MHz  113323468 s       5048 s   13225648 s  5295946913 s         31 s
       #2  3501 MHz  824923857 s        217 s   15232960 s  4590684809 s         26 s
       #3  3501 MHz   97403876 s       3260 s    7810534 s  5325840789 s         35 s
       #4  3501 MHz   91307510 s         39 s   11170637 s  5326396445 s         25 s
       
  Memory: 31.383651733398438 GB (14597.14453125 MB free)
  Uptime: 5.4349336e7 sec
...
Platform Info:
  ...
  CPU: Intel(R) Xeon(R) CPU E3-1241 v3 @ 3.50GHz: 
              speed         user         nice          sys         idle          irq
       #1  3501 MHz  113450753 s       5048 s   13234857 s  5297157763 s         31 s
       #2  3501 MHz  826183056 s        217 s   15259373 s  4590751464 s         26 s
       #3  3501 MHz   97533262 s       3260 s    7815952 s  5327057939 s         35 s
       #4  3501 MHz   91433619 s         39 s   11176084 s  5327616975 s         25 s
       
  Memory: 31.383651733398438 GB (14914.640625 MB free)
  Uptime: 5.4362861e7 sec
  Load Avg:  1.0029296875  1.0146484375  1.04541015625
  WORD_SIZE: 64
  LIBM: libopenlibm
  LLVM: libLLVM-8.0.1 (ORCJIT, haswell)
