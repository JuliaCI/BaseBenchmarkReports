...
*Commit(s):* [JuliaLang/julia@dd5eaaa92446c02cd260d89237ac1cb79a1c4f92](https://github.com/JuliaLang/julia/commit/dd5eaaa92446c02cd260d89237ac1cb79a1c4f92) vs [JuliaLang/julia@7301dc61bdeb5d66e94e15bdfcd4c54f7c90f068](https://github.com/JuliaLang/julia/commit/7301dc61bdeb5d66e94e15bdfcd4c54f7c90f068)

*Triggered By:* [link](https://github.com/JuliaLang/julia/pull/22208#issuecomment-636721646)
...
| `["array", "any/all", "(\"all\", \"Array{Float32,1}\")"]` | 1.59 (5%) :x: | 1.00 (1%)  |
...
| `["linalg", "arithmetic", "(\"\\\\\", \"HermitianSparseWithNonZeroPivots\", \"Vector\", 1024)"]` | 33.51 (45%) :x: | 13.23 (1%) :x: |
| `["linalg", "arithmetic", "(\"\\\\\", \"HermitianSparseWithNonZeroPivots\", \"Vector\", 256)"]` | 4.48 (45%) :x: | 3.49 (1%) :x: |
...
| `["random", "ranges", "(\"RangeGenerator\", \"BigInt\", \"1:4294967297\")"]` | 1.63 (25%) :x: | 1.00 (1%)  |
| `["random", "ranges", "(\"rand!\", \"MersenneTwister\", \"Int\", \"1:1000\")"]` | 1.27 (25%) :x: | 1.00 (1%)  |
| `["random", "ranges", "(\"rand\", \"MersenneTwister\", \"BigInt\", \"RangeGenerator(1:18446744073709551616)\")"]` | 0.69 (25%) :white_check_mark: | 1.00 (1%)  |
| `["scalar", "acos", "(\"small\", \"negative argument\", \"Float32\")"]` | 1.07 (5%) :x: | 1.00 (1%)  |
| `["scalar", "acos", "(\"small\", \"positive argument\", \"Float32\")"]` | 1.07 (5%) :x: | 1.00 (1%)  |
| `["scalar", "arithmetic", "(\"add\", \"UInt64\", \"Complex{BigInt}\")"]` | 1.68 (50%) :x: | 1.00 (1%)  |
| `["scalar", "arithmetic", "(\"sub\", \"Complex{BigInt}\", \"Int64\")"]` | 1.62 (50%) :x: | 1.00 (1%)  |
...
| `["scalar", "atan", "(\"11/16 <= abs(x) < 19/16\", \"positive argument\", \"Float64\")"]` | 0.73 (5%) :white_check_mark: | 1.00 (1%)  |
...
| `["scalar", "atan", "(\"39/16 <= abs(x) < 2^66\", \"negative argument\", \"Float64\")"]` | 0.77 (5%) :white_check_mark: | 1.00 (1%)  |
...
| `["scalar", "atanh", "(\"very small\", \"negative argument\", \"Float32\")"]` | 0.80 (5%) :white_check_mark: | 1.00 (1%)  |
...
| `["scalar", "cos", "(\"argument reduction (paynehanek) abs(x) > 2.0^20*π/2\", \"negative argument\", \"Float32\", \"cos_kernel\")"]` | 1.09 (5%) :x: | 1.00 (1%)  |
...
Commit dd5eaaa (2020-06-01 09:07 UTC)
Platform Info:
  ...
  CPU: Intel(R) Xeon(R) CPU E3-1241 v3 @ 3.50GHz: 
       ...
       #1  3501 MHz  142460032 s       5056 s   16150823 s  6710798545 s         35 s
       #2  3501 MHz  1074599518 s        217 s   21303998 s  5783676669 s         27 s
       #3  3501 MHz  127391212 s       3307 s    9616493 s  6742108801 s         38 s
       #4  3501 MHz  119614259 s         43 s   13784392 s  6743897553 s         27 s
       
  Memory: 31.383651733398438 GB (18733.69140625 MB free)
  Uptime: 6.8848912e7 sec
...
Platform Info:
  ...
  CPU: Intel(R) Xeon(R) CPU E3-1241 v3 @ 3.50GHz: 
              speed         user         nice          sys         idle          irq
       #1  3501 MHz  142596735 s       5056 s   16160594 s  6712043903 s         35 s
       #2  3501 MHz  1075897557 s        217 s   21331022 s  5783747612 s         27 s
       #3  3501 MHz  127539999 s       3307 s    9622518 s  6743350207 s         38 s
       #4  3501 MHz  119771342 s         43 s   13790706 s  6745130471 s         27 s
       
  Memory: 31.383651733398438 GB (18768.8515625 MB free)
  Uptime: 6.886288e7 sec
