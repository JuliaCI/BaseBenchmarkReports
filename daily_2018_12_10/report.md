...
*Commit(s):* [JuliaLang/julia@bd21aa75eb4c0e56ef870f6bffea3281c724cbb1](https://github.com/JuliaLang/julia/commit/bd21aa75eb4c0e56ef870f6bffea3281c724cbb1)

*Triggered By:* [link](https://github.com/JuliaLang/julia/commit/bd21aa75eb4c0e56ef870f6bffea3281c724cbb1#commitcomment-31614586)

*Tag Predicate:* `ALL`

*Daily Job:* 2018-12-10 vs 2018-12-09
...
| `["collection", "iteration", "(\"IdDict\", \"Int\", \"iterate second\")"]` | 0.71 (25%) :white_check_mark: | 1.00 (1%)  |
...
| `["find", "findprev", "(\"ispos\", \"Array{Float32,1}\")"]` | 1.11 (5%) :x: | 1.00 (1%)  |
| `["find", "findprev", "(\"ispos\", \"Array{Float64,1}\")"]` | 1.12 (5%) :x: | 1.00 (1%)  |
| `["find", "findprev", "(\"ispos\", \"Array{UInt64,1}\")"]` | 0.95 (5%) :white_check_mark: | 1.00 (1%)  |
| `["io", "array_limit", "(\"display\", \"Array{Float64,1}(100000000,)\")"]` | 1.14 (5%) :x: | 1.01 (1%)  |
| `["io", "array_limit", "(\"display\", \"Array{Float64,2}(100000000, 1)\")"]` | 1.13 (5%) :x: | 1.01 (1%)  |
...
| `["misc", "fastmath many args"]` | 0.64 (5%) :white_check_mark: | 1.00 (1%)  |
...
| `["random", "ranges", "(\"rand\", \"MersenneTwister\", \"Int128\", \"RangeGenerator(1:18446744073709551615)\")"]` | 1.29 (25%) :x: | 1.00 (1%)  |
| `["random", "ranges", "(\"rand\", \"MersenneTwister\", \"Int128\", \"RangeGenerator(1:18446744073709551616)\")"]` | 1.54 (25%) :x: | 1.00 (1%)  |
| `["random", "ranges", "(\"rand\", \"MersenneTwister\", \"UInt128\", \"RangeGenerator(1:18446744073709551615)\")"]` | 1.58 (25%) :x: | 1.00 (1%)  |
...
| `["scalar", "asinh", "(\"0 <= abs(x) < 2^-28\", \"negative argument\", \"Float64\")"]` | 1.28 (5%) :x: | 1.00 (1%)  |
| `["scalar", "atan", "(\"0 <= abs(x) < 7/16\", \"negative argument\", \"Float32\")"]` | 0.86 (5%) :white_check_mark: | 1.00 (1%)  |
| `["scalar", "atan", "(\"11/16 <= abs(x) < 19/16\", \"negative argument\", \"Float64\")"]` | 0.74 (5%) :white_check_mark: | 1.00 (1%)  |
| `["scalar", "atan", "(\"very large\", \"positive argument\", \"Float64\")"]` | 0.78 (5%) :white_check_mark: | 1.00 (1%)  |
| `["scalar", "atan", "(\"very small\", \"negative argument\", \"Float32\")"]` | 0.67 (5%) :white_check_mark: | 1.00 (1%)  |
| `["scalar", "atan", "(\"very small\", \"positive argument\", \"Float32\")"]` | 0.83 (5%) :white_check_mark: | 1.00 (1%)  |
| `["scalar", "atan", "(\"zero\", \"Float32\")"]` | 0.78 (5%) :white_check_mark: | 1.00 (1%)  |
...
| `["scalar", "atan2", "(\"abs(y/x) small\", \"y positive\", \"x positive\", \"Float32\")"]` | 0.65 (5%) :white_check_mark: | 1.00 (1%)  |
...
| `["scalar", "cos", "(\"argument reduction (paynehanek) abs(x) > 2.0^20*π/2\", \"positive argument\", \"Float64\", \"cos_kernel\")"]` | 0.85 (5%) :white_check_mark: | 1.00 (1%)  |
...
| `["string", "repeat", "repeat char 2"]` | 0.88 (5%) :white_check_mark: | 1.00 (1%)  |
...
```
Julia Version 1.1.0-DEV.847
Commit bd21aa7 (2018-12-09 21:57 UTC)
Platform Info:
  ...
  CPU: Intel(R) Xeon(R) CPU E3-1241 v3 @ 3.50GHz: 
       ...
       #1  3501 MHz   65887192 s       5009 s    7257005 s  2147399403 s         22 s
       #2  3501 MHz  367860110 s        203 s    5974423 s  1850460023 s         18 s
       #3  3501 MHz   49849210 s       3216 s    4210268 s  2170169107 s         26 s
       #4  3501 MHz   46513719 s          0 s    5368089 s  2171887881 s         16 s
       
  Memory: 31.383651733398438 GB (4261.1640625 MB free)
  Uptime: 2.2261434e7 sec
  Load Avg:  1.01171875  1.02490234375  1.04541015625
  WORD_SIZE: 64
  LIBM: libopenlibm
