...
*Commit(s):* [JuliaLang/julia@69eb29e1d502a4f8d22c120ea25fe568b39b77f9](https://github.com/JuliaLang/julia/commit/69eb29e1d502a4f8d22c120ea25fe568b39b77f9)

*Triggered By:* [link](https://github.com/JuliaLang/julia/commit/69eb29e1d502a4f8d22c120ea25fe568b39b77f9#commitcomment-26707987)

*Tag Predicate:* `ALL`

*Daily Job:* 2018-01-08 vs 2018-01-07
...
| `["array", "index", "2d"]` | 1.21 (15%) :x: | 1.00 (1%)  |
...
| `["random", "types", "(\"rand\", \"RandomDevice\", \"Int64\")"]` | 1.42 (25%) :x: | 1.00 (1%)  |
| `["scalar", "acos", "(\"one\", \"positive argument\", \"Float64\")"]` | 0.84 (15%) :white_check_mark: | 1.00 (1%)  |
...
| `["scalar", "atan", "(\"39/16 <= abs(x) < 2^66\", \"positive argument\", \"Float64\")"]` | 1.30 (15%) :x: | 1.00 (1%)  |
...
| `["scalar", "cos", "(\"argument reduction (hard) abs(x) < 6π/4\", \"positive argument\", \"Float64\", \"sin_kernel\")"]` | 0.82 (15%) :white_check_mark: | 1.00 (1%)  |
| `["scalar", "cos", "(\"argument reduction (hard) abs(x) < 8π/4\", \"positive argument\", \"Float64\", \"cos_kernel\")"]` | 0.79 (15%) :white_check_mark: | 1.00 (1%)  |
...
| `["scalar", "tanh", "(\"2f0^-12 <= abs(x) < 1f0\", \"negative argument\", \"Float32\")"]` | 1.23 (15%) :x: | 1.00 (1%)  |
| `["scalar", "tanh", "(\"very small\", \"negative argument\", \"Float32\")"]` | 1.44 (15%) :x: | 1.00 (1%)  |
| `["scalar", "tanh", "(\"very small\", \"positive argument\", \"Float32\")"]` | 1.81 (15%) :x: | 1.00 (1%)  |
| `["sparse", "constructors", "(\"Diagonal\", 100)"]` | 0.82 (15%) :white_check_mark: | 1.00 (1%)  |
| `["tuple", "linear algebra", "(\"matmat\", (16, 16), (16, 16))"]` | 1.24 (15%) :x: | 1.00 (1%)  |
| `["tuple", "reduction", "(\"minimum\", (2,))"]` | 1.87 (15%) :x: | 1.00 (1%)  |
...
```
Julia Version 0.7.0-DEV.3323
Commit 69eb29e (2018-01-08 02:32 UTC)
Platform Info:
  ...
  CPU: Intel(R) Xeon(R) CPU E3-1241 v3 @ 3.50GHz: 
       ...
       #1  3501 MHz  111367878 s          0 s   19695224 s  4958317943 s        100 s
       #2  3501 MHz  476656886 s          0 s   12526685 s  4612104679 s         24 s
       #3  3501 MHz   93304985 s          0 s   10675749 s  4997822853 s         84 s
       #4  3501 MHz   89311166 s          0 s   10881338 s  5001593072 s         21 s
       
  Memory: 31.383651733398438 GB (5889.2265625 MB free)
  Uptime: 5.1042293e7 sec
  Load Avg:  0.95556640625  1.01806640625  1.0400390625
  WORD_SIZE: 64
