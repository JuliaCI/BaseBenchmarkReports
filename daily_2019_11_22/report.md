...
*Triggered By:* [link](https://github.com/JuliaLang/julia/commit/8f7855a7c3a66486c1004603e8743fa56bd8eade#commitcomment-36082278)

*Tag Predicate:* `ALL`

*Daily Job:* 2019-11-22 vs 2019-11-21
...
| `["linalg", "arithmetic", "(\"-\", \"Matrix\", \"Matrix\", 256)"]` | 2.05 (45%) :x: | 1.00 (1%)  |
| `["misc", "fastmath many args"]` | 0.63 (5%) :white_check_mark: | 1.00 (1%)  |
| `["misc", "iterators", "zip(1:1)"]` | 0.71 (5%) :white_check_mark: | 1.00 (1%)  |
...
| `["scalar", "arithmetic", "(\"add\", \"Complex{UInt64}\", \"Complex{UInt64}\")"]` | 1.31 (25%) :x: | 1.00 (1%)  |
| `["scalar", "arithmetic", "(\"rem type\", \"Bool\", \"BigInt\")"]` | 1.83 (40%) :x: | 1.00 (1%)  |
| `["scalar", "arithmetic", "(\"rem type\", \"Int64\", \"BigInt\")"]` | 1.66 (40%) :x: | 1.00 (1%)  |
| `["scalar", "arithmetic", "(\"sub\", \"BigInt\", \"BigInt\")"]` | 1.92 (50%) :x: | 1.00 (1%)  |
...
| `["scalar", "exp2", "(\"2pow35\", \"positive argument\", \"Float32\")"]` | 1.60 (5%) :x: | 1.00 (1%)  |
...
| `["scalar", "sin", "(\"argument reduction (easy) abs(x) < 2.0^20π/4\", \"negative argument\", \"Float64\", \"sin_kernel\")"]` | 0.71 (5%) :white_check_mark: | 1.00 (1%)  |
...
| `["union", "array", "(\"broadcast\", *, Bool, (true, true))"]` | 1.13 (5%) :x: | 1.00 (1%)  |
...
| `["union", "array", "(\"perf_sum\", Int8, true)"]` | 0.91 (5%) :white_check_mark: | 1.00 (1%)  |
...
Platform Info:
  ...
  CPU: Intel(R) Xeon(R) CPU E3-1241 v3 @ 3.50GHz: 
       ...
       #1  3501 MHz  109516260 s       5047 s   12769224 s  5090086930 s         30 s
       #2  3501 MHz  787145298 s        217 s   14320980 s  4418937469 s         25 s
       #3  3501 MHz   93439996 s       3256 s    7577573 s  5119544191 s         34 s
       #4  3501 MHz   87530912 s         34 s   10838469 s  5120054137 s         24 s
       
  Memory: 31.383651733398438 GB (15602.125 MB free)
  Uptime: 5.2243096e7 sec
