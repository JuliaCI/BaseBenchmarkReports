...
*Commit(s):* [JuliaLang/julia@4f649c207a97104d7eb1b9bc3e486d39522f4a5e](https://github.com/JuliaLang/julia/commit/4f649c207a97104d7eb1b9bc3e486d39522f4a5e)

*Triggered By:* [link](https://github.com/JuliaLang/julia/commit/4f649c207a97104d7eb1b9bc3e486d39522f4a5e#commitcomment-35758267)

*Tag Predicate:* `ALL`

*Daily Job:* 2019-11-01 vs 2019-10-31
...
| `["collection", "initialization", "(\"BitSet\", \"Int\", \"sorted\", \"iterator\")"]` | 1.28 (25%) :x: | 1.00 (1%)  |
| `["collection", "set operations", "(\"BitSet\", \"Int\", \"intersect\", \"Vector\", \"Vector\")"]` | 1.49 (25%) :x: | 1.00 (1%)  |
| `["collection", "set operations", "(\"BitSet\", \"Int\", \"union!\", \"Vector\")"]` | 1.88 (25%) :x: | 1.00 (1%)  |
| `["collection", "set operations", "(\"BitSet\", \"Int\", \"union\", \"Vector\")"]` | 1.61 (25%) :x: | 1.00 (1%)  |
| `["collection", "set operations", "(\"BitSet\", \"Int\", \"union\", \"Vector\", \"Vector\")"]` | 1.53 (25%) :x: | 1.00 (1%)  |
...
| `["io", "array_limit", "(\"display\", \"Array{Float64,2}(10000, 10000)\")"]` | 1.00 (5%)  | 1.10 (1%) :x: |
...
| `["random", "types", "(\"rand\", \"RandomDevice\", \"ImplicitFloat64\")"]` | 0.72 (25%) :white_check_mark: | 1.00 (1%)  |
...
| `["random", "types", "(\"randexp\", \"RandomDevice\", \"Float64\")"]` | 0.68 (25%) :white_check_mark: | 1.00 (1%)  |
...
| `["random", "types", "(\"randn\", \"RandomDevice\", \"ImplicitFloat64\")"]` | 0.74 (25%) :white_check_mark: | 1.00 (1%)  |
...
| `["scalar", "atan", "(\"11/16 <= abs(x) < 19/16\", \"negative argument\", \"Float64\")"]` | 1.21 (5%) :x: | 1.00 (1%)  |
...
| `["scalar", "atan2", "(\"y finite\", \"y negative\", \"x infinite\", \"x positive\", \"Float64\")"]` | 0.87 (5%) :white_check_mark: | 1.00 (1%)  |
| `["scalar", "atanh", "(\"0.5 <= abs(x) < 1\", \"positive argument\", \"Float32\")"]` | 1.25 (5%) :x: | 1.00 (1%)  |
| `["scalar", "atanh", "(\"one\", \"Float32\")"]` | 1.06 (5%) :x: | 1.00 (1%)  |
| `["scalar", "atanh", "(\"one\", \"Float64\")"]` | 1.88 (5%) :x: | 1.00 (1%)  |
...
```
Julia Version 1.4.0-DEV.406
Commit 4f649c2 (2019-10-31 15:48 UTC)
Platform Info:
  ...
  CPU: Intel(R) Xeon(R) CPU E3-1241 v3 @ 3.50GHz: 
       ...
       #1  3501 MHz  106382118 s       5044 s   12421192 s  4912130641 s         30 s
       #2  3501 MHz  750806422 s        214 s   13504299 s  4274339186 s         24 s
       #3  3501 MHz   90148207 s       3255 s    7370369 s  4941326013 s         34 s
       #4  3501 MHz   84522479 s         32 s   10504012 s  4941778894 s         23 s
       
  Memory: 31.383651733398438 GB (15792.05078125 MB free)
  Uptime: 5.0424669e7 sec
