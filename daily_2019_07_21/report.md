...
*Commit(s):* [JuliaLang/julia@c49ba0d487b2f3c276c7b9599e8875ed7a888b03](https://github.com/JuliaLang/julia/commit/c49ba0d487b2f3c276c7b9599e8875ed7a888b03)

*Triggered By:* [link](https://github.com/JuliaLang/julia/commit/c49ba0d487b2f3c276c7b9599e8875ed7a888b03#commitcomment-34383028)

*Tag Predicate:* `ALL`

*Daily Job:* 2019-07-21 vs 2019-07-20
...
| `["array", "cat", "(\"hcat\", 500)"]` | 0.92 (5%) :white_check_mark: | 1.00 (1%)  |
...
| `["random", "types", "(\"randn\", \"MersenneTwister\", \"Complex{Float16}\")"]` | 1.35 (25%) :x: | 1.00 (1%)  |
...
| `["simd", "(\"auto_two_reductions\", \"Int32\", 4096)"]` | 1.20 (20%) :x: | 1.00 (1%)  |
...
| `["union", "array", "(\"broadcast\", *, BigInt, (false, false))"]` | 1.25 (5%) :x: | 1.00 (1%)  |
| `["union", "array", "(\"broadcast\", *, BigInt, (false, true))"]` | 1.25 (5%) :x: | 1.00 (1%)  |
| `["union", "array", "(\"broadcast\", abs, BigInt, false)"]` | 1.27 (5%) :x: | 1.00 (1%)  |
...
| `["union", "array", "(\"map\", *, BigInt, (false, false))"]` | 1.25 (5%) :x: | 1.00 (1%)  |
| `["union", "array", "(\"map\", *, BigInt, (false, true))"]` | 1.24 (5%) :x: | 1.00 (1%)  |
| `["union", "array", "(\"map\", *, Bool, (false, true))"]` | 1.11 (5%) :x: | 1.00 (1%)  |
| `["union", "array", "(\"map\", abs, BigInt, false)"]` | 1.26 (5%) :x: | 1.00 (1%)  |
...
| `["union", "array", "(\"map\", identity, Int8, false)"]` | 0.90 (5%) :white_check_mark: | 1.00 (1%)  |
| `["union", "array", "(\"perf_binaryop\", *, BigInt, (false, false))"]` | 1.25 (5%) :x: | 1.00 (1%)  |
| `["union", "array", "(\"perf_binaryop\", *, BigInt, (false, true))"]` | 1.25 (5%) :x: | 1.00 (1%)  |
...
| `["union", "array", "(\"perf_sum3\", BigInt, false)"]` | 1.23 (5%) :x: | 1.00 (1%)  |
...
| `["union", "array", "(\"perf_sum4\", BigInt, false)"]` | 1.23 (5%) :x: | 1.00 (1%)  |
| `["union", "array", "(\"perf_sum\", BigInt, false)"]` | 1.24 (5%) :x: | 1.00 (1%)  |
| `["union", "array", "(\"perf_sum\", Float32, true)"]` | 1.32 (5%) :x: | 1.00 (1%)  |
...
```
Julia Version 1.3.0-DEV.565
Commit c49ba0d (2019-07-21 02:12 UTC)
Platform Info:
  ...
  CPU: Intel(R) Xeon(R) CPU E3-1241 v3 @ 3.50GHz: 
       ...
       #1  3501 MHz   93461865 s       5037 s   10765298 s  4038783381 s         27 s
       #2  3501 MHz  614571194 s        208 s   10353616 s  3524564623 s         22 s
       #3  3501 MHz   76854646 s       3241 s    6433496 s  4066180134 s         30 s
       #4  3501 MHz   72147841 s         20 s    9088649 s  4066556596 s         22 s
       
  Memory: 31.383651733398438 GB (10596.97265625 MB free)
  Uptime: 4.152571e7 sec
