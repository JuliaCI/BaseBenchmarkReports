...
*Commit(s):* [JuliaLang/julia@f6bb81d293f92f2e014d1c60efd9d276cc8b7e3f](https://github.com/JuliaLang/julia/commit/f6bb81d293f92f2e014d1c60efd9d276cc8b7e3f) vs [JuliaLang/julia@58db74d820a7d7705e1d57053147b1992c573055](https://github.com/JuliaLang/julia/commit/58db74d820a7d7705e1d57053147b1992c573055)

*Triggered By:* [link](https://github.com/JuliaLang/julia/pull/33075#issuecomment-524839806)
...
| `["scalar", "arithmetic", "(\"add\", \"Complex{Float64}\", \"Complex{Float64}\")"]` | 1.36 (25%) :x: | 1.00 (1%)  |
| `["scalar", "arithmetic", "(\"add\", \"Complex{Int64}\", \"Complex{Int64}\")"]` | 1.36 (25%) :x: | 1.00 (1%)  |
| `["scalar", "arithmetic", "(\"add\", \"Complex{UInt64}\", \"Complex{UInt64}\")"]` | 1.36 (25%) :x: | 1.00 (1%)  |
| `["scalar", "arithmetic", "(\"div\", \"Complex{Float64}\", \"Complex{Float64}\")"]` | 1.50 (25%) :x: | 1.00 (1%)  |
| `["scalar", "arithmetic", "(\"mul\", \"Complex{Float64}\", \"Complex{Float64}\")"]` | 1.27 (25%) :x: | 1.00 (1%)  |
...
| `["scalar", "atanh", "(\"0.5 <= abs(x) < 1\", \"negative argument\", \"Float32\")"]` | 1.08 (5%) :x: | 1.00 (1%)  |
...
| `["scalar", "rem_pio2", "(\"argument reduction (easy) abs(x) < 2.0^20π/4\", \"negative argument\", \"Float64\")"]` | 1.17 (5%) :x: | 1.00 (1%)  |
...
| `["scalar", "rem_pio2", "(\"argument reduction (easy) abs(x) < 5π/4\", \"negative argument\", \"Float64\")"]` | 1.13 (5%) :x: | 1.00 (1%)  |
...
| `["scalar", "sincos", "(\"argument reduction (easy) abs(x) < 2π/4\", \"positive argument\", \"Float64\")"]` | 1.19 (5%) :x: | 1.00 (1%)  |
| `["scalar", "sincos", "(\"argument reduction (easy) abs(x) < 3π/4\", \"negative argument\", \"Float32\")"]` | 1.10 (5%) :x: | 1.00 (1%)  |
| `["scalar", "sincos", "(\"argument reduction (easy) abs(x) < 3π/4\", \"negative argument\", \"Float64\")"]` | 1.14 (5%) :x: | 1.00 (1%)  |
...
| `["scalar", "sincos", "(\"argument reduction (easy) abs(x) < 6π/4\", \"negative argument\", \"Float64\")"]` | 1.14 (5%) :x: | 1.00 (1%)  |
| `["scalar", "sincos", "(\"argument reduction (easy) abs(x) < 6π/4\", \"positive argument\", \"Float32\")"]` | 1.10 (5%) :x: | 1.00 (1%)  |
| `["scalar", "sincos", "(\"argument reduction (easy) abs(x) < 6π/4\", \"positive argument\", \"Float64\")"]` | 1.34 (5%) :x: | 1.00 (1%)  |
...
| `["scalar", "sincos", "(\"argument reduction (easy) abs(x) < 7π/4\", \"positive argument\", \"Float32\")"]` | 1.10 (5%) :x: | 1.00 (1%)  |
...
| `["scalar", "sincos", "(\"argument reduction (easy) abs(x) < 8π/4\", \"positive argument\", \"Float64\")"]` | 1.11 (5%) :x: | 1.00 (1%)  |
| `["scalar", "sincos", "(\"argument reduction (easy) abs(x) < 9π/4\", \"negative argument\", \"Float32\")"]` | 1.07 (5%) :x: | 1.00 (1%)  |
| `["scalar", "sincos", "(\"argument reduction (easy) abs(x) < 9π/4\", \"negative argument\", \"Float64\")"]` | 1.11 (5%) :x: | 1.00 (1%)  |
| `["scalar", "sincos", "(\"argument reduction (easy) abs(x) < 9π/4\", \"positive argument\", \"Float32\")"]` | 1.11 (5%) :x: | 1.00 (1%)  |
...
| `["scalar", "sincos", "(\"argument reduction (hard) abs(x) < 4π/4\", \"negative argument\", \"Float64\")"]` | 1.07 (5%) :x: | 1.00 (1%)  |
...
| `["scalar", "sincos", "(\"argument reduction (hard) abs(x) < 8π/4\", \"negative argument\", \"Float64\")"]` | 1.10 (5%) :x: | 1.00 (1%)  |
...
| `["scalar", "sincos", "(\"argument reduction (paynehanek) abs(x) > 2.0^20*π/2\", \"negative argument\", \"Float32\")"]` | 1.13 (5%) :x: | 1.00 (1%)  |
...
| `["scalar", "sincos", "(\"argument reduction (paynehanek) abs(x) > 2.0^20*π/2\", \"positive argument\", \"Float64\")"]` | 1.11 (5%) :x: | 1.00 (1%)  |
...
| `["scalar", "sincos", "(\"no reduction\", \"zero\", \"Float32\")"]` | 1.28 (5%) :x: | 1.00 (1%)  |
| `["scalar", "sincos", "(\"no reduction\", \"zero\", \"Float64\")"]` | 1.28 (5%) :x: | 1.00 (1%)  |
...
| `["sparse", "index", "(\"spmat\", \"row\", \"OneTo\", 1000)"]` | 0.57 (30%) :white_check_mark: | 1.00 (1%)  |
...
| `["tuple", "linear algebra", "(\"matvec\", (16, 16), (16,))"]` | 1.29 (5%) :x: | 1.00 (1%)  |
...
| `["union", "array", "(\"perf_simplecopy\", BigInt, false)"]` | 1.14 (5%) :x: | 1.00 (1%)  |
...
```
Julia Version 1.0.5-pre.37
Commit f6bb81d (2019-08-26 12:12 UTC)
Platform Info:
  ...
  CPU: Intel(R) Xeon(R) CPU E3-1241 v3 @ 3.50GHz: 
       ...
       #1  3501 MHz   98358121 s       5042 s   11396004 s  4346595416 s         28 s
       #2  3501 MHz  665900371 s        208 s   11481112 s  3786027384 s         24 s
       #3  3501 MHz   81817229 s       3248 s    6777040 s  4374804883 s         32 s
       #4  3501 MHz   76767149 s         24 s    9582313 s  4375279292 s         22 s
       
  Memory: 31.383651733398438 GB (13310.4140625 MB free)
  Uptime: 4.4666871e7 sec
...
```
Julia Version 1.0.5-pre.0
Commit 58db74d (2019-05-17 16:47 UTC)
Platform Info:
  OS: Linux (x86_64-linux-gnu)
      Ubuntu 14.04.5 LTS
  uname: Linux 3.13.0-85-generic #129-Ubuntu SMP Thu Mar 17 20:50:15 UTC 2016 x86_64 x86_64
  CPU: Intel(R) Xeon(R) CPU E3-1241 v3 @ 3.50GHz: 
              speed         user         nice          sys         idle          irq
       #1  3501 MHz   98472686 s       5042 s   11405889 s  4347685055 s         28 s
       #2  3501 MHz  667032074 s        208 s   11495902 s  3786098929 s         24 s
       #3  3501 MHz   81940906 s       3248 s    6783873 s  4375891881 s         32 s
       #4  3501 MHz   76876680 s         24 s    9589007 s  4376381020 s         22 s
       
  Memory: 31.383651733398438 GB (13065.57421875 MB free)
  Uptime: 4.4679056e7 sec
