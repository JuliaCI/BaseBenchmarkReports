...
*Commit(s):* [JuliaLang/julia@636f5ad21ff3fa2ff55bbd2f602355d3932c2d5b](https://github.com/JuliaLang/julia/commit/636f5ad21ff3fa2ff55bbd2f602355d3932c2d5b)

*Triggered By:* [link](https://github.com/JuliaLang/julia/commit/636f5ad21ff3fa2ff55bbd2f602355d3932c2d5b#commitcomment-31157359)

*Tag Predicate:* `ALL`

*Daily Job:* 2018-11-03 vs 2018-11-02
...
| `["array", "growth", "(\"prerend!\", 8)"]` | 0.73 (5%) :white_check_mark: | 1.00 (1%)  |
| `["array", "growth", "(\"push_multiple!\", 8)"]` | 1.10 (5%) :x: | 1.00 (1%)  |
| `["array", "index", "(\"sumcartesian_view\", \"100000:-1:1\")"]` | 59831.71 (50%) :x: | 1.00 (1%)  |
| `["array", "index", "(\"sumcartesian_view\", \"1:100000\")"]` | 642.13 (50%) :x: | 1.00 (1%)  |
| `["array", "index", "(\"sumeach_view\", \"100000:-1:1\")"]` | 59831.10 (50%) :x: | 1.00 (1%)  |
| `["array", "index", "(\"sumeach_view\", \"1:100000\")"]` | 642.67 (50%) :x: | 1.00 (1%)  |
| `["array", "index", "(\"sumlinear_view\", \"100000:-1:1\")"]` | 57111.95 (50%) :x: | 1.00 (1%)  |
...
| `["array", "subarray", "(\"lucompletepivSub!\", 100)"]` | 0.03 (5%) :white_check_mark: | 0.13 (1%) :white_check_mark: |
| `["array", "subarray", "(\"lucompletepivSub!\", 1000)"]` | 0.06 (5%) :white_check_mark: | 0.11 (1%) :white_check_mark: |
| `["array", "subarray", "(\"lucompletepivSub!\", 250)"]` | 0.05 (5%) :white_check_mark: | 0.12 (1%) :white_check_mark: |
| `["array", "subarray", "(\"lucompletepivSub!\", 500)"]` | 0.06 (5%) :white_check_mark: | 0.11 (1%) :white_check_mark: |
...
| `["collection", "queries & updates", "(\"IdDict\", \"Any\", \"pop!\", \"specified\")"]` | 0.69 (25%) :white_check_mark: | 1.00 (1%)  |
...
| `["find", "findall", "(\"BitArray{1}\", \"10-90\")"]` | 1.19 (5%) :x: | 1.00 (1%)  |
...
| `["problem", "laplacian", "laplace_iter_sub"]` | 0.03 (5%) :white_check_mark: | 0.06 (1%) :white_check_mark: |
...
| `["random", "types", "(\"randexp!\", \"MersenneTwister\", \"Float64\")"]` | 1.71 (25%) :x: | 1.00 (1%)  |
| `["random", "types", "(\"randn!\", \"MersenneTwister\", \"Float64\")"]` | 1.55 (25%) :x: | 1.00 (1%)  |
...
| `["scalar", "atan", "(\"very small\", \"negative argument\", \"Float32\")"]` | 0.75 (5%) :white_check_mark: | 1.00 (1%)  |
...
| `["scalar", "expm1", "(\"arg reduction I\", \"positive argument\", \"Float32\")"]` | 0.66 (5%) :white_check_mark: | 1.00 (1%)  |
...
| `["scalar", "predicate", "(\"isfinite\", \"BigFloat\")"]` | 1.59 (40%) :x: | 1.00 (1%)  |
| `["scalar", "predicate", "(\"isfinite\", \"Complex{BigFloat}\")"]` | 1.68 (40%) :x: | 1.00 (1%)  |
...
| `["scalar", "tan", "(\"small\", \"negative argument\", \"Float64\")"]` | 1.44 (5%) :x: | 1.00 (1%)  |
...
```
Julia Version 1.1.0-DEV.609
Commit 636f5ad (2018-11-02 21:34 UTC)
Platform Info:
  ...
  CPU: Intel(R) Xeon(R) CPU E3-1241 v3 @ 3.50GHz: 
       ...
       #1  3501 MHz   60705919 s       5004 s    6595132 s  1833810976 s         21 s
       #2  3501 MHz  324552384 s        203 s    5177717 s  1574713272 s         15 s
       #3  3501 MHz   44651009 s       3209 s    3777185 s  1855995537 s         25 s
       #4  3501 MHz   41463598 s          0 s    4703244 s  1857915458 s         14 s
       
  Memory: 31.383651733398438 GB (2841.38671875 MB free)
  Uptime: 1.9060677e7 sec
  Load Avg:  0.9228515625  1.00927734375  1.0400390625
  WORD_SIZE: 64
  LIBM: libopenlibm
