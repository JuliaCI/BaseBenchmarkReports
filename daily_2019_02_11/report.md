...
*Commit(s):* [JuliaLang/julia@92271ea56b0da2b34fbd0c83f76a24e9156fb7bd](https://github.com/JuliaLang/julia/commit/92271ea56b0da2b34fbd0c83f76a24e9156fb7bd)

*Triggered By:* [link](https://github.com/JuliaLang/julia/commit/92271ea56b0da2b34fbd0c83f76a24e9156fb7bd#commitcomment-32263640)

*Tag Predicate:* `ALL`

*Daily Job:* 2019-02-11 vs 2019-02-10
...
| `["collection", "set operations", "(\"BitSet\", \"Int\", \"symdiff\", \"BitSet\")"]` | 1.00 (25%)  | 1.06 (1%) :x: |
| `["collection", "set operations", "(\"BitSet\", \"Int\", \"symdiff\", \"Set\")"]` | 0.98 (25%)  | 0.95 (1%) :white_check_mark: |
| `["collection", "set operations", "(\"BitSet\", \"Int\", \"symdiff\", \"Set\", \"Set\")"]` | 0.56 (25%) :white_check_mark: | 0.88 (1%) :white_check_mark: |
| `["collection", "set operations", "(\"BitSet\", \"Int\", \"union\", \"BitSet\", \"BitSet\")"]` | 0.99 (25%)  | 1.06 (1%) :x: |
| `["collection", "set operations", "(\"Set\", \"Int\", \"intersect\", \"Vector\")"]` | 2.00 (25%) :x: | 1.00 (1%)  |
| `["collection", "set operations", "(\"Set\", \"Int\", \"intersect\", \"Vector\", \"Vector\")"]` | 1.43 (25%) :x: | 1.00 (1%)  |
...
| `["io", "array_limit", "(\"display\", \"Array{Float64,1}(100000000,)\")"]` | 0.88 (5%) :white_check_mark: | 0.99 (1%)  |
| `["io", "array_limit", "(\"display\", \"Array{Float64,2}(10000, 10000)\")"]` | 0.92 (5%) :white_check_mark: | 0.92 (1%) :white_check_mark: |
| `["io", "array_limit", "(\"display\", \"Array{Float64,2}(100000000, 1)\")"]` | 0.93 (5%) :white_check_mark: | 0.99 (1%)  |
...
| `["scalar", "asin", "(\"small\", \"negative argument\", \"Float64\")"]` | 1.57 (5%) :x: | 1.00 (1%)  |
...
| `["scalar", "asinh", "(\"0 <= abs(x) < 2^-28\", \"positive argument\", \"Float32\")"]` | 1.26 (5%) :x: | 1.00 (1%)  |
...
| `["union", "array", "(\"map\", identity, Float64, true)"]` | 0.81 (5%) :white_check_mark: | 1.00 (1%)  |
...
```
Julia Version 1.2.0-DEV.305
Commit 92271ea (2019-02-11 00:47 UTC)
Platform Info:
  ...
  CPU: Intel(R) Xeon(R) CPU E3-1241 v3 @ 3.50GHz: 
       ...
       #1  3501 MHz   75928238 s       5015 s    8488356 s  2679164771 s         23 s
       #2  3501 MHz  446888994 s        203 s    7401126 s  2313891261 s         19 s
       #3  3501 MHz   59083952 s       3228 s    4984668 s  2704013351 s         27 s
       #4  3501 MHz   55354929 s          4 s    6490078 s  2705547420 s         17 s
       
  Memory: 31.383651733398438 GB (4831.84375 MB free)
  Uptime: 2.7703752e7 sec
