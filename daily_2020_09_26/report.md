...
*Commit(s):* [JuliaLang/julia@d7b391dc60f9d30a1ca57668895b5900665dae1c](https://github.com/JuliaLang/julia/commit/d7b391dc60f9d30a1ca57668895b5900665dae1c)

*Triggered By:* [link](https://github.com/JuliaLang/julia/commit/d7b391dc60f9d30a1ca57668895b5900665dae1c#commitcomment-42739637)
...
| `["dates", "parse", "(\"Date\", \"ISODateFormat\")"]` | 1.23 (5%) :x: | 1.00 (1%)  |
...
| `["io", "array_limit", "(\"display\", \"Matrix{Float64}(10000, 10000)\")"]` | 1.00 (5%)  | 0.91 (1%) :white_check_mark: |
...
| `["scalar", "arithmetic", "(\"add\", \"BigInt\", \"BigInt\")"]` | 1.64 (50%) :x: | 1.00 (1%)  |
| `["scalar", "arithmetic", "(\"rem type\", \"Char\", \"BigInt\")"]` | 1.54 (40%) :x: | 1.00 (1%)  |
| `["scalar", "arithmetic", "(\"rem type\", \"Int64\", \"BigInt\")"]` | 1.81 (40%) :x: | 1.00 (1%)  |
| `["scalar", "arithmetic", "(\"sub\", \"BigInt\", \"BigInt\")"]` | 1.53 (50%) :x: | 1.00 (1%)  |
| `["scalar", "arithmetic", "(\"sub\", \"Complex{BigInt}\", \"UInt64\")"]` | 1.67 (50%) :x: | 1.00 (1%)  |
...
| `["scalar", "expm1", "(\"arg reduction II\", \"negative argument\", \"Float32\")"]` | 1.05 (5%) :x: | 1.00 (1%)  |
| `["scalar", "expm1", "(\"arg reduction I\", \"negative argument\", \"Float32\")"]` | 1.25 (5%) :x: | 1.00 (1%)  |
...
| `["union", "array", "(\"map\", abs, ComplexF64, true)"]` | 0.95 (5%) :white_check_mark: | 1.00 (1%)  |
...
| `["union", "array", "(\"map\", identity, ComplexF64, false)"]` | 1.61 (5%) :x: | 1.00 (1%)  |
...
| `["union", "array", "(\"perf_binaryop\", *, ComplexF64, (false, false))"]` | 0.87 (5%) :white_check_mark: | 1.00 (1%)  |
...
```
Julia Version 1.6.0-DEV.1057
Commit d7b391d (2020-09-25 23:09 UTC)
Platform Info:
  ...
  CPU: Intel(R) Xeon(R) CPU E3-1241 v3 @ 3.50GHz: 
       ...
       #1  3501 MHz   16121992 s        507 s    1780769 s  769798693 s          4 s
       #2  3501 MHz  122902961 s         22 s    2510664 s  663355970 s          3 s
       #3  3501 MHz   14683024 s        332 s    1080670 s  772842450 s          4 s
       #4  3501 MHz   13735925 s          4 s    1572635 s  773139278 s          3 s
       
  Memory: 31.383651733398438 GB (14516.640625 MB free)
  Uptime: 7.8938047e7 sec
