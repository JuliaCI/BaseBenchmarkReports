...
*Commit(s):* [JuliaLang/julia@52bafeb981bac548afd2264edb518d8d86944dca](https://github.com/JuliaLang/julia/commit/52bafeb981bac548afd2264edb518d8d86944dca)

*Triggered By:* [link](https://github.com/JuliaLang/julia/commit/52bafeb981bac548afd2264edb518d8d86944dca#commitcomment-32366409)

*Tag Predicate:* `ALL`

*Daily Job:* 2019-02-19 vs 2019-02-18
...
| `["collection", "iteration", "(\"Dict\", \"Any\", \"iterate second\")"]` | 0.70 (25%) :white_check_mark: | 1.00 (1%)  |
| `["collection", "queries & updates", "(\"Set\", \"Int\", \"in\", \"false\")"]` | 0.72 (25%) :white_check_mark: | 1.00 (1%)  |
| `["collection", "queries & updates", "(\"Set\", \"String\", \"in\", \"true\")"]` | 0.74 (25%) :white_check_mark: | 1.00 (1%)  |
| `["collection", "set operations", "(\"BitSet\", \"Int\", \"intersect!\", \"small\")"]` | 1.29 (25%) :x: | 1.00 (1%)  |
| `["collection", "set operations", "(\"BitSet\", \"Int\", \"symdiff!\", \"big\")"]` | 0.68 (25%) :white_check_mark: | 1.00 (1%)  |
...
| `["find", "findall", "(\"ispos\", \"Array{Bool,1}\")"]` | 1.46 (5%) :x: | 1.00 (1%)  |
...
| `["find", "findprev", "(\"BitArray{1}\", \"90-10\")"]` | 1.08 (5%) :x: | 1.00 (1%)  |
...
| `["random", "types", "(\"randn\", \"MersenneTwister\", \"ImplicitFloat64\")"]` | 0.73 (25%) :white_check_mark: | 1.00 (1%)  |
...
| `["simd", "(\"auto_two_reductions\", \"Int64\", 4096)"]` | 0.75 (20%) :white_check_mark: | 1.00 (1%)  |
| `["simd", "(\"two_reductions\", \"Int64\", 4096)"]` | 0.75 (20%) :white_check_mark: | 1.00 (1%)  |
...
| `["union", "array", "(\"broadcast\", identity, BigFloat, true)"]` | 1.05 (5%) :x: | 1.00 (1%)  |
...
```
Julia Version 1.2.0-DEV.354
Commit 52bafeb (2019-02-19 02:21 UTC)
Platform Info:
  ...
  CPU: Intel(R) Xeon(R) CPU E3-1241 v3 @ 3.50GHz: 
       ...
       #1  3501 MHz   77156070 s       5015 s    8640921 s  2746725082 s         23 s
       #2  3501 MHz  457935251 s        203 s    7600208 s  2371697553 s         19 s
       #3  3501 MHz   60314448 s       3228 s    5089746 s  2771711809 s         27 s
       #4  3501 MHz   56510443 s          7 s    6629954 s  2773266426 s         17 s
       
  Memory: 31.383651733398438 GB (5208.45703125 MB free)
  Uptime: 2.8394659e7 sec
