...
*Commit(s):* [JuliaLang/julia@2e819091e9fe73a45320b279fb88457cad54075c](https://github.com/JuliaLang/julia/commit/2e819091e9fe73a45320b279fb88457cad54075c) vs [JuliaLang/julia@11c5680d5620b0b64420055e8474a2b8cf757010](https://github.com/JuliaLang/julia/commit/11c5680d5620b0b64420055e8474a2b8cf757010)

*Triggered By:* [link](https://github.com/JuliaLang/julia/pull/30266)
...
| `["array", "index", "(\"mapr_access\", \"SubArray{Float32,2,Array{Float32,2},Tuple{Base.Slice{Base.OneTo{Int64}},Base.Slice{Base.OneTo{Int64}}},true}\")"]` | 0.07 (50%) :white_check_mark: | 0.29 (1%) :white_check_mark: |
| `["array", "index", "(\"mapr_access\", \"SubArray{Float32,2,Array{Float32,3},Tuple{Int64,Base.Slice{Base.OneTo{Int64}},Base.Slice{Base.OneTo{Int64}}},true}\")"]` | 0.10 (50%) :white_check_mark: | 0.29 (1%) :white_check_mark: |
| `["array", "index", "(\"mapr_access\", \"SubArray{Float32,2,Base.ReshapedArray{Float32,2,SubArray{Float32,3,Array{Float32,3},Tuple{Base.Slice{Base.OneTo{Int64}},Base.Slice{Base.OneTo{Int64}},Base.Slice{Base.OneTo{Int64}}},true},Tuple{}},Tuple{Base.Slice{Base.OneTo{Int64}},UnitRange{Int64}},true}\")"]` | 0.26 (50%) :white_check_mark: | 0.49 (1%) :white_check_mark: |
| `["array", "index", "(\"mapr_access\", \"SubArray{Int32,2,Array{Int32,2},Tuple{Base.Slice{Base.OneTo{Int64}},Base.Slice{Base.OneTo{Int64}}},true}\")"]` | 0.07 (50%) :white_check_mark: | 0.29 (1%) :white_check_mark: |
| `["array", "index", "(\"mapr_access\", \"SubArray{Int32,2,Array{Int32,3},Tuple{Int64,Base.Slice{Base.OneTo{Int64}},Base.Slice{Base.OneTo{Int64}}},true}\")"]` | 0.09 (50%) :white_check_mark: | 0.29 (1%) :white_check_mark: |
...
| `["collection", "initialization", "(\"Set\", \"String\", \"iterator\")"]` | 0.74 (25%) :white_check_mark: | 1.00 (1%)  |
| `["collection", "initialization", "(\"Set\", \"String\", \"loop\", \"sizehint!\")"]` | 0.75 (25%) :white_check_mark: | 1.00 (1%)  |
...
| `["find", "findall", "(\"ispos\", \"Array{Float32,1}\")"]` | 1.05 (5%) :x: | 1.00 (1%)  |
| `["find", "findall", "(\"ispos\", \"Array{Float64,1}\")"]` | 1.07 (5%) :x: | 1.00 (1%)  |
| `["find", "findall", "(\"ispos\", \"Array{Int64,1}\")"]` | 1.09 (5%) :x: | 1.00 (1%)  |
| `["find", "findall", "(\"ispos\", \"Array{Int8,1}\")"]` | 1.07 (5%) :x: | 1.00 (1%)  |
| `["find", "findall", "(\"ispos\", \"Array{UInt64,1}\")"]` | 1.08 (5%) :x: | 1.00 (1%)  |
...
| `["find", "findprev", "(\"ispos\", \"Array{Bool,1}\")"]` | 1.16 (5%) :x: | 1.00 (1%)  |
...
| `["linalg", "arithmetic", "(\"sqrt\", \"NPDUpperTriangular\", 1024)"]` | 1.65 (45%) :x: | 1.00 (1%)  |
...
| `["scalar", "predicate", "(\"isinteger\", \"Complex{BigFloat}\")"]` | 1.75 (40%) :x: | 1.00 (1%)  |
| `["scalar", "predicate", "(\"isless\", \"BigInt\")"]` | 1.82 (40%) :x: | 1.00 (1%)  |
...
| `["sparse", "transpose", "(\"adjoint!\", (20000, 20000))"]` | 1.57 (30%) :x: | 1.00 (1%)  |
...
| `["tuple", "reduction", "(\"sum\", (2, 2))"]` | 0.53 (5%) :white_check_mark: | 1.00 (1%)  |
| `["tuple", "reduction", "(\"sum\", (4, 4))"]` | 1.14 (5%) :x: | 1.00 (1%)  |
| `["tuple", "reduction", "(\"sum\", (4,))"]` | 1.05 (5%) :x: | 1.00 (1%)  |
| `["tuple", "reduction", "(\"sum\", (8,))"]` | 1.26 (5%) :x: | 1.00 (1%)  |
...
```
Julia Version 1.1.0-DEV.803
Commit 2e81909 (2018-12-04 19:39 UTC)
Platform Info:
  ...
  CPU: Intel(R) Xeon(R) CPU E3-1241 v3 @ 3.50GHz: 
       ...
       #1  3501 MHz   64337051 s       5009 s    7102811 s  2102717602 s         22 s
       #2  3501 MHz  358338786 s        203 s    5791477 s  1813721127 s         18 s
       #3  3501 MHz   48267035 s       3214 s    4100142 s  2125402360 s         26 s
       #4  3501 MHz   44961980 s          0 s    5230718 s  2127140017 s         15 s
       
  Memory: 31.383651733398438 GB (4395.8515625 MB free)
  Uptime: 2.1796546e7 sec
...
```
Julia Version 1.1.0-DEV.801
Commit 11c5680 (2018-12-04 19:17 UTC)
Platform Info:
  OS: Linux (x86_64-linux-gnu)
      Ubuntu 14.04.5 LTS
  uname: Linux 3.13.0-85-generic #129-Ubuntu SMP Thu Mar 17 20:50:15 UTC 2016 x86_64 x86_64
  CPU: Intel(R) Xeon(R) CPU E3-1241 v3 @ 3.50GHz: 
              speed         user         nice          sys         idle          irq
       #1  3501 MHz   64448263 s       5009 s    7113774 s  2103859005 s         22 s
       #2  3501 MHz  359521130 s        203 s    5807686 s  1813790092 s         18 s
       #3  3501 MHz   48388657 s       3214 s    4107436 s  2126540908 s         26 s
       #4  3501 MHz   45090178 s          0 s    5237677 s  2128272460 s         15 s
       
  Memory: 31.383651733398438 GB (4152.85546875 MB free)
  Uptime: 2.1809228e7 sec
