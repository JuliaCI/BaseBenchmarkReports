...
*Commit(s):* [JuliaLang/julia@93f8a45cf50aea577e07a4f5e8bacc602712af17](https://github.com/JuliaLang/julia/commit/93f8a45cf50aea577e07a4f5e8bacc602712af17)

*Triggered By:* [link](https://github.com/JuliaLang/julia/commit/93f8a45cf50aea577e07a4f5e8bacc602712af17#commitcomment-41394404)

*Tag Predicate:* `ALL`

*Daily Job:* 2020-08-12 vs 2020-08-11
...
| `["array", "setindex!", "(\"setindex!\", 3)"]` | 1.38 (5%) :x: | 1.00 (1%)  |
| `["collection", "queries & updates", "(\"Set\", \"Any\", \"push!\", \"overwrite\")"]` | 1.26 (25%) :x: | 1.00 (1%)  |
| `["collection", "set operations", "(\"BitSet\", \"Int\", \"intersect!\", \"big\")"]` | 1.68 (25%) :x: | 1.00 (1%)  |
| `["dates", "parse", "(\"DateTime\", \"DateFormat\")"]` | 0.91 (5%) :white_check_mark: | 0.62 (1%) :white_check_mark: |
| `["dates", "parse", "(\"DateTime\", \"ISODateTimeFormat\")"]` | 1.05 (5%) :x: | 1.00 (1%)  |
| `["dates", "parse", "(\"Date\", \"DateFormat\")"]` | 0.98 (5%)  | 0.62 (1%) :white_check_mark: |
...
| `["misc", "allocation elision view", "conditional"]` | 0.64 (5%) :white_check_mark: | 1.00 (1%)  |
...
| `["problem", "monte carlo", "euro_option_devec"]` | 0.84 (5%) :white_check_mark: | 1.00 (1%)  |
...
| `["union", "array", "(\"broadcast\", identity, ComplexF64, false)"]` | 1.64 (5%) :x: | 1.00 (1%)  |
...
| `["union", "array", "(\"map\", identity, ComplexF64, true)"]` | 1.22 (5%) :x: | 1.00 (1%)  |
...
| `["union", "array", "(\"perf_binaryop\", *, Int8, (false, false))"]` | 1.08 (5%) :x: | 1.00 (1%)  |
...
| `["union", "array", "(\"perf_sum3\", Float64, true)"]` | 1.31 (5%) :x: | 1.00 (1%)  |
...
```
Julia Version 1.6.0-DEV.624
Commit 93f8a45 (2020-08-12 00:25 UTC)
Platform Info:
  ...
  CPU: Intel(R) Xeon(R) CPU E3-1241 v3 @ 3.50GHz: 
       ...
       #1  3501 MHz  154466234 s       5064 s   17232513 s  7316766994 s         38 s
       #2  3501 MHz  1172446362 s        217 s   23644922 s  6303048910 s         29 s
       #3  3501 MHz  139875064 s       3324 s   10344358 s  7347959129 s         39 s
       #4  3501 MHz  130947150 s         43 s   15015906 s  7350470522 s         28 s
       
  Memory: 31.383651733398438 GB (17956.97265625 MB free)
  Uptime: 7.5049594e7 sec
