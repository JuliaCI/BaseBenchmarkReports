...
*Commit(s):* [JuliaLang/julia@ab541c3a1fc7916bcb2c5b7a198d52926a02cb34](https://github.com/JuliaLang/julia/commit/ab541c3a1fc7916bcb2c5b7a198d52926a02cb34)

*Triggered By:* [link](https://github.com/JuliaLang/julia/commit/ab541c3a1fc7916bcb2c5b7a198d52926a02cb34#commitcomment-34752138)

*Tag Predicate:* `ALL`

*Daily Job:* 2019-08-20 vs 2019-08-19
...
| `["collection", "queries & updates", "(\"Dict\", \"Int\", \"in\", \"false\")"]` | 1.83 (25%) :x: | 1.00 (1%)  |
| `["collection", "queries & updates", "(\"IdDict\", \"Any\", \"in\", \"true\")"]` | 1.27 (25%) :x: | 1.00 (1%)  |
| `["collection", "queries & updates", "(\"Set\", \"Int\", \"pop!\", \"specified\")"]` | 1.67 (25%) :x: | 1.00 (1%)  |
| `["collection", "set operations", "(\"BitSet\", \"Int\", \"union\")"]` | 1.28 (25%) :x: | 1.00 (1%)  |
...
| `["random", "ranges", "(\"RangeGenerator\", \"Int128\", \"1:1\")"]` | 0.54 (25%) :white_check_mark: | 1.00 (1%)  |
...
| `["scalar", "asinh", "(\"0 <= abs(x) < 2^-28\", \"positive argument\", \"Float32\")"]` | 2.38 (5%) :x: | 1.00 (1%)  |
...
| `["scalar", "atan", "(\"19/16 <= abs(x) < 39/16\", \"positive argument\", \"Float64\")"]` | 1.10 (5%) :x: | 1.00 (1%)  |
...
| `["scalar", "expm1", "(\"medium\", \"positive argument\", \"Float32\")"]` | 0.64 (5%) :white_check_mark: | 1.00 (1%)  |
| `["scalar", "mod2pi", "(\"argument reduction (easy) abs(x) > 2.0^20*π/2\", \"positive argument\", \"Float64\")"]` | 1.07 (5%) :x: | 1.00 (1%)  |
| `["scalar", "mod2pi", "(\"no reduction\", \"zero\", \"Float64\")"]` | 0.87 (5%) :white_check_mark: | 1.00 (1%)  |
...
| `["scalar", "sincos", "(\"argument reduction (paynehanek) abs(x) > 2.0^20*π/2\", \"positive argument\", \"Float32\")"]` | 1.11 (5%) :x: | 1.00 (1%)  |
...
| `["union", "array", "(\"perf_sum3\", Int64, true)"]` | 1.26 (5%) :x: | 1.00 (1%)  |
...
```
Julia Version 1.4.0-DEV.13
Commit ab541c3 (2019-08-20 03:08 UTC)
Platform Info:
  ...
  CPU: Intel(R) Xeon(R) CPU E3-1241 v3 @ 3.50GHz: 
       ...
       #1  3501 MHz   97346626 s       5041 s   11287306 s  4292903417 s         28 s
       #2  3501 MHz  656842342 s        208 s   11291844 s  3740374996 s         24 s
       #3  3501 MHz   80830284 s       3245 s    6702548 s  4320990823 s         32 s
       #4  3501 MHz   75805174 s         24 s    9468816 s  4321496249 s         22 s
       
  Memory: 31.383651733398438 GB (14867.85546875 MB free)
  Uptime: 4.411763e7 sec
