...
*Commit(s):* [JuliaLang/julia@773540d286fc6a5610b12dfb6f0ad5c98c935732](https://github.com/JuliaLang/julia/commit/773540d286fc6a5610b12dfb6f0ad5c98c935732)

*Triggered By:* [link](https://github.com/JuliaLang/julia/commit/773540d286fc6a5610b12dfb6f0ad5c98c935732#commitcomment-30473838)

*Tag Predicate:* `ALL`

*Daily Job:* 2018-09-12 vs 2018-09-11
...
| `["array", "reductions", "(\"Statistics.mean\", \"Int64\")"]` | 1.09 (5%) :x: | 1.00 (1%)  |
...
| `["array", "subarray", "(\"lucompletepivCopy!\", 250)"]` | 1.19 (5%) :x: | 1.00 (1%)  |
| `["array", "subarray", "(\"lucompletepivCopy!\", 500)"]` | 1.21 (5%) :x: | 1.00 (1%)  |
| `["array", "subarray", "(\"lucompletepivSub!\", 1000)"]` | 1.16 (5%) :x: | 1.00 (1%)  |
| `["array", "subarray", "(\"lucompletepivSub!\", 250)"]` | 1.12 (5%) :x: | 1.00 (1%)  |
| `["array", "subarray", "(\"lucompletepivSub!\", 500)"]` | 1.17 (5%) :x: | 1.00 (1%)  |
...
| `["broadcast", "typeargs", "(\"tuple\", 5)"]` | 0.56 (5%) :white_check_mark: | 1.00 (1%)  |
| `["collection", "iteration", "(\"Dict\", \"Any\", \"iterate second\")"]` | 1.36 (25%) :x: | 1.00 (1%)  |
| `["collection", "iteration", "(\"IdDict\", \"String\", \"iterate\")"]` | 1.33 (25%) :x: | 1.00 (1%)  |
| `["collection", "iteration", "(\"Vector\", \"Int\", \"iterate\")"]` | 1.86 (25%) :x: | 1.00 (1%)  |
...
| `["find", "findall", "(\"BitArray{1}\", \"90-10\")"]` | 1.26 (5%) :x: | 1.00 (1%)  |
...
| `["linalg", "arithmetic", "(\"sqrt\", \"NPDUpperTriangular\", 1024)"]` | 1.57 (45%) :x: | 1.00 (1%)  |
...
| `["problem", "laplacian", "laplace_sparse_matvec"]` | 1.17 (5%) :x: | 1.00 (1%)  |
| `["problem", "raytrace", "raytrace"]` | 1.11 (5%) :x: | 1.00 (1%)  |
...
| `["random", "ranges", "(\"RangeGenerator\", \"BigInt\", \"1:4294967297\")"]` | 1.26 (25%) :x: | 1.00 (1%)  |
| `["random", "ranges", "(\"rand\", \"MersenneTwister\", \"BigInt\", \"RangeGenerator(1:170141183460469231731687303715884105728)\")"]` | 1.31 (25%) :x: | 1.00 (1%)  |
| `["random", "types", "(\"randexp\", \"RandomDevice\", \"ImplicitFloat64\")"]` | 0.69 (25%) :white_check_mark: | 1.00 (1%)  |
...
| `["scalar", "arithmetic", "(\"mul\", \"BigInt\", \"UInt64\")"]` | 1.59 (50%) :x: | 1.00 (1%)  |
| `["scalar", "arithmetic", "(\"sub\", \"Int64\", \"BigInt\")"]` | 1.80 (50%) :x: | 1.00 (1%)  |
...
| `["scalar", "asin", "(\"one\", \"positive argument\", \"Float32\")"]` | 1.07 (5%) :x: | 1.00 (1%)  |
...
| `["scalar", "tan", "(\"large\", \"negative argument\", \"Float32\")"]` | 1.16 (5%) :x: | 1.00 (1%)  |
...
| `["shootout", "pidigits"]` | 1.17 (5%) :x: | 1.00 (1%)  |
...
| `["tuple", "misc", "11899"]` | 1.38 (5%) :x: | 1.00 (1%)  |
...
| `["union", "array", "(\"broadcast\", abs, Complex{Float64}, false)"]` | 1.06 (5%) :x: | 1.00 (1%)  |
...
| `["union", "array", "(\"perf_simplecopy\", BigInt, false)"]` | 1.10 (5%) :x: | 1.00 (1%)  |
...
| `["union", "array", "(\"sort\", BigInt, true)"]` | 1.07 (5%) :x: | 1.00 (1%)  |
...
Commit 773540d (2018-09-11 21:21 UTC)
Platform Info:
  ...
  CPU: Intel(R) Xeon(R) CPU E3-1241 v3 @ 3.50GHz: 
       ...
       #1  3501 MHz   49158629 s       4998 s    5360390 s  1398428641 s         19 s
       #2  3501 MHz  232228886 s        203 s    3613342 s  1219684244 s          9 s
       #3  3501 MHz   33522752 s       3198 s    2955490 s  1419047457 s         22 s
       #4  3501 MHz   31147878 s          0 s    3620356 s  1420572986 s         10 s
       
  Memory: 31.383651733398438 GB (4925.5 MB free)
  Uptime: 1.4568055e7 sec
  Load Avg:  1.0703125  1.041015625  1.05126953125
  WORD_SIZE: 64
  LIBM: libopenlibm
