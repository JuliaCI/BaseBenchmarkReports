...
*Commit(s):* [JuliaLang/julia@879fef402835c1727aac52bafae686b5913aec2d](https://github.com/JuliaLang/julia/commit/879fef402835c1727aac52bafae686b5913aec2d)

*Triggered By:* [link](https://github.com/JuliaLang/julia/commit/879fef402835c1727aac52bafae686b5913aec2d#commitcomment-35125542)

*Tag Predicate:* `ALL`

*Daily Job:* 2019-09-18 vs 2019-09-17
...
| `["array", "equality", "(\"isequal\", \"Array{Int64,1} isequal Array{Int64,1}\")"]` | 0.88 (5%) :white_check_mark: | 1.00 (1%)  |
| `["array", "reductions", "(\"perf_reduce\", \"Int64\")"]` | 0.95 (5%) :white_check_mark: | 1.00 (1%)  |
| `["array", "setindex!", "(\"setindex!\", 2)"]` | 1.41 (5%) :x: | 1.00 (1%)  |
...
| `["collection", "queries & updates", "(\"Vector\", \"Any\", \"setindex!\")"]` | 1.26 (25%) :x: | 1.00 (1%)  |
...
| `["io", "array_limit", "(\"display\", \"Array{Float64,2}(10000, 10000)\")"]` | 0.85 (5%) :white_check_mark: | 0.96 (1%) :white_check_mark: |
| `["io", "array_limit", "(\"display\", \"Array{Float64,2}(100000000, 1)\")"]` | 0.89 (5%) :white_check_mark: | 1.00 (1%)  |
...
| `["scalar", "asin", "(\"0.5 <= abs(x) < 0.975\", \"positive argument\", \"Float64\")"]` | 0.76 (5%) :white_check_mark: | 1.00 (1%)  |
...
| `["union", "array", "(\"perf_simplecopy\", Float64, true)"]` | 1.16 (5%) :x: | 1.00 (1%)  |
...
| `["union", "array", "(\"perf_sum3\", Int8, true)"]` | 0.86 (5%) :white_check_mark: | 1.00 (1%)  |
| `["union", "array", "(\"perf_sum\", Complex{Float64}, true)"]` | 0.83 (5%) :white_check_mark: | 1.00 (1%)  |
...
```
Julia Version 1.4.0-DEV.168
Commit 879fef4 (2019-09-17 20:00 UTC)
Platform Info:
  ...
  CPU: Intel(R) Xeon(R) CPU E3-1241 v3 @ 3.50GHz: 
       ...
       #1  3501 MHz  100989094 s       5044 s   11725876 s  4538887940 s         28 s
       #2  3501 MHz  695900638 s        208 s   12164999 s  3950823847 s         24 s
       #3  3501 MHz   84553331 s       3251 s    6977682 s  4567384199 s         33 s
       #4  3501 MHz   79311660 s         27 s    9905153 s  4567824073 s         22 s
       
  Memory: 31.383651733398438 GB (15389.0078125 MB free)
  Uptime: 4.6623274e7 sec
