...
*Commit(s):* [JuliaLang/julia@0d71d8cd8b2f149356f1d176914d5d9fae8f64ba](https://github.com/JuliaLang/julia/commit/0d71d8cd8b2f149356f1d176914d5d9fae8f64ba) vs [JuliaLang/julia@f0b8c76f6f8fd36ba74a43d2633adb0f6dedd022](https://github.com/JuliaLang/julia/commit/f0b8c76f6f8fd36ba74a43d2633adb0f6dedd022)

*Triggered By:* [link](https://github.com/JuliaLang/julia/pull/36899#issuecomment-674821277)
...
| `["array", "any/all", "(\"any\", \"Array{Int16,1}\")"]` | 1.08 (5%) :x: | 1.00 (1%)  |
...
| `["linalg", "arithmetic", "(\"-\", \"LowerTriangular\", \"LowerTriangular\", 256)"]` | 2.52 (45%) :x: | 1.00 (1%)  |
...
| `["scalar", "arithmetic", "(\"div\", \"BigFloat\", \"BigFloat\")"]` | 1.61 (50%) :x: | 1.00 (1%)  |
| `["scalar", "arithmetic", "(\"div\", \"Complex{BigFloat}\", \"BigFloat\")"]` | 1.59 (50%) :x: | 1.00 (1%)  |
| `["scalar", "arithmetic", "(\"div\", \"Complex{Int64}\", \"BigFloat\")"]` | 1.65 (50%) :x: | 1.00 (1%)  |
| `["scalar", "arithmetic", "(\"div\", \"Complex{Int64}\", \"BigInt\")"]` | 1.52 (50%) :x: | 1.00 (1%)  |
| `["scalar", "arithmetic", "(\"div\", \"Complex{UInt64}\", \"BigFloat\")"]` | 1.51 (50%) :x: | 1.00 (1%)  |
| `["scalar", "arithmetic", "(\"div\", \"Float64\", \"BigFloat\")"]` | 1.50 (50%) :x: | 1.00 (1%)  |
| `["scalar", "arithmetic", "(\"div\", \"Int64\", \"BigFloat\")"]` | 1.72 (50%) :x: | 1.00 (1%)  |
| `["scalar", "arithmetic", "(\"div\", \"Int64\", \"BigInt\")"]` | 1.64 (50%) :x: | 1.00 (1%)  |
| `["scalar", "arithmetic", "(\"div\", \"UInt64\", \"BigFloat\")"]` | 1.61 (50%) :x: | 1.00 (1%)  |
...
| `["scalar", "atanh", "(\"very small\", \"negative argument\", \"Float32\")"]` | 1.75 (5%) :x: | 1.00 (1%)  |
...
| `["scalar", "cos", "(\"argument reduction (easy) abs(x) < 7π/4\", \"negative argument\", \"Float32\", \"cos_kernel\")"]` | 0.89 (5%) :white_check_mark: | 1.00 (1%)  |
...
| `["scalar", "exp2", "(\"2pow3\", \"positive argument\", \"Float32\")"]` | 0.66 (5%) :white_check_mark: | 1.00 (1%)  |
...
| `["scalar", "fastmath", "(\"div\", \"BigFloat\")"]` | 1.69 (40%) :x: | 1.00 (1%)  |
...
| `["union", "array", "(\"perf_sum2\", BigFloat, false)"]` | 0.89 (5%) :white_check_mark: | 1.00 (1%)  |
| `["union", "array", "(\"perf_sum2\", BigFloat, true)"]` | 0.90 (5%) :white_check_mark: | 1.00 (1%)  |
...
| `["union", "array", "(\"perf_sum\", Float32, true)"]` | 0.69 (5%) :white_check_mark: | 1.00 (1%)  |
...
| `["union", "array", "(\"skipmissing\", sum, Union{Missing, BigFloat}, true)"]` | 0.91 (5%) :white_check_mark: | 1.00 (1%)  |
...
Commit 0d71d8c (2020-08-14 20:35 UTC)
Platform Info:
  ...
  CPU: Intel(R) Xeon(R) CPU E3-1241 v3 @ 3.50GHz: 
       ...
       #1  3501 MHz   61255566 s       2456 s   22755841 s  7442208213 s         21 s
       #2  3501 MHz  390976102 s         65 s    8344283 s  7146196598 s         29 s
       #3  3501 MHz   52428556 s       3262 s    6286315 s  7485899595 s         40 s
       #4  3501 MHz   50500637 s         19 s    4808854 s  7493327320 s         39 s
       
  Memory: 31.383651733398438 GB (18485.2109375 MB free)
  Uptime: 7.5508772e7 sec
...
Commit f0b8c76 (2020-08-02 04:55 UTC)
Platform Info:
  OS: Linux (x86_64-linux-gnu)
      Ubuntu 14.04.5 LTS
  uname: Linux 3.13.0-85-generic #129-Ubuntu SMP Thu Mar 17 20:50:15 UTC 2016 x86_64 x86_64
  CPU: Intel(R) Xeon(R) CPU E3-1241 v3 @ 3.50GHz: 
              speed         user         nice          sys         idle          irq
       #1  3501 MHz   61419964 s       2456 s   22765943 s  7443413277 s         21 s
       #2  3501 MHz  392246496 s         65 s    8370965 s  7146281720 s         29 s
       #3  3501 MHz   52579002 s       3262 s    6292626 s  7487125456 s         40 s
       #4  3501 MHz   50644224 s         19 s    4814888 s  7494559298 s         39 s
       
  Memory: 31.383651733398438 GB (18160.74609375 MB free)
  Uptime: 7.5522604e7 sec
  Load Avg:  1.0029296875  1.0146484375  1.04541015625
  WORD_SIZE: 64
  LIBM: libopenlibm
  LLVM: libLLVM-9.0.1 (ORCJIT, haswell)
