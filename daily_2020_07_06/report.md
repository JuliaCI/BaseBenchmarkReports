...
*Commit(s):* [JuliaLang/julia@dec679e352a5b4a38e3ec444bc8f68ce6247a919](https://github.com/JuliaLang/julia/commit/dec679e352a5b4a38e3ec444bc8f68ce6247a919)

*Triggered By:* [link](https://github.com/JuliaLang/julia/commit/dec679e352a5b4a38e3ec444bc8f68ce6247a919#commitcomment-40386164)

*Tag Predicate:* `ALL`

*Daily Job:* 2020-07-06 vs 2020-07-05
...
| `["array", "comprehension", "(\"collect\", \"Vector{Float64}\")"]` | 0.64 (5%) :white_check_mark: | 1.00 (1%)  |
...
| `["array", "equality", "(\"==\", \"Vector{Int64} == Vector{Float64}\")"]` | 1.05 (5%) :x: | 1.00 (1%)  |
...
| `["find", "findprev", "(\"ispos\", \"Vector{UInt8}\")"]` | 1.24 (5%) :x: | 1.00 (1%)  |
...
| `["random", "types", "(\"rand\", \"MersenneTwister\", \"ImplicitFloat64\")"]` | 0.63 (25%) :white_check_mark: | 1.00 (1%)  |
...
| `["scalar", "atan2", "(\"abs(y/x) safe (large)\", \"y negative\", \"x positive\", \"Float64\")"]` | 0.87 (5%) :white_check_mark: | 1.00 (1%)  |
...
| `["union", "array", "(\"broadcast\", identity, ComplexF64, true)"]` | 1.26 (5%) :x: | 1.00 (1%)  |
| `["union", "array", "(\"map\", abs, Float32, true)"]` | 1.08 (5%) :x: | 1.00 (1%)  |
| `["union", "array", "(\"map\", abs, Float64, true)"]` | 0.92 (5%) :white_check_mark: | 1.00 (1%)  |
| `["union", "array", "(\"map\", identity, ComplexF64, true)"]` | 1.21 (5%) :x: | 1.00 (1%)  |
| `["union", "array", "(\"perf_binaryop\", *, ComplexF64, (false, false))"]` | 1.14 (5%) :x: | 1.00 (1%)  |
...
```
Julia Version 1.6.0-DEV.370
Commit dec679e (2020-07-05 05:37 UTC)
Platform Info:
  ...
  CPU: Intel(R) Xeon(R) CPU E3-1241 v3 @ 3.50GHz: 
       ...
       #1  3501 MHz  148694486 s       5056 s   16770539 s  7003720090 s         37 s
       #2  3501 MHz  1123971350 s        217 s   22535155 s  6033111012 s         28 s
       #3  3501 MHz  133878443 s       3321 s    9967630 s  7035275923 s         38 s
       #4  3501 MHz  125534757 s         43 s   14303741 s  7037577285 s         28 s
       
  Memory: 31.383651733398438 GB (19270.05859375 MB free)
  Uptime: 7.1853004e7 sec
