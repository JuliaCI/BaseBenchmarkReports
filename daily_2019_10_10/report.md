...
*Commit(s):* [JuliaLang/julia@09795cdd2e1d1af291d87122897a580c78352999](https://github.com/JuliaLang/julia/commit/09795cdd2e1d1af291d87122897a580c78352999)

*Triggered By:* [link](https://github.com/JuliaLang/julia/commit/09795cdd2e1d1af291d87122897a580c78352999#commitcomment-35436915)

*Tag Predicate:* `ALL`

*Daily Job:* 2019-10-10 vs 2019-10-09
...
| `["collection", "queries & updates", "(\"Dict\", \"Any\", \"getindex\")"]` | 0.69 (25%) :white_check_mark: | 1.00 (1%)  |
| `["collection", "queries & updates", "(\"IdDict\", \"Int\", \"first\")"]` | 1.26 (25%) :x: | 1.00 (1%)  |
| `["collection", "set operations", "(\"BitSet\", \"Int\", \"union!\", \"big\")"]` | 1.88 (25%) :x: | 1.00 (1%)  |
...
| `["random", "ranges", "(\"RangeGenerator\", \"BigInt\", \"1:18446744073709551615\")"]` | 0.75 (25%) :white_check_mark: | 1.00 (1%)  |
| `["random", "types", "(\"rand\", \"ImplicitRNG\", \"ImplicitFloat64\")"]` | 2.08 (25%) :x: | 1.00 (1%)  |
| `["random", "types", "(\"rand\", \"MersenneTwister\", \"Complex{UInt16}\")"]` | 1.50 (25%) :x: | 1.00 (1%)  |
| `["random", "types", "(\"rand\", \"MersenneTwister\", \"Int16\")"]` | 1.94 (25%) :x: | 1.00 (1%)  |
| `["random", "types", "(\"randexp\", \"MersenneTwister\", \"Float16\")"]` | 1.83 (25%) :x: | 1.00 (1%)  |
...
| `["scalar", "arithmetic", "(\"mul\", \"Float64\", \"BigFloat\")"]` | 1.64 (50%) :x: | 1.00 (1%)  |
...
| `["scalar", "asinh", "(\"2^-28 <= abs(x) < 2\", \"positive argument\", \"Float64\")"]` | 1.10 (5%) :x: | 1.00 (1%)  |
...
| `["scalar", "atanh", "(\"very small\", \"positive argument\", \"Float64\")"]` | 1.40 (5%) :x: | 1.00 (1%)  |
| `["scalar", "atanh", "(\"zero\", \"Float64\")"]` | 0.94 (5%) :white_check_mark: | 1.00 (1%)  |
| `["scalar", "cbrt", "(\"very small\", \"positive argument\", \"Float32\")"]` | 1.31 (5%) :x: | 1.00 (1%)  |
...
| `["scalar", "predicate", "(\"isnan\", \"Complex{Float32}\")"]` | 1.31 (25%) :x: | 1.00 (1%)  |
...
| `["scalar", "tan", "(\"medium\", \"negative argument\", \"Float32\")"]` | 1.36 (5%) :x: | 1.00 (1%)  |
...
| `["union", "array", "(\"map\", identity, BigInt, true)"]` | 1.21 (5%) :x: | 1.00 (1%)  |
...
```
Julia Version 1.4.0-DEV.284
Commit 09795cd (2019-10-09 22:33 UTC)
Platform Info:
  ...
  CPU: Intel(R) Xeon(R) CPU E3-1241 v3 @ 3.50GHz: 
       ...
       #1  3501 MHz  103890364 s       5044 s   12093298 s  4725276614 s         29 s
       #2  3501 MHz  720852928 s        212 s   12816170 s  4115072055 s         24 s
       #3  3501 MHz   87488748 s       3255 s    7164145 s  4754240467 s         33 s
       #4  3501 MHz   82055168 s         27 s   10191322 s  4754698500 s         22 s
       
  Memory: 31.383651733398438 GB (14753.6171875 MB free)
  Uptime: 4.8523977e7 sec
