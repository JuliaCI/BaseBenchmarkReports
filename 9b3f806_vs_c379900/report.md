...
*Commit(s):* [JuliaLang/julia@9b3f80663dfc66fbedb941981b63e5c582fd1dd0](https://github.com/JuliaLang/julia/commit/9b3f80663dfc66fbedb941981b63e5c582fd1dd0) vs [JuliaLang/julia@c3799003d769c434a2507ec472aa3f80f6c39317](https://github.com/JuliaLang/julia/commit/c3799003d769c434a2507ec472aa3f80f6c39317)

*Triggered By:* [link](https://github.com/JuliaLang/julia/pull/30385#issuecomment-447414261)
...
| `["io", "array_limit", "(\"display\", \"Array{Float64,2}(10000, 10000)\")"]` | 1.07 (5%) :x: | 1.03 (1%) :x: |
...
| `["random", "collections", "(\"rand!\", \"ImplicitRNG\", \"large Set\")"]` | 0.34 (25%) :white_check_mark: | 1.00 (1%)  |
| `["random", "collections", "(\"rand!\", \"ImplicitRNG\", \"small Set\")"]` | 0.32 (25%) :white_check_mark: | 1.00 (1%)  |
| `["random", "collections", "(\"rand!\", \"MersenneTwister\", \"large Set\")"]` | 0.34 (25%) :white_check_mark: | 1.00 (1%)  |
| `["random", "collections", "(\"rand!\", \"MersenneTwister\", \"small Set\")"]` | 0.33 (25%) :white_check_mark: | 1.00 (1%)  |
...
| `["scalar", "acos", "(\"abs(x) < 0.5\", \"negative argument\", \"Float32\")"]` | 1.35 (5%) :x: | 1.00 (1%)  |
...
| `["scalar", "asinh", "(\"2 <= abs(x) < 2^28\", \"negative argument\", \"Float32\")"]` | 0.78 (5%) :white_check_mark: | 1.00 (1%)  |
...
| `["scalar", "predicate", "(\"isequal\", \"Complex{BigInt}\")"]` | 0.44 (40%) :white_check_mark: | 1.00 (1%)  |
| `["scalar", "predicate", "(\"isinteger\", \"Complex{BigFloat}\")"]` | 0.45 (40%) :white_check_mark: | 1.00 (1%)  |
| `["scalar", "predicate", "(\"isinteger\", \"UInt64\")"]` | 0.71 (25%) :white_check_mark: | 1.00 (1%)  |
...
| `["sparse", "index", "(\"spmat\", \"row\", \"logical\", 1000)"]` | 2.05 (30%) :x: | 1.00 (1%)  |
