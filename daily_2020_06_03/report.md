...
*Commit(s):* [JuliaLang/julia@5d6a910260c6114565c1102cbc4a4ca34362189c](https://github.com/JuliaLang/julia/commit/5d6a910260c6114565c1102cbc4a4ca34362189c)

*Triggered By:* [link](https://github.com/JuliaLang/julia/commit/5d6a910260c6114565c1102cbc4a4ca34362189c#commitcomment-39625389)
...
| `["misc", "repeat", "(200, 24, 1)"]` | 1.33 (5%) :x: | 1.00 (1%)  |
| `["misc", "splatting", "(3, 3, 3)"]` | 0.87 (5%) :white_check_mark: | 1.00 (1%)  |
...
| `["random", "collections", "(\"rand\", \"ImplicitRNG\", \"large String\")"]` | 1.67 (25%) :x: | 1.00 (1%)  |
...
| `["scalar", "cos", "(\"no reduction\", \"positive argument\", \"Float64\", \"cos_kernel\")"]` | 1.33 (5%) :x: | 1.00 (1%)  |
...
| `["scalar", "sinh", "(\"9f0 <= abs(x) < 88.72283f0\", \"negative argument\", \"Float32\")"]` | 1.61 (5%) :x: | 1.00 (1%)  |
...
| `["union", "array", "(\"map\", abs, Complex{Float64}, false)"]` | 0.94 (5%) :white_check_mark: | 1.00 (1%)  |
