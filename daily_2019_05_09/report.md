...
*Commit(s):* [JuliaLang/julia@48634f9f8669e1dc1be0a1589cd5be880c04055a](https://github.com/JuliaLang/julia/commit/48634f9f8669e1dc1be0a1589cd5be880c04055a)

*Triggered By:* [link](https://github.com/JuliaLang/julia/commit/48634f9f8669e1dc1be0a1589cd5be880c04055a#commitcomment-33467436)

*Tag Predicate:* `ALL`

*Daily Job:* 2019-05-09 vs 2019-05-08
...
| `["array", "index", "2d"]` | 0.72 (5%) :white_check_mark: | 1.00 (1%)  |
...
| `["collection", "queries & updates", "(\"Dict\", \"String\", \"pop!\", \"unspecified\")"]` | 0.73 (25%) :white_check_mark: | 1.00 (1%)  |
| `["collection", "queries & updates", "(\"Dict\", \"String\", \"setindex!\", \"new\")"]` | 0.69 (25%) :white_check_mark: | 1.00 (1%)  |
...
| `["random", "collections", "(\"rand!\", \"RandomDevice\", \"large Vector\")"]` | 1.27 (25%) :x: | 1.00 (1%)  |
| `["random", "collections", "(\"rand!\", \"RandomDevice\", \"small String\")"]` | 1.29 (25%) :x: | 1.00 (1%)  |
| `["random", "collections", "(\"rand!\", \"RandomDevice\", \"small Vector\")"]` | 1.28 (25%) :x: | 1.00 (1%)  |
...
| `["random", "types", "(\"randexp!\", \"RandomDevice\", \"Float64\")"]` | 1.42 (25%) :x: | 1.00 (1%)  |
...
| `["scalar", "atanh", "(\"0.5 <= abs(x) < 1\", \"negative argument\", \"Float32\")"]` | 0.91 (5%) :white_check_mark: | 1.00 (1%)  |
...
| `["scalar", "sincos", "(\"argument reduction (easy) abs(x) < 3π/4\", \"positive argument\", \"Float32\")"]` | 0.76 (5%) :white_check_mark: | 1.00 (1%)  |
| `["scalar", "tan", "(\"small\", \"negative argument\", \"Float64\")"]` | 1.07 (5%) :x: | 1.00 (1%)  |
| `["scalar", "tan", "(\"very small\", \"negative argument\", \"Float32\")"]` | 0.59 (5%) :white_check_mark: | 1.00 (1%)  |
...
| `["union", "array", "(\"perf_sum3\", Complex{Float64}, false)"]` | 1.10 (5%) :x: | 1.00 (1%)  |
...
| `["union", "array", "(\"skipmissing\", collect, Union{Nothing, Int64}, false)"]` | 1.60 (5%) :x: | 1.00 (1%)  |
...
```
Julia Version 1.3.0-DEV.188
Commit 48634f9 (2019-05-08 23:19 UTC)
Platform Info:
  ...
  CPU: Intel(R) Xeon(R) CPU E3-1241 v3 @ 3.50GHz: 
       ...
       #1  3501 MHz   88012815 s       5028 s   10001118 s  3415223238 s         24 s
       #2  3501 MHz  559145091 s        203 s    9386242 s  2950393080 s         20 s
       #3  3501 MHz   71334525 s       3237 s    5932080 s  3441731771 s         30 s
       #4  3501 MHz   66976022 s         12 s    7904272 s  3443019458 s         19 s
       
  Memory: 31.383651733398438 GB (4426.79296875 MB free)
  Uptime: 3.5216922e7 sec
