...
*Commit(s):* [JuliaLang/julia@9cd8097f27e4035e4cd3cc13bc5118027189392d](https://github.com/JuliaLang/julia/commit/9cd8097f27e4035e4cd3cc13bc5118027189392d) vs [JuliaLang/julia@a6bf74a2f9d69f31060d6294ab0e59bf61ce26d8](https://github.com/JuliaLang/julia/commit/a6bf74a2f9d69f31060d6294ab0e59bf61ce26d8)

*Triggered By:* [link](https://github.com/JuliaLang/julia/pull/34106#issuecomment-565853952)
...
| `["collection", "queries & updates", "(\"BitSet\", \"Int\", \"first\")"]` | 0.68 (25%) :white_check_mark: | 1.00 (1%)  |
| `["collection", "queries & updates", "(\"Set\", \"String\", \"in\", \"true\")"]` | 1.26 (25%) :x: | 1.00 (1%)  |
| `["collection", "set operations", "(\"BitSet\", \"Int\", \"==\", \"self\")"]` | 1.79 (25%) :x: | 1.00 (1%)  |
...
| `["scalar", "arithmetic", "(\"rem type\", \"Bool\", \"BigInt\")"]` | 0.48 (40%) :white_check_mark: | 1.00 (1%)  |
...
| `["scalar", "atan2", "(\"abs(y/x) safe (large)\", \"y negative\", \"x negative\", \"Float32\")"]` | 0.73 (5%) :white_check_mark: | 1.00 (1%)  |
...
| `["scalar", "expm1", "(\"medium\", \"negative argument\", \"Float32\")"]` | 1.20 (5%) :x: | 1.00 (1%)  |
...
| `["scalar", "sin", "(\"argument reduction (easy) abs(x) < 3π/4\", \"negative argument\", \"Float32\", \"cos_kernel\")"]` | 1.43 (5%) :x: | 1.00 (1%)  |
| `["scalar", "sin", "(\"argument reduction (easy) abs(x) < 3π/4\", \"positive argument\", \"Float32\", \"cos_kernel\")"]` | 0.69 (5%) :white_check_mark: | 1.00 (1%)  |
| `["scalar", "sin", "(\"argument reduction (easy) abs(x) < 4π/4\", \"positive argument\", \"Float32\", \"sin_kernel\")"]` | 1.20 (5%) :x: | 1.00 (1%)  |
| `["scalar", "sin", "(\"argument reduction (easy) abs(x) < 4π/4\", \"positive argument\", \"Float64\", \"sin_kernel\")"]` | 0.63 (5%) :white_check_mark: | 1.00 (1%)  |
| `["scalar", "sin", "(\"argument reduction (easy) abs(x) < 7π/4\", \"negative argument\", \"Float64\", \"sin_kernel\")"]` | 0.60 (5%) :white_check_mark: | 1.00 (1%)  |
...
| `["sparse", "index", "(\"spmat\", \"col\", \"OneTo\", 1000)"]` | 1.36 (30%) :x: | 1.00 (1%)  |
| `["sparse", "index", "(\"spmat\", \"col\", \"range\", 100)"]` | 1.37 (30%) :x: | 1.00 (1%)  |
| `["sparse", "index", "(\"spmat\", \"col\", \"range\", 1000)"]` | 1.32 (30%) :x: | 1.00 (1%)  |
| `["sparse", "index", "(\"spmat\", \"integer\", 1000)"]` | 1.45 (30%) :x: | 1.00 (1%)  |
| `["sparse", "index", "(\"spmat\", \"row\", \"OneTo\", 100)"]` | 2.35 (30%) :x: | 1.00 (1%)  |
| `["sparse", "index", "(\"spmat\", \"row\", \"OneTo\", 1000)"]` | 2.02 (30%) :x: | 1.00 (1%)  |
| `["sparse", "index", "(\"spmat\", \"row\", \"array\", 10)"]` | 1.41 (30%) :x: | 1.00 (1%)  |
| `["sparse", "index", "(\"spmat\", \"row\", \"array\", 100)"]` | 2.36 (30%) :x: | 1.00 (1%)  |
| `["sparse", "index", "(\"spmat\", \"row\", \"array\", 1000)"]` | 2.74 (30%) :x: | 1.00 (1%)  |
| `["sparse", "index", "(\"spmat\", \"row\", \"logical\", 100)"]` | 1.97 (30%) :x: | 1.00 (1%)  |
| `["sparse", "index", "(\"spmat\", \"row\", \"logical\", 1000)"]` | 2.45 (30%) :x: | 1.00 (1%)  |
| `["sparse", "index", "(\"spmat\", \"row\", \"range\", 100)"]` | 2.38 (30%) :x: | 1.00 (1%)  |
| `["sparse", "index", "(\"spmat\", \"row\", \"range\", 1000)"]` | 1.50 (30%) :x: | 1.00 (1%)  |
| `["sparse", "index", "(\"spvec\", \"integer\", 1000)"]` | 1.67 (30%) :x: | 1.00 (1%)  |
| `["sparse", "index", "(\"spvec\", \"integer\", 10000)"]` | 1.67 (30%) :x: | 1.00 (1%)  |
| `["sparse", "index", "(\"spvec\", \"integer\", 100000)"]` | 2.16 (30%) :x: | 1.00 (1%)  |
| `["sparse", "index", "(\"spvec\", \"logical\", 1000)"]` | 1.44 (30%) :x: | 1.00 (1%)  |
...
| `["union", "array", "(\"sort\", BigInt, false)"]` | 0.95 (5%) :white_check_mark: | 1.00 (1%)  |
...
```
Julia Version 1.4.0-DEV.613
Commit 9cd8097 (2019-12-15 22:31 UTC)
Platform Info:
  ...
  CPU: Intel(R) Xeon(R) CPU E3-1241 v3 @ 3.50GHz: 
       ...
       #1  3501 MHz   54023643 s       2445 s   16571741 s  5341211393 s         16 s
       #2  3501 MHz  333670305 s         47 s    6557179 s  5085707518 s         25 s
       #3  3501 MHz   45143432 s       3207 s    5367322 s  5375044490 s         36 s
       #4  3501 MHz   43479317 s         16 s    4164482 s  5380141427 s         33 s
       
  Memory: 31.383651733398438 GB (13923.50390625 MB free)
  Uptime: 5.4294458e7 sec
...
Platform Info:
  ...
  CPU: Intel(R) Xeon(R) CPU E3-1241 v3 @ 3.50GHz: 
              speed         user         nice          sys         idle          irq
       #1  3501 MHz   54153519 s       2445 s   16581298 s  5342426157 s         16 s
       #2  3501 MHz  334929304 s         47 s    6583270 s  5085781216 s         25 s
       #3  3501 MHz   45275178 s       3207 s    5372921 s  5376265402 s         36 s
       #4  3501 MHz   43602690 s         16 s    4169629 s  5381371567 s         34 s
       
  Memory: 31.383651733398438 GB (13615.59765625 MB free)
  Uptime: 5.4308049e7 sec
  Load Avg:  1.0029296875  1.0146484375  1.04541015625
  WORD_SIZE: 64
  LIBM: libopenlibm
  LLVM: libLLVM-8.0.1 (ORCJIT, haswell)
