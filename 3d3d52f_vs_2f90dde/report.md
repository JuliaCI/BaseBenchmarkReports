...
*Commit(s):* [JuliaLang/julia@3d3d52f3205eb5ae17c3287944d9c5f7a3346b1a](https://github.com/JuliaLang/julia/commit/3d3d52f3205eb5ae17c3287944d9c5f7a3346b1a) vs [JuliaLang/julia@2f90dded2ac6577197285fd48e20edbbd8732561](https://github.com/JuliaLang/julia/commit/2f90dded2ac6577197285fd48e20edbbd8732561)

*Triggered By:* [link](https://github.com/JuliaLang/julia/pull/35675#issuecomment-622130478)
...
| `["array", "any/all", "(\"any\", \"Array{Float64,1}\")"]` | 0.67 (5%) :white_check_mark: | 1.00 (1%)  |
...
| `["array", "index", "(\"sumeach\", \"100000:-1:1\")"]` | 1.67 (50%) :x: | 1.00 (1%)  |
| `["array", "subarray", "(\"gramschmidt!\", 100)"]` | 1.22 (5%) :x: | 1.00 (1%)  |
| `["array", "subarray", "(\"gramschmidt!\", 1000)"]` | 1.06 (5%) :x: | 1.00 (1%)  |
| `["array", "subarray", "(\"gramschmidt!\", 250)"]` | 1.24 (5%) :x: | 1.00 (1%)  |
| `["array", "subarray", "(\"gramschmidt!\", 500)"]` | 1.44 (5%) :x: | 1.00 (1%)  |
...
| `["misc", "23042", "Complex{Float32}"]` | 0.87 (5%) :white_check_mark: | 1.00 (1%)  |
| `["misc", "afoldl", "Complex{Float64}"]` | 1.36 (5%) :x: | 1.00 (1%)  |
...
| `["random", "types", "(\"rand\", \"ImplicitRNG\", \"Int64\")"]` | 0.57 (25%) :white_check_mark: | 1.00 (1%)  |
| `["random", "types", "(\"rand\", \"MersenneTwister\", \"ImplicitFloat64\")"]` | 0.73 (25%) :white_check_mark: | 1.00 (1%)  |
...
| `["scalar", "asinh", "(\"2^-28 <= abs(x) < 2\", \"negative argument\", \"Float32\")"]` | 0.76 (5%) :white_check_mark: | 1.00 (1%)  |
| `["scalar", "asinh", "(\"very large\", \"positive argument\", \"Float32\")"]` | 0.60 (5%) :white_check_mark: | 1.00 (1%)  |
...
| `["scalar", "atan", "(\"11/16 <= abs(x) < 19/16\", \"positive argument\", \"Float64\")"]` | 1.26 (5%) :x: | 1.00 (1%)  |
| `["scalar", "atan", "(\"19/16 <= abs(x) < 39/16\", \"negative argument\", \"Float64\")"]` | 1.22 (5%) :x: | 1.00 (1%)  |
| `["scalar", "atan", "(\"19/16 <= abs(x) < 39/16\", \"positive argument\", \"Float64\")"]` | 0.89 (5%) :white_check_mark: | 1.00 (1%)  |
...
| `["scalar", "atan", "(\"very small\", \"positive argument\", \"Float32\")"]` | 1.53 (5%) :x: | 1.00 (1%)  |
...
| `["scalar", "atan2", "(\"abs(y/x) safe (small)\", \"y negative\", \"x positive\", \"Float32\")"]` | 1.61 (5%) :x: | 1.00 (1%)  |
...
| `["scalar", "atan2", "(\"abs(y/x) small\", \"y positive\", \"x positive\", \"Float32\")"]` | 1.65 (5%) :x: | 1.00 (1%)  |
| `["scalar", "atan2", "(\"y finite\", \"y positive\", \"x infinite\", \"x negative\", \"Float64\")"]` | 1.31 (5%) :x: | 1.00 (1%)  |
...
| `["scalar", "cos", "(\"argument reduction (easy) abs(x) < 7π/4\", \"negative argument\", \"Float32\", \"cos_kernel\")"]` | 1.71 (5%) :x: | 1.00 (1%)  |
| `["scalar", "cos", "(\"argument reduction (easy) abs(x) < 7π/4\", \"negative argument\", \"Float64\", \"cos_kernel\")"]` | 1.17 (5%) :x: | 1.00 (1%)  |
| `["scalar", "cos", "(\"argument reduction (easy) abs(x) < 9π/4\", \"negative argument\", \"Float32\", \"cos_kernel\")"]` | 1.30 (5%) :x: | 1.00 (1%)  |
...
| `["scalar", "cos", "(\"no reduction\", \"zero\", \"Float64\")"]` | 1.33 (5%) :x: | 1.00 (1%)  |
...
| `["scalar", "floatexp", "(\"exp\", \"no agument reduction, k = 9\", \"Float64\")"]` | 1.56 (40%) :x: | 1.00 (1%)  |
...
| `["scalar", "sin", "(\"argument reduction (paynehanek) abs(x) > 2.0^20*π/2\", \"positive argument\", \"Float32\", \"sin_kernel\")"]` | 1.17 (5%) :x: | 1.00 (1%)  |
...
| `["scalar", "sinh", "(\"22.0 <= abs(x) < 709.7822265633563\", \"negative argument\", \"Float64\")"]` | 1.21 (5%) :x: | 1.00 (1%)  |
...
| `["shootout", "nbody_vec"]` | 1.70 (5%) :x: | 1.00 (1%)  |
...
| `["union", "array", "(\"map\", identity, Int64, false)"]` | 1.05 (5%) :x: | 1.00 (1%)  |
...
| `["union", "array", "(\"skipmissing\", sum, Union{Nothing, Complex{Float64}}, false)"]` | 1.61 (5%) :x: | 1.00 (1%)  |
...
Commit 3d3d52f (2020-04-30 21:42 UTC)
Platform Info:
  ...
  CPU: Intel(R) Xeon(R) CPU E3-1241 v3 @ 3.50GHz: 
       ...
       #1  3501 MHz  136594942 s       5056 s   15601946 s  6445814996 s         35 s
       #2  3501 MHz  1028793654 s        217 s   20191416 s  5559075012 s         26 s
       #3  3501 MHz  121388582 s       3296 s    9243370 s  6476683628 s         38 s
       #4  3501 MHz  113999844 s         43 s   13291519 s  6478327052 s         27 s
       
  Memory: 31.383651733398438 GB (19030.2265625 MB free)
  Uptime: 6.612937e7 sec
...
```
Julia Version 1.5.0-DEV.748
Commit 2f90dde (2020-04-30 21:35 UTC)
Platform Info:
  OS: Linux (x86_64-linux-gnu)
      Ubuntu 14.04.5 LTS
  uname: Linux 3.13.0-85-generic #129-Ubuntu SMP Thu Mar 17 20:50:15 UTC 2016 x86_64 x86_64
  CPU: Intel(R) Xeon(R) CPU E3-1241 v3 @ 3.50GHz: 
              speed         user         nice          sys         idle          irq
       #1  3501 MHz  136746372 s       5056 s   15611756 s  6447010464 s         35 s
       #2  3501 MHz  1030031442 s        217 s   20217667 s  5559171647 s         26 s
       #3  3501 MHz  121557799 s       3296 s    9249652 s  6477869103 s         38 s
       #4  3501 MHz  114146038 s         43 s   13297322 s  6479536098 s         27 s
       
  Memory: 31.383651733398438 GB (18612.93359375 MB free)
  Uptime: 6.6142985e7 sec
