...
*Commit(s):* [JuliaLang/julia@86b560d432acc24aa72815ff63ccf86ae7f285a1](https://github.com/JuliaLang/julia/commit/86b560d432acc24aa72815ff63ccf86ae7f285a1)

*Triggered By:* [link](https://github.com/JuliaLang/julia/commit/86b560d432acc24aa72815ff63ccf86ae7f285a1#commitcomment-33590812)

*Tag Predicate:* `ALL`

*Daily Job:* 2019-05-19 vs 2019-05-18
...
| `["array", "any/all", "(\"all\", \"Array{Int16,1}\")"]` | 1.06 (5%) :x: | 1.00 (1%)  |
| `["array", "bool", "boolarray_true_load!"]` | 1.27 (5%) :x: | 1.00 (1%)  |
| `["array", "comprehension", "(\"collect\", \"Array{Float64,1}\")"]` | 0.75 (5%) :white_check_mark: | 1.00 (1%)  |
| `["array", "comprehension", "(\"comprehension_collect\", \"Array{Float64,1}\")"]` | 0.76 (5%) :white_check_mark: | 1.00 (1%)  |
...
| `["random", "types", "(\"rand\", \"ImplicitRNG\", \"ImplicitFloat64\")"]` | 0.60 (25%) :white_check_mark: | 1.00 (1%)  |
...
| `["scalar", "asinh", "(\"very large\", \"positive argument\", \"Float32\")"]` | 0.68 (5%) :white_check_mark: | 1.00 (1%)  |
...
| `["scalar", "expm1", "(\"one\", \"Float64\")"]` | 0.87 (5%) :white_check_mark: | 1.00 (1%)  |
| `["scalar", "expm1", "(\"very small\", \"negative argument\", \"Float64\")"]` | 0.63 (5%) :white_check_mark: | 1.00 (1%)  |
| `["scalar", "expm1", "(\"very small\", \"positive argument\", \"Float64\")"]` | 0.63 (5%) :white_check_mark: | 1.00 (1%)  |
| `["scalar", "expm1", "(\"zero\", \"Float64\")"]` | 0.63 (5%) :white_check_mark: | 1.00 (1%)  |
...
| `["sparse", "index", "(\"spmat\", \"row\", \"OneTo\", 10)"]` | 1.37 (30%) :x: | 1.00 (1%)  |
...
| `["union", "array", "(\"perf_simplecopy\", Float64, false)"]` | 1.10 (5%) :x: | 1.00 (1%)  |
...
```
Julia Version 1.3.0-DEV.249
Commit 86b560d (2019-05-19 00:31 UTC)
Platform Info:
  ...
  CPU: Intel(R) Xeon(R) CPU E3-1241 v3 @ 3.50GHz: 
       ...
       #1  3501 MHz   89758155 s       5031 s   10197037 s  3499490825 s         24 s
       #2  3501 MHz  577031010 s        203 s    9652617 s  3018621404 s         21 s
       #3  3501 MHz   73111554 s       3237 s    6062200 s  3526205157 s         30 s
       #4  3501 MHz   68614469 s         12 s    8046468 s  3527599915 s         19 s
       
  Memory: 31.383651733398438 GB (5263.73046875 MB free)
  Uptime: 3.6081223e7 sec
