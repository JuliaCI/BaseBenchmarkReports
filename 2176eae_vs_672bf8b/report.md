...
*Commit(s):* [JuliaLang/julia@2176eae2587c2e8a16ce63337bb800a314777675](https://github.com/JuliaLang/julia/commit/2176eae2587c2e8a16ce63337bb800a314777675) vs [JuliaLang/julia@672bf8bea7b01a1828fc21e6689c8d3fa5f46ea6](https://github.com/JuliaLang/julia/commit/672bf8bea7b01a1828fc21e6689c8d3fa5f46ea6)

*Triggered By:* [link](https://github.com/JuliaLang/julia/pull/31338#issuecomment-475816029)
...
| `["array", "cat", "(\"catnd\", 5)"]` | 0.86 (5%) :white_check_mark: | 0.99 (1%) :white_check_mark: |
| `["array", "cat", "(\"catnd_setind\", 5)"]` | 0.87 (5%) :white_check_mark: | 1.00 (1%)  |
| `["array", "cat", "(\"vcat\", 5)"]` | 0.76 (5%) :white_check_mark: | 1.00 (1%)  |
...
| `["array", "equality", "(\"isequal\", \"Array{Int64,1} isequal Array{Float64,1}\")"]` | 0.93 (5%) :white_check_mark: | 1.00 (1%)  |
...
| `["collection", "iteration", "(\"IdDict\", \"String\", \"iterate\")"]` | 1.38 (25%) :x: | 1.00 (1%)  |
| `["collection", "set operations", "(\"BitSet\", \"Int\", \"union!\", \"big\")"]` | 1.31 (25%) :x: | 1.00 (1%)  |
| `["dates", "query", "(\"firstdayofmonth\", \"DateTime\")"]` | 0.71 (25%) :white_check_mark: | 1.00 (1%)  |
| `["dates", "string", "DateTime"]` | 1.07 (5%) :x: | 1.00 (1%)  |
| `["find", "findnext", "(\"ispos\", \"Array{Float32,1}\")"]` | 1.24 (5%) :x: | 1.00 (1%)  |
...
| `["find", "findprev", "(\"ispos\", \"Array{Float64,1}\")"]` | 1.27 (5%) :x: | 1.00 (1%)  |
| `["find", "findprev", "(\"ispos\", \"Array{UInt64,1}\")"]` | 1.06 (5%) :x: | 1.00 (1%)  |
| `["io", "array_limit", "(\"display\", \"Array{Float64,1}(100000000,)\")"]` | 0.91 (5%) :white_check_mark: | 0.99 (1%)  |
| `["io", "array_limit", "(\"display\", \"Array{Float64,2}(10000, 10000)\")"]` | 0.81 (5%) :white_check_mark: | 0.92 (1%) :white_check_mark: |
| `["io", "array_limit", "(\"display\", \"Array{Float64,2}(100000000, 1)\")"]` | 0.90 (5%) :white_check_mark: | 0.99 (1%)  |
...
| `["random", "ranges", "(\"rand\", \"MersenneTwister\", \"UInt64\", \"RangeGenerator(1:1)\")"]` | 1.44 (25%) :x: | 1.00 (1%)  |
| `["random", "ranges", "(\"rand\", \"MersenneTwister\", \"UInt64\", \"RangeGenerator(1:4294967295)\")"]` | 1.50 (25%) :x: | 1.00 (1%)  |
...
| `["scalar", "acos", "(\"small\", \"positive argument\", \"Float64\")"]` | 0.82 (5%) :white_check_mark: | 1.00 (1%)  |
| `["scalar", "acos", "(\"zero\", \"Float64\")"]` | 0.94 (5%) :white_check_mark: | 1.00 (1%)  |
| `["scalar", "arithmetic", "(\"add\", \"Int64\", \"Complex{BigInt}\")"]` | 1.54 (50%) :x: | 1.00 (1%)  |
...
| `["scalar", "asinh", "(\"very small\", \"negative argument\", \"Float64\")"]` | 1.87 (5%) :x: | 1.00 (1%)  |
...
| `["scalar", "exp2", "(\"2pow127\", \"positive argument\", Float32)"]` | 1.14 (5%) :x: | 1.00 (1%)  |
...
| `["scalar", "rem_pio2", "(\"argument reduction (easy) abs(x) < 2.0^20π/4\", \"positive argument\", \"Float64\")"]` | 1.25 (5%) :x: | 1.00 (1%)  |
...
| `["union", "array", "(\"broadcast\", abs, Float64, false)"]` | 1.11 (5%) :x: | 1.00 (1%)  |
...
| `["union", "array", "(\"map\", identity, Bool, true)"]` | 1.31 (5%) :x: | 1.00 (1%)  |
...
| `["union", "array", "(\"skipmissing\", collect, Bool, false)"]` | 0.91 (5%) :white_check_mark: | 1.00 (1%)  |
...
```
Julia Version 1.2.0-DEV.530
Commit 2176eae (2019-03-22 23:27 UTC)
Platform Info:
  ...
  CPU: Intel(R) Xeon(R) CPU E3-1241 v3 @ 3.50GHz: 
       ...
       #1  3501 MHz   45023842 s       2430 s    9612477 s  3049853326 s         12 s
       #2  3501 MHz  256026004 s         14 s    4642144 s  2851097217 s         19 s
       #3  3501 MHz   36024002 s       3159 s    4437128 s  3071081854 s         27 s
       #4  3501 MHz   34725978 s         14 s    3319265 s  3074890286 s         24 s
       
  Memory: 31.383651733398438 GB (4417.90625 MB free)
  Uptime: 3.1141237e7 sec
...
Platform Info:
  ...
  CPU: Intel(R) Xeon(R) CPU E3-1241 v3 @ 3.50GHz: 
              speed         user         nice          sys         idle          irq
       #1  3501 MHz   45146652 s       2430 s    9623128 s  3050902451 s         12 s
       #2  3501 MHz  257123252 s         14 s    4658394 s  2851170066 s         19 s
       #3  3501 MHz   36144954 s       3159 s    4444319 s  3072140025 s         27 s
       #4  3501 MHz   34844802 s         14 s    3326336 s  3075950836 s         24 s
       
  Memory: 31.383651733398438 GB (3687.84765625 MB free)
  Uptime: 3.1153107e7 sec
  Load Avg:  1.0029296875  1.0146484375  1.04541015625
  WORD_SIZE: 64
  LIBM: libopenlibm
  LLVM: libLLVM-6.0.1 (ORCJIT, haswell)
