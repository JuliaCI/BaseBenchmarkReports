...
*Commit(s):* [JuliaLang/julia@55a6dab76329b693f0fab372b1a80289bff01a90](https://github.com/JuliaLang/julia/commit/55a6dab76329b693f0fab372b1a80289bff01a90)

*Triggered By:* [link](https://github.com/JuliaLang/julia/commit/55a6dab76329b693f0fab372b1a80289bff01a90#commitcomment-42959559)

*Tag Predicate:* `ALL`

*Daily Job:* 2020-10-05 vs 2020-10-04
...
| `["misc", "afoldl", "Int"]` | 1.44 (5%) :x: | 1.00 (1%)  |
...
| `["misc", "parse", "Float64"]` | 1.25 (5%) :x: | 1.00 (1%)  |
...
| `["scalar", "arithmetic", "(\"add\", \"BigInt\", \"Complex{BigInt}\")"]` | 1.74 (50%) :x: | 1.00 (1%)  |
| `["scalar", "asin", "(\"0.5 <= abs(x) < 0.975\", \"negative argument\", \"Float64\")"]` | 0.75 (5%) :white_check_mark: | 1.00 (1%)  |
| `["scalar", "asin", "(\"small\", \"positive argument\", \"Float32\")"]` | 1.07 (5%) :x: | 1.00 (1%)  |
| `["scalar", "asin", "(\"zero\", \"Float64\")"]` | 0.88 (5%) :white_check_mark: | 1.00 (1%)  |
| `["scalar", "atan", "(\"11/16 <= abs(x) < 19/16\", \"positive argument\", \"Float64\")"]` | 0.74 (5%) :white_check_mark: | 1.00 (1%)  |
...
| `["scalar", "fastmath", "(\"add\", \"BigInt\")"]` | 2.09 (40%) :x: | 1.00 (1%)  |
| `["scalar", "fastmath", "(\"sub\", \"BigInt\")"]` | 0.60 (40%) :white_check_mark: | 1.00 (1%)  |
...
| `["scalar", "sin", "(\"no reduction\", \"negative argument\", \"Float64\", \"sin_kernel\")"]` | 1.06 (5%) :x: | 1.00 (1%)  |
| `["scalar", "sincos", "(\"argument reduction (easy) abs(x) < 2.0^20π/4\", \"negative argument\", \"Float64\")"]` | 1.25 (5%) :x: | 1.00 (1%)  |
| `["scalar", "sincos", "(\"argument reduction (hard) abs(x) < 4π/4\", \"positive argument\", \"Float32\")"]` | 1.10 (5%) :x: | 1.00 (1%)  |
...
| `["string", "repeat", "repeat char 2"]` | 1.84 (5%) :x: | 1.00 (1%)  |
...
| `["union", "array", "(\"broadcast\", abs, ComplexF64, true)"]` | 0.95 (5%) :white_check_mark: | 1.00 (1%)  |
...
| `["union", "array", "(\"broadcast\", identity, ComplexF64, false)"]` | 0.59 (5%) :white_check_mark: | 1.00 (1%)  |
...
| `["union", "array", "(\"map\", *, Float64, (false, true))"]` | 1.19 (5%) :x: | 1.00 (1%)  |
...
| `["union", "array", "(\"map\", identity, BigInt, true)"]` | 0.72 (5%) :white_check_mark: | 1.00 (1%)  |
| `["union", "array", "(\"map\", identity, Float64, true)"]` | 1.30 (5%) :x: | 1.00 (1%)  |
| `["union", "array", "(\"map\", identity, Int64, false)"]` | 0.93 (5%) :white_check_mark: | 1.00 (1%)  |
| `["union", "array", "(\"map\", identity, Int8, false)"]` | 1.12 (5%) :x: | 1.00 (1%)  |
...
| `["union", "array", "(\"perf_simplecopy\", Int64, true)"]` | 0.78 (5%) :white_check_mark: | 1.00 (1%)  |
...
Commit 55a6dab (2020-10-04 09:06 UTC)
Platform Info:
  ...
  CPU: Intel(R) Xeon(R) CPU E3-1241 v3 @ 3.50GHz: 
       ...
       #1  3501 MHz   16271901 s        508 s    1791668 s  777408646 s          4 s
       #2  3501 MHz  124098259 s         22 s    2536816 s  669908489 s          3 s
       #3  3501 MHz   14830051 s        332 s    1088726 s  780445729 s          4 s
       #4  3501 MHz   13878677 s          4 s    1594062 s  780728812 s          3 s
       
  Memory: 31.383651733398438 GB (14555.46484375 MB free)
  Uptime: 7.9715628e7 sec
