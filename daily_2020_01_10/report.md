...
*Commit(s):* [JuliaLang/julia@eb5410a70318378224fdd151fa5dab7ef84a0286](https://github.com/JuliaLang/julia/commit/eb5410a70318378224fdd151fa5dab7ef84a0286)

*Triggered By:* [link](https://github.com/JuliaLang/julia/commit/eb5410a70318378224fdd151fa5dab7ef84a0286#commitcomment-36738758)

*Tag Predicate:* `ALL`

*Daily Job:* 2020-01-10 vs 2020-01-09
...
| `["array", "comprehension", "(\"comprehension_collect\", \"Array{Float64,1}\")"]` | 1.82 (5%) :x: | 1.00 (1%)  |
...
| `["find", "findprev", "(\"ispos\", \"Array{UInt8,1}\")"]` | 0.86 (5%) :white_check_mark: | 1.00 (1%)  |
...
| `["random", "ranges", "(\"RangeGenerator\", \"BigInt\", \"1:4294967295\")"]` | 1.50 (25%) :x: | 1.00 (1%)  |
...
| `["scalar", "acosh", "(\"very large\", \"positive argument\", \"Float64\")"]` | 1.60 (5%) :x: | 1.00 (1%)  |
...
| `["scalar", "exp2", "(\"2pow35\", \"negative argument\", \"Float64\")"]` | 1.73 (5%) :x: | 1.00 (1%)  |
| `["scalar", "expm1", "(\"arg reduction II\", \"positive argument\", \"Float32\")"]` | 1.06 (5%) :x: | 1.00 (1%)  |
| `["scalar", "expm1", "(\"one\", \"Float32\")"]` | 1.58 (5%) :x: | 1.00 (1%)  |
| `["scalar", "predicate", "(\"isless\", \"BigFloat\")"]` | 0.46 (40%) :white_check_mark: | 1.00 (1%)  |
...
| `["sparse", "sparse solves", "square system (lu), matrix rhs"]` | 2.47 (5%) :x: | 2.38 (1%) :x: |
| `["sparse", "sparse solves", "square system (lu), vector rhs"]` | 1.80 (5%) :x: | 1.71 (1%) :x: |
...
| `["union", "array", "(\"map\", abs, BigFloat, false)"]` | 1.08 (5%) :x: | 1.00 (1%)  |
...
| `["union", "array", "(\"map\", abs, Int64, true)"]` | 1.27 (5%) :x: | 1.00 (1%)  |
| `["union", "array", "(\"map\", abs, Int8, false)"]` | 1.08 (5%) :x: | 1.00 (1%)  |
| `["union", "array", "(\"map\", identity, Int64, true)"]` | 0.74 (5%) :white_check_mark: | 1.00 (1%)  |
...
| `["union", "array", "(\"perf_sum\", BigFloat, false)"]` | 0.90 (5%) :white_check_mark: | 1.00 (1%)  |
...
| `["union", "array", "(\"skipmissing\", sum, Union{Nothing, BigFloat}, false)"]` | 1.12 (5%) :x: | 1.00 (1%)  |
...
Commit eb5410a (2020-01-10 02:37 UTC)
Platform Info:
  ...
  CPU: Intel(R) Xeon(R) CPU E3-1241 v3 @ 3.50GHz: 
       ...
       #1  3501 MHz  117507687 s       5050 s   13645946 s  5502906743 s         31 s
       #2  3501 MHz  864524953 s        217 s   16151750 s  4762062275 s         26 s
       #3  3501 MHz  101611997 s       3261 s    8088940 s  5533280820 s         36 s
       #4  3501 MHz   95239482 s         43 s   11577120 s  5533839192 s         25 s
       
  Memory: 31.383651733398438 GB (18381.06640625 MB free)
  Uptime: 5.6469726e7 sec
  Load Avg:  1.15966796875  1.0595703125  1.05908203125
  WORD_SIZE: 64
  LIBM: libopenlibm
