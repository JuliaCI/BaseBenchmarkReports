...
*Triggered By:* [link](https://github.com/JuliaLang/julia/commit/9b5fea51ca639f62bc65e5d92aced79bdb28b651#commitcomment-33413976)

*Tag Predicate:* `ALL`

*Daily Job:* 2019-05-05 vs 2019-05-04
...
| `["array", "reverse", "rev_load_fast!"]` | 1.39 (5%) :x: | 1.00 (1%)  |
| `["array", "reverse", "rev_load_slow!"]` | 1.12 (5%) :x: | 1.00 (1%)  |
| `["array", "reverse", "rev_loadmul_fast!"]` | 1.07 (5%) :x: | 1.00 (1%)  |
| `["array", "reverse", "rev_loadmul_slow!"]` | 1.07 (5%) :x: | 1.00 (1%)  |
| `["array", "setindex!", "(\"setindex!\", 2)"]` | 1.24 (5%) :x: | 1.00 (1%)  |
...
| `["collection", "set operations", "(\"BitSet\", \"Int\", \"setdiff!\", \"small\")"]` | 1.29 (25%) :x: | 1.00 (1%)  |
| `["collection", "set operations", "(\"BitSet\", \"Int\", \"symdiff!\", \"big\")"]` | 1.38 (25%) :x: | 1.00 (1%)  |
...
| `["scalar", "atan2", "(\"abs(y/x) safe (large)\", \"y negative\", \"x negative\", \"Float64\")"]` | 1.30 (5%) :x: | 1.00 (1%)  |
...
| `["scalar", "exp2", "(\"2pow127\", \"positive argument\", Float32)"]` | 0.86 (5%) :white_check_mark: | 1.00 (1%)  |
...
| `["scalar", "exp2", "(\"small\", \"positive argument\", \"Float64\")"]` | 1.54 (5%) :x: | 1.00 (1%)  |
...
| `["union", "array", "(\"perf_sum2\", BigFloat, true)"]` | 1.15 (5%) :x: | 1.00 (1%)  |
...
Platform Info:
  ...
  CPU: Intel(R) Xeon(R) CPU E3-1241 v3 @ 3.50GHz: 
       ...
       #1  3501 MHz   87605653 s       5026 s    9940458 s  3381233619 s         24 s
       #2  3501 MHz  554701162 s        203 s    9307834 s  2920407158 s         20 s
       #3  3501 MHz   70873757 s       3237 s    5899766 s  3407707604 s         30 s
       #4  3501 MHz   66566560 s         12 s    7856962 s  3408973722 s         19 s
       
  Memory: 31.383651733398438 GB (5164.9140625 MB free)
  Uptime: 3.4871576e7 sec
