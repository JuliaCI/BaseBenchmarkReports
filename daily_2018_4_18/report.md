...
*Commit(s):* [JuliaLang/julia@ca7e837658222cb93a230c96e80c62ca44bd7e16](https://github.com/JuliaLang/julia/commit/ca7e837658222cb93a230c96e80c62ca44bd7e16)

*Triggered By:* [link](https://github.com/JuliaLang/julia/commit/ca7e837658222cb93a230c96e80c62ca44bd7e16#commitcomment-28629176)

*Tag Predicate:* `ALL`

*Daily Job:* 2018-04-18 vs 2018-04-17
...
| `["array", "reductions", "(\"sumabs\", \"Int64\")"]` | 0.75 (15%) :white_check_mark: | 1.00 (1%)  |
...
| `["collection", "iteration", "(\"BitSet\", \"Int\", \"next\")"]` | 1.28 (25%) :x: | 1.00 (1%)  |
| `["collection", "queries & updates", "(\"Dict\", \"Int\", \"pop!\", \"specified\")"]` | 1.63 (25%) :x: | 1.00 (1%)  |
...
| `["scalar", "acos", "(\"0.5 <= abs(x) < 1\", \"positive argument\", \"Float64\")"]` | 1.38 (15%) :x: | 1.00 (1%)  |
| `["scalar", "arithmetic", "(\"add\", \"Complex{BigInt}\", \"Int64\")"]` | 1.56 (50%) :x: | 1.00 (1%)  |
| `["scalar", "arithmetic", "(\"div\", \"Complex{Float32}\", \"Complex{UInt64}\")"]` | 1.79 (50%) :x: | 1.00 (1%)  |
| `["scalar", "arithmetic", "(\"sub\", \"Int64\", \"BigInt\")"]` | 0.43 (50%) :white_check_mark: | 1.00 (1%)  |
...
| `["scalar", "asinh", "(\"2 <= abs(x) < 2^28\", \"positive argument\", \"Float64\")"]` | 1.18 (15%) :x: | 1.00 (1%)  |
| `["scalar", "atan", "(\"11/16 <= abs(x) < 19/16\", \"negative argument\", \"Float64\")"]` | 1.28 (15%) :x: | 1.00 (1%)  |
...
| `["scalar", "atan", "(\"very small\", \"positive argument\", \"Float32\")"]` | 0.75 (15%) :white_check_mark: | 1.00 (1%)  |
...
Platform Info:
  ...
  CPU: Intel(R) Xeon(R) CPU E3-1241 v3 @ 3.50GHz: 
       ...
       #1  3501 MHz    3491131 s        259 s     500151 s  181962506 s          2 s
       #2  3501 MHz   26662974 s          0 s     405320 s  159173417 s          0 s
       #3  3501 MHz    3059438 s       2368 s     318042 s  182631029 s          2 s
       #4  3501 MHz    3004294 s          0 s     414823 s  182746278 s          1 s
       
  Memory: 31.383651733398438 GB (16653.3359375 MB free)
  Uptime: 1.863608e6 sec
