...
*Commit(s):* [JuliaLang/julia@f9b053dfa2b08d6003954411093ed17f3a72da3d](https://github.com/JuliaLang/julia/commit/f9b053dfa2b08d6003954411093ed17f3a72da3d) vs [JuliaLang/julia@59e3df3ef6a9b1df791d75f502fa964e5a0affbe](https://github.com/JuliaLang/julia/commit/59e3df3ef6a9b1df791d75f502fa964e5a0affbe)

*Triggered By:* [link](https://github.com/JuliaLang/julia/pull/31984#issuecomment-492755234)
...
| `["collection", "set operations", "(\"Vector\", \"Int\", \"⊆\", \"BitSet\")"]` | 0.73 (25%) :white_check_mark: | 1.00 (1%)  |
...
| `["linalg", "factorization", "(\"svd\", \"Diagonal\", 1024)"]` | 1.01 (45%)  | 0.98 (1%) :white_check_mark: |
...
| `["scalar", "expm1", "(\"arg reduction I\", \"negative argument\", \"Float64\")"]` | 1.22 (5%) :x: | 1.00 (1%)  |
...
| `["scalar", "expm1", "(\"very small\", \"negative argument\", \"Float64\")"]` | 1.67 (5%) :x: | 1.00 (1%)  |
| `["scalar", "expm1", "(\"very small\", \"positive argument\", \"Float32\")"]` | 0.94 (5%) :white_check_mark: | 1.00 (1%)  |
| `["scalar", "expm1", "(\"very small\", \"positive argument\", \"Float64\")"]` | 2.67 (5%) :x: | 1.00 (1%)  |
| `["scalar", "expm1", "(\"zero\", \"Float64\")"]` | 2.27 (5%) :x: | 1.00 (1%)  |
...
| `["scalar", "sincos", "(\"argument reduction (easy) abs(x) < 2.0^20π/4\", \"negative argument\", \"Float32\")"]` | 0.86 (5%) :white_check_mark: | 1.00 (1%)  |
...
| `["scalar", "sinh", "(\"2.0^-28 <= abs(x) < 22.0\", \"positive argument\", \"Float64\")"]` | 1.21 (5%) :x: | 1.00 (1%)  |
...
| `["sparse", "matmul", "(\"At_mul_B!\", \"dense 40x4000, sparse 40x40 -> dense 4000x40\")"]` | 1.57 (30%) :x: | 1.00 (1%)  |
...
| `["tuple", "linear algebra", "(\"matmat\", (8, 8), (8, 8))"]` | 2.19 (5%) :x: | 1.00 (1%)  |
...
| `["union", "array", "(\"perf_binaryop\", *, Int64, (false, false))"]` | 1.11 (5%) :x: | 1.00 (1%)  |
...
| `["union", "array", "(\"skipmissing\", collect, Union{Nothing, BigInt}, false)"]` | 1.12 (5%) :x: | 1.00 (1%)  |
...
```
Julia Version 1.3.0-DEV.230
Commit f9b053d (2019-05-15 16:12 UTC)
Platform Info:
  ...
  CPU: Intel(R) Xeon(R) CPU E3-1241 v3 @ 3.50GHz: 
       ...
       #1  3501 MHz   89236930 s       5031 s   10134715 s  3470613375 s         24 s
       #2  3501 MHz  571387630 s        203 s    9570176 s  2994827614 s         21 s
       #3  3501 MHz   72567924 s       3237 s    6019881 s  3497271974 s         30 s
       #4  3501 MHz   68108135 s         12 s    8003818 s  3498635878 s         19 s
       
  Memory: 31.383651733398438 GB (5668.5390625 MB free)
  Uptime: 3.5785866e7 sec
...
```
Julia Version 1.3.0-DEV.225
Commit 59e3df3 (2019-05-15 16:09 UTC)
Platform Info:
  OS: Linux (x86_64-linux-gnu)
      Ubuntu 14.04.5 LTS
  uname: Linux 3.13.0-85-generic #129-Ubuntu SMP Thu Mar 17 20:50:15 UTC 2016 x86_64 x86_64
  CPU: Intel(R) Xeon(R) CPU E3-1241 v3 @ 3.50GHz: 
              speed         user         nice          sys         idle          irq
       #1  3501 MHz   89329352 s       5031 s   10142691 s  3471704142 s         24 s
       #2  3501 MHz  572515848 s        203 s    9583924 s  2994880962 s         21 s
       #3  3501 MHz   72676879 s       3237 s    6024734 s  3498353268 s         30 s
       #4  3501 MHz   68213747 s         12 s    8008157 s  3499721179 s         19 s
       
  Memory: 31.383651733398438 GB (5490.1953125 MB free)
  Uptime: 3.5797822e7 sec
