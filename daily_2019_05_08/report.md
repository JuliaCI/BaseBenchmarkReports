...
*Commit(s):* [JuliaLang/julia@b1267886c5de2b8e18c7fff5ad7cd79cd8a351ed](https://github.com/JuliaLang/julia/commit/b1267886c5de2b8e18c7fff5ad7cd79cd8a351ed)

*Triggered By:* [link](https://github.com/JuliaLang/julia/commit/b1267886c5de2b8e18c7fff5ad7cd79cd8a351ed#commitcomment-33452705)

*Tag Predicate:* `ALL`

*Daily Job:* 2019-05-08 vs 2019-05-07
...
| `["array", "index", "2d"]` | 1.38 (5%) :x: | 1.00 (1%)  |
...
| `["collection", "queries & updates", "(\"Dict\", \"String\", \"push!\", \"new\")"]` | 1.30 (25%) :x: | 1.00 (1%)  |
| `["collection", "queries & updates", "(\"Dict\", \"String\", \"setindex!\", \"new\")"]` | 1.49 (25%) :x: | 1.00 (1%)  |
...
| `["scalar", "sincos", "(\"argument reduction (easy) abs(x) < 3π/4\", \"positive argument\", \"Float32\")"]` | 1.31 (5%) :x: | 1.00 (1%)  |
...
| `["scalar", "tan", "(\"very small\", \"negative argument\", \"Float32\")"]` | 1.35 (5%) :x: | 1.00 (1%)  |
| `["scalar", "tan", "(\"very small\", \"negative argument\", \"Float64\")"]` | 0.94 (5%) :white_check_mark: | 1.00 (1%)  |
| `["scalar", "tan", "(\"very small\", \"positive argument\", \"Float32\")"]` | 0.84 (5%) :white_check_mark: | 1.00 (1%)  |
| `["scalar", "tan", "(\"zero\", \"Float32\")"]` | 0.79 (5%) :white_check_mark: | 1.00 (1%)  |
...
| `["union", "array", "(\"perf_sum4\", BigInt, true)"]` | 1.10 (5%) :x: | 1.00 (1%)  |
| `["union", "array", "(\"perf_sum\", Bool, true)"]` | 1.33 (5%) :x: | 1.00 (1%)  |
| `["union", "array", "(\"perf_sum\", Complex{Float64}, true)"]` | 1.06 (5%) :x: | 1.00 (1%)  |
...
```
Julia Version 1.3.0-DEV.184
Commit b126788 (2019-05-07 14:45 UTC)
Platform Info:
  ...
  CPU: Intel(R) Xeon(R) CPU E3-1241 v3 @ 3.50GHz: 
       ...
       #1  3501 MHz   87913708 s       5028 s    9986148 s  3406717677 s         24 s
       #2  3501 MHz  558042210 s        203 s    9366807 s  2942883658 s         20 s
       #3  3501 MHz   71216424 s       3237 s    5923931 s  3433224597 s         30 s
       #4  3501 MHz   66874003 s         12 s    7892345 s  3434503932 s         19 s
       
  Memory: 31.383651733398438 GB (5284.87109375 MB free)
  Uptime: 3.5130542e7 sec
