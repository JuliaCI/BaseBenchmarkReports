...
*Commit(s):* [JuliaLang/julia@11fe3e3170f849440429456fa60b9c79d27de554](https://github.com/JuliaLang/julia/commit/11fe3e3170f849440429456fa60b9c79d27de554)

*Triggered By:* [link](https://github.com/JuliaLang/julia/commit/11fe3e3170f849440429456fa60b9c79d27de554#commitcomment-33596694)

*Tag Predicate:* `ALL`

*Daily Job:* 2019-05-20 vs 2019-05-19
...
| `["collection", "queries & updates", "(\"Set\", \"Int\", \"first\")"]` | 0.68 (25%) :white_check_mark: | 1.00 (1%)  |
| `["dates", "construction", "DateTime"]` | 0.93 (5%) :white_check_mark: | 1.00 (1%)  |
| `["dates", "string", "Date"]` | 0.95 (5%) :white_check_mark: | 1.00 (1%)  |
| `["find", "findall", "(\"BitArray{1}\", \"10-90\")"]` | 1.51 (5%) :x: | 1.00 (1%)  |
...
| `["io", "array_limit", "(\"display\", \"Array{Float64,2}(100000000, 1)\")"]` | 1.01 (5%)  | 0.99 (1%) :white_check_mark: |
...
| `["problem", "spellcheck", "spellcheck"]` | 0.83 (5%) :white_check_mark: | 1.00 (1%)  |
...
| `["random", "types", "(\"rand\", \"ImplicitRNG\", \"ImplicitFloat64\")"]` | 0.71 (25%) :white_check_mark: | 1.00 (1%)  |
| `["random", "types", "(\"rand\", \"ImplicitRNG\", \"Int64\")"]` | 1.28 (25%) :x: | 1.00 (1%)  |
| `["random", "types", "(\"randn\", \"MersenneTwister\", \"Float32\")"]` | 0.69 (25%) :white_check_mark: | 1.00 (1%)  |
...
| `["scalar", "arithmetic", "(\"rem type\", \"Int64\", \"BigInt\")"]` | 0.47 (40%) :white_check_mark: | 1.00 (1%)  |
...
| `["scalar", "fastmath", "(\"mul\", \"BigInt\")"]` | 1.60 (40%) :x: | 1.00 (1%)  |
| `["scalar", "predicate", "(\"isfinite\", \"Complex{BigFloat}\")"]` | 1.43 (40%) :x: | 1.00 (1%)  |
...
| `["sparse", "sparse solves", "least squares (default), matrix rhs"]` | 0.89 (5%) :white_check_mark: | 1.00 (1%)  |
...
| `["union", "array", "(\"sort\", Union{Nothing, Int64}, false)"]` | 0.87 (5%) :white_check_mark: | 1.00 (1%)  |
...
```
Julia Version 1.3.0-DEV.251
Commit 11fe3e3 (2019-05-19 23:20 UTC)
Platform Info:
  ...
  CPU: Intel(R) Xeon(R) CPU E3-1241 v3 @ 3.50GHz: 
       ...
       #1  3501 MHz   89867066 s       5031 s   10212203 s  3507941075 s         24 s
       #2  3501 MHz  578121324 s        203 s    9670798 s  3026103182 s         21 s
       #3  3501 MHz   73210432 s       3237 s    6072821 s  3534683306 s         30 s
       #4  3501 MHz   68725340 s         14 s    8057094 s  3536066773 s         19 s
       
  Memory: 31.383651733398438 GB (5568.23046875 MB free)
  Uptime: 3.6167174e7 sec
