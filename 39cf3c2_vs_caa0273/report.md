...
*Commit(s):* [jw3126/julia@39cf3c25a43298cb15ba289240a3be13738db02a](https://github.com/jw3126/julia/commit/39cf3c25a43298cb15ba289240a3be13738db02a) vs [JuliaLang/julia@caa0273557dc172fd54bbc3a34fe171390b8eb74](https://github.com/JuliaLang/julia/commit/caa0273557dc172fd54bbc3a34fe171390b8eb74)

*Triggered By:* [link](https://github.com/JuliaLang/julia/pull/30320#issuecomment-446386177)
...
| `["array", "reductions", "(\"maxabs\", \"Float64\")"]` | 0.45 (5%) :white_check_mark: | 1.00 (1%)  |
| `["array", "reductions", "(\"maxabs\", \"Int64\")"]` | 0.79 (5%) :white_check_mark: | 1.00 (1%)  |
| `["array", "reverse", "rev_load_fast!"]` | 1.57 (5%) :x: | 1.00 (1%)  |
| `["array", "reverse", "rev_load_slow!"]` | 1.24 (5%) :x: | 1.00 (1%)  |
| `["array", "reverse", "rev_loadmul_fast!"]` | 1.09 (5%) :x: | 1.00 (1%)  |
...
| `["array", "subarray", "(\"lucompletepivCopy!\", 1000)"]` | 1.26 (5%) :x: | 1.00 (1%)  |
| `["array", "subarray", "(\"lucompletepivCopy!\", 250)"]` | 1.20 (5%) :x: | 1.00 (1%)  |
| `["array", "subarray", "(\"lucompletepivCopy!\", 500)"]` | 1.22 (5%) :x: | 1.00 (1%)  |
| `["array", "subarray", "(\"lucompletepivSub!\", 1000)"]` | 1.21 (5%) :x: | 1.00 (1%)  |
| `["array", "subarray", "(\"lucompletepivSub!\", 250)"]` | 1.13 (5%) :x: | 1.00 (1%)  |
| `["array", "subarray", "(\"lucompletepivSub!\", 500)"]` | 1.18 (5%) :x: | 1.00 (1%)  |
...
| `["io", "array_limit", "(\"display\", \"Array{Float64,1}(100000000,)\")"]` | 0.92 (5%) :white_check_mark: | 1.00 (1%)  |
| `["io", "array_limit", "(\"display\", \"Array{Float64,2}(10000, 10000)\")"]` | 0.87 (5%) :white_check_mark: | 0.96 (1%) :white_check_mark: |
...
| `["problem", "go", "go_game"]` | 1.16 (5%) :x: | 1.00 (1%)  |
| `["problem", "grigoriadis khachiyan", "grigoriadis_khachiyan"]` | 1.28 (5%) :x: | 1.00 (1%)  |
...
| `["problem", "stockcorr", "stockcorr"]` | 1.12 (5%) :x: | 1.00 (1%)  |
| `["problem", "ziggurat", "ziggurat"]` | 1.32 (5%) :x: | 1.00 (1%)  |
...
| `["random", "collections", "(\"rand\", \"MersenneTwister\", \"large Dict\")"]` | 1.41 (25%) :x: | 1.00 (1%)  |
...
| `["scalar", "arithmetic", "(\"add\", \"BigInt\", \"Int64\")"]` | 1.57 (50%) :x: | 1.00 (1%)  |
| `["scalar", "arithmetic", "(\"mul\", \"BigInt\", \"UInt64\")"]` | 1.65 (50%) :x: | 1.00 (1%)  |
...
| `["scalar", "atan", "(\"zero\", \"Float32\")"]` | 0.75 (5%) :white_check_mark: | 1.00 (1%)  |
...
| `["scalar", "cos", "(\"argument reduction (paynehanek) abs(x) > 2.0^20*π/2\", \"positive argument\", \"Float32\", \"cos_kernel\")"]` | 0.91 (5%) :white_check_mark: | 1.00 (1%)  |
| `["scalar", "cosh", "(\"0 <= abs(x) < 0.00024414062f0\", \"positive argument\", \"Float32\")"]` | 0.90 (5%) :white_check_mark: | 1.00 (1%)  |
| `["scalar", "cosh", "(\"0 <= abs(x) < 2.7755602085408512e-17\", \"negative argument\", \"Float64\")"]` | 1.26 (5%) :x: | 1.00 (1%)  |
| `["scalar", "cosh", "(\"0 <= abs(x) < 2.7755602085408512e-17\", \"positive argument\", \"Float64\")"]` | 1.33 (5%) :x: | 1.00 (1%)  |
...
| `["scalar", "predicate", "(\"isless\", \"BigFloat\")"]` | 2.42 (40%) :x: | 1.00 (1%)  |
...
| `["sparse", "sparse solves", "least squares (default), matrix rhs"]` | 1.14 (5%) :x: | 1.00 (1%)  |
| `["sparse", "sparse solves", "least squares (default), vector rhs"]` | 1.18 (5%) :x: | 1.00 (1%)  |
| `["sparse", "sparse solves", "least squares (qr), matrix rhs"]` | 1.16 (5%) :x: | 1.00 (1%)  |
| `["sparse", "sparse solves", "least squares (qr), vector rhs"]` | 1.13 (5%) :x: | 1.00 (1%)  |
...
| `["sparse", "sparse solves", "square system (lu), vector rhs"]` | 1.09 (5%) :x: | 1.00 (1%)  |
| `["string", "repeat", "repeat char 1"]` | 1.32 (5%) :x: | 1.00 (1%)  |
| `["string", "repeat", "repeat char 2"]` | 1.63 (5%) :x: | 1.00 (1%)  |
| `["string", "repeat", "repeat str len 1"]` | 1.13 (5%) :x: | 1.00 (1%)  |
...
| `["tuple", "reduction", "(\"sum\", (8, 8))"]` | 0.65 (5%) :white_check_mark: | 1.00 (1%)  |
...
| `["union", "array", "(\"skipmissing\", collect, Bool, false)"]` | 1.06 (5%) :x: | 1.00 (1%)  |
...
```
Julia Version 1.1.0-DEV.869
Commit 39cf3c2 (2018-12-11 22:25 UTC)
Platform Info:
  ...
  CPU: Intel(R) Xeon(R) CPU E3-1241 v3 @ 3.50GHz: 
       ...
       #1  3501 MHz   40496040 s       2418 s    7190366 s  2186549254 s         11 s
       #2  3501 MHz  221904991 s         14 s    3967505 s  2013426718 s         17 s
       #3  3501 MHz   31623553 s       3138 s    3658184 s  2203857779 s         26 s
       #4  3501 MHz   30404092 s         11 s    2838242 s  2206947108 s         21 s
       
  Memory: 31.383651733398438 GB (5745.875 MB free)
  Uptime: 2.2411472e7 sec
...
```
Julia Version 1.1.0-DEV.863
Commit caa0273 (2018-12-11 22:25 UTC)
Platform Info:
  OS: Linux (x86_64-linux-gnu)
      Ubuntu 14.04.5 LTS
  uname: Linux 3.13.0-85-generic #129-Ubuntu SMP Thu Mar 17 20:50:15 UTC 2016 x86_64 x86_64
  CPU: Intel(R) Xeon(R) CPU E3-1241 v3 @ 3.50GHz: 
              speed         user         nice          sys         idle          irq
       #1  3501 MHz   40623955 s       2418 s    7201232 s  2187656579 s         11 s
       #2  3501 MHz  223071086 s         14 s    3983538 s  2013494686 s         17 s
       #3  3501 MHz   31739350 s       3138 s    3665546 s  2204984552 s         26 s
       #4  3501 MHz   30518344 s         11 s    2845456 s  2208075901 s         21 s
       
  Memory: 31.383651733398438 GB (5456.95703125 MB free)
  Uptime: 2.242398e7 sec
  Load Avg:  1.0029296875  1.0146484375  1.04541015625
  WORD_SIZE: 64
  LIBM: libopenlibm
  LLVM: libLLVM-6.0.1 (ORCJIT, haswell)
