...
*Commit(s):* [JuliaLang/julia@d5583e02ee42d43953419ceb04cb72b7d7c6ddb6](https://github.com/JuliaLang/julia/commit/d5583e02ee42d43953419ceb04cb72b7d7c6ddb6) vs [JuliaLang/julia@7132c635ab8da723c0177a9d6617bf01f4e7460a](https://github.com/JuliaLang/julia/commit/7132c635ab8da723c0177a9d6617bf01f4e7460a)

*Triggered By:* [link](https://github.com/JuliaLang/julia/pull/31039#issuecomment-483233871)
...
| `["array", "cat", "(\"hvcat_setind\", 500)"]` | 1.05 (5%) :x: | 1.00 (1%)  |
...
| `["array", "index", "(\"mapr_access\", \"SubArray{Float32,2,Array{Float32,2},Tuple{Base.Slice{Base.OneTo{Int64}},Base.Slice{Base.OneTo{Int64}}},true}\")"]` | 0.02 (50%) :white_check_mark: | 0.00 (1%) :white_check_mark: |
...
| `["array", "index", "(\"mapr_access\", \"SubArray{Float32,2,Array{Float32,3},Tuple{Int64,Base.Slice{Base.OneTo{Int64}},Base.Slice{Base.OneTo{Int64}}},true}\")"]` | 0.02 (50%) :white_check_mark: | 0.00 (1%) :white_check_mark: |
| `["array", "index", "(\"mapr_access\", \"SubArray{Float32,2,Base.ReshapedArray{Float32,2,SubArray{Float32,3,Array{Float32,3},Tuple{Base.Slice{Base.OneTo{Int64}},Base.Slice{Base.OneTo{Int64}},Base.Slice{Base.OneTo{Int64}}},true},Tuple{}},Tuple{Base.Slice{Base.OneTo{Int64}},UnitRange{Int64}},true}\")"]` | 0.05 (50%) :white_check_mark: | 0.08 (1%) :white_check_mark: |
...
| `["array", "index", "(\"mapr_access\", \"SubArray{Int32,2,Array{Int32,2},Tuple{Base.Slice{Base.OneTo{Int64}},Base.Slice{Base.OneTo{Int64}}},true}\")"]` | 0.02 (50%) :white_check_mark: | 0.00 (1%) :white_check_mark: |
...
| `["array", "index", "(\"mapr_access\", \"SubArray{Int32,2,Array{Int32,3},Tuple{Int64,Base.Slice{Base.OneTo{Int64}},Base.Slice{Base.OneTo{Int64}}},true}\")"]` | 0.02 (50%) :white_check_mark: | 0.00 (1%) :white_check_mark: |
| `["array", "index", "(\"mapr_access\", \"SubArray{Int32,2,Base.ReshapedArray{Int32,2,SubArray{Int32,3,Array{Int32,3},Tuple{Base.Slice{Base.OneTo{Int64}},Base.Slice{Base.OneTo{Int64}},Base.Slice{Base.OneTo{Int64}}},true},Tuple{}},Tuple{Base.Slice{Base.OneTo{Int64}},UnitRange{Int64}},true}\")"]` | 0.05 (50%) :white_check_mark: | 0.09 (1%) :white_check_mark: |
...
| `["collection", "iteration", "(\"IdDict\", \"String\", \"iterate\")"]` | 0.57 (25%) :white_check_mark: | 1.00 (1%)  |
...
| `["dates", "parse", "(\"DateTime\", \"RFC1123Format\", \"Mixedcase\")"]` | 1.18 (5%) :x: | 1.00 (1%)  |
...
| `["io", "array_limit", "(\"display\", \"Array{Float64,1}(100000000,)\")"]` | 1.12 (5%) :x: | 1.01 (1%)  |
| `["io", "array_limit", "(\"display\", \"Array{Float64,2}(10000, 10000)\")"]` | 1.20 (5%) :x: | 1.00 (1%)  |
| `["io", "array_limit", "(\"display\", \"Array{Float64,2}(100000000, 1)\")"]` | 1.10 (5%) :x: | 1.01 (1%)  |
...
| `["scalar", "atan2", "(\"abs(y/x) safe (large)\", \"y positive\", \"x positive\", \"Float64\")"]` | 0.86 (5%) :white_check_mark: | 1.00 (1%)  |
...
| `["union", "array", "(\"perf_sum\", BigFloat, false)"]` | 0.91 (5%) :white_check_mark: | 1.00 (1%)  |
...
| `["union", "array", "(\"skipmissing\", sum, BigFloat, false)"]` | 0.91 (5%) :white_check_mark: | 1.00 (1%)  |
...
| `["union", "array", "(\"sort\", Union{Nothing, Int64}, false)"]` | 0.86 (5%) :white_check_mark: | 1.00 (1%)  |
...
```
Julia Version 1.1.1-pre.34
Commit d5583e0 (2019-04-15 12:34 UTC)
Platform Info:
  ...
  CPU: Intel(R) Xeon(R) CPU E3-1241 v3 @ 3.50GHz: 
       ...
       #1  3501 MHz   46632525 s       2433 s   10320750 s  3250301248 s         12 s
       #2  3501 MHz  269883219 s         14 s    4868582 s  3040367257 s         19 s
       #3  3501 MHz   37639168 s       3165 s    4557831 s  3272783013 s         28 s
       #4  3501 MHz   36297602 s         15 s    3427638 s  3276676836 s         25 s
       
  Memory: 31.383651733398438 GB (4815.2578125 MB free)
  Uptime: 3.3176189e7 sec
...
```
Julia Version 1.1.1-pre.2
Commit 7132c63 (2019-04-12 11:45 UTC)
Platform Info:
  OS: Linux (x86_64-linux-gnu)
      Ubuntu 14.04.5 LTS
  uname: Linux 3.13.0-85-generic #129-Ubuntu SMP Thu Mar 17 20:50:15 UTC 2016 x86_64 x86_64
  CPU: Intel(R) Xeon(R) CPU E3-1241 v3 @ 3.50GHz: 
              speed         user         nice          sys         idle          irq
       #1  3501 MHz   46747418 s       2433 s   10331641 s  3251431448 s         12 s
       #2  3501 MHz  271059109 s         14 s    4884262 s  3040435571 s         19 s
       #3  3501 MHz   37762514 s       3165 s    4564737 s  3273912740 s         28 s
       #4  3501 MHz   36411974 s         15 s    3434362 s  3277815920 s         25 s
       
  Memory: 31.383651733398438 GB (4887.73046875 MB free)
  Uptime: 3.3188796e7 sec
