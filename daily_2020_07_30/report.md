...
*Commit(s):* [JuliaLang/julia@7f348c50f7b0c4c3844e180957fab1e8c5e946ed](https://github.com/JuliaLang/julia/commit/7f348c50f7b0c4c3844e180957fab1e8c5e946ed)

*Triggered By:* [link](https://github.com/JuliaLang/julia/commit/7f348c50f7b0c4c3844e180957fab1e8c5e946ed#commitcomment-41025274)

*Tag Predicate:* `ALL`

*Daily Job:* 2020-07-30 vs 2020-07-29
...
| `["array", "any/all", "(\"any\", \"Vector{Int16} generator\")"]` | 0.92 (5%) :white_check_mark: | 1.00 (1%)  |
...
| `["collection", "set operations", "(\"BitSet\", \"Int\", \"union!\", \"big\")"]` | 1.50 (25%) :x: | 1.00 (1%)  |
...
| `["find", "findnext", "(\"Vector{Bool}\", \"50-50\")"]` | 2.81 (5%) :x: | 1.00 (1%)  |
...
| `["io", "array_limit", "(\"display\", \"Matrix{Float64}(10000, 10000)\")"]` | 1.06 (5%) :x: | 1.09 (1%) :x: |
| `["linalg", "factorization", "(\"eigen\", \"typename(Diagonal)\", 256)"]` | 0.48 (45%) :white_check_mark: | 1.00 (1%)  |
...
| `["random", "ranges", "(\"RangeGenerator\", \"BigInt\", \"1:4294967297\")"]` | 1.64 (25%) :x: | 1.00 (1%)  |
| `["random", "ranges", "(\"rand\", \"MersenneTwister\", \"BigInt\", \"RangeGenerator(1:170141183460469231731687303715884105728)\")"]` | 1.44 (25%) :x: | 1.00 (1%)  |
...
| `["scalar", "arithmetic", "(\"mul\", \"BigInt\", \"BigInt\")"]` | 1.55 (50%) :x: | 1.00 (1%)  |
| `["scalar", "arithmetic", "(\"rem type\", \"Bool\", \"BigInt\")"]` | 0.56 (40%) :white_check_mark: | 1.00 (1%)  |
| `["scalar", "arithmetic", "(\"sub\", \"BigInt\", \"BigInt\")"]` | 2.12 (50%) :x: | 1.00 (1%)  |
...
| `["scalar", "atan2", "(\"abs(y/x) safe (large)\", \"y negative\", \"x positive\", \"Float32\")"]` | 0.88 (5%) :white_check_mark: | 1.00 (1%)  |
...
| `["scalar", "cos", "(\"argument reduction (hard) abs(x) < 4π/4\", \"positive argument\", \"Float32\", \"cos_kernel\")"]` | 0.88 (5%) :white_check_mark: | 1.00 (1%)  |
...
| `["scalar", "sin", "(\"argument reduction (hard) abs(x) < 6π/4\", \"positive argument\", \"Float64\", \"cos_kernel\")"]` | 1.27 (5%) :x: | 1.00 (1%)  |
| `["scalar", "sin", "(\"argument reduction (hard) abs(x) < 8π/4\", \"negative argument\", \"Float64\", \"sin_kernel\")"]` | 1.25 (5%) :x: | 1.00 (1%)  |
...
| `["union", "array", "(\"perf_sum2\", Bool, true)"]` | 1.44 (5%) :x: | 1.00 (1%)  |
...
```
Julia Version 1.6.0-DEV.556
Commit 7f348c5 (2020-07-29 23:17 UTC)
Platform Info:
  ...
  CPU: Intel(R) Xeon(R) CPU E3-1241 v3 @ 3.50GHz: 
       ...
       #1  3501 MHz  152412514 s       5060 s   17094842 s  7206693675 s         38 s
       #2  3501 MHz  1155390263 s        217 s   23237236 s  6208242161 s         28 s
       #3  3501 MHz  137776705 s       3324 s   10203162 s  7238092326 s         39 s
       #4  3501 MHz  129019225 s         43 s   14762886 s  7240593056 s         28 s
       
  Memory: 31.383651733398438 GB (18408.203125 MB free)
  Uptime: 7.3926291e7 sec
