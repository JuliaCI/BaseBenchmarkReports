...
*Commit(s):* [JuliaLang/julia@c670f60ec1f82c226409f9769b9133757d1fcafa](https://github.com/JuliaLang/julia/commit/c670f60ec1f82c226409f9769b9133757d1fcafa) vs [JuliaLang/julia@3fcb168ceb336f5af11954d2c47f2975d8547944](https://github.com/JuliaLang/julia/commit/3fcb168ceb336f5af11954d2c47f2975d8547944)

*Triggered By:* [link](https://github.com/JuliaLang/julia/pull/32270#issuecomment-503584229)
...
| `["array", "growth", "(\"prerend!\", 256)"]` | 0.77 (5%) :white_check_mark: | 1.00 (1%)  |
...
| `["array", "subarray", "(\"lucompletepivCopy!\", 250)"]` | 0.95 (5%) :white_check_mark: | 1.00 (1%)  |
...
| `["scalar", "arithmetic", "(\"rem type\", \"Int64\", \"BigInt\")"]` | 1.68 (40%) :x: | 1.00 (1%)  |
...
| `["scalar", "asinh", "(\"zero\", \"Float64\")"]` | 1.44 (5%) :x: | 1.00 (1%)  |
...
| `["scalar", "atan2", "(\"abs(y/x) high\", \"y positive\", \"x positive\", \"Float64\")"]` | 0.71 (5%) :white_check_mark: | 1.00 (1%)  |
...
| `["scalar", "sincos", "(\"argument reduction (easy) abs(x) < 7π/4\", \"positive argument\", \"Float32\")"]` | 1.15 (5%) :x: | 1.00 (1%)  |
| `["scalar", "sincos", "(\"argument reduction (paynehanek) abs(x) > 2.0^20*π/2\", \"negative argument\", \"Float32\")"]` | 0.86 (5%) :white_check_mark: | 1.00 (1%)  |
| `["scalar", "tan", "(\"small\", \"negative argument\", \"Float64\")"]` | 1.07 (5%) :x: | 1.00 (1%)  |
| `["scalar", "tan", "(\"very small\", \"negative argument\", \"Float32\")"]` | 1.44 (5%) :x: | 1.00 (1%)  |
| `["scalar", "tan", "(\"very small\", \"negative argument\", \"Float64\")"]` | 1.07 (5%) :x: | 1.00 (1%)  |
| `["scalar", "tan", "(\"very small\", \"positive argument\", \"Float64\")"]` | 1.07 (5%) :x: | 1.00 (1%)  |
| `["scalar", "tan", "(\"zero\", \"Float32\")"]` | 2.13 (5%) :x: | 1.00 (1%)  |
...
| `["union", "array", "(\"broadcast\", abs, Float32, false)"]` | 1.11 (5%) :x: | 1.00 (1%)  |
| `["union", "array", "(\"broadcast\", abs, Int64, true)"]` | 0.95 (5%) :white_check_mark: | 1.00 (1%)  |
...
| `["union", "array", "(\"skipmissing\", sum, Union{Missing, Float64}, true)"]` | 1.05 (5%) :x: | 1.00 (1%)  |
...
```
Julia Version 1.2.0-rc1.18
Commit c670f60 (2019-06-19 13:45 UTC)
Platform Info:
  ...
  CPU: Intel(R) Xeon(R) CPU E3-1241 v3 @ 3.50GHz: 
       ...
       #1  3501 MHz   49248030 s       2436 s   12031616 s  3806208217 s         13 s
       #2  3501 MHz  293306185 s         26 s    5301638 s  3578294944 s         19 s
       #3  3501 MHz   40268432 s       3174 s    4843847 s  3831854435 s         31 s
       #4  3501 MHz   38859842 s         16 s    3654706 s  3835957309 s         28 s
       
  Memory: 31.383651733398438 GB (5829.70703125 MB free)
  Uptime: 3.8797893e7 sec
...
Platform Info:
  ...
  CPU: Intel(R) Xeon(R) CPU E3-1241 v3 @ 3.50GHz: 
              speed         user         nice          sys         idle          irq
       #1  3501 MHz   49349013 s       2436 s   12040717 s  3807333839 s         13 s
       #2  3501 MHz  294475513 s         26 s    5316007 s  3578350974 s         19 s
       #3  3501 MHz   40383554 s       3174 s    4848898 s  3832973978 s         31 s
       #4  3501 MHz   38955736 s         16 s    3659866 s  3837096071 s         28 s
       
  Memory: 31.383651733398438 GB (4561.9765625 MB free)
  Uptime: 3.8810295e7 sec
  Load Avg:  1.0029296875  1.0146484375  1.04541015625
  WORD_SIZE: 64
  LIBM: libopenlibm
  LLVM: libLLVM-6.0.1 (ORCJIT, haswell)
