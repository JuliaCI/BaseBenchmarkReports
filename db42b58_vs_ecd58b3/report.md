...
*Commit(s):* [JuliaLang/julia@db42b5806a6ce5777295325e5ac09d4d74eb2d57](https://github.com/JuliaLang/julia/commit/db42b5806a6ce5777295325e5ac09d4d74eb2d57) vs [JuliaLang/julia@ecd58b3b9d0bf81cffb06a8a6fe3252d22d57f92](https://github.com/JuliaLang/julia/commit/ecd58b3b9d0bf81cffb06a8a6fe3252d22d57f92)

*Triggered By:* [link](https://github.com/JuliaLang/julia/pull/35086)
...
| `["array", "comprehension", "(\"collect\", \"Array{Float64,1}\")"]` | 1.49 (5%) :x: | 1.00 (1%)  |
...
| `["array", "growth", "(\"append!\", 2048)"]` | 0.89 (5%) :white_check_mark: | 1.00 (1%)  |
...
| `["array", "index", "(\"sumcolon_view\", \"100000:-1:1\")"]` | 1.53 (50%) :x: | 1.00 (1%)  |
...
| `["io", "array_limit", "(\"display\", \"Array{Float64,2}(10000, 10000)\")"]` | 1.01 (5%)  | 0.96 (1%) :white_check_mark: |
| `["misc", "allocation elision view", "no conditional"]` | 0.72 (5%) :white_check_mark: | 1.00 (1%)  |
| `["misc", "bitshift", "(\"UInt\", \"UInt\")"]` | 1.07 (5%) :x: | 1.00 (1%)  |
| `["misc", "fastmath many args"]` | 1.50 (5%) :x: | 1.00 (1%)  |
...
| `["random", "ranges", "(\"rand\", \"MersenneTwister\", \"UInt64\", \"RangeGenerator(1:4294967295)\")"]` | 1.28 (25%) :x: | 1.00 (1%)  |
| `["random", "types", "(\"rand\", \"MersenneTwister\", \"ImplicitFloat64\")"]` | 1.29 (25%) :x: | 1.00 (1%)  |
...
| `["scalar", "arithmetic", "(\"rem type\", \"Char\", \"BigInt\")"]` | 2.00 (40%) :x: | 1.00 (1%)  |
...
| `["scalar", "cos", "(\"argument reduction (easy) abs(x) < 6π/4\", \"positive argument\", \"Float64\", \"sin_kernel\")"]` | 0.60 (5%) :white_check_mark: | 1.00 (1%)  |
| `["scalar", "cos", "(\"argument reduction (hard) abs(x) < 2π/4\", \"positive argument\", \"Float64\", \"sin_kernel\")"]` | 0.79 (5%) :white_check_mark: | 1.00 (1%)  |
| `["scalar", "cos", "(\"argument reduction (hard) abs(x) < 4π/4\", \"positive argument\", \"Float64\", \"cos_kernel\")"]` | 1.27 (5%) :x: | 1.00 (1%)  |
...
| `["scalar", "exp2", "(\"very small\", \"negative argument\", \"Float64\")"]` | 1.60 (5%) :x: | 1.00 (1%)  |
...
| `["sort", "issorted", "(\"forwards\", \"ascending\")"]` | 1.38 (30%) :x: | 1.00 (1%)  |
...
| `["sparse", "index", "(\"spmat\", \"row\", \"array\", 1000)"]` | 1.45 (30%) :x: | 1.00 (1%)  |
...
| `["union", "array", "(\"map\", identity, Int8, true)"]` | 0.89 (5%) :white_check_mark: | 1.00 (1%)  |
...
| `["union", "array", "(\"perf_simplecopy\", Int8, true)"]` | 1.34 (5%) :x: | 1.00 (1%)  |
| `["union", "array", "(\"perf_sum2\", Bool, false)"]` | 1.21 (5%) :x: | 1.00 (1%)  |
| `["union", "array", "(\"perf_sum2\", Bool, true)"]` | 1.15 (5%) :x: | 1.00 (1%)  |
| `["union", "array", "(\"perf_sum2\", Float32, true)"]` | 1.08 (5%) :x: | 1.00 (1%)  |
...
| `["union", "array", "(\"skipmissing\", sum, Union{Missing, Complex{Float64}}, true)"]` | 1.40 (5%) :x: | 1.00 (1%)  |
| `["union", "array", "(\"skipmissing\", sum, Union{Missing, Float64}, true)"]` | 1.44 (5%) :x: | 1.00 (1%)  |
...
| `["union", "array", "(\"sort\", Union{Nothing, BigFloat}, false)"]` | 1.07 (5%) :x: | 1.00 (1%)  |
...
Commit db42b58 (2020-03-12 04:47 UTC)
Platform Info:
  ...
  CPU: Intel(R) Xeon(R) CPU E3-1241 v3 @ 3.50GHz: 
       ...
       #1  3501 MHz   54959636 s       2446 s   18830656 s  6089419527 s         18 s
       #2  3501 MHz  341505077 s         62 s    7026864 s  5831181746 s         26 s
       #3  3501 MHz   46066253 s       3216 s    5450663 s  6127451086 s         39 s
       #4  3501 MHz   44372650 s         19 s    4286568 s  6133062711 s         36 s
       
  Memory: 31.383651733398438 GB (18816.98046875 MB free)
  Uptime: 6.1834963e7 sec
  Load Avg:  1.13525390625  1.0576171875  1.05810546875
  WORD_SIZE: 64
  LIBM: libopenlibm
...
Platform Info:
  ...
  CPU: Intel(R) Xeon(R) CPU E3-1241 v3 @ 3.50GHz: 
              speed         user         nice          sys         idle          irq
       #1  3501 MHz   55107580 s       2446 s   18841323 s  6090677633 s         18 s
       #2  3501 MHz  342812557 s         62 s    7053697 s  5831268936 s         26 s
       #3  3501 MHz   46229656 s       3216 s    5456882 s  6128701171 s         39 s
       #4  3501 MHz   44520812 s         19 s    4292640 s  6134329913 s         36 s
       
  Memory: 31.383651733398438 GB (18683.0390625 MB free)
  Uptime: 6.1849181e7 sec
