...
*Commit(s):* [JuliaLang/julia@fe6975b1e65cfde222e5d7aa18cba4ed7fe14ab5](https://github.com/JuliaLang/julia/commit/fe6975b1e65cfde222e5d7aa18cba4ed7fe14ab5)

*Triggered By:* [link](https://github.com/JuliaLang/julia/commit/fe6975b1e65cfde222e5d7aa18cba4ed7fe14ab5#commitcomment-28008666)

*Tag Predicate:* `ALL`

*Daily Job:* 2018-03-09 vs 2018-03-08
...
| `["collection", "deletion", "(\"Dict\", \"Int\", \"pop!\")"]` | 0.73 (25%) :white_check_mark: | 1.00 (1%)  |
| `["collection", "iteration", "(\"Dict\", \"Int\", \"next\")"]` | 2.09 (25%) :x: | 1.00 (1%)  |
| `["collection", "queries & updates", "(\"Set\", \"String\", \"pop!\", \"specified\")"]` | 1.43 (25%) :x: | 1.00 (1%)  |
| `["collection", "queries & updates", "(\"Vector\", \"Any\", \"pop!\", \"unspecified\")"]` | 1.96 (25%) :x: | 1.00 (1%)  |
| `["collection", "queries & updates", "(\"Vector\", \"String\", \"pop!\", \"unspecified\")"]` | 1.35 (25%) :x: | 1.00 (1%)  |
| `["collection", "set operations", "(\"Set\", \"Int\", \"==\", \"self\")"]` | 1.72 (25%) :x: | 1.00 (1%)  |
| `["find", "findnext", "(\"Array{Bool,1}\", \"50-50\")"]` | 2.09 (15%) :x: | 1.00 (1%)  |
...
| `["random", "types", "(\"randn\", \"MersenneTwister\", \"Float32\")"]` | 1.48 (25%) :x: | 1.00 (1%)  |
...
| `["scalar", "cos", "(\"argument reduction (hard) abs(x) < 6π/4\", \"negative argument\", \"Float32\", \"sin_kernel\")"]` | 0.77 (15%) :white_check_mark: | 1.00 (1%)  |
...
| `["scalar", "sincos", "(\"argument reduction (easy) abs(x) < 5π/4\", \"positive argument\", \"Float64\")"]` | 1.28 (15%) :x: | 1.00 (1%)  |
...
| `["union", "array", "(\"broadcast\", abs, BigInt, true)"]` | 0.84 (15%) :white_check_mark: | 1.00 (1%)  |
| `["union", "array", "(\"map\", abs, Float64, false)"]` | 0.84 (15%) :white_check_mark: | 1.00 (1%)  |
...
| `["union", "array", "(\"perf_countnothing\", Float64, true)"]` | 0.84 (15%) :white_check_mark: | 1.00 (1%)  |
...
```
Julia Version 0.7.0-DEV.4501
Commit fe6975b (2018-03-09 01:25 UTC)
Platform Info:
  ...
  CPU: Intel(R) Xeon(R) CPU E3-1241 v3 @ 3.50GHz: 
       ...
       #1  3501 MHz  122215198 s          0 s   21562976 s  5462125531 s        105 s
       #2  3501 MHz  537589590 s          0 s   13417362 s  5068379921 s         26 s
       #3  3501 MHz  100067826 s          0 s   11426648 s  5508443124 s         88 s
       #4  3501 MHz   95689704 s          0 s   11601652 s  5512646505 s         23 s
       
  Memory: 31.383651733398438 GB (5545.765625 MB free)
  Uptime: 5.6225651e7 sec
