...
*Commit(s):* [JuliaLang/julia@fbc2c0aec19a7c415011c1abd4f05622ac9c41e7](https://github.com/JuliaLang/julia/commit/fbc2c0aec19a7c415011c1abd4f05622ac9c41e7)

*Triggered By:* [link](https://github.com/JuliaLang/julia/commit/fbc2c0aec19a7c415011c1abd4f05622ac9c41e7#commitcomment-37075895)

*Tag Predicate:* `ALL`

*Daily Job:* 2020-02-02 vs 2020-02-01
...
| `["collection", "iteration", "(\"IdDict\", \"String\", \"iterate\")"]` | 0.74 (25%) :white_check_mark: | 1.00 (1%)  |
| `["collection", "queries & updates", "(\"BitSet\", \"Int\", \"in\", \"false\")"]` | 1.27 (25%) :x: | 1.00 (1%)  |
| `["collection", "queries & updates", "(\"IdDict\", \"Int\", \"push!\", \"new\")"]` | 1.36 (25%) :x: | 1.00 (1%)  |
| `["collection", "set operations", "(\"BitSet\", \"Int\", \"intersect!\", \"small\")"]` | 1.69 (25%) :x: | 1.00 (1%)  |
...
| `["linalg", "small exp #29116"]` | 0.40 (5%) :white_check_mark: | 0.96 (1%) :white_check_mark: |
...
| `["random", "randstring", "(\"randstring\", \"MersenneTwister\")"]` | 1.36 (25%) :x: | 1.00 (1%)  |
| `["random", "ranges", "(\"rand\", \"MersenneTwister\", \"BigInt\", \"RangeGenerator(1:18446744073709551616)\")"]` | 0.70 (25%) :white_check_mark: | 1.00 (1%)  |
| `["random", "ranges", "(\"rand\", \"MersenneTwister\", \"UInt128\", \"RangeGenerator(1:18446744073709551616)\")"]` | 1.45 (25%) :x: | 1.00 (1%)  |
...
| `["scalar", "arithmetic", "(\"add\", \"BigInt\", \"BigFloat\")"]` | 1.64 (50%) :x: | 1.00 (1%)  |
...
| `["scalar", "sin", "(\"argument reduction (easy) abs(x) < 6π/4\", \"negative argument\", \"Float64\", \"cos_kernel\")"]` | 1.29 (5%) :x: | 1.00 (1%)  |
| `["scalar", "sin", "(\"no reduction\", \"negative argument\", \"Float32\", \"sin_kernel\")"]` | 1.06 (5%) :x: | 1.00 (1%)  |
| `["scalar", "sin", "(\"no reduction\", \"negative argument\", \"Float64\", \"sin_kernel\")"]` | 0.86 (5%) :white_check_mark: | 1.00 (1%)  |
...
| `["union", "array", "(\"broadcast\", abs, Int64, true)"]` | 1.17 (5%) :x: | 1.00 (1%)  |
| `["union", "array", "(\"broadcast\", identity, BigFloat, true)"]` | 1.13 (5%) :x: | 1.00 (1%)  |
| `["union", "array", "(\"broadcast\", identity, Complex{Float64}, true)"]` | 0.85 (5%) :white_check_mark: | 1.00 (1%)  |
| `["union", "array", "(\"broadcast\", identity, Int8, true)"]` | 1.32 (5%) :x: | 1.00 (1%)  |
...
| `["union", "array", "(\"map\", identity, Int64, true)"]` | 0.70 (5%) :white_check_mark: | 1.00 (1%)  |
...
| `["union", "array", "(\"skipmissing\", collect, Complex{Float64}, false)"]` | 0.90 (5%) :white_check_mark: | 1.00 (1%)  |
...
Commit fbc2c0a (2020-02-01 18:55 UTC)
Platform Info:
  ...
  CPU: Intel(R) Xeon(R) CPU E3-1241 v3 @ 3.50GHz: 
       ...
       #1  3501 MHz  120903408 s       5052 s   13993215 s  5698259973 s         32 s
       #2  3501 MHz  893077989 s        217 s   16922343 s  4932072250 s         26 s
       #3  3501 MHz  105104570 s       3267 s    8318206 s  5728876021 s         36 s
       #4  3501 MHz   98507035 s         43 s   11943500 s  5729436985 s         26 s
       
  Memory: 31.383651733398438 GB (18656.42578125 MB free)
  Uptime: 5.8464534e7 sec
