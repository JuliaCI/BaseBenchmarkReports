...
*Commit(s):* [JuliaLang/julia@2f8cdd045cc6b7e77db14393e39cfee8ef4d4a66](https://github.com/JuliaLang/julia/commit/2f8cdd045cc6b7e77db14393e39cfee8ef4d4a66)

*Triggered By:* [link](https://github.com/JuliaLang/julia/commit/2f8cdd045cc6b7e77db14393e39cfee8ef4d4a66#commitcomment-37599790)
...
|----|------------|--------------|
| `["array", "comprehension", "(\"collect\", \"Array{Float64,1}\")"]` | 1.60 (5%) :x: | 1.00 (1%)  |
...
| `["array", "convert", "(\"Float64\", \"Int\")"]` | 1.34 (5%) :x: | 1.00 (1%)  |
| `["array", "equality", "(\"==\", \"Array{Int64,1} == UnitRange{Int64}\")"]` | 0.88 (5%) :white_check_mark: | 1.00 (1%)  |
...
| `["random", "types", "(\"rand\", \"MersenneTwister\", \"Complex{UInt32}\")"]` | 1.47 (25%) :x: | 1.00 (1%)  |
...
| `["scalar", "cos", "(\"argument reduction (hard) abs(x) < 6π/4\", \"positive argument\", \"Float32\", \"sin_kernel\")"]` | 1.28 (5%) :x: | 1.00 (1%)  |
...
| `["scalar", "fastmath", "(\"add\", \"BigInt\")"]` | 1.41 (40%) :x: | 1.00 (1%)  |
...
| `["sparse", "matmul", "(\"At_mul_B!\", \"sparse 40x400, dense 40x400 -> dense 400x400\")"]` | 1.57 (30%) :x: | 1.00 (1%)  |
| `["sparse", "matmul", "(\"At_mul_B\", \"dense 50x5, sparse 50x500 -> dense 5x500\")"]` | 0.69 (30%) :white_check_mark: | 1.00 (1%)  |
| `["sparse", "matmul", "(\"At_mul_B\", \"sparse 500x500, dense 500x5 -> dense 500x5\")"]` | 1.42 (30%) :x: | 1.00 (1%)  |
...
| `["union", "array", "(\"broadcast\", abs, Int8, true)"]` | 1.26 (5%) :x: | 1.00 (1%)  |
| `["union", "array", "(\"broadcast\", identity, BigFloat, true)"]` | 0.89 (5%) :white_check_mark: | 1.00 (1%)  |
...
| `["union", "array", "(\"map\", *, Int64, (false, true))"]` | 1.12 (5%) :x: | 1.00 (1%)  |
...
| `["union", "array", "(\"perf_simplecopy\", Int64, false)"]` | 0.66 (5%) :white_check_mark: | 1.00 (1%)  |
...
```
Julia Version 1.5.0-DEV.389
Commit 2f8cdd0 (2020-03-02 20:40 UTC)
Platform Info:
  ...
  CPU: Intel(R) Xeon(R) CPU E3-1241 v3 @ 3.50GHz: 
       ...
       #1  3501 MHz  126270751 s       5055 s   14565353 s  5950959110 s         33 s
       #2  3501 MHz  940038295 s        217 s   18052793 s  5143029998 s         26 s
       #3  3501 MHz  110694335 s       3277 s    8611714 s  5981962181 s         36 s
       #4  3501 MHz  103788264 s         43 s   12376252 s  5982718366 s         26 s
       
  Memory: 31.383651733398438 GB (18459.19140625 MB free)
  Uptime: 6.1056775e7 sec
