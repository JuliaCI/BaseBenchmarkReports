...
*Commit(s):* [JuliaLang/julia@f611b46e72c788c016933033dfadee6a9e138d47](https://github.com/JuliaLang/julia/commit/f611b46e72c788c016933033dfadee6a9e138d47)

*Triggered By:* [link](https://github.com/JuliaLang/julia/commit/f611b46e72c788c016933033dfadee6a9e138d47#commitcomment-32853297)

*Tag Predicate:* `ALL`

*Daily Job:* 2019-03-21 vs 2019-03-20
...
|----|------------|--------------|
| `["array", "comprehension", "(\"collect\", \"Array{Float64,1}\")"]` | 0.81 (5%) :white_check_mark: | 1.00 (1%)  |
...
| `["array", "comprehension", "(\"comprehension_collect\", \"Array{Float64,1}\")"]` | 0.86 (5%) :white_check_mark: | 1.00 (1%)  |
...
| `["random", "collections", "(\"rand\", \"MersenneTwister\", \"'a':'z'\")"]` | 1.48 (25%) :x: | 1.00 (1%)  |
...
| `["scalar", "atan", "(\"19/16 <= abs(x) < 39/16\", \"negative argument\", \"Float32\")"]` | 1.36 (5%) :x: | 1.00 (1%)  |
...
| `["scalar", "atan2", "(\"abs(y/x) safe (large)\", \"y positive\", \"x negative\", \"Float32\")"]` | 1.50 (5%) :x: | 1.00 (1%)  |
...
| `["scalar", "cos", "(\"argument reduction (easy) abs(x) < 9π/4\", \"negative argument\", \"Float64\", \"cos_kernel\")"]` | 1.25 (5%) :x: | 1.00 (1%)  |
| `["scalar", "cos", "(\"argument reduction (hard) abs(x) < 4π/4\", \"positive argument\", \"Float64\", \"cos_kernel\")"]` | 1.25 (5%) :x: | 1.00 (1%)  |
| `["scalar", "cosh", "(\"0 <= abs(x) < 0.00024414062f0\", \"negative argument\", \"Float32\")"]` | 0.83 (5%) :white_check_mark: | 1.00 (1%)  |
...
| `["scalar", "exp2", "(\"2pow1023\", \"positive argument\", Float64)"]` | 1.71 (5%) :x: | 1.00 (1%)  |
...
| `["sparse", "constructors", "(\"IJV\", 100)"]` | 0.89 (5%) :white_check_mark: | 1.00 (1%)  |
...
| `["sparse", "sparse solves", "least squares (default), vector rhs"]` | 0.88 (5%) :white_check_mark: | 1.00 (1%)  |
...
| `["union", "array", "(\"map\", abs, Bool, true)"]` | 1.22 (5%) :x: | 1.00 (1%)  |
...
| `["union", "array", "(\"perf_sum4\", Int8, true)"]` | 0.90 (5%) :white_check_mark: | 1.00 (1%)  |
...
```
Julia Version 1.2.0-DEV.516
Commit f611b46 (2019-03-20 14:57 UTC)
Platform Info:
  ...
  CPU: Intel(R) Xeon(R) CPU E3-1241 v3 @ 3.50GHz: 
       ...
       #1  3501 MHz   81370744 s       5022 s    9196590 s  3000266113 s         24 s
       #2  3501 MHz  495974050 s        203 s    8308507 s  2591597530 s         19 s
       #3  3501 MHz   64531882 s       3228 s    5453433 s  3025838527 s         28 s
       #4  3501 MHz   60632707 s          9 s    7127940 s  3027250657 s         18 s
       
  Memory: 31.383651733398438 GB (4651.2265625 MB free)
  Uptime: 3.0983321e7 sec
