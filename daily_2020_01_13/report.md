...
*Commit(s):* [JuliaLang/julia@aa35ee2d30065803410718378e5673c7f845da62](https://github.com/JuliaLang/julia/commit/aa35ee2d30065803410718378e5673c7f845da62)

*Triggered By:* [link](https://github.com/JuliaLang/julia/commit/aa35ee2d30065803410718378e5673c7f845da62#commitcomment-36767300)

*Tag Predicate:* `ALL`

*Daily Job:* 2020-01-13 vs 2020-01-12
...
| `["array", "bool", "boolarray_true_load!"]` | 0.69 (5%) :white_check_mark: | 1.00 (1%)  |
...
| `["scalar", "arithmetic", "(\"sub\", \"BigFloat\", \"BigFloat\")"]` | 1.76 (50%) :x: | 1.00 (1%)  |
...
| `["scalar", "expm1", "(\"small\", \"positive argument\", \"Float32\")"]` | 1.43 (5%) :x: | 1.00 (1%)  |
| `["scalar", "expm1", "(\"very small\", \"negative argument\", \"Float64\")"]` | 0.88 (5%) :white_check_mark: | 1.00 (1%)  |
| `["scalar", "sin", "(\"argument reduction (easy) abs(x) < 8π/4\", \"negative argument\", \"Float64\", \"sin_kernel\")"]` | 0.83 (5%) :white_check_mark: | 1.00 (1%)  |
...
| `["scalar", "sincos", "(\"argument reduction (easy) abs(x) < 2π/4\", \"negative argument\", \"Float64\")"]` | 1.53 (5%) :x: | 1.00 (1%)  |
...
| `["scalar", "sincos", "(\"argument reduction (easy) abs(x) < 8π/4\", \"positive argument\", \"Float64\")"]` | 1.33 (5%) :x: | 1.00 (1%)  |
...
| `["scalar", "sincos", "(\"argument reduction (hard) abs(x) < 4π/4\", \"negative argument\", \"Float64\")"]` | 1.27 (5%) :x: | 1.00 (1%)  |
...
| `["scalar", "sinh", "(\"2f-12 <= abs(x) < 9f0\", \"negative argument\", \"Float32\")"]` | 0.92 (5%) :white_check_mark: | 1.00 (1%)  |
...
| `["union", "array", "(\"broadcast\", abs, BigFloat, true)"]` | 1.08 (5%) :x: | 1.00 (1%)  |
...
| `["union", "array", "(\"perf_simplecopy\", Int8, true)"]` | 1.30 (5%) :x: | 1.00 (1%)  |
...
| `["union", "array", "(\"perf_sum4\", BigFloat, true)"]` | 1.12 (5%) :x: | 1.00 (1%)  |
| `["union", "array", "(\"perf_sum4\", Complex{Float64}, true)"]` | 1.10 (5%) :x: | 1.00 (1%)  |
| `["union", "array", "(\"perf_sum\", BigFloat, false)"]` | 0.85 (5%) :white_check_mark: | 1.00 (1%)  |
...
```
Julia Version 1.5.0-DEV.54
Commit aa35ee2 (2020-01-12 01:56 UTC)
Platform Info:
  ...
  CPU: Intel(R) Xeon(R) CPU E3-1241 v3 @ 3.50GHz: 
       ...
       #1  3501 MHz  117905307 s       5050 s   13682970 s  5528349213 s         31 s
       #2  3501 MHz  866202151 s        217 s   16243409 s  4786194425 s         26 s
       #3  3501 MHz  102023796 s       3264 s    8119378 s  5558739601 s         36 s
       #4  3501 MHz   95620996 s         43 s   11627090 s  5559286554 s         25 s
       
  Memory: 31.383651733398438 GB (18024.6015625 MB free)
  Uptime: 5.6728932e7 sec
