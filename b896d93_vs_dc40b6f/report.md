...
*Commit(s):* [JuliaLang/julia@b896d93cdc65b1af3a2ce08ab4e8f21806de415a](https://github.com/JuliaLang/julia/commit/b896d93cdc65b1af3a2ce08ab4e8f21806de415a) vs [JuliaLang/julia@dc40b6f89e723df2c6cf1fac4710df60ac569c61](https://github.com/JuliaLang/julia/commit/dc40b6f89e723df2c6cf1fac4710df60ac569c61)

*Triggered By:* [link](https://github.com/JuliaLang/julia/pull/28764#issuecomment-419908154)
...
| `["array", "reductions", "(\"BaseBenchmarks.ArrayBenchmarks.perf_reduce\", \"Int64\")"]` | 0.90 (5%) :white_check_mark: | 1.00 (1%)  |
| `["array", "reductions", "(\"Statistics.mean\", \"Int64\")"]` | 0.95 (5%) :white_check_mark: | 1.00 (1%)  |
| `["array", "setindex!", "(\"setindex!\", 1)"]` | 2.38 (5%) :x: | 1.00 (1%)  |
| `["array", "setindex!", "(\"setindex!\", 2)"]` | 2.30 (5%) :x: | 1.00 (1%)  |
| `["array", "setindex!", "(\"setindex!\", 3)"]` | 2.21 (5%) :x: | 1.00 (1%)  |
| `["array", "setindex!", "(\"setindex!\", 4)"]` | 2.20 (5%) :x: | 1.00 (1%)  |
| `["array", "setindex!", "(\"setindex!\", 5)"]` | 2.22 (5%) :x: | 1.00 (1%)  |
...
| `["broadcast", "mix_scalar_tuple", "(5, \"scal_tup\")"]` | 1.05 (5%) :x: | 1.00 (1%)  |
...
| `["collection", "set operations", "(\"BitSet\", \"Int\", \"symdiff!\", \"small\")"]` | 1.25 (25%) :x: | 1.00 (1%)  |
| `["collection", "set operations", "(\"Vector\", \"Int\", \"⊆\", \"Vector\")"]` | 1.90 (25%) :x: | 1.00 (1%)  |
...
| `["dates", "string", "Date"]` | 0.25 (5%) :white_check_mark: | 0.96 (1%) :white_check_mark: |
...
| `["find", "findprev", "(\"ispos\", \"Array{Int8,1}\")"]` | 0.81 (5%) :white_check_mark: | 1.00 (1%)  |
| `["find", "findprev", "(\"ispos\", \"Array{UInt64,1}\")"]` | 0.78 (5%) :white_check_mark: | 1.00 (1%)  |
| `["io", "serialization", "(\"deserialize\", \"Vector{String}\")"]` | 1.12 (5%) :x: | 1.00 (1%)  |
| `["io", "skipchars"]` | 1.01 (5%)  | 0.98 (1%) :white_check_mark: |
| `["micro", "parseint"]` | 0.64 (5%) :white_check_mark: | 1.00 (1%)  |
| `["micro", "printfd"]` | 0.58 (5%) :white_check_mark: | 1.00 (1%)  |
...
| `["problem", "spellcheck", "spellcheck"]` | 0.60 (5%) :white_check_mark: | 0.62 (1%) :white_check_mark: |
...
| `["random", "types", "(\"randn\", \"MersenneTwister\", \"Float32\")"]` | 1.45 (25%) :x: | 1.00 (1%)  |
...
| `["scalar", "acos", "(\"small\", \"positive argument\", \"Float64\")"]` | 0.52 (5%) :white_check_mark: | 1.00 (1%)  |
...
| `["scalar", "atan", "(\"11/16 <= abs(x) < 19/16\", \"negative argument\", \"Float64\")"]` | 1.26 (5%) :x: | 1.00 (1%)  |
...
| `["scalar", "cbrt", "(\"one\", \"Float32\")"]` | 1.21 (5%) :x: | 1.00 (1%)  |
| `["scalar", "cbrt", "(\"one\", \"Float64\")"]` | 1.07 (5%) :x: | 1.00 (1%)  |
| `["scalar", "cbrt", "(\"small\", \"negative argument\", \"Float32\")"]` | 1.21 (5%) :x: | 1.00 (1%)  |
...
| `["scalar", "floatexp", "(\"exp\", \"fast path, k = 1\", \"Float32\")"]` | 0.58 (40%) :white_check_mark: | 1.00 (1%)  |
| `["scalar", "floatexp", "(\"exp\", \"normal path -> small, k = -1045\", \"Float32\")"]` | 0.52 (40%) :white_check_mark: | 1.00 (1%)  |
| `["scalar", "floatexp", "(\"exp\", \"normal path, k = 2\", \"Float32\")"]` | 0.58 (40%) :white_check_mark: | 1.00 (1%)  |
| `["scalar", "floatexp", "(\"exp\", \"small argument path\", \"Float32\")"]` | 0.58 (40%) :white_check_mark: | 1.00 (1%)  |
...
| `["scalar", "sincos", "(\"argument reduction (easy) abs(x) < 2.0^20π/4\", \"negative argument\", \"Float64\")"]` | 1.26 (5%) :x: | 1.00 (1%)  |
...
| `["scalar", "sinh", "(\"9f0 <= abs(x) < 88.72283f0\", \"negative argument\", \"Float32\")"]` | 0.65 (5%) :white_check_mark: | 1.00 (1%)  |
| `["scalar", "sinh", "(\"9f0 <= abs(x) < 88.72283f0\", \"positive argument\", \"Float32\")"]` | 0.68 (5%) :white_check_mark: | 1.00 (1%)  |
...
| `["shootout", "meteor_contest"]` | 0.88 (5%) :white_check_mark: | 0.99 (1%)  |
| `["shootout", "nbody_vec"]` | 0.94 (5%) :white_check_mark: | 1.00 (1%)  |
...
| `["tuple", "reduction", "(\"sum\", (16, 16))"]` | 0.79 (5%) :white_check_mark: | 1.00 (1%)  |
...
| `["union", "array", "(\"perf_sum4\", BigInt, true)"]` | 0.71 (5%) :white_check_mark: | 1.00 (1%)  |
...
| `["union", "array", "(\"skipmissing\", sum, BigInt, true)"]` | 0.90 (5%) :white_check_mark: | 1.00 (1%)  |
| `["union", "array", "(\"skipmissing\", sum, Bool, true)"]` | 1.06 (5%) :x: | 1.00 (1%)  |
...
```
Julia Version 1.0.1-pre.131
Commit b896d93 (2018-09-10 13:13 UTC)
Platform Info:
  ...
  CPU: Intel(R) Xeon(R) CPU E3-1241 v3 @ 3.50GHz: 
       ...
       #1  3501 MHz   48544555 s       4998 s    5298399 s  1385222525 s         19 s
       #2  3501 MHz  226473143 s        203 s    3527254 s  1211622130 s          9 s
       #3  3501 MHz   32925742 s       3198 s    2914474 s  1405772781 s         22 s
       #4  3501 MHz   30556629 s          0 s    3576748 s  1407297967 s         10 s
       
  Memory: 31.383651733398438 GB (4884.7578125 MB free)
  Uptime: 1.4428853e7 sec
...
Platform Info:
  ...
  CPU: Intel(R) Xeon(R) CPU E3-1241 v3 @ 3.50GHz: 
              speed         user         nice          sys         idle          irq
       #1  3501 MHz   48664360 s       4998 s    5309546 s  1386350313 s         19 s
       #2  3501 MHz  227655272 s        203 s    3543335 s  1211686124 s          9 s
       #3  3501 MHz   33038676 s       3198 s    2922236 s  1406914526 s         22 s
       #4  3501 MHz   30677861 s          0 s    3583913 s  1408432297 s         10 s
       
  Memory: 31.383651733398438 GB (4557.20703125 MB free)
  Uptime: 1.4441486e7 sec
  Load Avg:  1.0029296875  1.0146484375  1.04541015625
  WORD_SIZE: 64
  LIBM: libopenlibm
  LLVM: libLLVM-6.0.0 (ORCJIT, haswell)
