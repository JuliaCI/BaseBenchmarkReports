...
*Commit(s):* [JuliaLang/julia@91effa2da420408f05fcb925dd3a349d47e0d28f](https://github.com/JuliaLang/julia/commit/91effa2da420408f05fcb925dd3a349d47e0d28f)

*Triggered By:* [link](https://github.com/JuliaLang/julia/commit/91effa2da420408f05fcb925dd3a349d47e0d28f#commitcomment-35906556)

*Tag Predicate:* `ALL`

*Daily Job:* 2019-11-12 vs 2019-11-11
...
| `["array", "index", "(\"sumrange\", \"1:100000\")"]` | 1.53 (50%) :x: | 1.00 (1%)  |
...
| `["linalg", "arithmetic", "(\"-\", \"Matrix\", \"Matrix\", 256)"]` | 2.17 (45%) :x: | 1.00 (1%)  |
| `["linalg", "small exp #29116"]` | 2.86 (5%) :x: | 1.04 (1%) :x: |
| `["misc", "bitshift", "(\"Int\", \"UInt\")"]` | 1.07 (5%) :x: | 1.00 (1%)  |
| `["misc", "bitshift", "(\"UInt\", \"UInt\")"]` | 1.07 (5%) :x: | 1.00 (1%)  |
| `["misc", "repeat", "(200, 1, 24)"]` | 0.95 (5%) :white_check_mark: | 1.00 (1%)  |
| `["misc", "repeat", "(200, 24, 1)"]` | 1.66 (5%) :x: | 1.00 (1%)  |
| `["problem", "monte carlo", "euro_option_devec"]` | 1.11 (5%) :x: | 1.00 (1%)  |
| `["problem", "seismic", "(\"seismic\", \"Float64\")"]` | 1.06 (5%) :x: | 1.00 (1%)  |
| `["random", "ranges", "(\"rand!\", \"ImplicitRNG\", \"Int\", \"1:1000\")"]` | 1.32 (25%) :x: | 1.00 (1%)  |
...
| `["random", "types", "(\"rand\", \"ImplicitRNG\", \"ImplicitFloat64\")"]` | 1.27 (25%) :x: | 1.00 (1%)  |
...
| `["scalar", "arithmetic", "(\"rem type\", \"Int64\", \"BigInt\")"]` | 0.49 (40%) :white_check_mark: | 1.00 (1%)  |
...
| `["scalar", "asinh", "(\"2 <= abs(x) < 2^28\", \"negative argument\", \"Float64\")"]` | 1.14 (5%) :x: | 1.00 (1%)  |
...
| `["scalar", "asinh", "(\"very large\", \"negative argument\", \"Float64\")"]` | 1.39 (5%) :x: | 1.00 (1%)  |
| `["scalar", "asinh", "(\"very large\", \"positive argument\", \"Float64\")"]` | 1.14 (5%) :x: | 1.00 (1%)  |
| `["scalar", "asinh", "(\"very small\", \"negative argument\", \"Float64\")"]` | 1.31 (5%) :x: | 1.00 (1%)  |
| `["scalar", "asinh", "(\"very small\", \"positive argument\", \"Float64\")"]` | 1.31 (5%) :x: | 1.00 (1%)  |
...
| `["scalar", "cos", "(\"no reduction\", \"zero\", \"Float64\")"]` | 0.83 (5%) :white_check_mark: | 1.00 (1%)  |
...
| `["scalar", "sin", "(\"no reduction\", \"zero\", \"Float64\")"]` | 2.00 (5%) :x: | 1.00 (1%)  |
...
| `["scalar", "sinh", "(\"0 <= abs(x) < 2.0^-28\", \"negative argument\", \"Float64\")"]` | 1.44 (5%) :x: | 1.00 (1%)  |
...
| `["union", "array", "(\"broadcast\", abs, Int8, true)"]` | 1.14 (5%) :x: | 1.00 (1%)  |
...
```
Julia Version 1.4.0-DEV.441
Commit 91effa2 (2019-11-11 17:28 UTC)
Platform Info:
  ...
  CPU: Intel(R) Xeon(R) CPU E3-1241 v3 @ 3.50GHz: 
       ...
       #1  3501 MHz  107929018 s       5047 s   12597424 s  5005621182 s         30 s
       #2  3501 MHz  769710179 s        217 s   13923786 s  4350383511 s         25 s
       #3  3501 MHz   91831510 s       3255 s    7479332 s  5034856652 s         34 s
       #4  3501 MHz   86042201 s         32 s   10683338 s  5035357881 s         24 s
       
  Memory: 31.383651733398438 GB (15933.625 MB free)
  Uptime: 5.1378735e7 sec
  Load Avg:  0.87646484375  0.98974609375  1.03466796875
  WORD_SIZE: 64
  LIBM: libopenlibm
