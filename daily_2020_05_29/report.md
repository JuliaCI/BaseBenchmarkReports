...
*Commit(s):* [JuliaLang/julia@59a315cac72f048847b85e285ae19ef2dc9514c3](https://github.com/JuliaLang/julia/commit/59a315cac72f048847b85e285ae19ef2dc9514c3)

*Triggered By:* [link](https://github.com/JuliaLang/julia/commit/59a315cac72f048847b85e285ae19ef2dc9514c3#commitcomment-39519333)

*Tag Predicate:* `ALL`

*Daily Job:* 2020-05-29 vs 2020-05-28
...
| `["array", "cat", "(\"vcat\", 5)"]` | 1.46 (5%) :x: | 1.00 (1%)  |
| `["array", "convert", "(\"Complex{Float64}\", \"Int\")"]` | 0.94 (5%) :white_check_mark: | 1.00 (1%)  |
| `["array", "equality", "(\"==\", \"Array{Int64,1} == Array{Float32,1}\")"]` | 0.93 (5%) :white_check_mark: | 1.00 (1%)  |
...
| `["dates", "parse", "(\"Date\", \"ISODateFormat\")"]` | 1.15 (5%) :x: | 1.00 (1%)  |
...
| `["shootout", "k_nucleotide"]` | 1.12 (5%) :x: | 1.00 (1%)  |
...
| `["union", "array", "(\"broadcast\", identity, Complex{Float64}, true)"]` | 1.09 (5%) :x: | 1.00 (1%)  |
...
| `["union", "array", "(\"map\", abs, Int64, false)"]` | 1.25 (5%) :x: | 1.00 (1%)  |
...
| `["union", "array", "(\"map\", identity, Bool, true)"]` | 0.92 (5%) :white_check_mark: | 1.00 (1%)  |
...
| `["union", "array", "(\"skipmissing\", collect, Union{Nothing, Bool}, false)"]` | 1.07 (5%) :x: | 1.00 (1%)  |
...
```
Julia Version 1.6.0-DEV.126
Commit 59a315c (2020-05-29 03:05 UTC)
Platform Info:
  ...
  CPU: Intel(R) Xeon(R) CPU E3-1241 v3 @ 3.50GHz: 
       ...
       #1  3501 MHz  141848938 s       5056 s   16092619 s  6683570753 s         35 s
       #2  3501 MHz  1069508325 s        217 s   21178701 s  5760979206 s         27 s
       #3  3501 MHz  126754798 s       3305 s    9575963 s  6714849587 s         38 s
       #4  3501 MHz  119013785 s         43 s   13739174 s  6716607085 s         27 s
       
  Memory: 31.383651733398438 GB (18996.421875 MB free)
  Uptime: 6.8569346e7 sec
