...
*Commit(s):* [pkofod/julia@2a7da27af687619e47b2e75b007732e4ee49f7ea](https://github.com/pkofod/julia/commit/2a7da27af687619e47b2e75b007732e4ee49f7ea) vs [JuliaLang/julia@f965fd48dd89a90a2ce7a8e5a94c902f1a6bdfe3](https://github.com/JuliaLang/julia/commit/f965fd48dd89a90a2ce7a8e5a94c902f1a6bdfe3)

*Triggered By:* [link](https://github.com/JuliaLang/julia/pull/25903#issuecomment-365764654)
...
| `["collection", "set operations", "(\"BitSet\", \"Int\", \"union!\", \"big\")"]` | 1.48 (25%) :x: | 1.00 (1%)  |
...
| `["dates", "arithmetic", "(\"DateTime\", \"Second\")"]` | 0.58 (15%) :white_check_mark: | 1.00 (1%)  |
...
| `["random", "types", "(\"rand\", \"MersenneTwister\", \"Complex{Int8}\")"]` | 0.39 (25%) :white_check_mark: | 1.00 (1%)  |
| `["random", "types", "(\"rand\", \"MersenneTwister\", \"Int32\")"]` | 1.41 (25%) :x: | 1.00 (1%)  |
| `["scalar", "acos", "(\"one\", \"positive argument\", \"Float32\")"]` | 0.83 (15%) :white_check_mark: | 1.00 (1%)  |
| `["scalar", "arithmetic", "(\"add\", \"BigInt\", \"UInt64\")"]` | 1.77 (50%) :x: | 1.00 (1%)  |
| `["scalar", "asin", "(\"0.5 <= abs(x) < 0.975\", \"positive argument\", \"Float64\")"]` | 0.80 (15%) :white_check_mark: | 1.00 (1%)  |
| `["scalar", "asin", "(\"one\", \"negative argument\", \"Float32\")"]` | 1.60 (15%) :x: | 1.00 (1%)  |
| `["scalar", "atan", "(\"7/16 <= abs(x) < 11/16\", \"positive argument\", \"Float64\")"]` | 0.80 (15%) :white_check_mark: | 1.00 (1%)  |
| `["scalar", "atan2", "(\"abs(y/x) high\", \"y positive\", \"x negative\", \"Float64\")"]` | 0.74 (15%) :white_check_mark: | 1.00 (1%)  |
...
| `["scalar", "atan2", "(\"x zero\", \"y positive\", \"Float64\")"]` | 0.84 (15%) :white_check_mark: | 1.00 (1%)  |
| `["scalar", "cos", "(\"argument reduction (hard) abs(x) < 2π/4\", \"positive argument\", \"Float32\", \"sin_kernel\")"]` | 1.22 (15%) :x: | 1.00 (1%)  |
...
| `["scalar", "predicate", "(\"isfinite\", \"Complex{Int64}\")"]` | 0.61 (25%) :white_check_mark: | 1.00 (1%)  |
| `["scalar", "sin", "(\"argument reduction (easy) abs(x) < 7π/4\", \"negative argument\", \"Float32\", \"sin_kernel\")"]` | 1.50 (15%) :x: | 1.00 (1%)  |
| `["scalar", "sin", "(\"argument reduction (hard) abs(x) < 2π/4\", \"negative argument\", \"Float64\", \"cos_kernel\")"]` | 1.38 (15%) :x: | 1.00 (1%)  |
| `["scalar", "sin", "(\"no reduction\", \"positive argument\", \"Float64\", \"sin_kernel\")"]` | 1.25 (15%) :x: | 1.00 (1%)  |
...
| `["union", "array", "(\"perf_binaryop\", *, BigFloat, (false, false))"]` | 0.83 (15%) :white_check_mark: | 1.00 (1%)  |
| `["union", "array", "(\"perf_binaryop\", *, BigFloat, (false, true))"]` | 0.83 (15%) :white_check_mark: | 1.00 (1%)  |
| `["union", "array", "(\"perf_binaryop\", *, BigFloat, (true, true))"]` | 0.83 (15%) :white_check_mark: | 1.00 (1%)  |
| `["union", "array", "(\"perf_binaryop\", *, BigInt, (false, false))"]` | 1.19 (15%) :x: | 1.00 (1%)  |
| `["union", "array", "(\"perf_binaryop\", *, BigInt, (false, true))"]` | 1.16 (15%) :x: | 1.00 (1%)  |
| `["union", "array", "(\"perf_binaryop\", *, BigInt, (true, true))"]` | 1.17 (15%) :x: | 1.00 (1%)  |
...
```
Julia Version 0.7.0-DEV.3987
Commit 2a7da27 (2018-02-14 22:21 UTC)
Platform Info:
  ...
  CPU: Intel(R) Xeon(R) CPU E3-1241 v3 @ 3.50GHz: 
       ...
       #1  3501 MHz  118289432 s          0 s   20886948 s  5275238213 s        103 s
       #2  3501 MHz  519663795 s          0 s   13143036 s  4894380895 s         26 s
       #3  3501 MHz   98071456 s          0 s   11180700 s  5318475361 s         86 s
       #4  3501 MHz   93815773 s          0 s   11379224 s  5322522094 s         22 s
       
  Memory: 31.383651733398438 GB (5570.0078125 MB free)
  Uptime: 5.4302831e7 sec
...
Platform Info:
  ...
  CPU: Intel(R) Xeon(R) CPU E3-1241 v3 @ 3.50GHz: 
              speed         user         nice          sys         idle          irq
       #1  3501 MHz  118379575 s          0 s   20897152 s  5276051264 s        103 s
       #2  3501 MHz  520505488 s          0 s   13152876 s  4894445465 s         26 s
       #3  3501 MHz   98178280 s          0 s   11188448 s  5319276956 s         86 s
       #4  3501 MHz   93900075 s          0 s   11387284 s  5323345970 s         23 s
       
  Memory: 31.383651733398438 GB (5303.09375 MB free)
  Uptime: 5.4311999e7 sec
  Load Avg:  1.0029296875  1.0146484375  1.04541015625
  WORD_SIZE: 64
  LIBM: libopenlibm
  LLVM: libLLVM-3.9.1 (ORCJIT, haswell)
