...
*Commit(s):* [JuliaLang/julia@c5cc3f2811804b9d5ef8cd0b584ba2e7ad8f67c7](https://github.com/JuliaLang/julia/commit/c5cc3f2811804b9d5ef8cd0b584ba2e7ad8f67c7)

*Triggered By:* [link](https://github.com/JuliaLang/julia/commit/c5cc3f2811804b9d5ef8cd0b584ba2e7ad8f67c7#commitcomment-35161352)

*Tag Predicate:* `ALL`

*Daily Job:* 2019-09-20 vs 2019-09-19
...
| `["array", "growth", "(\"append!\", 8)"]` | 0.86 (5%) :white_check_mark: | 1.00 (1%)  |
...
| `["array", "index", "(\"sumcolon\", \"1:100000\")"]` | 1.91 (50%) :x: | 1.00 (1%)  |
| `["array", "index", "(\"sumrange\", \"100000:-1:1\")"]` | 1.66 (50%) :x: | 1.00 (1%)  |
...
| `["collection", "queries & updates", "(\"Dict\", \"String\", \"pop!\", \"unspecified\")"]` | 1.49 (25%) :x: | 1.00 (1%)  |
| `["collection", "queries & updates", "(\"IdDict\", \"Int\", \"first\")"]` | 0.47 (25%) :white_check_mark: | 1.00 (1%)  |
...
| `["io", "array_limit", "(\"display\", \"Array{Float64,1}(100000000,)\")"]` | 1.07 (5%) :x: | 1.02 (1%) :x: |
| `["io", "array_limit", "(\"display\", \"Array{Float64,2}(10000, 10000)\")"]` | 0.83 (5%) :white_check_mark: | 0.93 (1%) :white_check_mark: |
| `["io", "array_limit", "(\"display\", \"Array{Float64,2}(100000000, 1)\")"]` | 1.17 (5%) :x: | 1.02 (1%) :x: |
...
| `["scalar", "arithmetic", "(\"rem type\", \"Int64\", \"BigInt\")"]` | 1.82 (40%) :x: | 1.00 (1%)  |
| `["scalar", "arithmetic", "(\"rem type\", \"UInt64\", \"BigInt\")"]` | 1.64 (40%) :x: | 1.00 (1%)  |
...
| `["scalar", "atan2", "(\"abs(y/x) high\", \"y negative\", \"x positive\", \"Float64\")"]` | 0.66 (5%) :white_check_mark: | 1.00 (1%)  |
...
| `["string", "readuntil", "target length 1"]` | 0.86 (5%) :white_check_mark: | 1.00 (1%)  |
...
| `["union", "array", "(\"map\", identity, BigInt, true)"]` | 1.26 (5%) :x: | 1.00 (1%)  |
...
```
Julia Version 1.4.0-DEV.184
Commit c5cc3f2 (2019-09-20 01:50 UTC)
Platform Info:
  ...
  CPU: Intel(R) Xeon(R) CPU E3-1241 v3 @ 3.50GHz: 
       ...
       #1  3501 MHz  101422279 s       5044 s   11766951 s  4555670899 s         28 s
       #2  3501 MHz  698731420 s        208 s   12248511 s  3965184213 s         24 s
       #3  3501 MHz   84991863 s       3251 s    7001170 s  4584210526 s         33 s
       #4  3501 MHz   79727641 s         27 s    9938899 s  4584654029 s         22 s
       
  Memory: 31.383651733398438 GB (14727.49609375 MB free)
  Uptime: 4.6796224e7 sec
