...
*Commit(s):* [JuliaLang/julia@1a6e34bb1b49c67852f3e4ec3c37eb1737d857f8](https://github.com/JuliaLang/julia/commit/1a6e34bb1b49c67852f3e4ec3c37eb1737d857f8)

*Triggered By:* [link](https://github.com/JuliaLang/julia/commit/1a6e34bb1b49c67852f3e4ec3c37eb1737d857f8#commitcomment-26495392)

*Tag Predicate:* `ALL`

*Daily Job:* 2017-12-27 vs 2017-12-26
...
| `["collection", "queries & updates", "(\"Dict\", \"Int\", \"pop!\", \"specified\")"]` | 0.51 (25%) :white_check_mark: | 1.00 (1%)  |
| `["collection", "queries & updates", "(\"Vector\", \"Int\", \"pop!\", \"unspecified\")"]` | 0.73 (25%) :white_check_mark: | 1.00 (1%)  |
| `["collection", "set operations", "(\"Set\", \"Int\", \"⊆\", \"self\")"]` | 1.36 (25%) :x: | 1.00 (1%)  |
| `["dates", "arithmetic", "(\"Date\", \"Month\")"]` | 1.23 (15%) :x: | 1.00 (1%)  |
| `["find", "(\"ispos\", \"Array{Int64,1}\")"]` | 0.82 (15%) :white_check_mark: | 1.00 (1%)  |
| `["find", "findnext", "(\"ispos\", \"Array{Int64,1}\")"]` | 1.17 (15%) :x: | 1.00 (1%)  |
| `["find", "findnext", "(\"ispos\", \"Array{UInt64,1}\")"]` | 0.77 (15%) :white_check_mark: | 1.00 (1%)  |
...
| `["random", "collections", "(\"rand\", \"RandomDevice\", \"large String\")"]` | 1.63 (25%) :x: | 1.00 (1%)  |
...
| `["scalar", "arithmetic", "(\"add\", \"Float64\", \"Float64\")"]` | 0.67 (25%) :white_check_mark: | 1.00 (1%)  |
...
| `["scalar", "cos", "(\"argument reduction (hard) abs(x) < 6π/4\", \"negative argument\", \"Float64\", \"sin_kernel\")"]` | 0.77 (15%) :white_check_mark: | 1.00 (1%)  |
| `["scalar", "fastmath", "(\"mul\", \"Complex{BigInt}\")"]` | 0.52 (40%) :white_check_mark: | 1.00 (1%)  |
| `["scalar", "predicate", "(\"isless\", \"Float32\")"]` | 0.50 (25%) :white_check_mark: | 1.00 (1%)  |
| `["scalar", "rem_pio2", "(\"argument reduction (easy) abs(x) < 9π/4\", \"positive argument\", \"Float64\")"]` | 0.75 (15%) :white_check_mark: | 1.00 (1%)  |
...
| `["tuple", "reduction", "(\"minimum\", (8,))"]` | 1.41 (15%) :x: | 1.00 (1%)  |
...
Platform Info:
  ...
  CPU: Intel(R) Xeon(R) CPU E3-1241 v3 @ 3.50GHz: 
       ...
       #1  3501 MHz  110250242 s          0 s   19447975 s  4856112809 s        100 s
       #2  3501 MHz  467419340 s          0 s   12353779 s  4517744664 s         24 s
       #3  3501 MHz   92259936 s          0 s   10542670 s  4895209842 s         84 s
       #4  3501 MHz   88329536 s          0 s   10737248 s  4898940190 s         21 s
       
  Memory: 31.383651733398438 GB (4958.75390625 MB free)
  Uptime: 5.0003924e7 sec
