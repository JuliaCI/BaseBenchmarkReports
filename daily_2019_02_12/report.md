...
*Commit(s):* [JuliaLang/julia@236c69b1a53acf4057de830979138765c79aa596](https://github.com/JuliaLang/julia/commit/236c69b1a53acf4057de830979138765c79aa596)

*Triggered By:* [link](https://github.com/JuliaLang/julia/commit/236c69b1a53acf4057de830979138765c79aa596#commitcomment-32279218)

*Tag Predicate:* `ALL`

*Daily Job:* 2019-02-12 vs 2019-02-11
...
| `["collection", "queries & updates", "(\"Dict\", \"String\", \"pop!\", \"unspecified\")"]` | 1.32 (25%) :x: | 1.00 (1%)  |
| `["collection", "queries & updates", "(\"Set\", \"Int\", \"in\", \"true\")"]` | 0.74 (25%) :white_check_mark: | 1.00 (1%)  |
| `["collection", "set operations", "(\"Set\", \"Int\", \"intersect\", \"Vector\")"]` | 0.50 (25%) :white_check_mark: | 1.00 (1%)  |
| `["collection", "set operations", "(\"Set\", \"Int\", \"intersect\", \"Vector\", \"Vector\")"]` | 0.70 (25%) :white_check_mark: | 1.00 (1%)  |
| `["dates", "parse", "Date"]` | 0.93 (5%) :white_check_mark: | 1.00 (1%)  |
| `["dates", "string", "Date"]` | 1.31 (5%) :x: | 1.00 (1%)  |
...
| `["random", "ranges", "(\"rand\", \"MersenneTwister\", \"Int32\", \"RangeGenerator(1:1)\")"]` | 0.53 (25%) :white_check_mark: | 1.00 (1%)  |
...
| `["scalar", "arithmetic", "(\"mul\", \"BigFloat\", \"UInt64\")"]` | 1.55 (50%) :x: | 1.00 (1%)  |
| `["scalar", "arithmetic", "(\"mul\", \"Complex{BigFloat}\", \"UInt64\")"]` | 1.62 (50%) :x: | 1.00 (1%)  |
| `["scalar", "arithmetic", "(\"mul\", \"Int64\", \"Complex{BigFloat}\")"]` | 1.52 (50%) :x: | 1.00 (1%)  |
| `["scalar", "arithmetic", "(\"mul\", \"UInt64\", \"BigFloat\")"]` | 1.55 (50%) :x: | 1.00 (1%)  |
| `["scalar", "arithmetic", "(\"mul\", \"UInt64\", \"Complex{BigFloat}\")"]` | 1.63 (50%) :x: | 1.00 (1%)  |
| `["scalar", "arithmetic", "(\"rem type\", \"Bool\", \"BigInt\")"]` | 1.66 (40%) :x: | 1.00 (1%)  |
...
| `["scalar", "asin", "(\"small\", \"negative argument\", \"Float64\")"]` | 0.64 (5%) :white_check_mark: | 1.00 (1%)  |
| `["scalar", "asinh", "(\"0 <= abs(x) < 2^-28\", \"positive argument\", \"Float32\")"]` | 0.76 (5%) :white_check_mark: | 1.00 (1%)  |
...
| `["scalar", "cosh", "(\"very small\", \"positive argument\", \"Float64\")"]` | 0.82 (5%) :white_check_mark: | 1.00 (1%)  |
...
| `["sparse", "matmul", "(\"At_mul_B!\", \"dense 40x4000, sparse 40x40 -> dense 4000x40\")"]` | 1.38 (30%) :x: | 1.00 (1%)  |
...
| `["union", "array", "(\"broadcast\", identity, BigInt, true)"]` | 1.08 (5%) :x: | 1.00 (1%)  |
...
```
Julia Version 1.2.0-DEV.309
Commit 236c69b (2019-02-11 23:14 UTC)
Platform Info:
  ...
  CPU: Intel(R) Xeon(R) CPU E3-1241 v3 @ 3.50GHz: 
       ...
       #1  3501 MHz   76048022 s       5015 s    8506236 s  2687630838 s         23 s
       #2  3501 MHz  447971664 s        203 s    7422245 s  2321406410 s         19 s
       #3  3501 MHz   59206936 s       3228 s    4997437 s  2712497247 s         27 s
       #4  3501 MHz   55472652 s          4 s    6503871 s  2714033171 s         17 s
       
  Memory: 31.383651733398438 GB (4990.96484375 MB free)
  Uptime: 2.7789998e7 sec
