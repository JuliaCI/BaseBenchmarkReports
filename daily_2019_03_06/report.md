...
*Commit(s):* [JuliaLang/julia@1c8c8e764e3346fb80441193cb88a11fef74f6a2](https://github.com/JuliaLang/julia/commit/1c8c8e764e3346fb80441193cb88a11fef74f6a2)

*Triggered By:* [link](https://github.com/JuliaLang/julia/commit/1c8c8e764e3346fb80441193cb88a11fef74f6a2#commitcomment-32607446)

*Tag Predicate:* `ALL`

*Daily Job:* 2019-03-06 vs 2019-03-05
...
| `["collection", "queries & updates", "(\"Set\", \"Int\", \"pop!\", \"specified\")"]` | 1.96 (25%) :x: | 1.00 (1%)  |
| `["collection", "queries & updates", "(\"Set\", \"Int\", \"pop!\", \"unspecified\")"]` | 1.48 (25%) :x: | 1.00 (1%)  |
| `["collection", "queries & updates", "(\"Set\", \"Int\", \"push!\", \"new\")"]` | 1.83 (25%) :x: | 1.00 (1%)  |
| `["collection", "queries & updates", "(\"Set\", \"Int\", \"push!\", \"overwrite\")"]` | 2.11 (25%) :x: | 1.00 (1%)  |
...
| `["problem", "imdb", "centrality"]` | 1.13 (5%) :x: | 1.00 (1%)  |
...
| `["random", "types", "(\"rand!\", \"MersenneTwister\", \"Complex{UInt16}\")"]` | 1.32 (25%) :x: | 1.00 (1%)  |
...
| `["random", "types", "(\"randn!\", \"MersenneTwister\", \"Float16\")"]` | 1.31 (25%) :x: | 1.00 (1%)  |
...
| `["scalar", "cos", "(\"argument reduction (paynehanek) abs(x) > 2.0^20*π/2\", \"negative argument\", \"Float32\", \"sin_kernel\")"]` | 0.68 (5%) :white_check_mark: | 1.00 (1%)  |
...
| `["union", "array", "(\"broadcast\", abs, Int8, true)"]` | 0.88 (5%) :white_check_mark: | 1.00 (1%)  |
...
| `["union", "array", "(\"perf_sum2\", BigFloat, false)"]` | 1.14 (5%) :x: | 1.00 (1%)  |
| `["union", "array", "(\"perf_sum2\", BigFloat, true)"]` | 1.13 (5%) :x: | 1.00 (1%)  |
...
| `["union", "array", "(\"perf_sum3\", BigFloat, false)"]` | 1.18 (5%) :x: | 1.00 (1%)  |
...
| `["union", "array", "(\"perf_sum\", BigFloat, false)"]` | 1.12 (5%) :x: | 1.00 (1%)  |
| `["union", "array", "(\"perf_sum\", BigFloat, true)"]` | 1.11 (5%) :x: | 1.00 (1%)  |
| `["union", "array", "(\"skipmissing\", sum, BigFloat, false)"]` | 1.15 (5%) :x: | 1.00 (1%)  |
| `["union", "array", "(\"skipmissing\", sum, Union{Missing, BigFloat}, true)"]` | 1.13 (5%) :x: | 1.00 (1%)  |
...
```
Julia Version 1.2.0-DEV.424
Commit 1c8c8e7 (2019-03-06 02:45 UTC)
Platform Info:
  ...
  CPU: Intel(R) Xeon(R) CPU E3-1241 v3 @ 3.50GHz: 
       ...
       #1  3501 MHz   79446188 s       5019 s    8936517 s  2873523826 s         24 s
       #2  3501 MHz  478901960 s        203 s    7984006 s  2479929867 s         19 s
       #3  3501 MHz   62635780 s       3228 s    5281387 s  2898794138 s         27 s
       #4  3501 MHz   58755074 s          7 s    6881816 s  2900328474 s         17 s
       
  Memory: 31.383651733398438 GB (5150.7109375 MB free)
  Uptime: 2.969146e7 sec
