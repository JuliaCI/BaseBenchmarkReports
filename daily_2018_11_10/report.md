...
*Commit(s):* [JuliaLang/julia@a3599e99d423353a828803a45d6087c16d4c8c78](https://github.com/JuliaLang/julia/commit/a3599e99d423353a828803a45d6087c16d4c8c78)

*Triggered By:* [link](https://github.com/JuliaLang/julia/commit/a3599e99d423353a828803a45d6087c16d4c8c78#commitcomment-31247347)

*Tag Predicate:* `ALL`

*Daily Job:* 2018-11-10 vs 2018-11-03
...
| `["broadcast", "fusion", "(\"Float64\", (1000, 1000), 2)"]` | 2.99 (5%) :x: | 1.00 (1%)  |
| `["broadcast", "fusion", "(\"Float64\", (1000, 1000), 3)"]` | 3.79 (5%) :x: | 1.00 (1%)  |
| `["broadcast", "fusion", "(\"Float64\", (1000000,), 1)"]` | 1.92 (5%) :x: | 1.00 (1%)  |
| `["broadcast", "fusion", "(\"Float64\", (1000000,), 2)"]` | 2.06 (5%) :x: | 1.00 (1%)  |
| `["broadcast", "mix_scalar_tuple", "(10, \"scal_tup_x3\")"]` | 0.92 (5%) :white_check_mark: | 1.00 (1%)  |
| `["broadcast", "mix_scalar_tuple", "(3, \"scal_tup_x3\")"]` | 0.79 (5%) :white_check_mark: | 1.00 (1%)  |
...
| `["problem", "spellcheck", "spellcheck"]` | 0.60 (5%) :white_check_mark: | 0.66 (1%) :white_check_mark: |
...
| `["random", "types", "(\"rand!\", \"MersenneTwister\", \"Complex{Float16}\")"]` | 0.60 (25%) :white_check_mark: | 1.00 (1%)  |
| `["random", "types", "(\"rand!\", \"MersenneTwister\", \"Float16\")"]` | 0.50 (25%) :white_check_mark: | 1.00 (1%)  |
| `["random", "types", "(\"randexp!\", \"MersenneTwister\", \"Float64\")"]` | 0.58 (25%) :white_check_mark: | 1.00 (1%)  |
| `["random", "types", "(\"randn!\", \"MersenneTwister\", \"Complex{Float16}\")"]` | 0.69 (25%) :white_check_mark: | 1.00 (1%)  |
| `["random", "types", "(\"randn!\", \"MersenneTwister\", \"Float64\")"]` | 0.64 (25%) :white_check_mark: | 1.00 (1%)  |
...
| `["scalar", "cosh", "(\"zero\", \"Float32\")"]` | 0.82 (5%) :white_check_mark: | 1.00 (1%)  |
...
| `["scalar", "predicate", "(\"isfinite\", \"Complex{BigFloat}\")"]` | 0.59 (40%) :white_check_mark: | 1.00 (1%)  |
...
| `["scalar", "tan", "(\"small\", \"negative argument\", \"Float64\")"]` | 0.65 (5%) :white_check_mark: | 1.00 (1%)  |
...
| `["sparse", "index", "(\"spmat\", \"row\", \"OneTo\", 1000)"]` | 1.34 (30%) :x: | 1.00 (1%)  |
...
Platform Info:
  ...
  CPU: Intel(R) Xeon(R) CPU E3-1241 v3 @ 3.50GHz: 
       ...
       #1  3501 MHz   60838659 s       5006 s    6638091 s  1894378582 s         22 s
       #2  3501 MHz  325680483 s        203 s    5221087 s  1634352736 s         15 s
       #3  3501 MHz   44777157 s       3210 s    3811226 s  1916616786 s         25 s
       #4  3501 MHz   41588698 s          0 s    4815242 s  1918394707 s         14 s
       
  Memory: 31.383651733398438 GB (5142.91015625 MB free)
  Uptime: 1.9668992e7 sec
