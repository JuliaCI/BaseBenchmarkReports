...
*Commit(s):* [JuliaLang/julia@d762e8c23538d745389a9ca959a90a769c864ce7](https://github.com/JuliaLang/julia/commit/d762e8c23538d745389a9ca959a90a769c864ce7) vs [JuliaLang/julia@52c55d7934f71c5b2d9f6e6fa98cb48817def57c](https://github.com/JuliaLang/julia/commit/52c55d7934f71c5b2d9f6e6fa98cb48817def57c)

*Triggered By:* [link](https://github.com/JuliaLang/julia/commit/d762e8c23538d745389a9ca959a90a769c864ce7#commitcomment-40209347)
...
| `["array", "cat", "4467"]` | 0.33 (5%) :white_check_mark: | 1.00 (1%)  |
...
| `["collection", "deletion", "(\"Set\", \"Any\", \"pop!\")"]` | 1.29 (25%) :x: | 1.00 (1%)  |
...
| `["find", "findprev", "(\"ispos\", \"Array{Float32,1}\")"]` | 1.25 (5%) :x: | 1.00 (1%)  |
| `["find", "findprev", "(\"ispos\", \"Array{UInt8,1}\")"]` | 1.09 (5%) :x: | 1.00 (1%)  |
| `["io", "array_limit", "(\"display\", \"Array{Float64,1}(100000000,)\")"]` | 0.11 (5%) :white_check_mark: | 1.00 (1%)  |
| `["io", "array_limit", "(\"display\", \"Array{Float64,2}(10000, 10000)\")"]` | 0.13 (5%) :white_check_mark: | 1.00 (1%)  |
| `["io", "array_limit", "(\"display\", \"Array{Float64,2}(100000000, 1)\")"]` | 0.11 (5%) :white_check_mark: | 1.00 (1%)  |
...
| `["problem", "json", "parse_json"]` | 1.05 (5%)  | 1.67 (1%) :x: |
...
| `["scalar", "arithmetic", "(\"sub\", \"Complex{BigInt}\", \"Int64\")"]` | 1.61 (50%) :x: | 1.00 (1%)  |
...
| `["sparse", "matmul", "(\"At_mul_B!\", \"sparse 40x400, dense 40x400 -> dense 400x400\")"]` | 0.59 (30%) :white_check_mark: | 1.00 (1%)  |
...
| `["union", "array", "(\"broadcast\", identity, Complex{Float64}, true)"]` | 1.37 (5%) :x: | 1.00 (1%)  |
...
Platform Info:
  ...
  CPU: Intel(R) Xeon(R) CPU E3-1241 v3 @ 3.50GHz: 
       ...
       #1  3501 MHz   60068845 s       2454 s   21613399 s  7006881059 s         21 s
       #2  3501 MHz  380450674 s         62 s    8067678 s  6718873456 s         28 s
       #3  3501 MHz   51185034 s       3247 s    6019230 s  7048688833 s         40 s
       #4  3501 MHz   49303428 s         19 s    4597197 s  7056166105 s         38 s
       
  Memory: 31.383651733398438 GB (20150.20703125 MB free)
  Uptime: 7.1119803e7 sec
...
Platform Info:
  ...
  CPU: Intel(R) Xeon(R) CPU E3-1241 v3 @ 3.50GHz: 
              speed         user         nice          sys         idle          irq
       #1  3501 MHz   60216256 s       2454 s   21623622 s  7008132928 s         21 s
       #2  3501 MHz  381757473 s         62 s    8094129 s  6718953664 s         28 s
       #3  3501 MHz   51346374 s       3247 s    6025481 s  7049935341 s         40 s
       #4  3501 MHz   49446009 s         19 s    4603161 s  7057431705 s         38 s
       
  Memory: 31.383651733398438 GB (19276.06640625 MB free)
  Uptime: 7.1133949e7 sec
  Load Avg:  1.0029296875  1.0146484375  1.04541015625
  WORD_SIZE: 64
  LIBM: libopenlibm
  LLVM: libLLVM-9.0.1 (ORCJIT, haswell)
