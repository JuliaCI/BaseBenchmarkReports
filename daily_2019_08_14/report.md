...
*Commit(s):* [JuliaLang/julia@df1ee8cb185bbf75999384ce882a89cd9ca8d3fd](https://github.com/JuliaLang/julia/commit/df1ee8cb185bbf75999384ce882a89cd9ca8d3fd)

*Triggered By:* [link](https://github.com/JuliaLang/julia/commit/df1ee8cb185bbf75999384ce882a89cd9ca8d3fd#commitcomment-34682793)

*Tag Predicate:* `ALL`

*Daily Job:* 2019-08-14 vs 2019-08-13
...
| `["collection", "iteration", "(\"IdDict\", \"Any\", \"iterate\")"]` | 1.57 (25%) :x: | 1.00 (1%)  |
| `["collection", "iteration", "(\"IdDict\", \"Int\", \"iterate\")"]` | 1.33 (25%) :x: | 1.00 (1%)  |
| `["collection", "iteration", "(\"IdDict\", \"String\", \"iterate\")"]` | 1.43 (25%) :x: | 1.00 (1%)  |
| `["collection", "iteration", "(\"Set\", \"Int\", \"iterate\")"]` | 1.42 (25%) :x: | 1.00 (1%)  |
| `["collection", "iteration", "(\"Vector\", \"Int\", \"iterate\")"]` | 1.36 (25%) :x: | 1.00 (1%)  |
| `["collection", "queries & updates", "(\"Dict\", \"String\", \"in\", \"true\")"]` | 1.42 (25%) :x: | 1.00 (1%)  |
...
| `["io", "array_limit", "(\"display\", \"Array{Float64,2}(100000000, 1)\")"]` | 1.03 (5%)  | 0.99 (1%) :white_check_mark: |
...
| `["random", "ranges", "(\"rand\", \"MersenneTwister\", \"BigInt\", \"RangeGenerator(1:1)\")"]` | 1.35 (25%) :x: | 1.00 (1%)  |
...
| `["scalar", "arithmetic", "(\"rem type\", \"Int64\", \"BigInt\")"]` | 1.72 (40%) :x: | 1.00 (1%)  |
| `["scalar", "asin", "(\"0.5 <= abs(x) < 0.975\", \"positive argument\", \"Float64\")"]` | 1.31 (5%) :x: | 1.00 (1%)  |
...
| `["scalar", "expm1", "(\"arg reduction II\", \"negative argument\", \"Float32\")"]` | 0.73 (5%) :white_check_mark: | 1.00 (1%)  |
...
| `["scalar", "predicate", "(\"isinf\", \"BigFloat\")"]` | 1.69 (40%) :x: | 1.00 (1%)  |
| `["scalar", "rem_pio2", "(\"argument reduction (paynehanek) abs(x) > 2.0^20*π/2\", \"negative argument\", \"Float64\")"]` | 1.07 (5%) :x: | 1.00 (1%)  |
| `["scalar", "sin", "(\"argument reduction (easy) abs(x) < 4π/4\", \"positive argument\", \"Float64\", \"sin_kernel\")"]` | 1.38 (5%) :x: | 1.00 (1%)  |
| `["scalar", "sincos", "(\"argument reduction (easy) abs(x) < 2.0^20π/4\", \"negative argument\", \"Float32\")"]` | 1.77 (5%) :x: | 1.00 (1%)  |
...
| `["sparse", "constructors", "(\"Diagonal\", 10)"]` | 1.36 (5%) :x: | 1.00 (1%)  |
...
```
Julia Version 1.3.0-alpha.110
Commit df1ee8c (2019-08-13 18:25 UTC)
Platform Info:
  ...
  CPU: Intel(R) Xeon(R) CPU E3-1241 v3 @ 3.50GHz: 
       ...
       #1  3501 MHz   96278161 s       5041 s   11169265 s  4242385098 s         27 s
       #2  3501 MHz  646721932 s        208 s   11083184 s  3698917051 s         24 s
       #3  3501 MHz   79741696 s       3245 s    6625880 s  4270385903 s         32 s
       #4  3501 MHz   74796975 s         22 s    9385945 s  4270806648 s         22 s
       
  Memory: 31.383651733398438 GB (14798.453125 MB free)
  Uptime: 4.3599432e7 sec
  Load Avg:  0.99609375  1.01416015625  1.044921875
  WORD_SIZE: 64
  LIBM: libopenlibm
