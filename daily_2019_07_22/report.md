...
*Commit(s):* [JuliaLang/julia@db1fc0a7209554080ce896f049a1cf91b7f33257](https://github.com/JuliaLang/julia/commit/db1fc0a7209554080ce896f049a1cf91b7f33257)

*Triggered By:* [link](https://github.com/JuliaLang/julia/commit/db1fc0a7209554080ce896f049a1cf91b7f33257#commitcomment-34387854)

*Tag Predicate:* `ALL`

*Daily Job:* 2019-07-22 vs 2019-07-21
...
| `["io", "array_limit", "(\"display\", \"Array{Float64,1}(100000000,)\")"]` | 1.04 (5%)  | 1.01 (1%) :x: |
| `["io", "array_limit", "(\"display\", \"Array{Float64,2}(10000, 10000)\")"]` | 0.91 (5%) :white_check_mark: | 1.01 (1%)  |
...
| `["sparse", "constructors", "(\"Bidiagonal\", 10)"]` | 1.34 (5%) :x: | 1.00 (1%)  |
...
| `["union", "array", "(\"broadcast\", *, BigInt, (false, false))"]` | 0.77 (5%) :white_check_mark: | 1.00 (1%)  |
| `["union", "array", "(\"broadcast\", *, BigInt, (false, true))"]` | 0.77 (5%) :white_check_mark: | 1.00 (1%)  |
| `["union", "array", "(\"broadcast\", *, Int64, (false, true))"]` | 0.95 (5%) :white_check_mark: | 1.00 (1%)  |
| `["union", "array", "(\"broadcast\", abs, BigInt, false)"]` | 0.75 (5%) :white_check_mark: | 1.00 (1%)  |
| `["union", "array", "(\"broadcast\", abs, Float32, false)"]` | 0.88 (5%) :white_check_mark: | 1.00 (1%)  |
...
| `["union", "array", "(\"map\", *, BigInt, (false, false))"]` | 0.76 (5%) :white_check_mark: | 1.00 (1%)  |
| `["union", "array", "(\"map\", *, BigInt, (false, true))"]` | 0.77 (5%) :white_check_mark: | 1.00 (1%)  |
| `["union", "array", "(\"map\", *, Bool, (false, true))"]` | 0.93 (5%) :white_check_mark: | 1.00 (1%)  |
| `["union", "array", "(\"map\", abs, BigInt, false)"]` | 0.75 (5%) :white_check_mark: | 1.00 (1%)  |
...
| `["union", "array", "(\"perf_binaryop\", *, BigInt, (false, false))"]` | 0.77 (5%) :white_check_mark: | 1.00 (1%)  |
| `["union", "array", "(\"perf_binaryop\", *, BigInt, (false, true))"]` | 0.77 (5%) :white_check_mark: | 1.00 (1%)  |
...
| `["union", "array", "(\"perf_sum2\", BigInt, false)"]` | 0.77 (5%) :white_check_mark: | 1.00 (1%)  |
...
| `["union", "array", "(\"perf_sum3\", BigInt, false)"]` | 0.77 (5%) :white_check_mark: | 1.00 (1%)  |
...
| `["union", "array", "(\"perf_sum4\", BigInt, false)"]` | 0.77 (5%) :white_check_mark: | 1.00 (1%)  |
| `["union", "array", "(\"perf_sum4\", Complex{Float64}, true)"]` | 0.84 (5%) :white_check_mark: | 1.00 (1%)  |
| `["union", "array", "(\"perf_sum4\", Int8, true)"]` | 1.05 (5%) :x: | 1.00 (1%)  |
| `["union", "array", "(\"perf_sum\", BigInt, false)"]` | 0.76 (5%) :white_check_mark: | 1.00 (1%)  |
...
| `["union", "array", "(\"skipmissing\", sum, BigInt, false)"]` | 0.80 (5%) :white_check_mark: | 1.00 (1%)  |
...
| `["union", "array", "(\"skipmissing\", sum, Union{Nothing, BigInt}, false)"]` | 0.80 (5%) :white_check_mark: | 1.00 (1%)  |
...
```
Julia Version 1.3.0-DEV.568
Commit db1fc0a (2019-07-22 01:18 UTC)
Platform Info:
  ...
  CPU: Intel(R) Xeon(R) CPU E3-1241 v3 @ 3.50GHz: 
       ...
       #1  3501 MHz   93559954 s       5037 s   10781886 s  4047294549 s         27 s
       #2  3501 MHz  615836086 s        208 s   10373038 s  3531917991 s         22 s
       #3  3501 MHz   76979298 s       3243 s    6440527 s  4074687778 s         30 s
       #4  3501 MHz   72250190 s         20 s    9101074 s  4075079228 s         22 s
       
  Memory: 31.383651733398438 GB (11286.21484375 MB free)
  Uptime: 4.1612163e7 sec
