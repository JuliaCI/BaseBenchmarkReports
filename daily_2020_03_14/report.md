...
*Triggered By:* [link](https://github.com/JuliaLang/julia/commit/3935491dc5028f23587ca8df6d4e0de75cf50e53#commitcomment-37822089)

*Tag Predicate:* `ALL`

*Daily Job:* 2020-03-14 vs 2020-03-13
...
| `["broadcast", "mix_scalar_tuple", "(10, \"scal_tup_x3\")"]` | 0.87 (5%) :white_check_mark: | 1.00 (1%)  |
| `["broadcast", "mix_scalar_tuple", "(10, \"tup_tup\")"]` | 0.80 (5%) :white_check_mark: | 1.00 (1%)  |
...
| `["linalg", "arithmetic", "(\"+\", \"Matrix\", \"Matrix\", 256)"]` | 2.66 (45%) :x: | 1.00 (1%)  |
...
| `["random", "ranges", "(\"RangeGenerator\", \"UInt64\", \"1:18446744073709551615\")"]` | 0.68 (25%) :white_check_mark: | 1.00 (1%)  |
| `["random", "ranges", "(\"rand\", \"MersenneTwister\", \"BigInt\", \"RangeGenerator(1:18446744073709551615)\")"]` | 1.42 (25%) :x: | 1.00 (1%)  |
...
| `["scalar", "cosh", "(\"0.00024414062f0 <= abs(x) < 9f0\", \"negative argument\", \"Float32\")"]` | 1.41 (5%) :x: | 1.00 (1%)  |
...
| `["scalar", "exp2", "(\"2pow35\", \"negative argument\", \"Float32\")"]` | 0.65 (5%) :white_check_mark: | 1.00 (1%)  |
| `["scalar", "exp2", "(\"2pow3\", \"positive argument\", \"Float64\")"]` | 1.52 (5%) :x: | 1.00 (1%)  |
...
| `["union", "array", "(\"map\", identity, Complex{Float64}, false)"]` | 1.62 (5%) :x: | 1.00 (1%)  |
...
| `["union", "array", "(\"perf_sum\", Bool, false)"]` | 0.95 (5%) :white_check_mark: | 1.00 (1%)  |
| `["union", "array", "(\"perf_sum\", Bool, true)"]` | 1.46 (5%) :x: | 1.00 (1%)  |
...
| `["union", "array", "(\"sort\", Union{Nothing, Int64}, false)"]` | 1.50 (5%) :x: | 1.00 (1%)  |
...
Platform Info:
  ...
  CPU: Intel(R) Xeon(R) CPU E3-1241 v3 @ 3.50GHz: 
       ...
       #1  3501 MHz  127969313 s       5056 s   14751875 s  6043506583 s         34 s
       #2  3501 MHz  954472716 s        217 s   18408694 s  5222813318 s         26 s
       #3  3501 MHz  112391081 s       3279 s    8734148 s  6074599524 s         36 s
       #4  3501 MHz  105429874 s         43 s   12514715 s  6075495703 s         26 s
       
  Memory: 31.383651733398438 GB (18716.26171875 MB free)
  Uptime: 6.2003081e7 sec
