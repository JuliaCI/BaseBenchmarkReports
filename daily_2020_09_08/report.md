...
*Commit(s):* [JuliaLang/julia@31d72108acd8f5145389d6c15bc81741cb4acc07](https://github.com/JuliaLang/julia/commit/31d72108acd8f5145389d6c15bc81741cb4acc07)

*Triggered By:* [link](https://github.com/JuliaLang/julia/commit/31d72108acd8f5145389d6c15bc81741cb4acc07#commitcomment-42109587)

*Tag Predicate:* `ALL`

*Daily Job:* 2020-09-08 vs 2020-09-07
...
| `["io", "array_limit", "(\"display\", \"Matrix{Float64}(10000, 10000)\")"]` | 1.09 (5%) :x: | 1.10 (1%) :x: |
| `["io", "read", "readstring"]` | 0.89 (5%) :white_check_mark: | 1.00 (1%)  |
| `["linalg", "factorization", "(\"eigen\", \"typename(Diagonal)\", 256)"]` | 2.14 (45%) :x: | 1.00 (1%)  |
| `["micro", "printfd"]` | 0.76 (5%) :white_check_mark: | 1459.15 (1%) :x: |
...
| `["misc", "fastmath many args"]` | 1.73 (5%) :x: | 1.00 (1%)  |
...
| `["scalar", "acosh", "(\"1 <= abs(x) < 2\", \"positive argument\", \"Float64\")"]` | 1.12 (5%) :x: | 1.00 (1%)  |
...
| `["scalar", "cos", "(\"argument reduction (hard) abs(x) < 2π/4\", \"positive argument\", \"Float32\", \"sin_kernel\")"]` | 0.79 (5%) :white_check_mark: | 1.00 (1%)  |
...
| `["scalar", "cos", "(\"argument reduction (hard) abs(x) < 6π/4\", \"positive argument\", \"Float32\", \"sin_kernel\")"]` | 0.79 (5%) :white_check_mark: | 1.00 (1%)  |
...
| `["scalar", "tanh", "(\"very small\", \"positive argument\", \"Float64\")"]` | 1.69 (5%) :x: | 1.00 (1%)  |
...
| `["sparse", "constructors", "(\"IV\", 10)"]` | 1.22 (5%) :x: | 1.00 (1%)  |
...
```
Julia Version 1.6.0-DEV.855
Commit 31d7210 (2020-09-07 18:08 UTC)
Platform Info:
  ...
  CPU: Intel(R) Xeon(R) CPU E3-1241 v3 @ 3.50GHz: 
       ...
       #1  3501 MHz  158066778 s       5069 s   17497476 s  7546044418 s         39 s
       #2  3501 MHz  1202828666 s        220 s   24476589 s  6504913964 s         29 s
       #3  3501 MHz  143606177 s       3325 s   10589677 s  7576689954 s         40 s
       #4  3501 MHz  134383029 s         43 s   15465646 s  7579343498 s         28 s
       
  Memory: 31.383651733398438 GB (14590.79296875 MB free)
  Uptime: 7.7382297e7 sec
