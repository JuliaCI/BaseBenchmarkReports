...
*Commit(s):* [JuliaLang/julia@48f942bdd659ae55d7d3e34dcf15dbb8bd871d71](https://github.com/JuliaLang/julia/commit/48f942bdd659ae55d7d3e34dcf15dbb8bd871d71)

*Triggered By:* [link](https://github.com/JuliaLang/julia/commit/48f942bdd659ae55d7d3e34dcf15dbb8bd871d71#commitcomment-37307166)

*Tag Predicate:* `ALL`

*Daily Job:* 2020-02-15 vs 2020-02-14
...
| `["find", "findall", "(\"Array{Bool,1}\", \"10-90\")"]` | 0.82 (5%) :white_check_mark: | 1.00 (1%)  |
...
| `["random", "ranges", "(\"RangeGenerator\", \"UInt32\", \"1:1\")"]` | 1.81 (25%) :x: | 1.00 (1%)  |
| `["random", "ranges", "(\"rand\", \"MersenneTwister\", \"UInt64\", \"RangeGenerator(1:4294967297)\")"]` | 1.32 (25%) :x: | 1.00 (1%)  |
| `["random", "types", "(\"rand\", \"MersenneTwister\", \"Complex{Int8}\")"]` | 1.56 (25%) :x: | 1.00 (1%)  |
| `["random", "types", "(\"randexp\", \"ImplicitRNG\", \"Float64\")"]` | 1.56 (25%) :x: | 1.00 (1%)  |
| `["scalar", "acos", "(\"abs(x) < 0.5\", \"positive argument\", \"Float32\")"]` | 1.24 (5%) :x: | 1.00 (1%)  |
| `["scalar", "acos", "(\"small\", \"negative argument\", \"Float64\")"]` | 0.94 (5%) :white_check_mark: | 1.00 (1%)  |
| `["scalar", "acos", "(\"small\", \"positive argument\", \"Float32\")"]` | 1.33 (5%) :x: | 1.00 (1%)  |
...
| `["scalar", "cos", "(\"argument reduction (easy) abs(x) < 2π/4\", \"positive argument\", \"Float32\", \"sin_kernel\")"]` | 1.17 (5%) :x: | 1.00 (1%)  |
...
| `["scalar", "cos", "(\"argument reduction (easy) abs(x) < 3π/4\", \"positive argument\", \"Float64\", \"sin_kernel\")"]` | 1.17 (5%) :x: | 1.00 (1%)  |
...
| `["scalar", "cosh", "(\"very large\", \"positive argument\", \"Float64\")"]` | 0.70 (5%) :white_check_mark: | 1.00 (1%)  |
...
| `["scalar", "fastmath", "(\"sub\", \"BigInt\")"]` | 1.63 (40%) :x: | 1.00 (1%)  |
...
| `["sparse", "matmul", "(\"At_mul_B!\", \"sparse 40x400, dense 40x400 -> dense 400x400\")"]` | 0.66 (30%) :white_check_mark: | 1.00 (1%)  |
...
| `["union", "array", "(\"broadcast\", abs, Int8, true)"]` | 1.21 (5%) :x: | 1.00 (1%)  |
| `["union", "array", "(\"broadcast\", identity, BigFloat, true)"]` | 1.07 (5%) :x: | 1.00 (1%)  |
| `["union", "array", "(\"broadcast\", identity, BigInt, true)"]` | 1.21 (5%) :x: | 1.00 (1%)  |
...
| `["union", "array", "(\"perf_sum\", BigFloat, true)"]` | 0.92 (5%) :white_check_mark: | 1.00 (1%)  |
...
| `["union", "array", "(\"skipmissing\", sum, Union{Nothing, Int8}, false)"]` | 0.59 (5%) :white_check_mark: | 1.00 (1%)  |
| `["union", "array", "(\"sort\", Union{Nothing, Float32}, false)"]` | 0.74 (5%) :white_check_mark: | 1.00 (1%)  |
| `["union", "array", "(\"sort\", Union{Nothing, Int64}, false)"]` | 1.53 (5%) :x: | 1.00 (1%)  |
...
```
Julia Version 1.5.0-DEV.272
Commit 48f942b (2020-02-14 20:44 UTC)
Platform Info:
  ...
  CPU: Intel(R) Xeon(R) CPU E3-1241 v3 @ 3.50GHz: 
       ...
       #1  3501 MHz  123125813 s       5052 s   14232409 s  5807840024 s         33 s
       #2  3501 MHz  912599785 s        217 s   17396255 s  5024286541 s         26 s
       #3  3501 MHz  107370529 s       3272 s    8438113 s  5838675461 s         36 s
       #4  3501 MHz  100637025 s         43 s   12132117 s  5839302643 s         26 s
       
  Memory: 31.383651733398438 GB (17916.875 MB free)
  Uptime: 5.9587443e7 sec
