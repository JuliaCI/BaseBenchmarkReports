...
*Commit(s):* [JuliaLang/julia@57c6786d69c4cfa8df182d38ca4834395da237e7](https://github.com/JuliaLang/julia/commit/57c6786d69c4cfa8df182d38ca4834395da237e7)

*Triggered By:* [link](https://github.com/JuliaLang/julia/commit/57c6786d69c4cfa8df182d38ca4834395da237e7#commitcomment-36973642)
...
| `["collection", "queries & updates", "(\"Set\", \"Int\", \"in\", \"true\")"]` | 1.30 (25%) :x: | 1.00 (1%)  |
| `["dates", "string", "DateTime"]` | 1.06 (5%) :x: | 1.00 (1%)  |
| `["find", "findnext", "(\"ispos\", \"Array{Int64,1}\")"]` | 1.13 (5%) :x: | 1.00 (1%)  |
| `["io", "array_limit", "(\"display\", \"Array{Float64,1}(100000000,)\")"]` | 1.10 (5%) :x: | 1.00 (1%)  |
| `["io", "array_limit", "(\"display\", \"Array{Float64,2}(10000, 10000)\")"]` | 1.15 (5%) :x: | 1.04 (1%) :x: |
...
| `["random", "collections", "(\"rand\", \"MersenneTwister\", \"small Vector\")"]` | 1.40 (25%) :x: | 1.00 (1%)  |
...
| `["scalar", "arithmetic", "(\"rem type\", \"Bool\", \"BigInt\")"]` | 2.10 (40%) :x: | 1.00 (1%)  |
...
| `["scalar", "cos", "(\"argument reduction (easy) abs(x) < 6π/4\", \"negative argument\", \"Float64\", \"sin_kernel\")"]` | 0.61 (5%) :white_check_mark: | 1.00 (1%)  |
...
| `["scalar", "cos", "(\"argument reduction (hard) abs(x) < 6π/4\", \"negative argument\", \"Float64\", \"sin_kernel\")"]` | 0.87 (5%) :white_check_mark: | 1.00 (1%)  |
...
| `["union", "array", "(\"perf_sum2\", Int8, true)"]` | 0.90 (5%) :white_check_mark: | 1.00 (1%)  |
...
```
Julia Version 1.5.0-DEV.153
Commit 57c6786 (2020-01-26 22:36 UTC)
Platform Info:
  ...
  CPU: Intel(R) Xeon(R) CPU E3-1241 v3 @ 3.50GHz: 
       ...
       #1  3501 MHz  120002776 s       5052 s   13903245 s  5647470685 s         32 s
       #2  3501 MHz  885269515 s        217 s   16731811 s  4888246075 s         26 s
       #3  3501 MHz  104194750 s       3267 s    8265808 s  5677979216 s         36 s
       #4  3501 MHz   97635061 s         43 s   11844409 s  5678604481 s         26 s
       
  Memory: 31.383651733398438 GB (18641.67578125 MB free)
  Uptime: 5.7945765e7 sec
