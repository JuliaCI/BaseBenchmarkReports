...
*Commit(s):* [JuliaLang/julia@d9f893e6c06cd84bf743fdf8abda1b8b265f28fd](https://github.com/JuliaLang/julia/commit/d9f893e6c06cd84bf743fdf8abda1b8b265f28fd) vs [JuliaLang/julia@5b241c2aa97b824ff6b87ad0f89ef05fbb309ddf](https://github.com/JuliaLang/julia/commit/5b241c2aa97b824ff6b87ad0f89ef05fbb309ddf)

*Triggered By:* [link](https://github.com/JuliaLang/julia/pull/34940#issuecomment-593564685)
...
| `["array", "cat", "(\"catnd_setind\", 5)"]` | 1.27 (5%) :x: | 1.00 (1%)  |
...
| `["broadcast", "mix_scalar_tuple", "(3, \"scal_tup_x3\")"]` | 1.59 (5%) :x: | 1.00 (1%)  |
| `["collection", "deletion", "(\"Set\", \"Int\", \"pop!\")"]` | 1.31 (25%) :x: | 1.00 (1%)  |
| `["collection", "queries & updates", "(\"IdDict\", \"String\", \"push!\", \"new\")"]` | 0.68 (25%) :white_check_mark: | 1.00 (1%)  |
| `["collection", "queries & updates", "(\"IdDict\", \"String\", \"setindex!\", \"new\")"]` | 0.64 (25%) :white_check_mark: | 1.00 (1%)  |
...
| `["io", "array_limit", "(\"display\", \"Array{Float64,2}(10000, 10000)\")"]` | 1.01 (5%)  | 0.97 (1%) :white_check_mark: |
| `["linalg", "arithmetic", "(\"*\", \"Bidiagonal\", \"Vector\", 1024)"]` | 1.47 (45%) :x: | 1.00 (1%)  |
...
| `["random", "collections", "(\"rand\", \"MersenneTwister\", \"large Vector\")"]` | 0.73 (25%) :white_check_mark: | 1.00 (1%)  |
| `["random", "types", "(\"rand\", \"MersenneTwister\", \"Complex{Float16}\")"]` | 0.56 (25%) :white_check_mark: | 1.00 (1%)  |
...
| `["scalar", "predicate", "(\"isnan\", \"Complex{UInt64}\")"]` | 0.59 (25%) :white_check_mark: | 1.00 (1%)  |
...
| `["simd", "(\"auto_conditional_loop!\", \"Int32\", 4095)"]` | 0.67 (20%) :white_check_mark: | 1.00 (1%)  |
| `["simd", "(\"auto_conditional_loop!\", \"Int32\", 4096)"]` | 0.69 (20%) :white_check_mark: | 1.00 (1%)  |
...
| `["simd", "(\"conditional_loop!\", \"Int32\", 4096)"]` | 0.62 (20%) :white_check_mark: | 1.00 (1%)  |
...
| `["simd", "(\"conditional_loop!_aliased\", \"Int32\", 4096)"]` | 0.62 (20%) :white_check_mark: | 1.00 (1%)  |
| `["simd", "(\"conditional_loop!_aliased\", \"Int64\", 4095)"]` | 0.80 (20%) :white_check_mark: | 1.00 (1%)  |
...
| `["union", "array", "(\"broadcast\", identity, BigFloat, true)"]` | 0.87 (5%) :white_check_mark: | 1.00 (1%)  |
| `["union", "array", "(\"broadcast\", identity, Bool, true)"]` | 0.93 (5%) :white_check_mark: | 1.00 (1%)  |
| `["union", "array", "(\"broadcast\", identity, Complex{Float64}, false)"]` | 1.65 (5%) :x: | 1.00 (1%)  |
...
| `["union", "array", "(\"map\", abs, BigInt, false)"]` | 1.65 (5%) :x: | 1.00 (1%)  |
...
| `["union", "array", "(\"map\", identity, Float64, true)"]` | 1.25 (5%) :x: | 1.00 (1%)  |
...
| `["union", "array", "(\"perf_sum\", Complex{Float64}, true)"]` | 0.72 (5%) :white_check_mark: | 1.00 (1%)  |
...
| `["union", "array", "(\"skipmissing\", sum, Union{Nothing, Int8}, false)"]` | 1.57 (5%) :x: | 1.00 (1%)  |
...
Commit d9f893e (2020-03-02 19:03 UTC)
Platform Info:
  ...
  CPU: Intel(R) Xeon(R) CPU E3-1241 v3 @ 3.50GHz: 
       ...
       #1  3501 MHz   54651622 s       2446 s   18565609 s  6008997606 s         18 s
       #2  3501 MHz  338830301 s         62 s    6953209 s  5752668195 s         26 s
       #3  3501 MHz   45763621 s       3214 s    5433674 s  6046591678 s         38 s
       #4  3501 MHz   44063567 s         19 s    4267048 s  6052116561 s         36 s
       
  Memory: 31.383651733398438 GB (19164.6875 MB free)
  Uptime: 6.1022114e7 sec
...
Commit 5b241c2 (2020-03-02 14:46 UTC)
Platform Info:
  OS: Linux (x86_64-linux-gnu)
      Ubuntu 14.04.5 LTS
  uname: Linux 3.13.0-85-generic #129-Ubuntu SMP Thu Mar 17 20:50:15 UTC 2016 x86_64 x86_64
  CPU: Intel(R) Xeon(R) CPU E3-1241 v3 @ 3.50GHz: 
              speed         user         nice          sys         idle          irq
       #1  3501 MHz   54799002 s       2446 s   18576324 s  6010293013 s         18 s
       #2  3501 MHz  340170038 s         62 s    6980324 s  5752759768 s         26 s
       #3  3501 MHz   45913304 s       3214 s    5439682 s  6047893602 s         38 s
       #4  3501 MHz   44229682 s         19 s    4273210 s  6053402767 s         36 s
       
  Memory: 31.383651733398438 GB (18194.7265625 MB free)
  Uptime: 6.1036703e7 sec
  Load Avg:  1.0029296875  1.0146484375  1.04541015625
  WORD_SIZE: 64
  LIBM: libopenlibm
  LLVM: libLLVM-9.0.1 (ORCJIT, haswell)
