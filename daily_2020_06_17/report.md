...
*Commit(s):* [JuliaLang/julia@bf3ed5788eb9993db71798372128d47855d86715](https://github.com/JuliaLang/julia/commit/bf3ed5788eb9993db71798372128d47855d86715)

*Triggered By:* [link](https://github.com/JuliaLang/julia/commit/bf3ed5788eb9993db71798372128d47855d86715#commitcomment-39960937)
...
| `["collection", "queries & updates", "(\"Dict\", \"Int\", \"in\", \"true\")"]` | 1.33 (25%) :x: | 1.00 (1%)  |
| `["collection", "queries & updates", "(\"Vector\", \"Any\", \"setindex!\")"]` | 2.35 (25%) :x: | 1.00 (1%)  |
...
| `["parallel", "remotecall", "(\"identity\", 1024)"]` | 0.97 (5%)  | 0.96 (1%) :white_check_mark: |
| `["parallel", "remotecall", "(\"identity\", 2)"]` | 0.97 (5%)  | 0.91 (1%) :white_check_mark: |
| `["parallel", "remotecall", "(\"identity\", 4096)"]` | 0.97 (5%)  | 0.98 (1%) :white_check_mark: |
| `["parallel", "remotecall", "(\"identity\", 512)"]` | 0.97 (5%)  | 0.95 (1%) :white_check_mark: |
| `["parallel", "remotecall", "(\"identity\", 64)"]` | 0.97 (5%)  | 0.92 (1%) :white_check_mark: |
...
| `["random", "ranges", "(\"RangeGenerator\", \"Int32\", \"1:1\")"]` | 1.47 (25%) :x: | 1.00 (1%)  |
...
| `["scalar", "atan2", "(\"abs(y/x) safe (large)\", \"y negative\", \"x negative\", \"Float64\")"]` | 1.14 (5%) :x: | 1.00 (1%)  |
...
| `["scalar", "cos", "(\"no reduction\", \"zero\", \"Float32\")"]` | 1.33 (5%) :x: | 1.00 (1%)  |
...
| `["sparse", "constructors", "(\"IV\", 10)"]` | 1.23 (5%) :x: | 1.00 (1%)  |
| `["sparse", "constructors", "(\"IV\", 1000)"]` | 1.20 (5%) :x: | 1.00 (1%)  |
...
| `["union", "array", "(\"broadcast\", identity, Complex{Float64}, true)"]` | 1.14 (5%) :x: | 1.00 (1%)  |
...
| `["union", "array", "(\"perf_sum2\", BigFloat, true)"]` | 0.92 (5%) :white_check_mark: | 1.00 (1%)  |
