...
*Commit(s):* [JuliaLang/julia@69fabf7aa03643cba155b3aa237fa8fdd27b7e3c](https://github.com/JuliaLang/julia/commit/69fabf7aa03643cba155b3aa237fa8fdd27b7e3c)

*Triggered By:* [link](https://github.com/JuliaLang/julia/commit/69fabf7aa03643cba155b3aa237fa8fdd27b7e3c#commitcomment-31359930)

*Tag Predicate:* `ALL`

*Daily Job:* 2018-11-20 vs 2018-11-19
...
| `["array", "cat", "(\"hcat\", 500)"]` | 0.95 (5%) :white_check_mark: | 1.00 (1%)  |
...
| `["array", "subarray", "(\"lucompletepivCopy!\", 500)"]` | 0.81 (5%) :white_check_mark: | 1.00 (1%)  |
...
| `["array", "subarray", "(\"lucompletepivSub!\", 500)"]` | 0.84 (5%) :white_check_mark: | 1.00 (1%)  |
| `["broadcast", "mix_scalar_tuple", "(10, \"scal_tup_x3\")"]` | 0.92 (5%) :white_check_mark: | 1.00 (1%)  |
| `["collection", "deletion", "(\"Vector\", \"Any\", \"filter!\")"]` | 1.86 (25%) :x: | 1.00 (1%)  |
| `["collection", "queries & updates", "(\"BitSet\", \"Int\", \"in\", \"false\")"]` | 0.70 (25%) :white_check_mark: | 1.00 (1%)  |
| `["collection", "queries & updates", "(\"BitSet\", \"Int\", \"in\", \"true\")"]` | 0.70 (25%) :white_check_mark: | 1.00 (1%)  |
...
| `["collection", "queries & updates", "(\"Set\", \"String\", \"pop!\", \"unspecified\")"]` | 0.64 (25%) :white_check_mark: | 1.00 (1%)  |
| `["collection", "queries & updates", "(\"Set\", \"String\", \"push!\", \"new\")"]` | 0.55 (25%) :white_check_mark: | 1.00 (1%)  |
| `["collection", "queries & updates", "(\"Set\", \"String\", \"push!\", \"overwrite\")"]` | 0.73 (25%) :white_check_mark: | 1.00 (1%)  |
...
| `["dates", "parse", "(\"DateTime\", \"RFC1123Format\", \"Lowercase\")"]` | 0.78 (5%) :white_check_mark: | 1.00 (1%)  |
...
| `["scalar", "atan2", "(\"abs(y/x) safe (large)\", \"y negative\", \"x negative\", \"Float32\")"]` | 1.34 (5%) :x: | 1.00 (1%)  |
| `["scalar", "atan2", "(\"abs(y/x) safe (large)\", \"y negative\", \"x positive\", \"Float32\")"]` | 1.35 (5%) :x: | 1.00 (1%)  |
| `["scalar", "atan2", "(\"abs(y/x) safe (large)\", \"y positive\", \"x negative\", \"Float32\")"]` | 1.31 (5%) :x: | 1.00 (1%)  |
| `["scalar", "atan2", "(\"abs(y/x) safe (large)\", \"y positive\", \"x positive\", \"Float32\")"]` | 1.35 (5%) :x: | 1.00 (1%)  |
...
| `["scalar", "atan2", "(\"abs(y/x) safe (small)\", \"y positive\", \"x negative\", \"Float32\")"]` | 1.10 (5%) :x: | 1.00 (1%)  |
...
| `["scalar", "atanh", "(\"very small\", \"negative argument\", \"Float32\")"]` | 0.84 (5%) :white_check_mark: | 1.00 (1%)  |
...
| `["shootout", "regex_dna"]` | 1.10 (5%) :x: | 1.00 (1%)  |
...
| `["union", "array", "(\"map\", *, Int64, (false, false))"]` | 0.94 (5%) :white_check_mark: | 1.00 (1%)  |
...
| `["union", "array", "(\"skipmissing\", sum, BigInt, true)"]` | 0.91 (5%) :white_check_mark: | 1.00 (1%)  |
...
```
Julia Version 1.1.0-DEV.694
Commit 69fabf7 (2018-11-20 00:51 UTC)
Platform Info:
  ...
  CPU: Intel(R) Xeon(R) CPU E3-1241 v3 @ 3.50GHz: 
       ...
       #1  3501 MHz   62354838 s       5007 s    6840062 s  1978884004 s         22 s
       #2  3501 MHz  339658415 s        203 s    5465706 s  1706488888 s         17 s
       #3  3501 MHz   46286363 s       3212 s    3935629 s  2001291836 s         25 s
       #4  3501 MHz   43021140 s          0 s    4971560 s  2003148258 s         15 s
       
  Memory: 31.383651733398438 GB (4919.52734375 MB free)
  Uptime: 2.0533164e7 sec
