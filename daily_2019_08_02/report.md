...
*Commit(s):* [JuliaLang/julia@dc0bf52d0bd8ccfab414d1f465569fdd0755ae73](https://github.com/JuliaLang/julia/commit/dc0bf52d0bd8ccfab414d1f465569fdd0755ae73)

*Triggered By:* [link](https://github.com/JuliaLang/julia/commit/dc0bf52d0bd8ccfab414d1f465569fdd0755ae73#commitcomment-34543132)

*Tag Predicate:* `ALL`

*Daily Job:* 2019-08-02 vs 2019-08-01
...
| `["collection", "iteration", "(\"Vector\", \"Int\", \"iterate second\")"]` | 1.29 (25%) :x: | 1.00 (1%)  |
...
| `["find", "findprev", "(\"BitArray{1}\", \"10-90\")"]` | 0.91 (5%) :white_check_mark: | 1.00 (1%)  |
| `["find", "findprev", "(\"ispos\", \"Array{UInt8,1}\")"]` | 0.91 (5%) :white_check_mark: | 1.00 (1%)  |
| `["io", "array_limit", "(\"display\", \"Array{Float64,2}(10000, 10000)\")"]` | 0.91 (5%) :white_check_mark: | 0.88 (1%) :white_check_mark: |
| `["linalg", "arithmetic", "(\"-\", \"LowerTriangular\", \"LowerTriangular\", 256)"]` | 2.54 (45%) :x: | 1.00 (1%)  |
| `["linalg", "arithmetic", "(\"-\", \"Matrix\", \"Matrix\", 256)"]` | 0.43 (45%) :white_check_mark: | 1.00 (1%)  |
| `["misc", "bitshift", "(\"Int\", \"Int\")"]` | 1.13 (5%) :x: | 1.00 (1%)  |
...
| `["random", "types", "(\"rand!\", \"MersenneTwister\", \"Complex{Float64}\")"]` | 1.30 (25%) :x: | 1.00 (1%)  |
...
| `["scalar", "acosh", "(\"very large\", \"positive argument\", \"Float64\")"]` | 1.69 (5%) :x: | 1.00 (1%)  |
| `["scalar", "arithmetic", "(\"div\", \"Complex{BigFloat}\", \"UInt64\")"]` | 1.53 (50%) :x: | 1.00 (1%)  |
...
| `["scalar", "sin", "(\"argument reduction (easy) abs(x) < 2.0^20π/4\", \"negative argument\", \"Float64\", \"sin_kernel\")"]` | 0.76 (5%) :white_check_mark: | 1.00 (1%)  |
...
| `["sparse", "constructors", "(\"Bidiagonal\", 100)"]` | 1.31 (5%) :x: | 1.00 (1%)  |
...
| `["union", "array", "(\"map\", identity, Int64, true)"]` | 0.65 (5%) :white_check_mark: | 1.00 (1%)  |
...
| `["union", "array", "(\"perf_simplecopy\", Int8, true)"]` | 0.77 (5%) :white_check_mark: | 1.00 (1%)  |
| `["union", "array", "(\"perf_sum2\", Bool, true)"]` | 0.79 (5%) :white_check_mark: | 1.00 (1%)  |
...
```
Julia Version 1.3.0-alpha.39
Commit dc0bf52 (2019-08-02 03:01 UTC)
Platform Info:
  ...
  CPU: Intel(R) Xeon(R) CPU E3-1241 v3 @ 3.50GHz: 
       ...
       #1  3501 MHz   94980886 s       5038 s   10976257 s  4140456751 s         27 s
       #2  3501 MHz  631727014 s        208 s   10726762 s  3610648225 s         23 s
       #3  3501 MHz   78423931 s       3244 s    6529090 s  4168157795 s         31 s
       #4  3501 MHz   73573384 s         20 s    9246902 s  4168564868 s         22 s
       
  Memory: 31.383651733398438 GB (15224.49609375 MB free)
  Uptime: 4.2562538e7 sec
