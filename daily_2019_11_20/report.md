...
*Commit(s):* [JuliaLang/julia@0a277811c8b40bcf2fe6e38166806bc3c51d87da](https://github.com/JuliaLang/julia/commit/0a277811c8b40bcf2fe6e38166806bc3c51d87da)

*Triggered By:* [link](https://github.com/JuliaLang/julia/commit/0a277811c8b40bcf2fe6e38166806bc3c51d87da#commitcomment-36042578)

*Tag Predicate:* `ALL`

*Daily Job:* 2019-11-20 vs 2019-11-19
...
| `["array", "any/all", "(\"any\", \"Array{Float32,1} generator\")"]` | 1.58 (5%) :x: | 1.00 (1%)  |
...
| `["array", "equality", "(\"isequal\", \"Array{Int64,1} isequal Array{Int64,1}\")"]` | 0.68 (5%) :white_check_mark: | 1.00 (1%)  |
...
| `["array", "growth", "(\"push_single!\", 8)"]` | 0.78 (5%) :white_check_mark: | 1.00 (1%)  |
...
| `["collection", "deletion", "(\"Dict\", \"String\", \"pop!\")"]` | 1.58 (25%) :x: | 1.00 (1%)  |
| `["collection", "queries & updates", "(\"Dict\", \"Any\", \"in\", \"false\")"]` | 0.75 (25%) :white_check_mark: | 1.00 (1%)  |
| `["collection", "queries & updates", "(\"Dict\", \"Int\", \"pop!\", \"unspecified\")"]` | 0.59 (25%) :white_check_mark: | 1.00 (1%)  |
| `["collection", "queries & updates", "(\"Dict\", \"Int\", \"push!\", \"new\")"]` | 0.50 (25%) :white_check_mark: | 1.00 (1%)  |
| `["collection", "queries & updates", "(\"Dict\", \"Int\", \"setindex!\", \"new\")"]` | 0.49 (25%) :white_check_mark: | 1.00 (1%)  |
...
| `["collection", "set operations", "(\"Vector\", \"Int\", \"⊆\", \"Vector\")"]` | 0.70 (25%) :white_check_mark: | 1.00 (1%)  |
...
| `["random", "types", "(\"rand\", \"ImplicitRNG\", \"Int64\")"]` | 0.59 (25%) :white_check_mark: | 1.00 (1%)  |
| `["random", "types", "(\"randn\", \"ImplicitRNG\", \"Float64\")"]` | 0.74 (25%) :white_check_mark: | 1.00 (1%)  |
...
| `["scalar", "acos", "(\"abs(x) < 0.5\", \"negative argument\", \"Float64\")"]` | 0.86 (5%) :white_check_mark: | 1.00 (1%)  |
| `["scalar", "acos", "(\"abs(x) < 0.5\", \"positive argument\", \"Float32\")"]` | 0.88 (5%) :white_check_mark: | 1.00 (1%)  |
| `["scalar", "acos", "(\"abs(x) < 0.5\", \"positive argument\", \"Float64\")"]` | 0.86 (5%) :white_check_mark: | 1.00 (1%)  |
...
| `["scalar", "acosh", "(\"very large\", \"positive argument\", \"Float64\")"]` | 0.86 (5%) :white_check_mark: | 1.00 (1%)  |
| `["scalar", "arithmetic", "(\"rem type\", \"Bool\", \"BigInt\")"]` | 0.51 (40%) :white_check_mark: | 1.00 (1%)  |
| `["scalar", "arithmetic", "(\"rem type\", \"Int64\", \"BigInt\")"]` | 1.56 (40%) :x: | 1.00 (1%)  |
...
| `["scalar", "asinh", "(\"2^-28 <= abs(x) < 2\", \"negative argument\", \"Float64\")"]` | 0.92 (5%) :white_check_mark: | 1.00 (1%)  |
...
| `["scalar", "atan", "(\"39/16 <= abs(x) < 2^66\", \"negative argument\", \"Float64\")"]` | 0.78 (5%) :white_check_mark: | 1.00 (1%)  |
| `["scalar", "atan", "(\"39/16 <= abs(x) < 2^66\", \"positive argument\", \"Float32\")"]` | 0.90 (5%) :white_check_mark: | 1.00 (1%)  |
...
| `["scalar", "atan2", "(\"abs(y/x) high\", \"y positive\", \"x positive\", \"Float64\")"]` | 0.70 (5%) :white_check_mark: | 1.00 (1%)  |
| `["scalar", "atan2", "(\"abs(y/x) safe (large)\", \"y negative\", \"x negative\", \"Float32\")"]` | 0.76 (5%) :white_check_mark: | 1.00 (1%)  |
...
| `["scalar", "atan2", "(\"abs(y/x) safe (large)\", \"y positive\", \"x negative\", \"Float64\")"]` | 0.93 (5%) :white_check_mark: | 1.00 (1%)  |
...
| `["scalar", "cos", "(\"argument reduction (paynehanek) abs(x) > 2.0^20*π/2\", \"negative argument\", \"Float32\", \"cos_kernel\")"]` | 0.93 (5%) :white_check_mark: | 1.00 (1%)  |
...
| `["scalar", "exp2", "(\"very small\", \"negative argument\", \"Float32\")"]` | 0.75 (5%) :white_check_mark: | 1.00 (1%)  |
...
| `["scalar", "expm1", "(\"arg reduction II\", \"positive argument\", \"Float32\")"]` | 0.76 (5%) :white_check_mark: | 1.00 (1%)  |
| `["scalar", "expm1", "(\"arg reduction II\", \"positive argument\", \"Float64\")"]` | 0.88 (5%) :white_check_mark: | 1.00 (1%)  |
| `["scalar", "expm1", "(\"arg reduction I\", \"negative argument\", \"Float32\")"]` | 0.76 (5%) :white_check_mark: | 1.00 (1%)  |
...
| `["scalar", "sin", "(\"argument reduction (easy) abs(x) < 4π/4\", \"negative argument\", \"Float64\", \"sin_kernel\")"]` | 0.81 (5%) :white_check_mark: | 1.00 (1%)  |
...
| `["scalar", "sin", "(\"argument reduction (paynehanek) abs(x) > 2.0^20*π/2\", \"negative argument\", \"Float64\", \"sin_kernel\")"]` | 0.87 (5%) :white_check_mark: | 1.00 (1%)  |
...
| `["scalar", "sincos", "(\"argument reduction (easy) abs(x) < 2π/4\", \"negative argument\", \"Float32\")"]` | 0.76 (5%) :white_check_mark: | 1.00 (1%)  |
| `["scalar", "sincos", "(\"argument reduction (easy) abs(x) < 5π/4\", \"positive argument\", \"Float32\")"]` | 0.81 (5%) :white_check_mark: | 1.00 (1%)  |
...
| `["scalar", "tan", "(\"small\", \"negative argument\", \"Float32\")"]` | 0.38 (5%) :white_check_mark: | 1.00 (1%)  |
| `["scalar", "tan", "(\"small\", \"positive argument\", \"Float32\")"]` | 0.79 (5%) :white_check_mark: | 1.00 (1%)  |
| `["scalar", "tan", "(\"very small\", \"negative argument\", \"Float32\")"]` | 0.71 (5%) :white_check_mark: | 1.00 (1%)  |
| `["scalar", "tan", "(\"very small\", \"negative argument\", \"Float64\")"]` | 0.83 (5%) :white_check_mark: | 1.00 (1%)  |
| `["scalar", "tan", "(\"very small\", \"positive argument\", \"Float32\")"]` | 0.83 (5%) :white_check_mark: | 1.00 (1%)  |
| `["scalar", "tan", "(\"very small\", \"positive argument\", \"Float64\")"]` | 0.52 (5%) :white_check_mark: | 1.00 (1%)  |
...
| `["scalar", "tanh", "(\"1f0 <= abs(x) < 9f0\", \"negative argument\", \"Float32\")"]` | 0.90 (5%) :white_check_mark: | 1.00 (1%)  |
| `["scalar", "tanh", "(\"1f0 <= abs(x) < 9f0\", \"positive argument\", \"Float32\")"]` | 0.90 (5%) :white_check_mark: | 1.00 (1%)  |
...
| `["sort", "issorted", "(\"forwards\", \"ascending\")"]` | 1.48 (30%) :x: | 1.00 (1%)  |
...
| `["union", "array", "(\"broadcast\", abs, BigInt, false)"]` | 1.13 (5%) :x: | 1.00 (1%)  |
...
| `["union", "array", "(\"map\", identity, BigFloat, true)"]` | 1.31 (5%) :x: | 1.00 (1%)  |
...
| `["union", "array", "(\"perf_countequals\", \"BigInt\")"]` | 1.23 (5%) :x: | 1.00 (1%)  |
...
| `["union", "array", "(\"perf_sum2\", BigInt, false)"]` | 1.25 (5%) :x: | 1.00 (1%)  |
...
Platform Info:
  ...
  CPU: Intel(R) Xeon(R) CPU E3-1241 v3 @ 3.50GHz: 
       ...
       #1  3501 MHz  108997850 s       5047 s   12721593 s  5073382725 s         30 s
       #2  3501 MHz  782168705 s        217 s   14208827 s  4406729633 s         25 s
       #3  3501 MHz   92943214 s       3256 s    7551781 s  5102763711 s         34 s
       #4  3501 MHz   87060732 s         34 s   10804604 s  5103261266 s         24 s
       
  Memory: 31.383651733398438 GB (15339.0625 MB free)
  Uptime: 5.2069985e7 sec
