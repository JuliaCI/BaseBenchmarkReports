...
*Commit(s):* [JuliaLang/julia@604046c1e1063d393261c07fc66a4f825b244697](https://github.com/JuliaLang/julia/commit/604046c1e1063d393261c07fc66a4f825b244697)

*Triggered By:* [link](https://github.com/JuliaLang/julia/commit/604046c1e1063d393261c07fc66a4f825b244697#commitcomment-31322856)

*Tag Predicate:* `ALL`

*Daily Job:* 2018-11-16 vs 2018-11-15
...
| `["random", "collections", "(\"rand\", \"ImplicitRNG\", \"large Set\")"]` | 1.34 (25%) :x: | 1.00 (1%)  |
| `["random", "collections", "(\"rand\", \"ImplicitRNG\", \"small Set\")"]` | 1.33 (25%) :x: | 1.00 (1%)  |
| `["random", "collections", "(\"rand\", \"MersenneTwister\", \"small Set\")"]` | 1.34 (25%) :x: | 1.00 (1%)  |
...
| `["scalar", "arithmetic", "(\"add\", \"BigFloat\", \"Complex{BigInt}\")"]` | 1.54 (50%) :x: | 1.00 (1%)  |
| `["scalar", "arithmetic", "(\"add\", \"BigFloat\", \"Complex{UInt64}\")"]` | 1.65 (50%) :x: | 1.00 (1%)  |
| `["scalar", "arithmetic", "(\"add\", \"Complex{BigInt}\", \"BigFloat\")"]` | 1.52 (50%) :x: | 1.00 (1%)  |
...
| `["scalar", "expm1", "(\"huge\", \"positive argument\", \"Float64\")"]` | 1.27 (5%) :x: | 1.00 (1%)  |
| `["scalar", "expm1", "(\"large\", \"negative argument\", \"Float32\")"]` | 0.94 (5%) :white_check_mark: | 1.00 (1%)  |
| `["scalar", "expm1", "(\"large\", \"positive argument\", \"Float32\")"]` | 1.60 (5%) :x: | 1.00 (1%)  |
...
| `["union", "array", "(\"broadcast\", identity, BigInt, false)"]` | 1.20 (5%) :x: | 1.00 (1%)  |
| `["union", "array", "(\"map\", *, Bool, (false, false))"]` | 1.29 (5%) :x: | 1.00 (1%)  |
| `["union", "array", "(\"map\", *, Bool, (false, true))"]` | 1.30 (5%) :x: | 1.00 (1%)  |
| `["union", "array", "(\"map\", *, Bool, (true, true))"]` | 1.24 (5%) :x: | 1.00 (1%)  |
| `["union", "array", "(\"map\", *, Complex{Float64}, (true, true))"]` | 1.07 (5%) :x: | 1.00 (1%)  |
| `["union", "array", "(\"map\", *, Float32, (false, false))"]` | 1.16 (5%) :x: | 1.00 (1%)  |
...
| `["union", "array", "(\"perf_binaryop\", *, Complex{Float64}, (false, true))"]` | 0.94 (5%) :white_check_mark: | 1.00 (1%)  |
...
| `["union", "array", "(\"perf_sum2\", BigFloat, false)"]` | 1.28 (5%) :x: | 1.00 (1%)  |
| `["union", "array", "(\"perf_sum2\", BigFloat, true)"]` | 1.28 (5%) :x: | 1.00 (1%)  |
...
| `["union", "array", "(\"perf_sum3\", BigFloat, false)"]` | 1.37 (5%) :x: | 1.00 (1%)  |
| `["union", "array", "(\"perf_sum3\", BigFloat, true)"]` | 1.36 (5%) :x: | 1.00 (1%)  |
...
| `["union", "array", "(\"perf_sum4\", BigFloat, false)"]` | 1.28 (5%) :x: | 1.00 (1%)  |
| `["union", "array", "(\"perf_sum4\", BigFloat, true)"]` | 1.25 (5%) :x: | 1.00 (1%)  |
...
| `["union", "array", "(\"perf_sum\", BigFloat, false)"]` | 1.28 (5%) :x: | 1.00 (1%)  |
| `["union", "array", "(\"perf_sum\", BigFloat, true)"]` | 1.28 (5%) :x: | 1.00 (1%)  |
...
| `["union", "array", "(\"skipmissing\", sum, BigFloat, false)"]` | 1.40 (5%) :x: | 1.00 (1%)  |
| `["union", "array", "(\"skipmissing\", sum, BigFloat, true)"]` | 1.36 (5%) :x: | 1.00 (1%)  |
...
```
Julia Version 1.1.0-DEV.664
Commit 604046c (2018-11-16 00:32 UTC)
Platform Info:
  ...
  CPU: Intel(R) Xeon(R) CPU E3-1241 v3 @ 3.50GHz: 
       ...
       #1  3501 MHz   61862728 s       5006 s    6766268 s  1944964754 s         22 s
       #2  3501 MHz  334994753 s        203 s    5382434 s  1676697261 s         16 s
       #3  3501 MHz   45789632 s       3212 s    3885443 s  1967334632 s         25 s
       #4  3501 MHz   42536062 s          0 s    4917998 s  1969152451 s         15 s
       
  Memory: 31.383651733398438 GB (5036.41796875 MB free)
  Uptime: 2.0187559e7 sec
